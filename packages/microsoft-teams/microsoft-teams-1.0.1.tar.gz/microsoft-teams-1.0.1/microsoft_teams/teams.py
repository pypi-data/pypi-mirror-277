...
class MicrosoftTeams:
    ...
    def get_access_token_ropc(tenant_id, client_id, client_secret, username, password):
    ...
    def get_team_id(access_token, team_name):
    ...
    def get_channel_id(access_token, team_id, channel_name):
