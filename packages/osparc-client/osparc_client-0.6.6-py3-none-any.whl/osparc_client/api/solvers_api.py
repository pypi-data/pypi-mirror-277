...
class SolversApi(object):
    ...
    def create_job_with_http_info(self, solver_key, version, job_inputs, **kwargs):  # noqa: E501
        ...
        all_params = ['solver_key', 'version', 'job_inputs', 'hidden']  # noqa: E501
    ...
    def delete_job(self, solver_key, version, job_id, **kwargs):  # noqa: E501
        ...
        Deletes an existing solver job  New in *version 0.5*  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_job_custom_metadata(self, solver_key, version, job_id, **kwargs):  # noqa: E501
        ...
        Gets custom metadata from a job  New in *version 0.5*  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_jobs_page(self, solver_key, version, **kwargs):  # noqa: E501
        ...
        List of jobs on a specific released solver (includes pagination)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_solver_releases_page(self, solver_key, **kwargs):  # noqa: E501
        """Get Solver Releases Page  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_solver_releases_page(solver_key, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_solver_releases_page_with_http_info(solver_key, **kwargs)  # noqa: E501

    def get_solver_releases_page_with_http_info(self, solver_key, **kwargs):  # noqa: E501
        """Get Solver Releases Page  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_solver_releases_page_with_http_info(solver_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['solver_key', 'limit', 'offset']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_solver_releases_page" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'solver_key' is set
        if self.api_client.client_side_validation and ('solver_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['solver_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `solver_key` when calling `get_solver_releases_page`")  # noqa: E501

        if self.api_client.client_side_validation and 'solver_key' in local_var_params and not re.search(r'^simcore\/services\/comp\/([a-z0-9][a-z0-9_.-]*\/)*([a-z0-9-_]+[a-z0-9])$', local_var_params['solver_key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `solver_key` when calling `get_solver_releases_page`, must conform to the pattern `/^simcore\/services\/comp\/([a-z0-9][a-z0-9_.-]*\/)*([a-z0-9-_]+[a-z0-9])$/`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_solver_releases_page`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_solver_releases_page`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `get_solver_releases_page`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/v0/solvers/{solver_key}/releases/page', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_solvers_page(self, **kwargs):  # noqa: E501
        """Get Solvers Page  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_solvers_page(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_solvers_page_with_http_info(**kwargs)  # noqa: E501

    def get_solvers_page_with_http_info(self, **kwargs):  # noqa: E501
        """Get Solvers Page  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_solvers_page_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_solvers_page" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']

        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_solvers_page`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_solvers_page`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `get_solvers_page`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def get_solvers_releases_page(self, **kwargs):  # noqa: E501
        """Get Solvers Releases Page  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_solvers_releases_page(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_solvers_releases_page_with_http_info(**kwargs)  # noqa: E501

    def get_solvers_releases_page_with_http_info(self, **kwargs):  # noqa: E501
        """Get Solvers Releases Page  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_solvers_releases_page_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_solvers_releases_page" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']

        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_solvers_releases_page`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_solvers_releases_page`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `get_solvers_releases_page`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def list_jobs(self, solver_key, version, **kwargs):  # noqa: E501
        ...
        List of jobs in a specific released solver (limited to 20 jobs)  SEE get_jobs_page for paginated version of this function  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def replace_job_custom_metadata(self, solver_key, version, job_id, job_metadata_update, **kwargs):  # noqa: E501
        ...
        Updates custom metadata from a job  New in *version 0.5*  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def start_job(self, solver_key, version, job_id, **kwargs):  # noqa: E501
        ...
        Starts job job_id created with the solver solver_key:version  New in *version 0.4.3*: cluster_id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
