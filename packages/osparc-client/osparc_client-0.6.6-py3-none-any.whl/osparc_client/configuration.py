...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of osparc_client.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the osparc_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = osparc_client.Configuration(
        signing_info = osparc_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.osparc.io",
                 ...
                 *, 
                 ...
                 retry_methods: Set[str] = {"DELETE", "GET", "HEAD", "OPTIONS", "PUT", "TRACE", "POST", "PATCH", "CONNECT"},
