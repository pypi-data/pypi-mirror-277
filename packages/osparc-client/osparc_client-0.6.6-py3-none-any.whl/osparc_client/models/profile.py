...
class Profile(object):
    ...
    def __init__(self, first_name=None, last_name=None, id=None, login=None, role=None, groups=None, gravatar_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def id(self, id):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            raise ValueError("Invalid value for `id`, must be a value greater than `0`")  # noqa: E501
