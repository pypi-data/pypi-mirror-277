...
class Meta(object):
    ...
    @property
    def docs_url(self):
        """Gets the docs_url of this Meta.  # noqa: E501


        :return: The docs_url of this Meta.  # noqa: E501
        :rtype: str
        """
    ...
    def docs_url(self, docs_url):
        """Sets the docs_url of this Meta.
        ...
        if (self.local_vars_configuration.client_side_validation and
                docs_url is not None and len(docs_url) < 1):
            raise ValueError("Invalid value for `docs_url`, length must be greater than or equal to `1`")  # noqa: E501

        self._docs_url = docs_url

    @property
    def docs_dev_url(self):
        """Gets the docs_dev_url of this Meta.  # noqa: E501


        :return: The docs_dev_url of this Meta.  # noqa: E501
        :rtype: str
        """
        return self._docs_dev_url

    @docs_dev_url.setter
    def docs_dev_url(self, docs_dev_url):
        """Sets the docs_dev_url of this Meta.
        ...
        if (self.local_vars_configuration.client_side_validation and
                docs_dev_url is not None and len(docs_dev_url) < 1):
            raise ValueError("Invalid value for `docs_dev_url`, length must be greater than or equal to `1`")  # noqa: E501

        self._docs_dev_url = docs_dev_url
