...
class RunningState(object):
    ...
    allowable_values = [UNKNOWN, PUBLISHED, NOT_STARTED, PENDING, WAITING_FOR_RESOURCES, STARTED, SUCCESS, FAILED, ABORTED, WAITING_FOR_CLUSTER]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """RunningState - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunningState):
            return False
