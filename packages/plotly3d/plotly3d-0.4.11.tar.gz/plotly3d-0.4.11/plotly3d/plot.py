...
def scatter(points, colors=None, **kwargs):
    ...
    colors = np.asarray(colors).flatten() if colors is not None else None
    ...
    if not ticks:
        fig.update_layout(
            scene=dict(
                xaxis=dict(showticklabels=False, showticks=False, title='', backgroundcolor='white'),
                yaxis=dict(showticklabels=False, showticks=False, title='', backgroundcolor='white'),
                zaxis=dict(showticklabels=False, showticks=False, title='', backgroundcolor='white')
            ) if is_3d else dict(
                xaxis=dict(showticklabels=False, showticks=False, title='', backgroundcolor='white'),
                yaxis=dict(showticklabels=False, showticks=False, title='', backgroundcolor='white'),
            ),
