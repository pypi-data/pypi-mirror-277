...
def points_in_polygons(polygon_geometry,polygon_id,point_latitude,point_longitude,point_id, 
                       return_near_matches=True,max_distance=None, distance_unit = 'metre',
    ...
    point_latitude : array-like
        A vector of floats containing the latitude of the points.
    point_longitude : array-like
        A vector of floats containing the latitude of the points.
    point_id : array-like
    ...
    handle_multiple_matches: bool, optional
    ...
    projected_crs : int,str, pyproj CRS, optional
        The projected CRS to use when calculating near misses. 
    ...
    #Points -----------------------------------
    points_gdf=shape_utilities.create_points_from_coordinates(source_crs,point_latitude,point_longitude)
