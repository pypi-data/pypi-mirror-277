...
def get_crs(crs):
    '''
    Create and teturn a pyproj.CRS object from an input CRS integer or string.
...
def change_crs_coordinates(source_crs, target_crs, a, b=None):
    '''
...
def change_crs_geometry(geometry, target_crs, source_crs = 'EPSG:4326', extra_columns=None, 
    ...
    ignore_centroid_projection : bool, optional
        If True, the final centroid is calculated on the current CRS, regardless of 
        whether this is geographic or projected. Otherwise, the geometry is 
        first temporarily projected (to EPSG:6933) for the centroid calculation. 
        The default is True.
    ...
    output_df =io_utilities.create_shapefile_output(output_df, 
                                                        ...
                                                        extra_columns, 
                                                        geo_column_name,
                                                        ignore_centroid_projection=ignore_centroid_projection)
