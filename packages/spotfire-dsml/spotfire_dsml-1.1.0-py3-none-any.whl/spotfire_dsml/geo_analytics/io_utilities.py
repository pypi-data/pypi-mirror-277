...
def prepare_geo_dataframe_for_spotfire(geo_df):
    '''
    ...
    return create_shapefile_output(geo_df, True, crs, extra_columns, 
                                   geo_column_name,
                                   representative_centroid=True)
        

def add_bounds_and_centroid(geo_df):
    '''
...
def create_shapefile_output(geo_df, to_spotfire, crs='EPSG:4326',
                            ...
                            representative_centroid=True,
                            ignore_centroid_projection=True):
    '''
    ...
    representative_centroid: bool, optional
    ...
    ignore_centroid_projection: bool, optional
        Ignored if representative_centroid is True.
    ...
    shape_centroid= shape_utilities._calculate_centroid(crs, geo_df, 
                                                        representative_point = representative_centroid,
                                                        ignore_projection=ignore_centroid_projection)
