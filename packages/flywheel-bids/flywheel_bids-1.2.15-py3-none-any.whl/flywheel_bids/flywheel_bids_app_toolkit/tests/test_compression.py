...
@pytest.mark.parametrize(
    ...
    [
        ([Path("a_straight_forward.html"), Path("list.html")], [Path("a_straight_forward.html"), Path("list.html")]),
        (
            [Path("NONfiltered_ses.html"), Path("filtered_CITATION.html"), Path("random.html")],
...
def test_zip_html_and_svg_files(tmpdir, extended_gear_context):
    ...
    zip_html_and_svg_files(
        extended_gear_context.analysis_output_dir, html_path, "test_destination", extended_gear_context.output_dir
    )
