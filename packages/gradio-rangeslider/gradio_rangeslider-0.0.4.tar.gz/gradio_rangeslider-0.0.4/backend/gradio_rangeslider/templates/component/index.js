...
function Qn(l, e, t) {
  ...
  function Pt(w) {
    st[w ? "unshift" : "push"](() => {
      k = w, t(16, k), t(7, v), t(14, D), t(15, g);
    });
  }
  const Bt = () => {
    a("clear_status");
  ...
  return l.$$set = (w) => {
    ...
    114816 && (v != null ? t(14, D = v.map((w) => {
      if (w.index != null && w.length != null)
        return w.index / w.length;
      if (w.progress != null)
        return w.progress;
    })) : t(14, D = null), D ? (t(15, g = D[D.length - 1]), k && (g === 0 ? t(16, k.style.transition = "0", k) : t(16, k.style.transition = "150ms", k))) : t(15, g = void 0)), l.$$.dirty[0] & /*status*/
...
function oi(l) {
  ...
  return e = new Un({ props: D }), e.$on(
    ...
    m(g, k) {
      Ye(e, g, k), ke(g, t, k), ke(g, n, k), T(n, i), Ye(s, i, null), T(i, a), T(i, r), T(r, f), ne(
        f,
        /*selected_max*/
        l[16]
      ), T(r, _), T(r, m), ne(
        ...
        /*selected_min*/
        l[15]
      ), ke(g, V, k), ke(g, v, k), T(v, I), T(v, d), T(v, c), T(v, S), T(v, z), ne(
        z,
        /*selected_min*/
        l[15]
      ), T(v, P), T(v, N), ne(
...
function ri(l, e, t) {
  ...
  function h(p) {
    t(15, y = parseInt(p.target.value)), y > Z && t(16, Z = y);
  }
  function P(p) {
    t(16, Z = parseInt(p.target.value)), Z < y && t(15, y = Z);
  }
  function N(p) {
