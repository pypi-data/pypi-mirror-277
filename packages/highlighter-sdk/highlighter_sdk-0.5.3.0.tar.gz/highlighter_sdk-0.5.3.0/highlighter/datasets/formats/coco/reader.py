...
from highlighter.const import OBJECT_CLASS_ATTRIBUTE_UUID
from highlighter.datasets.base_models import AttributeRecord, ImageRecord
from highlighter.datasets.formats.coco.common import CocoKeys
    ...
    def read(self) -> Tuple[List[AttributeRecord], List[ImageRecord]]:
        ...
        def get_pixel_location_attribute_value(anno, bbox_only=self.bbox_only):
            if bbox_only:
                ...
                value = PixelLocationAttributeValue.from_multpolygon_coords(
