...
def color_filter(
    ...
    *,
    type: str | None = "HUE",
    strength: typing.Any | None = 1.0,
    fill_color: typing.Any | None = (0.0, 0.0, 0.0),
):
...
def dirty_mask(
    ...
    undo: bool | None = None,
    *,
    dirty_only: bool | typing.Any | None = False,
):
    ...
    :type dirty_only: bool | typing.Any | None
    """
...
def face_set_change_visibility(
    ...
    *,
    ...
    INVERT
    Invert Face Set Visibility -- Invert Face Set Visibility.
...
def mask_expand(
    ...
    undo: bool | None = None,
    *,
    invert: bool | typing.Any | None = True,
    use_cursor: bool | typing.Any | None = True,
    update_pivot: bool | typing.Any | None = True,
    smooth_iterations: typing.Any | None = 2,
    mask_speed: typing.Any | None = 5,
    use_normals: bool | typing.Any | None = True,
    keep_previous_mask: bool | typing.Any | None = False,
    edge_sensitivity: typing.Any | None = 300,
    create_face_set: bool | typing.Any | None = False,
):
    ...
    :type keep_previous_mask: bool | typing.Any | None
...
def mask_filter(
    ...
    *,
    ...
    auto_iteration_count: bool | typing.Any | None = False,
):
...
def symmetrize(
    ...
    undo: bool | None = None,
    *,
    merge_tolerance: typing.Any | None = 0.001,
):
