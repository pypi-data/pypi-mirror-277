...
class MhdGgd(IdsBaseClass):
    ...
    electrons: Optional[MhdGgdElectrons] = field(default=None)
    t_i_average: list[GenericGridScalar] = field(default_factory=list)
    n_i_total: list[GenericGridScalar] = field(default_factory=list)
    ...
    velocity_r: list[GenericGridScalar] = field(default_factory=list)
    velocity_z: list[GenericGridScalar] = field(default_factory=list)
    velocity_tor: list[GenericGridScalar] = field(default_factory=list)
    velocity_parallel: list[GenericGridScalar] = field(default_factory=list)
    ...
    vorticity: list[GenericGridScalar] = field(default_factory=list)
    vorticity_over_r: list[GenericGridScalar] = field(default_factory=list)
    j_r: list[GenericGridScalar] = field(default_factory=list)
    j_z: list[GenericGridScalar] = field(default_factory=list)
    j_tor: list[GenericGridScalar] = field(default_factory=list)
    j_tor_r: list[GenericGridScalar] = field(default_factory=list)
    mass_density: list[GenericGridScalar] = field(default_factory=list)
...
class Mhd(IdsBaseClass):
    ...
    ggd: list[MhdGgd] = field(default_factory=list)
