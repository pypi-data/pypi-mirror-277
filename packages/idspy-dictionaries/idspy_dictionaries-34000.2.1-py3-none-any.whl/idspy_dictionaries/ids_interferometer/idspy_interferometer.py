...
class InterferometerChannelNE(IdsBaseClass):
    """
    N_e profile along the line of sight.
...
class InterferometerChannelWavelengthInterf(IdsBaseClass):
    ...
    phase_corrected: Optional[SignalFlt1D] = field(default=None)
    ...
    phase_to_n_e_line: float = field(default=9e40)
...
class InterferometerChannel(IdsBaseClass):
    ...
    :ivar n_e_line: Line integrated density, possibly obtained by a
        ...
        correction)
    :ivar n_e_line_average: Line average density inferred from
        interferometer measurements. Corresponds to the density
        integrated along the full line-of-sight and then divided by the
        length of the line-of-sight
    :ivar n_e: Estimated electron density profile on a set of positions
        along the line of sight and used by forward models.
    """
    ...
    line_of_sight: Optional[LineOfSight3Points] = field(default=None)
    ...
    path_length_variation: Optional[SignalFlt1D] = field(default=None)
    n_e_line: Optional[SignalFlt1DValidity] = field(default=None)
    n_e_line_average: Optional[SignalFlt1DValidity] = field(default=None)
    n_e: Optional[InterferometerChannelNE] = field(default=None)
...
class Interferometer(IdsBaseClass):
    ...
    n_e_volume_average: Optional[SignalFlt1DValidity] = field(default=None)
    electrons_n: Optional[SignalFlt1DValidity] = field(default=None)
