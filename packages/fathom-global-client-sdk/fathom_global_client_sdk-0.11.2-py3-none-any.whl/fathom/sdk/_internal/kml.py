...
from fathom import FathomException
...
def polygon_from_kml(kml_file_path: os.PathLike) -> Dict:
    ...
    try:
        ...
        raise FathomException(f"Unable to load KML file '{kml_file_path}'") from e
...
def polygon_from_kmz(kmz_file_path: os.PathLike) -> Dict:
    ...
    raise FathomException(f"No '.kml' file found in {kmz_file_path}")
