...
class SwigPyIterator(object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _VisualTest.delete_SwigPyIterator

    def value(self):
        return _VisualTest.SwigPyIterator_value(self)

    def incr(self, n=1):
        return _VisualTest.SwigPyIterator_incr(self, n)

    def decr(self, n=1):
        return _VisualTest.SwigPyIterator_decr(self, n)

    def distance(self, x):
        return _VisualTest.SwigPyIterator_distance(self, x)

    def equal(self, x):
        return _VisualTest.SwigPyIterator_equal(self, x)

    def copy(self):
        return _VisualTest.SwigPyIterator_copy(self)

    def next(self):
        return _VisualTest.SwigPyIterator_next(self)

    def __next__(self):
        return _VisualTest.SwigPyIterator___next__(self)

    def previous(self):
        return _VisualTest.SwigPyIterator_previous(self)

    def advance(self, n):
        return _VisualTest.SwigPyIterator_advance(self, n)

    def __eq__(self, x):
        return _VisualTest.SwigPyIterator___eq__(self, x)

    def __ne__(self, x):
        return _VisualTest.SwigPyIterator___ne__(self, x)

    def __iadd__(self, n):
        return _VisualTest.SwigPyIterator___iadd__(self, n)

    def __isub__(self, n):
        return _VisualTest.SwigPyIterator___isub__(self, n)

    def __add__(self, n):
        return _VisualTest.SwigPyIterator___add__(self, n)

    def __sub__(self, *args):
        return _VisualTest.SwigPyIterator___sub__(self, *args)
    def __iter__(self):
        return self

# Register SwigPyIterator in _VisualTest:
_VisualTest.SwigPyIterator_swigregister(SwigPyIterator)
...
import openturns.LinearModelTest
...
def DrawQQplot(*args):
    ...
    >>> View(QQ_plot).show()
    """
    return _VisualTest.DrawQQplot(*args)
...
def DrawPPplot(*args):
    ...
    >>> View(graph).show()
    """
    return _VisualTest.DrawPPplot(*args)
...
def DrawCDFplot(*args):
    ...
    >>> View(CDF_plot).show()
    """
    return _VisualTest.DrawCDFplot(*args)
...
def DrawHenryLine(*args):
    ...
    >>> View(henry_graph).show()
    """
    return _VisualTest.DrawHenryLine(*args)
...
def DrawPairs(sample):
    ...
    >>> View(clouds).show()
    """
    return _VisualTest.DrawPairs(sample)
...
def DrawPairsMarginals(sample, distribution):
    ...
    >>> View(clouds).show()
    """
    return _VisualTest.DrawPairsMarginals(sample, distribution)
...
def DrawLinearModel(*args):
    ...
    """
    return _VisualTest.DrawLinearModel(*args)
...
def DrawLinearModelResidual(*args):
    ...
    >>> View(drawLinearModelVTest2).show()
    """
    return _VisualTest.DrawLinearModelResidual(*args)
...
def DrawParallelCoordinates(inputSample, outputSample, minValue, maxValue, color, quantileScale=True):
    ...
    *Ymax* in the quantile based scale of :math:`Y` or in its specific scale. In
    ...
    >>> View(parplot).show()
    """
    return _VisualTest.DrawParallelCoordinates(inputSample, outputSample, minValue, maxValue, color, quantileScale)
...
def DrawKendallPlot(*args):
    ...
    """
    return _VisualTest.DrawKendallPlot(*args)

def DrawUpperTailDependenceFunction(data):
    r"""
    ...
    """
    return _VisualTest.DrawUpperTailDependenceFunction(data)

def DrawUpperExtremalDependenceFunction(data):
    r"""
    ...
    """
    return _VisualTest.DrawUpperExtremalDependenceFunction(data)

def DrawLowerTailDependenceFunction(data):
    r"""
    ...
    """
    return _VisualTest.DrawLowerTailDependenceFunction(data)

def DrawLowerExtremalDependenceFunction(data):
    r"""
    ...
    """
    return _VisualTest.DrawLowerExtremalDependenceFunction(data)
