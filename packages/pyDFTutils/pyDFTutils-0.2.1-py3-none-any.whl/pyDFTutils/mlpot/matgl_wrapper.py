...
def relax_with_ml(
    ...
    **ucf_kwargs
    ...
    Args:
        ...
        **uc_kwargs (dict, optional): Additional keyword arguments to pass to the UnitCellFilter constructor.
...
def phonon_with_ml(atoms, calc=None, relax=False, plot=True, knames=None, kvectors=None, npoints=100, figname="phonon.pdf", **kwargs):
    """
    ...
    if plot:
        ...
        plot_phonon(path="./", knames=knames, kvectors=kvectors, npoints=npoints, figname=figname, show=True)
