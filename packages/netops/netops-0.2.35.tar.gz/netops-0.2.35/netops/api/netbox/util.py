...
def get_interface_child_by_parent_device(interface_name, device_name):
    """
    Retrieves a child interface by its parent device and parent interface from NetBox.

    Args:
        interface_name (str): The name of the parent interface.
        device_name (str): The name of the parent device.

    Returns:
        str: A string representation of the retrieved child interface.
    """
...
def get_interface_parent_by_child_device(interface_name, device_name):
    """
    Retrieves a parent interface by its child device and child interface from NetBox.

    Args:
        interface_name (str): The name of the child interface.
        device_name (str): The name of the child device.

    Returns:
        str: A string representation of the retrieved parent interface.
    """
...
def get_interfaces_unused_device(device_name):
    """
    Retrieves unused interfaces of a device from NetBox.

    Args:
        device_name (str): The name of the device.

    Returns:
        List[str]: A list of string representations of unused interfaces.
    """
