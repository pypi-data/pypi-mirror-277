...
class Robot:
    ...
    def __init__(
        ...
        self.mqtt = MqttClient(broker_host, broker_port, broker_ca_certs)
    ...
    def consumer(self, topic: str, qos: int = 0):
        return MqttConsumer(topic, qos, self.broker_host, self.broker_port, self.broker_ca_certs)
    ...
    def establish_connection(self):
        ...
        if self.broker_ca_certs is not None:
