...
class SettingsValueArray(SettingsValue):
    ...
    def __eq__(self, other: SettingsValueArray):
        if not super(SettingsValueArray, self).__eq__(other): 
            return False
    ...
    # Name of the type.
    _type_str = "SettingsValueArray"

    # Datatype attributes.
    _attributes = Attributes("SettingsValueArray", version=0, member_count=9)

    # Serialization.
    def serialize(self, writer_fun: Callable[[Any, str, str, Optional[CustomSerializer]], None]):
        super(SettingsValueArray, self).serialize(writer_fun)
    ...
    def deserialize(reader_fun: Callable[[str, Optional[CustomSerializer]], Any]):
        data = super(SettingsValueArray, SettingsValueArray).deserialize(reader_fun)
