...
def gpencil_add(
    ...
    *,
    ...
    scale: typing.Any | None = (0.0, 0.0, 0.0),
    type: str | None = "EMPTY",
    use_in_front: bool | typing.Any | None = False,
...
def mode_set(
    ...
    *,
    ...
    PAINT_GPENCIL
    Draw, Paint Grease Pencil Strokes.
...
def transfer_mode(
    ...
    undo: bool | None = None,
    *,
    use_eyedropper: bool | typing.Any | None = False,
):
    ...
    :type use_eyedropper: bool | typing.Any | None
    """
