...
def flip(
    ...
    undo: bool | None = None,
    *,
    use_flip_horizontal: bool | typing.Any | None = False,
    use_flip_vertical: bool | typing.Any | None = False,
):
    """Flip the image
    ...
    :type use_flip_horizontal: bool | typing.Any | None
    :param use_flip_vertical: Vertical, Flip the image vertically
    :type use_flip_vertical: bool | typing.Any | None
    """
