...
def lerp(from_value, to: float, factor: float) -> float:
    """Linearly interpolate between two float values based on factor.

    :param to: The value to return when factor is 1.
    :type to: float
...
def smoothstep(from_value, to: float, value) -> float:
    ...
    Outside the range the function returns the same value as the nearest edge.
        ...
        :param to: The edge value where the result is 1.
        :type to: float
