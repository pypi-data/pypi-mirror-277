...
class RateTimeTestCase(TestCase):
    ...
    def test_earliest_match(self):
        ...
        start_time_1 = tz.localize(datetime.datetime(year=2022, month=2, day=20, hour=17))  # Sun Feb 20 2022 at 5PM
        end_time_1 = tz.localize(datetime.datetime(year=2022, month=2, day=23, hour=17))  # Wed Feb 23 2022 at 5PM
        ...
        start_result_1 = tz.localize(datetime.datetime(year=2022, month=2, day=21, hour=16))  # Mon Feb 21 at 4PM
        end_result_1 = tz.localize(datetime.datetime(year=2022, month=2, day=21, hour=20))  # Mon Feb 21 at 8PM
        ...
        # Should work without timezone too
        ...
        self.assertEqual(first_start_3, start_result_3)
        self.assertEqual(first_end_3, end_result_3)

        start_time_4 = tz.localize(datetime.datetime(year=2022, month=2, day=21, hour=17))  # Mon Feb 21 2022 at 5PM
        end_time_4 = tz.localize(datetime.datetime(year=2022, month=2, day=28, hour=22))  # Mon Feb 28 2022 at 10PM
        start_result_4 = tz.localize(datetime.datetime(year=2022, month=2, day=21, hour=17))  # Mon Feb 21 at 5PM
        end_result_4 = tz.localize(datetime.datetime(year=2022, month=2, day=21, hour=20))  # Mon Feb 21 at 8PM
        first_start_4, first_end_4 = rate_time_1.earliest_match(start_time_4, end_time_4)
        self.assertEqual(first_start_4, start_result_4)
        self.assertEqual(first_end_4, end_result_4)
