...
class SecretServicerMiddleware(Middleware):
            ...
            async def run_Write(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    response = await (SecretWorkflowStub(
                        ...
                        cast(resemble.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest, task.request),
            ...
            async def run_Read(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    response = await (SecretWorkflowStub(
                        ...
                        cast(google.protobuf.empty_pb2.Empty, task.request),
                        bearer_token=__internal_magic_token__,
                    ))
    ...
    async def _schedule_Write(
        ...
        *,
        ...
        headers: Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[WriterContext, resemble.cloud.v1alpha1.secrets.secrets_pb2.WriteResponse]:
    ...
    async def _schedule_WriteTask(
        ...
        *,
        ...
        headers: Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[WriterContext, resemble.cloud.v1alpha1.secrets.secrets_pb2.WriteTaskResponse]:
        context: WriterContext = self.create_context(
            headers=headers,
            context_type=WriterContext,
        )
    ...
    async def _schedule_Read(
        ...
        *,
        ...
        headers: Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[WriterContext, resemble.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse]:
        context: WriterContext = self.create_context(
            headers=headers,
            context_type=WriterContext,
        )
    ...
    async def _schedule_Delete(
        ...
        *,
        ...
        headers: Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[WriterContext, resemble.cloud.v1alpha1.secrets.secrets_pb2.DeleteResponse]:
        context: WriterContext = self.create_context(
            headers=headers,
            context_type=WriterContext,
        )
    ...
    async def _schedule_DeleteTask(
        ...
        *,
        ...
        headers: Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[WriterContext, resemble.cloud.v1alpha1.secrets.secrets_pb2.DeleteTaskResponse]:
        context: WriterContext = self.create_context(
            headers=headers,
            context_type=WriterContext,
        )
...
class Secret:
    ...
    class WriteFuture:
        ...
        def __await__(self) -> Generator[None, None, resemble.cloud.v1alpha1.secrets.secrets_pb2.WriteResponse]:
    ...
    class WriteTaskFuture:
        ...
        def __await__(self) -> Generator[None, None, resemble.cloud.v1alpha1.secrets.secrets_pb2.WriteTaskResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class ReadFuture:
        ...
        def __await__(self) -> Generator[None, None, resemble.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class DeleteFuture:
        ...
        def __await__(self) -> Generator[None, None, resemble.cloud.v1alpha1.secrets.secrets_pb2.DeleteResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class DeleteTaskFuture:
        ...
        def __await__(self) -> Generator[None, None, resemble.cloud.v1alpha1.secrets.secrets_pb2.DeleteTaskResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class WeakReference:
        ...
        def __init__(
            ...
            *,
            ...
            self._tasks_stub: Optional[SecretTasksStub] = None
        ...
        class Reactively:
            ...
            async def Read(
                ...
                workflow: Workflow,
                __options__: Optional[resemble.aio.call.Options] = None,
            ) -> AsyncIterator[resemble.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse]:
        ...
        def reactively(self):
            return Secret.WeakReference.Reactively(
                service_name='resemble.cloud.v1alpha1.secrets.Secret',
                actor_id=self._actor_id,
                bearer_token=self._bearer_token,
            )
        ...
        def schedule(
            ...
            *,
            when: Optional[datetime | timedelta] = None,
        ) -> Any: # TODO: Avoid the nesting as it breaks mypy.
            class Tasks:
                def __init__(
                    self,
                    tasks: Callable[[TransactionContext | WorkflowContext | Workflow], SecretTasksStub],
                    *,
                    when: Optional[datetime | timedelta] = None,
                ) -> None:
                    self._tasks = tasks
                ...
                async def Write(
                    ...
                    *,
                    ...
                    return Secret.WriteFuture(
                        ...
                        task_id=await self._tasks(__context_or_workflow__).Write(
                            request,
                            idempotency=idempotency,
                            metadata=metadata,
                            bearer_token=bearer_token,
                ...
                async def WriteTask(
                    ...
                    *,
                    ...
                    return Secret.WriteTaskFuture(
                        __context_or_workflow__,
                        task_id=await self._tasks(__context_or_workflow__).WriteTask(
                            request,
                            idempotency=idempotency,
                            metadata=metadata,
                            bearer_token=bearer_token,
                ...
                async def Read(
                    ...
                    return Secret.ReadFuture(
                        __context_or_workflow__,
                        task_id=await self._tasks(__context_or_workflow__).Read(
                            request,
                            idempotency=idempotency,
                            metadata=metadata,
                            bearer_token=bearer_token,
                ...
                async def Delete(
                    ...
                    return Secret.DeleteFuture(
                        __context_or_workflow__,
                        task_id=await self._tasks(__context_or_workflow__).Delete(
                            request,
                            idempotency=idempotency,
                            metadata=metadata,
                            bearer_token=bearer_token,
                ...
                async def DeleteTask(
                    ...
                    return Secret.DeleteTaskFuture(
                        __context_or_workflow__,
                        task_id=await self._tasks(__context_or_workflow__).DeleteTask(
                            request,
                            idempotency=idempotency,
                            metadata=metadata,
                            bearer_token=bearer_token,
...
class SecretNodeAdaptor(Secret.WeakReference):
