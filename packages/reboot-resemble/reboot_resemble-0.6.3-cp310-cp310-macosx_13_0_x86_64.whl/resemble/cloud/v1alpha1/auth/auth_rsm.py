...
class APIKeyServicerMiddleware(Middleware):
        ...
        *,
        ...
        if 'Create' == task.method_name:
            if only_validate:
                ...
                return resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse()
            ...
            async def run_Create(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    response = await (APIKeyWorkflowStub(
                        ...
                        cast(resemble.cloud.v1alpha1.auth.auth_pb2.CreateRequest, task.request),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse()
            ...
            async def run_Revoke(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    response = await (APIKeyWorkflowStub(
                        ...
                        cast(resemble.cloud.v1alpha1.auth.auth_pb2.RevokeRequest, task.request),
                        bearer_token=__internal_magic_token__,
                        idempotency=Idempotency(
                            alias=f'Task {task.task_id.task_uuid}',
                        ),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse()
            ...
            async def run_Authenticate(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    response = await (APIKeyWorkflowStub(
                        ...
                        cast(resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest, task.request),
                        bearer_token=__internal_magic_token__,
                    ))
    ...
    async def _schedule_Create(
        ...
        *,
        ...
        headers: Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[WriterContext, resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse]:
    ...
    async def _schedule_Revoke(
        ...
        *,
        ...
        headers: Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[WriterContext, resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse]:
        context: WriterContext = self.create_context(
            headers=headers,
            context_type=WriterContext,
        )
    ...
    async def _schedule_Authenticate(
        ...
        *,
        ...
        headers: Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[WriterContext, resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse]:
        context: WriterContext = self.create_context(
            headers=headers,
            context_type=WriterContext,
        )
        response = resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse()
...
class APIKey:
    ...
    class CreateFuture:
        ...
        def __await__(self) -> Generator[None, None, resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse:
                ...
                try:
                    ...
                    if (
                        ...
                        raise resemble.aio.aborted.SystemAborted(
                            ...
                            "but expecting type 'resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse'; "
...
resemble.cloud.v1alpha1.auth.auth_pb2.InvalidInputError        ]
    ...
    class RevokeFuture:
        ...
        def __await__(self) -> Generator[None, None, resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse:
                channel = self._channel_manager.get_channel_from_service_name(
                    self._task_id.service, self._task_id.actor_id
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise resemble.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {str(uuid.UUID(bytes=self._task_id.task_uuid))} "
                            f"has a response of type '{wait_for_task_response.response.TypeName()}' "
                            "but expecting type 'resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class AuthenticateFuture:
        ...
        def __await__(self) -> Generator[None, None, resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse:
                channel = self._channel_manager.get_channel_from_service_name(
                    self._task_id.service, self._task_id.actor_id
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise resemble.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {str(uuid.UUID(bytes=self._task_id.task_uuid))} "
                            f"has a response of type '{wait_for_task_response.response.TypeName()}' "
                            "but expecting type 'resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class WeakReference:
        ...
        class Reactively:
            ...
            async def Authenticate(
                ...
                *,
                secret: Optional[str] = None,
            ) -> AsyncIterator[resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse]:
        ...
        def reactively(self):
            return APIKey.WeakReference.Reactively(
                service_name='resemble.cloud.v1alpha1.auth.APIKey',
                actor_id=self._actor_id,
                bearer_token=self._bearer_token,
            )
            ...
            class Tasks:
                ...
                async def Revoke(
                    ...
                    return APIKey.RevokeFuture(
                        ...
                        task_id=await self._tasks(__context_or_workflow__).Revoke(
                            request,
                            idempotency=idempotency,
                            metadata=metadata,
                            bearer_token=bearer_token,
                ...
                async def Authenticate(
                    ...
                    *,
                    ...
                    return APIKey.AuthenticateFuture(
                        __context_or_workflow__,
                        task_id=await self._tasks(__context_or_workflow__).Authenticate(
                            request,
                            idempotency=idempotency,
                            metadata=metadata,
                            bearer_token=bearer_token,
