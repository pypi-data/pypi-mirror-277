...
class Bot:
    def __init__(self, name):
        ...
        # Start loading conversations in a separate thread
        self.load_conversations_async("https://ee81092e-030a-4f24-bb1b-a451de060147-00-pz5we05cygxq.worf.replit.dev/conversations.json")
    ...
    def load_conversations_async(self, url):
        ...
        threading.Thread(target=load_conversations).start()
