...
def main():
    ...
    # Or set by label
    # response = sigen.set_operational_sigen_ai_mode()
    # response = sigen.set_operational_mode_tou()
    # response = sigen.set_operational_fully_fed_to_grid()
    # response = sigen.set_operational_maximum_self_powered()
    #
