...
def add_gnb_skills(skill_library):
  ...
  skill_library.add_skill(Skill(name='Keen Edge',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=893)))
  ...
  skill_library.add_skill(Skill(name='Brutal Shell',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1074)))
  skill_library.add_skill(Skill(name='Demon Slice',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=100),
                                combo_spec=(ComboSpec(combo_group=0),),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=626)))
  skill_library.add_skill(Skill(name='Lightning Shot',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=150),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=716)))
  skill_library.add_skill(Skill(name='Solid Barrel',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1653)))
  skill_library.add_skill(Skill(name='Burst Strike',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=380),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=714)))
  ...
  skill_library.add_skill(Skill(name='Rough Divide',
                                is_GCD=False,
                                damage_spec=DamageSpec(potency=150),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=491)))
  ...
  skill_library.add_skill(Skill(name='Wicked Talon',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1162)))
  ...
  skill_library.add_skill(Skill(name='Bow Shock',
                                is_GCD=False,
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=627),
                                damage_spec=DamageSpec(potency=150),
  ...
  skill_library.add_skill(Skill(name='Eye Gouge',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=981)))
  skill_library.add_skill(Skill(name='Fated Circle',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=300),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=537)))
