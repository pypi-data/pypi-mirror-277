...
from simulator.game_data.class_skills.convenince_timings import get_shot_timing, get_instant_timing_spec
...
def add_brd_skills(skill_library):
  ...
  skill_library.add_resource(name="Mage's Coda", job_resource_settings=JobResourceSettings(max_value=1, skill_allowlist=("Mage's Ballad", 'Radiant Finale',)))
  skill_library.add_resource(name="Army's Coda", job_resource_settings=JobResourceSettings(max_value=1, skill_allowlist=("Army's Paeon", 'Radiant Finale',)))
  skill_library.add_resource(name="Wanderer's Coda", job_resource_settings=JobResourceSettings(max_value=1, skill_allowlist=("The Wanderer's Minuet", 'Radiant Finale',)))
  skill_library.add_resource(name="Soul Voice", job_resource_settings=JobResourceSettings(max_value=100, skill_allowlist=('Apex Arrow', 'Add Soul Voice',)))
  skill_library.add_resource(name="Repertoire", job_resource_settings=JobResourceSettings(max_value=3, skill_allowlist=('Pitch Perfect', 'Add Repertoire',)))

  skill_library.add_skill(Skill(name='Shot',
                                is_GCD=False,
  ...
  skill_library.add_skill(Skill(name='Raging Strikes',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=540)))
  skill_library.add_skill(Skill(name='Bloodletter',
                                is_GCD=False,
                                damage_spec=DamageSpec(potency=110),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1600)))
  ...
  skill_library.add_skill(Skill(name="Mage's Ballad",
                                ...
                                damage_spec={SimConsts.DEFAULT_CONDITION: mage_ballad_potency,
                                             'Buff Only': None},
                                buff_spec= {SimConsts.DEFAULT_CONDITION: StatusEffectSpec(damage_mult=1.01, duration=45*1000, is_party_effect=True, expires_status_effects = ("The Wanderer's Minuet", "Army's Paeon",)),
                                            'From Log': StatusEffectSpec(crit_rate_add=0.02, duration=5*1000, is_party_effect=True, expires_status_effects = ("Army's Paeon", "Mage's Ballad",))},
                                timing_spec=instant_timing_spec,
                                job_resource_spec={SimConsts.DEFAULT_CONDITION : (JobResourceSpec(name="Mage's Coda", change=1),),
                                                   'Buff Only': tuple()},
  ...
  skill_library.add_skill(Skill(name="Army's Paeon",
                                is_GCD=False,
                                damage_spec={SimConsts.DEFAULT_CONDITION: DamageSpec(potency=100, trait_damage_mult_override=1.0),
                                             'Buff Only' : None,
                                             '1 Repertoire': None,
                                             '2 Repertoire': None,
                                             '3 Repertoire': None,
                                             '4 Repertoire': None},
                                buff_spec={SimConsts.DEFAULT_CONDITION: StatusEffectSpec(dh_rate_add=0.03, duration=45*1000, is_party_effect=True, extends_existing_duration=False, expires_status_effects = ("The Wanderer's Minuet", "Mage's Ballad",)),
                                           'Buff Only': StatusEffectSpec(dh_rate_add=0.03, duration=45*1000, is_party_effect=True, extends_existing_duration=False, expires_status_effects = ("The Wanderer's Minuet", "Mage's Ballad",)),
                                           'From Log, Buff Only': StatusEffectSpec(dh_rate_add=0.03, duration=5*1000, is_party_effect=True, extends_existing_duration=False, expires_status_effects = ("The Wanderer's Minuet", "Mage's Ballad",)),
                                           'From Log': StatusEffectSpec(dh_rate_add=0.03, duration=5*1000, is_party_effect=True, extends_existing_duration=False, expires_status_effects = ("The Wanderer's Minuet", "Mage's Ballad",)),
                                           '1 Repertoire': None,
                                           '2 Repertoire': None,
                                           '3 Repertoire': None,
                                           '4 Repertoire': None},
                                timing_spec={SimConsts.DEFAULT_CONDITION: instant_timing_spec,
                                ...
                                job_resource_spec={SimConsts.DEFAULT_CONDITION: (JobResourceSpec(name="Army's Coda", change=1),),
                                                   'Buff Only': tuple(),
  ...
  skill_library.add_skill(Skill(name='Rain of Death',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1650)))
  skill_library.add_skill(Skill(name='Battle Voice',
                                is_GCD=False,
                                buff_spec=StatusEffectSpec(dh_rate_add=0.20, duration=15*1000, is_party_effect=True),
                                timing_spec=instant_timing_spec))
  ...
  skill_library.add_skill(Skill(name="The Wanderer's Minuet",
                                ...
                                damage_spec={SimConsts.DEFAULT_CONDITION : wanderer_potency,
                                             'Buff Only': None},
                                buff_spec= {SimConsts.DEFAULT_CONDITION: StatusEffectSpec(crit_rate_add=0.02, duration=45*1000, is_party_effect=True, expires_status_effects = ("Army's Paeon", "Mage's Ballad",)),
                                            'From Log': StatusEffectSpec(crit_rate_add=0.02, duration=5*1000, is_party_effect=True, expires_status_effects = ("Army's Paeon", "Mage's Ballad",))},
                                timing_spec=instant_timing_spec,
                                job_resource_spec={SimConsts.DEFAULT_CONDITION : (JobResourceSpec(name="Wanderer's Coda", change=1),),
                                                   'Buff Only': tuple()},
                                follow_up_skills= {SimConsts.DEFAULT_CONDITION: tuple(),
                                                   "Army's Muse, 1 Repertoire": (army_muse_1_follow_up,),
                                                   "Army's Muse, 2 Repertoire": (army_muse_2_follow_up,),
  ...
  skill_library.add_skill(Skill(name='Pitch Perfect',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=800),
  ...
  skill_library.add_skill(Skill(name='Empyreal Arrow',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1030)))

  iron_jaw_barrage2 = FollowUp(skill=Skill(name='_Iron Jaws Barrage', damage_spec=DamageSpec(potency=100)),
                               delay_after_parent_application=120)
  iron_jaw_barrage3 = FollowUp(skill=Skill(name='_Iron Jaws Barrage', damage_spec=DamageSpec(potency=100)),
                               delay_after_parent_application=240)
  skill_library.add_skill(Skill(name='Iron Jaws',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=100),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=670),
                                follow_up_skills={SimConsts.DEFAULT_CONDITION : (stormbite_follow_up, caustic_bite_follow_up),
                                                  ...
                                                  'No Dot' : tuple(),
                                                  'Barrage': (stormbite_follow_up, caustic_bite_follow_up, iron_jaw_barrage2, iron_jaw_barrage3),
                                                  'Barrage, Stormbite': (stormbite_follow_up, iron_jaw_barrage2, iron_jaw_barrage3),
                                                  'Barrage, Caustic Bite': (caustic_bite_follow_up, iron_jaw_barrage2, iron_jaw_barrage3),
  ...
  skill_library.add_skill(Skill(name='Sidewinder',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=530)))
  ...
  skill_library.add_skill(Skill(name='Caustic Bite',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1290),
  ...
  stormbite_barrage2 = FollowUp(skill=Skill(name='_Stormbite Barrage', is_GCD=False, damage_spec=DamageSpec(potency=100)),
                               delay_after_parent_application=120)
  stormbite_barrage3 = FollowUp(skill=Skill(name='_Stormbite Barrage', is_GCD=False, damage_spec=DamageSpec(potency=100)),
                               delay_after_parent_application=240)
  skill_library.add_skill(Skill(name='Stormbite',
                                ...
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (stormbite_follow_up,),
                                                  'Barrage': (stormbite_follow_up,stormbite_barrage2,stormbite_barrage3)}))

  refulgent_arrow_barrage2 = FollowUp(skill=Skill(name='_Refulgent Arrow Barrage2', is_GCD=False, damage_spec=DamageSpec(potency=280)),
                                      delay_after_parent_application=120)
  refulgent_arrow_barrage3 = FollowUp(skill=Skill(name='_Refulgent Arrow Barrage3', is_GCD=False, damage_spec=DamageSpec(potency=280)),
                                      delay_after_parent_application=240)
  skill_library.add_skill(Skill(name='Refulgent Arrow',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=280),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1470),
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: tuple(),
  ...
  skill_library.add_skill(Skill(name='Shadowbite',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1430)))

  burst_shot_barrage2 = FollowUp(skill=Skill(name='_Burst Shot Barrage2', is_GCD=False, damage_spec=DamageSpec(potency=220)),
                                 delay_after_parent_application=120)
  burst_shot_barrage3 = FollowUp(skill=Skill(name='_Burst Shot Barrage3', is_GCD=False, damage_spec=DamageSpec(potency=220)),
                                 delay_after_parent_application=240)
  ...
  skill_library.add_skill(Skill(name='Apex Arrow',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1070),
                                job_resource_spec= (JobResourceSpec(name="Soul Voice", change=-np.inf),)))

  ladonsbite_barrage2 = FollowUp(skill=Skill(name='_Ladonsbite Barrage2', is_GCD=False, damage_spec=DamageSpec(potency=130)),
                                 delay_after_parent_application=120)
  ladonsbite_barrage3 = FollowUp(skill=Skill(name='_Ladonsbite Barrage3', is_GCD=False, damage_spec=DamageSpec(potency=130)),
                                 delay_after_parent_application=240)
  skill_library.add_skill(Skill(name='Ladonsbite',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=130),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1110),
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: tuple(),
  ...
  skill_library.add_skill(Skill(name='Radiant Finale',
                                is_GCD=False,
                                buff_spec= {SimConsts.DEFAULT_CONDITION : StatusEffectSpec(damage_mult=1.06, duration=int(14.97*1000), is_party_effect=True),
                                            "1 Mage's Coda" : StatusEffectSpec(damage_mult=1.02, duration=int(14.97*1000), is_party_effect=True),
                                            "1 Army's Coda" : StatusEffectSpec(damage_mult=1.02, duration=int(14.97*1000), is_party_effect=True),
                                            "1 Wanderer's Coda" : StatusEffectSpec(damage_mult=1.02, duration=int(14.97*1000), is_party_effect=True),
                                            "1 Mage's Coda, 1 Army's Coda" : StatusEffectSpec(damage_mult=1.04, duration=int(14.97*1000), is_party_effect=True),
                                            "1 Mage's Coda, 1 Wanderer's Coda" : StatusEffectSpec(damage_mult=1.04, duration=int(14.97*1000), is_party_effect=True),
                                            "1 Army's Coda, 1 Wanderer's Coda" : StatusEffectSpec(damage_mult=1.04, duration=int(14.97*1000), is_party_effect=True),
                                            "1 Mage's Coda, 1 Army's Coda, 1 Wanderer's Coda" : StatusEffectSpec(damage_mult=1.06, duration=int(14.97*1000), is_party_effect=True),
                                            "1 Coda, Buff Only": StatusEffectSpec(damage_mult=1.02, duration=int(14.97*1000), is_party_effect=True),
                                            "2 Coda, Buff Only": StatusEffectSpec(damage_mult=1.04, duration=int(14.97*1000), is_party_effect=True),
                                            "3 Coda, Buff Only": StatusEffectSpec(damage_mult=1.06, duration=int(14.97*1000), is_party_effect=True)},
                                job_resource_spec= {SimConsts.DEFAULT_CONDITION : (JobResourceSpec(name="Mage's Coda", change=-1), JobResourceSpec(name="Army's Coda", change=-1), JobResourceSpec(name="Wanderer's Coda", change=-1)),
                                                    'Buff Only': tuple()},
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=660)))
  ...
  skill_library.add_skill(Skill(name='Barrage',
                                ...
                                buff_spec=StatusEffectSpec(add_to_skill_modifier_condition=True,
                                                           num_uses=1,
                                                           duration=10*1000,
                                                           skill_allowlist=('Iron Jaws', 'Caustic Bite', 'Stormbite', 'Refulgent Arrow', 'Shadowbite', 'Burst Shot', 'Ladonsbite'))))
  skill_library.add_skill(Skill(name='Add Soul Voice',
                                is_GCD=False,
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=0, application_delay=0),
                                job_resource_spec = {SimConsts.DEFAULT_CONDITION: (JobResourceSpec(name="Soul Voice", change=5),),
  ...
  skill_library.add_skill(Skill(name='Add Repertoire',
                                is_GCD=False,
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=0, application_delay=0),
                                job_resource_spec = {SimConsts.DEFAULT_CONDITION: (JobResourceSpec(name="Repertoire", change=1),),
