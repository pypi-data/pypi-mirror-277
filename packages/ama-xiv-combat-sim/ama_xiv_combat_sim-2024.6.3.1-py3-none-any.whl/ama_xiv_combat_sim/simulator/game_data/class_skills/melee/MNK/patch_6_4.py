...
def add_mnk_skills(skill_library):
    ...
    skill_library.add_skill(Skill(name="Formless Fist",
                                  is_GCD=False,
    ...
    formless_fist_follow_up = FollowUp(skill = Skill(name="Formless Fist",
                                                     is_GCD=False,
                                                     buff_spec=StatusEffectSpec(add_to_skill_modifier_condition=True,
                                                                                num_uses=1,
                                                                                duration=30 * 1000,
    ...
    skill_library.add_skill(
        Skill(
            ...
            timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=840),
    ...
    skill_library.add_skill(
        Skill(
            ...
            timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=940),
            follow_up_skills=(opo_opo_form_follow_up,),
        )
    )
    skill_library.add_skill(
    ...
    skill_library.add_skill(
        Skill(
            ...
            timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1480),
        )
    )
    skill_library.add_skill(
        Skill(
    ...
    skill_library.add_skill(
        Skill(
            ...
            timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=800),
            buff_spec=StatusEffectSpec(damage_mult=1.05, duration=int(14.95 * 1000), is_party_effect=True)
        )
    )
    skill_library.add_skill(
        Skill(
    ...
    skill_library.add_skill(
        Skill(
            ...
            timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=400),
        )
    )
    skill_library.add_skill(
        Skill(
