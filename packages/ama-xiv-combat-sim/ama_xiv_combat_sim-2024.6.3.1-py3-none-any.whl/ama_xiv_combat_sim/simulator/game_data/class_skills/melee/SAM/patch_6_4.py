...
def add_sam_skills(skill_library):
  ...
  jinpu_follow_up = FollowUp(skill=Skill(name='Jinpu',
                                         damage_spec=DamageSpec(potency=280)),
                             delay_after_parent_application=620)
  jinpu_no_combo_follow_up = FollowUp(skill=Skill(name='Jinpu',
  ...
  skill_library.add_skill(Skill(name='Jinpu',
                                ...
                                combo_spec={SimConsts.DEFAULT_CONDITION: (ComboSpec(combo_actions=('Hakaze',)),),
                                            ...
                                            'Meikyo Shisui': (ComboSpec(combo_auto_succeed= True, combo_actions=('Hakaze',)),)},
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills= {SimConsts.DEFAULT_CONDITION: (jinpu_follow_up, _fugetsu_follow_up,),
                                                   'No Combo': (jinpu_no_combo_follow_up,)}))

  enhanced_enpi_buff = Skill(name='Enhanced_Enpi',
                             buff_spec=StatusEffectSpec(add_to_skill_modifier_condition=True,
                                                        num_uses=1,
                                                        duration=15*1000,
                                                        skill_allowlist=('Enpi',)))
  enhanced_enpi_follow_up = FollowUp(skill=enhanced_enpi_buff, delay_after_parent_application=0)
  ...
  skill_library.add_skill(Skill(name='Enpi',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=710)))

  shifu_follow_up = FollowUp(skill=Skill(name='Shifu',
                                         damage_spec=DamageSpec(potency=280)),
                             delay_after_parent_application=800)
  shifu_no_combo_follow_up = FollowUp(skill=Skill(name='Shifu',
                                                  damage_spec=DamageSpec(potency=120)),
                                      delay_after_parent_application=800)
  skill_library.add_skill(Skill(name='Shifu',
                                ...
                                combo_spec={SimConsts.DEFAULT_CONDITION: (ComboSpec(combo_actions=('Hakaze',)),),
                                            ...
                                            'Meikyo Shisui': (ComboSpec(combo_auto_succeed= True, combo_actions=('Hakaze',)),)},
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills= {SimConsts.DEFAULT_CONDITION: (shifu_follow_up, _fuka_follow_up,),
                                                   'No Combo': (shifu_no_combo_follow_up,)}))

  gekko_follow_up = FollowUp(skill=Skill(name='Gekko',
                                         damage_spec=DamageSpec(potency=380)),
                             delay_after_parent_application=760)
  gekko_no_combo_follow_up = FollowUp(skill=Skill(name='Gekko',
                                                  damage_spec=DamageSpec(potency=170)),
                                      delay_after_parent_application=760)
  gekko_no_pos_follow_up = FollowUp(skill=Skill(name='Gekko',
                                                  damage_spec=DamageSpec(potency=330)),
                                      delay_after_parent_application=760)
  gekko_no_pos_no_combo_follow_up = FollowUp(skill=Skill(name='Gekko',
                                                  damage_spec=DamageSpec(potency=120)),
                                      delay_after_parent_application=760)
  skill_library.add_skill(Skill(name='Gekko',
                                ...
                                combo_spec={SimConsts.DEFAULT_CONDITION: (ComboSpec(combo_actions=('Jinpu',)),),
                                            ...
                                            'Meikyo Shisui': (ComboSpec(combo_auto_succeed=True, combo_actions=('Jinpu',)),),
                                            'No Positional, Meikyo Shisui': (ComboSpec(combo_auto_succeed=True, combo_actions=('Jinpu',)),)},
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills ={SimConsts.DEFAULT_CONDITION: (gekko_follow_up,),
                                                   ...
                                                   'Meikyo Shisui, No Combo, No Positional': (gekko_no_pos_follow_up,_fugetsu_follow_up),
                                                   'Meikyo Shisui, No Combo': (gekko_follow_up,_fugetsu_follow_up),
                                                   'Meikyo Shisui, No Positional': (gekko_no_pos_follow_up,_fugetsu_follow_up)}))
  ...
  skill_library.add_skill(Skill(name='Kaeshi: Higanbana',
                                ...
                                follow_up_skills=(higanbana_follow_up,)))
  skill_library.add_skill(Skill(name='Kaeshi: Goken',
                                is_GCD=True,
                                damage_spec = DamageSpec(potency=300),
                                timing_spec = TimingSpec(base_cast_time=0, animation_lock=650, application_delay=620)))
  ...
  magnetsu_follow_up = FollowUp(skill=Skill(name='Magnetsu',
                                         damage_spec=DamageSpec(potency=120)),
                             delay_after_parent_application=620)
  magnetsu_no_combo_follow_up = FollowUp(skill=Skill(name='Magnetsu',
  ...
  skill_library.add_skill(Skill(name='Mangetsu',
                                ...
                                combo_spec={SimConsts.DEFAULT_CONDITION: (ComboSpec(combo_actions=('Fuko',)),),
                                            ...
                                            'Meikyo Shisui': (ComboSpec(combo_auto_succeed=True, combo_actions=('Fuko',)),)},
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (magnetsu_follow_up,_fugetsu_follow_up),
                                                  'No Combo': (magnetsu_no_combo_follow_up,)}))

  kasha_follow_up = FollowUp(skill=Skill(name='Kasha',
                                         damage_spec=DamageSpec(potency=380)),
                             delay_after_parent_application=620)
  kasha_no_combo_follow_up = FollowUp(skill=Skill(name='Kasha',
                                                  damage_spec=DamageSpec(potency=170)),
                                      delay_after_parent_application=620)
  kasha_no_pos_follow_up = FollowUp(skill=Skill(name='Kasha',
                                                  damage_spec=DamageSpec(potency=330)),
                                      delay_after_parent_application=620)
  kasha_no_pos_no_combo_follow_up = FollowUp(skill=Skill(name='Kasha',
                                                  damage_spec=DamageSpec(potency=120)),
                                      delay_after_parent_application=620)
  skill_library.add_skill(Skill(name='Kasha',
                                ...
                                combo_spec= {SimConsts.DEFAULT_CONDITION: (ComboSpec(combo_actions=('Shifu',)),),
                                             ...
                                             'Meikyo Shisui': (ComboSpec(combo_auto_succeed=True, combo_actions=('Shifu',)),),
                                             'No Positional, Meikyo Shisui': (ComboSpec(combo_auto_succeed=True, combo_actions=('Shifu',)),)},
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills ={SimConsts.DEFAULT_CONDITION: (kasha_follow_up,),
                                                   ...
                                                   'Meikyo Shisui, No Combo, No Positional': (kasha_no_pos_follow_up,_fuka_follow_up),
                                                   'Meikyo Shisui, No Combo': (kasha_follow_up,_fuka_follow_up),
                                                   'Meikyo Shisui, No Positional': (kasha_no_pos_follow_up,_fuka_follow_up)}))
  oka_follow_up = FollowUp(skill=Skill(name='Oka',
                                         damage_spec=DamageSpec(potency=120)),
                             delay_after_parent_application=620)
  oka_no_combo_follow_up = FollowUp(skill=Skill(name='Oka',
                                                  damage_spec=DamageSpec(potency=100)),
                             delay_after_parent_application=620)
  skill_library.add_skill(Skill(name='Oka',
                                ...
                                combo_spec={SimConsts.DEFAULT_CONDITION: (ComboSpec(combo_actions=('Fuko',)),),
                                            ...
                                            'Meikyo Shisui': (ComboSpec(combo_auto_succeed=True, combo_actions=('Fuko',)),)},
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills ={SimConsts.DEFAULT_CONDITION: (oka_follow_up,_fuka_follow_up),
  ...
  skill_library.add_skill(Skill(name='Hissatsu: Yaten',
                                is_GCD=False,
                                damage_spec=DamageSpec(potency=100),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=450),
  ...
  skill_library.add_skill(Skill(name='Meikyo Shisui',
                                ...
                                buff_spec=StatusEffectSpec(add_to_skill_modifier_condition=True,
                                                           ...
                                                           skill_allowlist=('Hakaze', 'Jinpu', 'Shifu', 'Gekko', 'Mangetsu', 'Kasha', 'Oka', 'Yukikaze', 'Fuko'))))
