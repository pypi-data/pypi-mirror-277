...
from simulator.game_data.class_skills.convenince_timings import get_auto_timing, get_instant_timing_spec
...
def add_nin_skills(skill_library):
  ...
  bunshin_melee_follow_up_ = FollowUp(skill=Skill(name="_Bunshin_melee",
                                                  is_GCD=False,
                                                  damage_spec = DamageSpec(potency=160, damage_class=DamageClass.PET, pet_job_mod_override=100),
  ...
  bunshin_area_follow_up_ = FollowUp(skill=Skill(name="_Bunshin_area",
                                                  is_GCD=False,
                                                  damage_spec = DamageSpec(potency=80, damage_class=DamageClass.PET, pet_job_mod_override=100),
                                                  status_effect_denylist=('Dragon Sight',)),
                                      delay_after_parent_application=88,
                                      snapshot_buffs_with_parent=False,
                                      snapshot_debuffs_with_parent=False)
  ...
  spinning_edge_damage = Skill(name='Spinning Edge',
                                damage_spec = DamageSpec(potency=220))
  spinning_edge_follow_up = FollowUp(skill=spinning_edge_damage,
                                      delay_after_parent_application=400)
  skill_library.add_skill(Skill(name='Spinning Edge',
                                is_GCD=True,
                                combo_spec = (ComboSpec(),),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (spinning_edge_follow_up,),
                                                  'Bunshin': (bunshin_melee_follow_up_, spinning_edge_follow_up)}))

  gust_slash_damage_follow_up = FollowUp(Skill(name='Gust Slash', damage_spec = DamageSpec(potency=320)),
                                          delay_after_parent_application=400)
  gust_slash_damage_no_combo_follow_up = FollowUp(Skill(name='Gust Slash', damage_spec = DamageSpec(potency=160)),
                                                  delay_after_parent_application=400)
  skill_library.add_skill(Skill(name='Gust Slash',
                                is_GCD=True,
                                combo_spec = (ComboSpec(combo_actions=('Spinning Edge',)),),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (gust_slash_damage_follow_up,),
                                                  'No Combo': (gust_slash_damage_no_combo_follow_up,),
                                                  'Bunshin': (bunshin_melee_follow_up_, gust_slash_damage_follow_up),
                                                  'Bunshin, No Combo': (bunshin_melee_follow_up_, gust_slash_damage_no_combo_follow_up)}))


  throwing_dagger_follow_up = FollowUp(skill=Skill(name='Throwing Dagger', damage_spec = DamageSpec(potency=120)),
                                        delay_after_parent_application=620)
  skill_library.add_skill(Skill(name='Throwing Dagger',
                                is_GCD=True,
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (throwing_dagger_follow_up,),
                                                  'Bunshin': (throwing_dagger_follow_up,bunshin_ranged_follow_up_)}))

  mug_damage_follow_up = FollowUp(skill=Skill(name='Mug',
                                              damage_spec = DamageSpec(potency=150)),
                                  delay_after_parent_application=620)
  mug_debuff_follow_up = FollowUp(skill=Skill(name='Mug',
                                              debuff_spec= StatusEffectSpec(damage_mult=1.05, duration=int(20.5*1000), is_party_effect=True)),
                                  delay_after_parent_application=0)
  skill_library.add_skill(Skill(name='Mug',
                                is_GCD=False,
                                timing_spec=instant_timing_spec,
                                follow_up_skills= {SimConsts.DEFAULT_CONDITION: (mug_damage_follow_up, mug_debuff_follow_up),
                                                   'Debuff Only': (mug_debuff_follow_up,)}))

  trick_damage_follow_up = FollowUp(skill=Skill(name='Trick Attack',
                                                damage_spec = DamageSpec(potency=400)),
                                    delay_after_parent_application=800)
  trick_damage_no_pos_follow_up =  FollowUp(skill=Skill(name='Trick Attack',
                                                damage_spec = DamageSpec(potency=300)),
                                    delay_after_parent_application=800)

  trick_debuff_follow_up = FollowUp(skill=Skill(name='Trick Attack (Debuff)',
                                                debuff_spec=StatusEffectSpec(damage_mult=1.10, duration=int(15.77*1000))),
                                    delay_after_parent_application=0)
  skill_library.add_skill(Skill(name='Trick Attack',
                                is_GCD=False,
                                follow_up_skills= {SimConsts.DEFAULT_CONDITION: (trick_damage_follow_up, trick_debuff_follow_up),
                                                   'No Positional': (trick_damage_no_pos_follow_up, trick_debuff_follow_up)},
                                timing_spec=instant_timing_spec))


  aeolian_edge_follow_up = FollowUp(skill=Skill(name='Aeolian Edge', damage_spec = DamageSpec(440)),
                                    delay_after_parent_application=540)
  aeolian_edge_no_combo_follow_up = FollowUp(skill=Skill(name='Aeolian Edge', damage_spec = DamageSpec(200)),
                                              delay_after_parent_application=540)
  aeolian_edge_no_pos_follow_up = FollowUp(skill=Skill(name='Aeolian Edge', damage_spec = DamageSpec(380)),
                                            delay_after_parent_application=540)
  aeolian_edge_no_pos_no_combo_follow_up = FollowUp(skill=Skill(name='Aeolian Edge', damage_spec = DamageSpec(140)),
                                                    delay_after_parent_application=540)
  skill_library.add_skill(Skill(name='Aeolian Edge',
                                is_GCD=True,
                                combo_spec = (ComboSpec(combo_actions=('Gust Slash',)),),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills= {SimConsts.DEFAULT_CONDITION : (aeolian_edge_follow_up,),
                                                    ...
                                                    'Bunshin, No Combo': (aeolian_edge_no_combo_follow_up, bunshin_melee_follow_up_),
                                                    'Bunshin, No Positional': (aeolian_edge_no_pos_follow_up, bunshin_melee_follow_up_),
                                                    'Bunshin, No Combo, No Positional': (aeolian_edge_no_pos_no_combo_follow_up, bunshin_melee_follow_up_)}))

  skill_library.add_skill(Skill(name='Ten', is_GCD=True, timing_spec=mudra_timing_spec))
  skill_library.add_skill(Skill(name='Chi', is_GCD=True, timing_spec=mudra_timing_spec))
  skill_library.add_skill(Skill(name='Jin', is_GCD=True, timing_spec=mudra_timing_spec))
  death_blossom_follow_up = FollowUp(skill=Skill(name='_Death Blossom', damage_spec = DamageSpec(100)),
                                      delay_after_parent_application=710)
  skill_library.add_skill(Skill(name='Death Blossom',
                                is_GCD=True,
                                combo_spec = (ComboSpec(),),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (death_blossom_follow_up,),
                                                  'Bunshin': (bunshin_area_follow_up_,death_blossom_follow_up)}))

  hakke_follow_up = FollowUp(skill=Skill(name='Hakke Mujinsatsu', damage_spec = DamageSpec(130)),
                              delay_after_parent_application=620)
  hakke_no_combo_follow_up = FollowUp(skill=Skill(name='Hakke Mujinsatsu', damage_spec = DamageSpec(100)),
                                      delay_after_parent_application=620)
  ...
  skill_library.add_skill(Skill(name='Hakke Mujinsatsu',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills = {SimConsts.DEFAULT_CONDITION: (_huton_follow_up_hakke,hakke_follow_up),
                                                    'No Combo': (hakke_no_combo_follow_up,),
                                                    'Bunshin': (_huton_follow_up_hakke, bunshin_area_follow_up_, hakke_follow_up),
                                                    'Bunshin, No Combo': (bunshin_area_follow_up_,hakke_no_combo_follow_up)})),

  armor_crush_follow_up = FollowUp(skill=Skill(name='Armor Crush', damage_spec = DamageSpec(420)),
                                    delay_after_parent_application=620)
  armor_crush_no_combo_follow_up = FollowUp(skill=Skill(name='Armor Crush', damage_spec = DamageSpec(200)),
                                            delay_after_parent_application=620)
  armor_crush_no_pos_follow_up = FollowUp(skill=Skill(name='Armor Crush', damage_spec = DamageSpec(360)),
                                          delay_after_parent_application=620)
  armor_crush_no_pos_no_combo_follow_up = FollowUp(skill=Skill(name='Armor Crush', damage_spec = DamageSpec(140)),
                                                    delay_after_parent_application=620)
  skill_library.add_skill(Skill(name='Armor Crush',
                                is_GCD=True,
                                combo_spec = (ComboSpec(combo_actions=('Gust Slash',)),),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                follow_up_skills = {SimConsts.DEFAULT_CONDITION: (armor_crush_follow_up, _huton_follow_up_armor_crush),
                                                    'No Combo' : (armor_crush_no_combo_follow_up,),
                                                    'No Positional' : (armor_crush_no_pos_follow_up, _huton_follow_up_armor_crush),
                                                    'No Combo, No Positional': (armor_crush_no_pos_no_combo_follow_up,),
                                                    'Bunshin': (armor_crush_follow_up, _huton_follow_up_armor_crush, bunshin_melee_follow_up_),
                                                    'Bunshin, No Combo': (armor_crush_no_combo_follow_up, bunshin_melee_follow_up_),
                                                    'Bunshin, No Positional': (armor_crush_no_pos_follow_up, _huton_follow_up_armor_crush, bunshin_melee_follow_up_),
                                                    'Bunshin, No Combo, No Positional': (armor_crush_no_pos_no_combo_follow_up, bunshin_melee_follow_up_)}))
  ...
  skill_library.add_skill(Skill(name='Phantom Kamaitachi',
                                is_GCD=True,
                                damage_spec= DamageSpec(potency=600, damage_class=DamageClass.PET, pet_job_mod_override=100),
  ...
  skill_library.add_skill(Skill(name='Hollow Nozuchi',
                                is_GCD=True,
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=270),
  ...
  skill_library.add_skill(Skill(name='Fleeting Raiju',
                                is_GCD=True,
                                damage_spec= DamageSpec(potency=560),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=760),
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: tuple(),
                                                  'Bunshin': (bunshin_melee_follow_up_,)}))
  ...
  skill_library.add_skill(Skill(name='Fuma Shuriken',
                                ...
                                timing_spec={SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=0,
                                                                                      gcd_base_recast_time=1500,
                                                                                      application_delay=890,
                                                                                      affected_by_speed_stat=False,
                                                                                      affected_by_haste_buffs=False),
                                              'Ten Chi Jin': TimingSpec(base_cast_time=0,
  ...
  skill_library.add_skill(Skill(name='Kassatsu',
                                ...
                                buff_spec=StatusEffectSpec(add_to_skill_modifier_condition=True,
                                                            ...
                                                            duration=15*1000,
                                                            damage_mult=1.3,
                                                            skill_allowlist=('Fuma Shuriken', 'Raiton', 'Doton', 'Suiton', 'Goka Mekkyaku', 'Huton', 'Hyosho Ranryu',))))
