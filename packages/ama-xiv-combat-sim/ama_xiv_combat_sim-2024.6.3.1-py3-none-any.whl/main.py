...
class DisplayUtils:
  ...
  def print_damage_applications(per_skill_damage):
    ...
    for sk in per_skill_damage:
      print('time: {:>8}, name: {:>22}, expected_damage: {:9.2f}, potency: {:4n}, skill modifier: {:>22}, damage variance: {:6.2f}'.format(sk.application_time,
                                                                                                                                           sk.skill_name,
                                                                                                                                           sk.expected_damage,
                                                                                                                                           sk.potency,
  ...
  def print_damage_details(per_skill_damage, damage_ranges, status_effect_names_only=True):
    ...
    for i in range(0, len(damage_ranges)):
      ...
      print('{:5n}: {:<22}, Potency: {:4n}, Modifier: "{}". '.format( sk.application_time, damage_ranges[i][0], sk.potency, ", ".join(sk.skill_modifier_condition)))
