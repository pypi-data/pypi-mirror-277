...
def add_rdm_skills(skill_library):
  ...
  skill_library.add_skill(Skill(name='Corps-a-corps',
                                is_GCD=False,
                                damage_spec=DamageSpec(potency=130),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=630),
                                status_effect_denylist=('Manafication', 'Embolden')))

  verthunder_2_damage_follow_up = FollowUp(skill=Skill(name='Verthunder II', damage_spec=DamageSpec(potency=140)), delay_after_parent_application=800)
  skill_library.add_skill(Skill(name='Verthunder II',
                                is_GCD=True,
                                timing_spec={SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=2000, animation_lock=650, application_delay=0),
                                             'Dualcast': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0)},
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (verthunder_2_damage_follow_up, dualcast_follow_up,),
                                                  'Dualcast': (verthunder_2_damage_follow_up,)}))

  veraero_2_damage_follow_up = FollowUp(skill=Skill(name='Veraero II', damage_spec=DamageSpec(potency=140)), delay_after_parent_application=800)
  skill_library.add_skill(Skill(name='Veraero II',
                                is_GCD=True,
                                timing_spec={SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=2000, animation_lock=650, application_delay=0),
                                             'Dualcast': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0)},
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (veraero_2_damage_follow_up, dualcast_follow_up,),
                                                  'Dualcast': (veraero_2_damage_follow_up,)}))

  verfire_damage_follow_up = FollowUp(skill=Skill(name='Verfire', damage_spec=DamageSpec(potency=340)), delay_after_parent_application=800)
  skill_library.add_skill(Skill(name='Verfire',
                                is_GCD=True,
                                timing_spec={SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=2000, animation_lock=650, application_delay=0),
                                             'Dualcast': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0)},
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (verfire_damage_follow_up, dualcast_follow_up,),
                                                  'Dualcast': (verfire_damage_follow_up,)}))

  verstone_damage_follow_up = FollowUp(skill=Skill(name='Verstone', damage_spec=DamageSpec(potency=340)), delay_after_parent_application=800)
  skill_library.add_skill(Skill(name='Verstone',
                                is_GCD=True,
                                timing_spec={SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=2000, animation_lock=650, application_delay=0),
                                             'Dualcast': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0)},
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (verstone_damage_follow_up, dualcast_follow_up,),
  ...
  skill_library.add_skill(Skill(name='Engagement',
                                is_GCD=False,
                                damage_spec=DamageSpec(potency=180),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=580),
                                status_effect_denylist=('Manafication', 'Embolden')))
  skill_library.add_skill(Skill(name='Fleche',
                                is_GCD=False,
                                damage_spec=DamageSpec(potency=460),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1160),
                                status_effect_denylist=('Manafication', 'Embolden')))
  ...
  skill_library.add_skill(Skill(name='Embolden',
                                is_GCD=False,
                                buff_spec=StatusEffectSpec(damage_mult=1.05, duration=int(19.9)*1000, is_party_effect=True),
  ...
  manafication_allowlist=('Verthunder II', 'Veraero II', 'Verfire', 'Verstone',
                           ...
                           'Scorch', 'Verthunder III', 'Veraero III', 'Resolution',
                           'Enchanted Riposte', 'Enchanted Zwerchhau', 'Enchanted Redoublement',
                           'Enchanted Moulinet', 'Enchanted Reprise')
  skill_library.add_skill(Skill(name='Manafication',
                                is_GCD=False,
                                combo_spec=(ComboSpec(),),
                                buff_spec=StatusEffectSpec(damage_mult=1.05,
                                                           duration=15*1000,
                                                           num_uses=6,
                                                           skill_allowlist=manafication_allowlist),
                                timing_spec=instant_timing_spec))

  jolt_2_damage_follow_up = FollowUp(skill=Skill(name='Jolt II', damage_spec=DamageSpec(potency=320)), delay_after_parent_application=760)
  skill_library.add_skill(Skill(name='Jolt II',
                                is_GCD=True,
                                timing_spec={SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=2000, animation_lock=650, application_delay=0),
                                             'Dualcast': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0)},
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (jolt_2_damage_follow_up, dualcast_follow_up,),
                                                  'Dualcast': (jolt_2_damage_follow_up,)}))

  impact_damage_follow_up = FollowUp(skill=Skill(name='Impact', damage_spec=DamageSpec(potency=210)), delay_after_parent_application=760)
  impact_acceleration_damage_follow_up = FollowUp(skill=Skill(name='Impact', damage_spec=DamageSpec(potency=260)), delay_after_parent_application=760)
  skill_library.add_skill(Skill(name='Impact',
                                is_GCD=True,
                                timing_spec= {SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=5000, animation_lock=650, application_delay=0),
                                              'Dualcast': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                              'Acceleration': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                              'Acceleration, Dualcast': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0)},
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (impact_damage_follow_up,dualcast_follow_up,),
  ...
  skill_library.add_skill(Skill(name='Scorch',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1830)))

  verthunder_3_damage_follow_up = FollowUp(skill=Skill(name='Verthunder III', damage_spec=DamageSpec(potency=380)), delay_after_parent_application=760)
  skill_library.add_skill(Skill(name='Verthunder III',
                                ...
                                timing_spec={SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=5000, animation_lock=650, application_delay=0),
                                             ...
                                             'Acceleration': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                             'Acceleration, Dualcast': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0)},
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (verthunder_3_damage_follow_up,dualcast_follow_up,),
  ...
  veraero_3_damage_follow_up = FollowUp(skill=Skill(name='Veraero III', damage_spec=DamageSpec(potency=380)), delay_after_parent_application=760)
  skill_library.add_skill(Skill(name='Veraero III',
                                ...
                                timing_spec={SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=5000, animation_lock=650, application_delay=0),
                                             ...
                                             'Acceleration': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0),
                                             'Acceleration, Dualcast': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=0)},
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (veraero_3_damage_follow_up,dualcast_follow_up,),
  ...
  skill_library.add_skill(Skill(name='Resolution',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1560)))
  skill_library.add_skill(Skill(name='Enchanted Riposte',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=280),
                                combo_spec=(ComboSpec(),),
                                timing_spec=TimingSpec(base_cast_time=0, gcd_base_recast_time=1500, application_delay=630)))
  ...
  skill_library.add_skill(Skill(name='Enchanted Redoublement',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, gcd_base_recast_time=2200, application_delay=630)))
  skill_library.add_skill(Skill(name='Enchanted Moulinet',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=130),
                                timing_spec=TimingSpec(base_cast_time=0, gcd_base_recast_time=1500, application_delay=800)))
  skill_library.add_skill(Skill(name='Enchanted Reprise',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=340),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=650)))
