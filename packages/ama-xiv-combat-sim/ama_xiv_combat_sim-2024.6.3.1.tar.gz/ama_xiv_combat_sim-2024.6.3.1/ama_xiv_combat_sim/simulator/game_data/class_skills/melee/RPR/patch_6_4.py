...
def add_rpr_skills(skill_library):
  ...
  shadow_of_death_damage = FollowUp(skill=Skill(name='Shadow of Death',
  ...
  skill_library.add_skill(Skill(name='Harpe',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=300),
                                timing_spec={SimConsts.DEFAULT_CONDITION:TimingSpec(base_cast_time=1300, gcd_base_recast_time=2500, application_delay=890, affected_by_speed_stat=False),
                                             'Enhanced Harpe': TimingSpec(base_cast_time=0, animation_lock=650, application_delay=890)}))
  ...
  whorl_of_death_damage = FollowUp(skill=Skill(name='Whorl of Death',
  ...
  skill_library.add_skill(Skill(name='Arcane Circle',
                                is_GCD=False,
                                buff_spec= StatusEffectSpec(damage_mult=1.03, duration=int(19.98*1000), is_party_effect=True),
  ...
  skill_library.add_skill(Skill(name='Void Reaping',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, gcd_base_recast_time=1500, application_delay=540),
  ...
  skill_library.add_skill(Skill(name='Cross Reaping',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, gcd_base_recast_time=1500, application_delay=620),
  ...
  skill_library.add_skill(Skill(name='Harvest Moon',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, gcd_base_recast_time=2500, application_delay = 1160, affected_by_speed_stat=False)))
  ...
  skill_library.add_skill(Skill(name='Communio',
                                ...
                                timing_spec=TimingSpec(base_cast_time=1300, application_delay=620, affected_by_speed_stat=False)))
  ...
  skill_library.add_skill(Skill(name='Enshroud',
                                is_GCD=False,
                                buff_spec=StatusEffectSpec(expires_status_effects=('Enhanced Void Reaping', 'Enhanced Cross Reaping')),
                                timing_spec=instant_timing_spec))
  ...
  skill_library.add_skill(Skill(name='Soulsow',
                                ...
                                timing_spec={SimConsts.DEFAULT_CONDITION: instant_timing_spec,
                                             'In Combat': TimingSpec(base_cast_time=5000, gcd_base_recast_time=2500, affected_by_speed_stat=False)}))
