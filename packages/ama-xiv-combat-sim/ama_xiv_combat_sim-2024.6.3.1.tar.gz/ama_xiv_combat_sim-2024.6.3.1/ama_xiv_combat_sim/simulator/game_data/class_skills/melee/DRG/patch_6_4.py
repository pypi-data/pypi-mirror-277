...
def add_drg_skills(skill_library):
  ...
  drg_weapon_skills = ('True Thrust', 'Vorpal Thrust', 'Piercing Talon',
                       'Disembowel', 'Doom Spike', 'Fang and Claw',
                       'Wheeling Thrust', 'Sonic Thrust', 'Coerthan Torment',
                       'Raiden Thrust', 'Draconian Fury', "Heavens' Thrust",
                       'Chaotic Spring')
  ...
  skill_library.add_skill(Skill(name='True Thrust',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=760)))
  skill_library.add_skill(Skill(name='Vorpal Thrust',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=1020)))
  skill_library.add_skill(Skill(name='Piercing Talon',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=150),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=850)))

  disembowel_damage_follow_up = FollowUp(skill=Skill(name='Disembowel', damage_spec=DamageSpec(potency=250)), delay_after_parent_application=1650)
  disembowel_no_combo_damage_follow_up = FollowUp(skill=Skill(name='Disembowel', damage_spec=DamageSpec(potency=140)), delay_after_parent_application=1650)
  skill_library.add_skill(Skill(name='Disembowel',
                                is_GCD=True,
                                combo_spec=(ComboSpec(combo_actions=('True Thrust', 'Raiden Thrust')),),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=0),
                                follow_up_skills= {SimConsts.DEFAULT_CONDITION: (disembowel_damage_follow_up, _power_surge_follow_up,),
                                                   'No Combo': (disembowel_no_combo_damage_follow_up,)}))
  skill_library.add_skill(Skill(name='Lance Charge',
                                is_GCD=False,
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=660),
  ...
  skill_library.add_skill(Skill(name='Doom Spike',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=1290)))
  skill_library.add_skill(Skill(name='Spineshatter Dive',
                                is_GCD=False,
                                damage_spec=DamageSpec(potency=250),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=800, application_delay=800)))
  ...
  skill_library.add_skill(Skill(name='Battle Litany',
                                ...
                                buff_spec=StatusEffectSpec(crit_rate_add=0.10, duration=15*1000, is_party_effect=True)))
  ...
  skill_library.add_skill(Skill(name='Fang and Claw',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=620),
                                buff_spec = {SimConsts.DEFAULT_CONDITION: StatusEffectSpec(add_to_skill_modifier_condition=True,
                                                                                           num_uses=1,
                                                                                           duration=30*1000, #is this actually 31.6? or 30+application delay or whatever?
  ...
  skill_library.add_skill(Skill(name='Wheeling Thrust',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=670),
                                buff_spec = {SimConsts.DEFAULT_CONDITION: StatusEffectSpec(add_to_skill_modifier_condition=True,
                                                                                           num_uses=1,
                                                                                           duration=30*1000, #is this actually 31.6? or 30+application delay or whatever?
                                                                                           skill_allowlist=drg_weapon_skills),
  ...
  sonic_thrust_damage_follow_up = FollowUp(skill=Skill(name='Sonic Thrust', damage_spec=DamageSpec(potency=120)), delay_after_parent_application=800)
  sonic_thrust_no_combo_damage_follow_up = FollowUp(skill=Skill(name='Sonic Thrust', damage_spec=DamageSpec(potency=100)), delay_after_parent_application=800)
  skill_library.add_skill(Skill(name='Sonic Thrust',
                                is_GCD=True,
                                combo_spec=(ComboSpec(combo_actions=('Doom Spike',)),),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=0),
                                follow_up_skills= {SimConsts.DEFAULT_CONDITION: (sonic_thrust_damage_follow_up, _power_surge_follow_up,),
                                                   'No Combo': (sonic_thrust_no_combo_damage_follow_up,)}))
  skill_library.add_skill(Skill(name='Dragon Sight',
                                is_GCD=False,
                                timing_spec= {SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=0, animation_lock=600, application_delay=660),
                                ...
                                buff_spec= {SimConsts.DEFAULT_CONDITION: StatusEffectSpec(damage_mult=1.1, duration=20*1000),
                                            'Left Eye': StatusEffectSpec(damage_mult=1.05, duration=20*1000, is_party_effect=True)}))
  # add this is a potential buff for convenience
  skill_library.add_skill(Skill(name='Left Eye',
                                is_GCD=False,
                                timing_spec= TimingSpec(base_cast_time=0, animation_lock=0),
                                buff_spec= StatusEffectSpec(damage_mult=1.05, duration=20*1000, is_party_effect=True)))

  skill_library.add_skill(Skill(name='Mirage Dive',
                                is_GCD=False,
                                damage_spec=DamageSpec(potency=200),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=800)))
  ...
  skill_library.add_skill(Skill(name='Coerthan Torment',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=490)))
  skill_library.add_skill(Skill(name='High Jump',
                                is_GCD=False,
                                damage_spec=DamageSpec(potency=400),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=800, application_delay=490)))
  ...
  skill_library.add_skill(Skill(name='Stardiver',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=1500, application_delay=1290)))
  ...
  skill_library.add_skill(Skill(name="Heavens' Thrust",
                                ...
                                damage_spec={SimConsts.DEFAULT_CONDITION: DamageSpec(potency=480),
                                             'No Combo': DamageSpec(potency=100)},
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=710)))
  ...
  skill_library.add_skill(Skill(name='Chaotic Spring',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=450),
  ...
  skill_library.add_skill(Skill(name='Wyrmwind Thrust',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=600, application_delay=1200)))
