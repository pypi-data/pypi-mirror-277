...
def add_drk_skills(skill_library):
  ...
  skill_library.add_skill(Skill(name='Hard Slash',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=581)))
  skill_library.add_skill(Skill(name='Syphon Strike',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=624)))
  skill_library.add_skill(Skill(name='Unleash',
                                is_GCD=True,
                                combo_spec=(ComboSpec(),),
                                damage_spec=DamageSpec(potency=120),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=712)))
  skill_library.add_skill(Skill(name='Unmend',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=150),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=978)))
  ...
  flood_of_shadow_damage_follow_up = FollowUp(skill=Skill(name='Flood of Shadow', damage_spec=DamageSpec(potency=160)), delay_after_parent_application=624)
  skill_library.add_skill(Skill(name='Flood of Shadow',
                                is_GCD=False,
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=624),
                                follow_up_skills= (flood_of_shadow_damage_follow_up, FollowUp(skill=_darkside_buff, delay_after_parent_application=0),)))
  ...
  edge_of_shadow_damage_follow_up = FollowUp(skill=Skill(name='Edge of Shadow', damage_spec=DamageSpec(potency=460)), delay_after_parent_application=624)
  skill_library.add_skill(Skill(name='Edge of Shadow',
                                ...
                                follow_up_skills= (edge_of_shadow_damage_follow_up, FollowUp(skill=_darkside_buff, delay_after_parent_application=0),)))
  ...
  skill_library.add_skill(Skill(name='Salted Earth',
                                is_GCD=False,
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=757),
  ...
  skill_library.add_skill(Skill(name='Carve and Spit',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1473)))
  skill_library.add_skill(Skill(name='Bloodspiller',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=500),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=802)))
  ...
  _living_shadow_shadowbringer=Skill(name='_Living Shadow Shadowbringer',
                                     is_GCD=False,
                                     damage_spec=DamageSpec(potency=500, damage_class=DamageClass.PET, pet_job_mod_override=100),
                                     status_effect_denylist=('Darkside', 'Dragon Sight'))
