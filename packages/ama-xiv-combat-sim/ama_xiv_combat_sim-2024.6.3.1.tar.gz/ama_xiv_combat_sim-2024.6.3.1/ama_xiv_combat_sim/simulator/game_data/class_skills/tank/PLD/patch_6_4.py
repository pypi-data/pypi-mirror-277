...
def add_pld_skills(skill_library):
  ...
  cast_instant_timing_spec = TimingSpec(base_cast_time=0,
  ...
  skill_library.add_skill(Skill(name='Riot Blade',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=758)))
  ...
  skill_library.add_skill(Skill(name='Shield Bash',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=100),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=446)))
  skill_library.add_skill(Skill(name='Shield Lob',
                                is_GCD=True,
                                damage_spec=DamageSpec(potency=100),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=889)))

  promimence_follow_up = FollowUp(skill=Skill(name='Prominence', damage_spec=DamageSpec(potency=170)), delay_after_parent_application=623)
  promimence_no_combo_follow_up = FollowUp(skill=Skill(name='Prominence', damage_spec=DamageSpec(potency=100)), delay_after_parent_application=623)
  skill_library.add_skill(Skill(name='Prominence',
                                is_GCD=True,
                                combo_spec=(ComboSpec(combo_actions=('Total Eclipse',)),),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=623),
                                follow_up_skills={SimConsts.DEFAULT_CONDITION: (promimence_follow_up, divine_might_follow_up,),
  ...
  skill_library.add_skill(Skill(name='Circle of Scorn',
                                is_GCD=False,
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1023),
  ...
  skill_library.add_skill(Skill(name='Goring Blade',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=534)))
  ...
  skill_library.add_skill(Skill(name='Royal Authority',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=578),
  ...
  skill_library.add_skill(Skill(name='Holy Spirit',
                                ...
                                timing_spec={SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=1500, animation_lock=100, application_delay=758, affected_by_speed_stat=False),
                                             'Divine Might': TimingSpec(base_cast_time=0, animation_lock=100, application_delay=758, affected_by_speed_stat=False),
                                             'Requiescat': TimingSpec(base_cast_time=0, animation_lock=100, application_delay=758, affected_by_speed_stat=False),
                                             'Divine Might, Requiescat': TimingSpec(base_cast_time=0, animation_lock=100, application_delay=758, affected_by_speed_stat=False)}))
  ...
  skill_library.add_skill(Skill(name='Holy Circle',
                                ...
                                timing_spec={SimConsts.DEFAULT_CONDITION: TimingSpec(base_cast_time=1500, animation_lock=100, application_delay=623, affected_by_speed_stat=False),
                                             'Divine Might': TimingSpec(base_cast_time=0, animation_lock=100, application_delay=623, affected_by_speed_stat=False),
                                             'Requiescat': TimingSpec(base_cast_time=0, animation_lock=100, application_delay=623, affected_by_speed_stat=False),
                                             'Divine Might, Requiescat': TimingSpec(base_cast_time=0, animation_lock=100, application_delay=623, affected_by_speed_stat=False)}))
  ...
  skill_library.add_skill(Skill(name='Atonement',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=1293)))
  skill_library.add_skill(Skill(name='Confiteor',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=623)))
  skill_library.add_skill(Skill(name='Expiacion',
                                is_GCD=False,
                                damage_spec=DamageSpec(potency=450),
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=357)))
  skill_library.add_skill(Skill(name='Blade of Faith',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=666)))
  skill_library.add_skill(Skill(name='Blade of Truth',
                                ...
                                timing_spec=TimingSpec(base_cast_time=0, animation_lock=650, application_delay=891)))
