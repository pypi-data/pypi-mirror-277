...
from lino_xl.lib.trading.mixins import SalesPrintable, ProductDocItem
from lino_xl.lib.excerpts.mixins import Certifiable
# from lino_xl.lib.storage.mixins import ProvisionFiller


class Subscription(Voucher, LedgerRegistrable, PartnerRelated, SalesPrintable,
                   DateRange, Duplicable, Referrable, Summarized):
...
class SubscriptionPeriod(DateRange, InvoiceGenerator):
    ...
    master = dd.ForeignKey(Subscription, related_name="periods_by_master")
