...
to the setActions() method instead.`);
  ...
  var _dec$3, _class$5, _class2$3, _$itemState;
  /**
  ...
  }), _dec$3(_class$5 = (_$itemState = /*#__PURE__*/new WeakMap(), (_class2$3 = class ListItemView extends Spina.BaseView {
    constructor() {
      super(...arguments);
...
<% } else { %>
<%- text %>
<% } %>`)), _defineProperty(_class2$3, "actionHandlers", {}), _class2$3))) || _class$5);
  ...
  var _dec$2, _class$3, _class2$2, _renderItems;
  ...
  }), _dec$2(_class$3 = (_renderItems = /*#__PURE__*/new WeakSet(), (_class2$2 = class ListView extends Spina.BaseView {
    constructor() {
      super(...arguments);
