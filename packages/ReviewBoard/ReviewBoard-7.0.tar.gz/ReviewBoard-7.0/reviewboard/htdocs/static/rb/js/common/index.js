(function (global, factory) {
     ...
     *     6.0
     */
    let Action = spina.spina(_class$i = class Action extends spina.BaseModel {
      static defaults = {
        actionId: '',
        domID: null,
        iconClass: null,
     ...
     *     6.0
     */
    let MenuAction = spina.spina(_class$h = class MenuAction extends Action {
      static defaults() {
        return {
          children: []
        };
     ...
     *     6.0
     */
    let ActionView = spina.spina(_class$g = class ActionView extends spina.BaseView {}) || _class$g;

    var _class$f, _class2$1;
     ...
     *     6.0
     */
    let MenuActionView = spina.spina(_class$f = class MenuActionView extends ActionView {
      static events = {
        'focusout': 'onFocusOut',
        'keydown': 'onKeyDown',
        'mouseenter': 'openMenu',
     ...
     *     6.0
     */
    let MenuItemActionView = spina.spina(_class2$1 = class MenuItemActionView extends ActionView {
      static events = {
        'click': '_onClick',
     ...
     */
    let BaseCollection = spina.spina(_class$e = class BaseCollection extends spina.BaseCollection {
      /**
     ...
     */
    let ResourceCollection = spina.spina(_class$d = class ResourceCollection extends BaseCollection {
      /**********************
       * Instance variables *
       **********************/
     ...
     */
    let ExtraData = spina.spina(_class$c = class ExtraData extends spina.BaseModel {
      /**
    ...
    }), _dec$4(_class$b = class BaseResource extends spina.BaseModel {
      static strings = {
     ...
     */
    let Item = spina.spina(_class$a = class Item extends BaseResource {
      /**
     ...
     * of objects.
     */
    let StoredItems = spina.spina(_class2 = class StoredItems extends BaseResource {
      /**
     ...
     */
    let BaseComment = spina.spina(_class$9 = class BaseComment extends BaseResource {
      /**
       * Return default values for the model attributes.
       *
       * Returns:
...
STATE_VERIFYING_RESOLVED.`
     ...
     */
    let FileAttachment = spina.spina(_class$8 = class FileAttachment extends BaseResource {
      /**
       * Return default values for the model attributes.
       *
       * Returns:
      ...
      static deserializedAttrs = ['attachmentHistoryID', 'caption', 'downloadURL', 'filename', 'reviewURL', 'revision', 'state', 'thumbnailHTML'];
      static serializers = {
    ...
    }), _dec$3(_class$7 = class DraftFileAttachment extends FileAttachment {
    ...
    }), _dec$2(_class$6 = class ReviewReply extends BaseResource {
      /**
       * Return default values for the model attributes.
       *
       * Returns:
     ...
     * ReviewReply.
     */
    let Review = spina.spina(_class$5 = class Review extends BaseResource {
      /**
       * Return default values for the model attributes.
       *
       * Returns:
    ...
    let DraftReview = (_dec$1 = spina.spina({
      mixins: [DraftResourceModelMixin]
    }), _dec$1(_class$4 = class DraftReview extends Review {
      static defaults = {
