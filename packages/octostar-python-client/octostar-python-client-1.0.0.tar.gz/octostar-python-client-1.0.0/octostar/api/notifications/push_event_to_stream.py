...
from ...models.push_event_to_stream_response_401 import PushEventToStreamResponse401
...
def _parse_response(
    *, client: Client = None, response: httpx.Response
) -> Optional[Union[Acknowledgement, Any, PushEventToStreamResponse401]]:
    if not client:
        client = get_default_client()
    ...
    if response.status_code == HTTPStatus.UNAUTHORIZED:
        response_401 = PushEventToStreamResponse401.from_dict(response.json())
...
def _build_response(
    *, client: Client = None, response: httpx.Response
) -> Response[Union[Acknowledgement, Any, PushEventToStreamResponse401]]:
    if not client:
        client = get_default_client()
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Push an Octostar event to a stream
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Acknowledgement, Any, PushEventToStreamResponse401]
    """
