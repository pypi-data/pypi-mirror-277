...
from ...models.create_workspace_response_200 import CreateWorkspaceResponse200
...
def _get_kwargs(
    *,
    ...
    url = "{}/api/octostar/workspace_data_api/create_workspace".format(client.base_url)
...
def _parse_response(
    *, client: Client = None, response: httpx.Response
    ...
    Union[
        CreateWorkspaceResponse200, CreateWorkspaceResponse400, CreateWorkspaceResponse401, CreateWorkspaceResponse500
    ]
]:
    if not client:
        client = get_default_client()
    if response.status_code == HTTPStatus.OK:
        response_200 = CreateWorkspaceResponse200.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[CreateWorkspaceResponse200, CreateWorkspaceResponse400, CreateWorkspaceResponse401, CreateWorkspaceResponse500]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[CreateWorkspaceResponse200, CreateWorkspaceResponse400, CreateWorkspaceResponse401, CreateWorkspaceResponse500]
    """
