    ...
    def __init__(
        ...
        if _skip_api_server:
            if query_server is None:
                ...
                raise ValueError("Skipping API server auth only enabled if query_server URI is localhost.")
            ...
            query_server = t.grpc_engines.get(self._environment_id, None)
        ...
        self._engine_channel: Optional[grpc.Channel] = (
            ...
            if query_server is None
                ...
                grpc.intercept_channel(
                    ...
                    if query_server.startswith("localhost") or query_server.startswith("127.0.0.1")
                    else grpc.secure_channel(
                        target=query_server,
                        credentials=grpc.ssl_channel_credentials(),
                        options=channel_options,
