...
def run_workflow_task(logs: str):
    ...
    commit_ref = EnvironmentVariables().commit_ref
    branch_ref = EnvironmentVariables().commit_ref_name
    data = AnalyseLogsSchema(logs=logs, pipeline_id=pipeline_id, job_id=job_id, commit_ref=commit_ref,
