...
class ModelsArtifactRepository(ArtifactRepository):
    ...
    def get_underlying_uri(uri):
        ...
        download_uri = client._get_model_version_download_uri(name, version)
    ...
    def list_artifacts(
        ...
        :param max_results: max number of items to return per page while paginating
        :param page_token: continuation token to resume pagination from a certain point

        :return: List of artifacts as FileInfo listed directly under path.
        """
        return self.repo.list_artifacts(path, max_results=max_results, page_token=page_token)
