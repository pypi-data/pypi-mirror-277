...
class ArtifactRepositoryRegistry:
    ...
    def get_artifact_repository(self, artifact_uri, credentials=None, storage_integration_id=None):
        ...
        return repository(
            artifact_uri, credentials=credentials, storage_integration_id=storage_integration_id
        )
...
# ToDo(nikp1172) Add support for other artifact repositories
...
def get_artifact_repository(artifact_uri, credentials=None, storage_integration_id=None):
    """Get an artifact repository from the registry based on the scheme of artifact_uri
