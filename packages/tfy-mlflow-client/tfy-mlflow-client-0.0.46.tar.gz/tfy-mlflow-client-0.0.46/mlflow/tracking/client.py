...
# TODO (chiragjn): Fix signature warnings and issues from this module in abstract classes and implementations
...
class MlflowClient:
    ...
    def get_run_by_name(
        ...
        return self._tracking_client.get_run_by_name(
    ...
    def get_model_version(
        self, experiment_id: int, model_name: str, version: Optional[int]
    ) -> ModelVersion:
    ...
    def list_artifacts_mlf(
        ...
        return self._tracking_client.list_artifacts_mlf(
    ...
    def authorize_user_for_model_version(
        ...
        return self._tracking_client.authorize_user_for_model_version(
            version_id=version_id, role=role
        )
    ...
    def get_dataset(
        ...
        return self._tracking_client.get_dataset(id=id)

    def get_dataset_by_fqn(
        self,
        fqn: str,
    ) -> Dataset:
        return self._tracking_client.get_dataset_by_fqn(
            fqn=fqn,
        )

    def get_signed_urls_for_dataset_read(self, fqn: str, paths: List[str]) -> List[SignedURL]:
        return self._tracking_client.get_signed_urls_for_dataset_read(
            fqn=fqn,
            paths=paths,
        )

    def get_signed_urls_for_dataset_write(self, fqn: str, paths: List[str]) -> List[SignedURL]:
    ...
    def list_datasets(
        ...
        return self._tracking_client.list_datasets(
            experiment_id=experiment_id,
            name=name,
            max_results=max_results,
            page_token=page_token,
    ...
    def update_dataset(
        ...
        fqn: str,
        description: Optional[str] = SENTINEL,
        dataset_metadata: Dict[str, Any] = SENTINEL,
    ) -> Dataset:
        return self._tracking_client.update_dataset(
            fqn=fqn,
            description=description,
            dataset_metadata=dataset_metadata,
        )
