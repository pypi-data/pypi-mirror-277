...
class DatabricksArtifactRepository(ArtifactRepository):
    ...
    def _call_endpoint(self, api, json_body):
        ...
        return call_endpoint(db_creds, endpoint, method, json_body, response_dto_cls)

    def _get_run_artifact_root(self, run_id):
        json_body = json.dumps({"run_id": run_id})

        run_response = self._call_endpoint(config.GetRun, json_body)
