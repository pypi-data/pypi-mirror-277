...
def main(target: str, name: str, user: str, run_type: Literal['normal', 'python_only', 'dotnet_only'], port: int, domain: str, whitelist_me: bool, via_proxy: bool, dev_dll_path: str):
...
def run(target: str, name: str, user: str, port: int, domain: str, whitelist_me: bool, via_proxy: bool, run_type: Literal['normal', 'python_only', 'dotnet_only'], dev_dll_path):
    ...
    """
    main(target, name, user, run_type, port, domain, whitelist_me, via_proxy, dev_dll_path)
