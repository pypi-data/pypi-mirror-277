...
def get_offset_fit(th, I, dI, Beam_Energy, fitflag, varylist = None, startlist = None, showfit=True, verbose=True):
    """
    ...
    fitflag : str
        The fitting configuration flag. Options are:
        - 'NN': New cell, New multilayer.
        - 'OO': Old cell, Old multilayer.
    ...
    result = fitfun.fit(I, theta=th_refrac, params=params, 
                        Energy=Beam_Energy, water=True, bilayer=True, 
    ...
    if showfit:    
        ysim = result.eval(theta=th_refrac, Energy=Beam_Energy, 
