...
def main():
  ...
  #base_url 可不传，默认正式环境
  bos = SunnyOrderSplitter(platform, symbol, api_key, secret_key, base_url)
  
  params = {
      "side": "BUY",
      "orderAmount": 20, # USDT 金额
      "totalAmount": 85, # USDT 金额
      "interval": 5 #秒
  }
  """
  params = {
      "side": "SELL",
      "orderAmount": 1000, #NOT 数量
      "totalAmount": 4100, #NOT 数量 
      "interval": 5
  }
  """
  bos.split_order(params) 
