from soda_generator.connectors.connectors import Connector
from soda_generator.connectors.click_connect import ClickhouseConnector
from soda_generator.connectors.trino_connector import TrinoConnector
