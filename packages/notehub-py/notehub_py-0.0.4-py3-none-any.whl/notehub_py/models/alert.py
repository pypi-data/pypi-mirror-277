...
class Alert(BaseModel):
    ...
    resolved: Optional[StrictBool] = Field(default=None, description="If true, the alert has been resolved")
    version: Optional[StrictInt] = Field(default=None, description="The version of the alert")
    alert_source: Optional[StrictStr] = Field(default=None, description="The source of the alert")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [AlertDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "notifications": [AlertNotificationsInner.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None
        })
        return _obj
