...
class AlertDataInner(BaseModel):
    ...
    source_type: Optional[StrictStr] = Field(default=None, description="The type of source.")
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The value that triggered the alert")
    source_uid: Optional[StrictStr] = Field(default=None, description="The UID of the source of the alert")
    when: Optional[StrictStr] = Field(default=None, description="The time the alert was created")
    __properties: ClassVar[List[str]] = ["alert_source", "source", "source_type", "value", "source_uid", "when"]
