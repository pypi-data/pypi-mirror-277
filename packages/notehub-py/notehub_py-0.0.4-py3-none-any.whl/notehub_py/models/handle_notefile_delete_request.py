...
class HandleNotefileDeleteRequest(BaseModel):
    """
    HandleNotefileDeleteRequest
    """ # noqa: E501
    files: Optional[List[StrictStr]] = Field(default=None, description="One or more files to obtain change information from.")
