...
class Azure(BaseModel):
    ...
    functions_key_secret: Optional[StrictStr] = Field(default=None, description="This value is input-only and will be omitted from the response and replaced with a placeholder")
    sas_policy_name: Optional[StrictStr] = None
    sas_policy_key: Optional[StrictStr] = Field(default=None, description="This value is input-only and will be omitted from the response and replaced with a placeholder")
    __properties: ClassVar[List[str]] = ["fleets", "filter", "transform", "throttle_ms", "url", "timeout", "functions_key_secret", "sas_policy_name", "sas_policy_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "functions_key_secret": obj.get("functions_key_secret"),
            "sas_policy_name": obj.get("sas_policy_name"),
            "sas_policy_key": obj.get("sas_policy_key")
        })
        return _obj
