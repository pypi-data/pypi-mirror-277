...
class Google(BaseModel):
    ...
    token: Optional[StrictStr] = Field(default=None, description="Optional authentication token")
    __properties: ClassVar[List[str]] = ["fleets", "filter", "transform", "throttle_ms", "url", "timeout", "token"]
