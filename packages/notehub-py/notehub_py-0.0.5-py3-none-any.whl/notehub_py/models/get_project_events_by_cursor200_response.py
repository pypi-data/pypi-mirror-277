...
class GetProjectEventsByCursor200Response(BaseModel):
    """
    GetProjectEventsByCursor200Response
    """ # noqa: E501
    events: List[Event]
    next_cursor: StrictStr = Field(description="The cursor value of the next result, which is intended to be used as the \"cursor\" parameter value of the next call to this method. An empty string is returned if there are no more results after this results set. ")
