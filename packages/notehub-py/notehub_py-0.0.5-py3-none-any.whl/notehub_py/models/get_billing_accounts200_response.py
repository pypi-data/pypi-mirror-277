...
class GetBillingAccounts200Response(BaseModel):
    """
    GetBillingAccounts200Response
    """ # noqa: E501
    billing_accounts: Optional[List[BillingAccount]] = None
    __properties: ClassVar[List[str]] = ["billing_accounts"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.billing_accounts:
            for _item in self.billing_accounts:
                if _item:
                    _items.append(_item.to_dict())
            _dict['billing_accounts'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "billing_accounts": [BillingAccount.from_dict(_item) for _item in obj["billing_accounts"]] if obj.get("billing_accounts") is not None else None
        })
        return _obj
