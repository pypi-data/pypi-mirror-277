...
class Mqtt(BaseModel):
    ...
    password: Optional[StrictStr] = Field(default=None, description="This value is input-only and will be omitted from the response and replaced with a placeholder")
    topic: Optional[StrictStr] = None
    certificate: Optional[StrictStr] = Field(default=None, description="Certificate with \\n newlines.  This value is input-only and will be omitted from the response and replaced with a placeholder")
    certificate_name: Optional[StrictStr] = Field(default=None, description="Name of certificate.")
    key: Optional[StrictStr] = Field(default=None, description="Key with \\n newlines.  This value is input-only and will be omitted from the response and replaced with a placeholder")
    private_key_name: Optional[StrictStr] = Field(default=None, description="Name of key")
    __properties: ClassVar[List[str]] = ["fleets", "filter", "transform", "throttle_ms", "timeout", "broker", "port", "username", "password", "topic", "certificate", "certificate_name", "key", "private_key_name"]
