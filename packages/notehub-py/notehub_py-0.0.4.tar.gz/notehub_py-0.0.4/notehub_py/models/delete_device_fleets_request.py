...
class DeleteDeviceFleetsRequest(BaseModel):
    """
    DeleteDeviceFleetsRequest
    """ # noqa: E501
    fleet_uids: List[StrictStr] = Field(description="The fleetUIDs to remove from the device.")
    __properties: ClassVar[List[str]] = ["fleet_uids"]
