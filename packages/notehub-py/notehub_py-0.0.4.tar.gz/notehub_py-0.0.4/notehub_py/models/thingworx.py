...
class Thingworx(BaseModel):
    ...
    app_key: Optional[StrictStr] = Field(default=None, description="This value is input-only and will be omitted from the response and replaced with a placeholder")
    __properties: ClassVar[List[str]] = ["fleets", "filter", "transform", "throttle_ms", "url", "timeout", "app_key"]
