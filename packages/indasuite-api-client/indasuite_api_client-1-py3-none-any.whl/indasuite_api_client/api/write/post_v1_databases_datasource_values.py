...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = OkResponse.from_dict(response.text)
    ...
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = WarningResponse.from_dict(response.text)
...
def sync_detailed(
    ...
    *,
    ...
    """Ingest values. Automatically creates non existent time series. Beware: only send points if you are
    absolutely certain they should be persisted.
