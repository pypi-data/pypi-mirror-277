...
from ActionStreamer import API
import WebService.API


def create_file(ws_config: ActionStreamer.API.WebServiceConfig, device_name: str, filename: str, file_size: int, sha256_hash: str) -> tuple[int, str, str, int]:
