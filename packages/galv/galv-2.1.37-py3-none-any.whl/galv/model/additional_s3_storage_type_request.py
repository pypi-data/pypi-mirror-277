...
"""
    ...
    The version of the OpenAPI document: 2.1.37
...
class AdditionalS3StorageTypeRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lab", "quota", "name", "priority", "enabled", "bucket_name", "location", "custom_domain", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lab", "quota", "name", "priority", "enabled", "bucket_name", "location", "custom_domain", ], str]):
