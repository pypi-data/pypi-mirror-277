...
class NsSearchSavedExport:
    def __init__(self, url: str, consumer_key: str, consumer_secret: str, token_key: str, token_secret: str, realm: str, search_id: str = ''):
        ...
        self.path_part = self.create_folder_part("part")
    ...
    def create_folder_part(self, name: str = "part") -> str:
        """Create a folder to save the data
        ...
        """
        try:
            self.path_part = os.path.join(self.path, name)
            if not os.path.exists(self.path_part):
                os.makedirs(self.path_part)
                
            return self.path
        except Exception as e:
            logger.error(f"Error  {self.create_folder_part.__name__}: ".format(e))
