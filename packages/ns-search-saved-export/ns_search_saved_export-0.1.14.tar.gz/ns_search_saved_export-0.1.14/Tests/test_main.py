...
saved = 'customsearch_mc_iges_producto'
...
while True:
    ...
    # Send request
    payload = {'searchID': saved, 'pageIndex': page_index, 'pageRange': page_range }
    ...
    if page_index == 4:
        ...
        print(f"{results}")
        with open(os.path.join("data_test", 'conslidado.json'), 'w', encoding='utf-8') as json_file:
