...
from ...types.key_import import KeyImport
...
class KeysClient:
    ...
    def key_generate(
        ...
        *,
        ...
        ---
        from truvity_sdk import KeyGenerate, KeySpec
    ...
    def key_import(
        ...
        *,
        ...
        client = TruvityApi(api_key="YOUR_API_KEY", )
        client.keys.key_import(data="-----BEGIN PRIVATE KEY-----
        MIG2AgEAMBAGByqGSM49AgEGBSuBBAAiBIGeMIGbAgEBBDANVkwr29lAEVjW91gr
        AQASTxRf07kG+TUYqFS/1p2B7t7JVYEh/x5R0cIWh8eZeaOhZANiAAQiB906hR9Y
        E0OBrYAYRbRJYwyFLUa9xScZF5bCY8ZxhtnB0Wh56KarkIcIw2sIko1Bi8PfW/WW
        FG0PfxczFs7bVjQg7m4ApV0KZ4hzzSUQ0mCEw00n/GKaBxuwmipgSTo=
        -----END PRIVATE KEY-----
        ", )
        """
        _request: typing.Dict[str, typing.Any] = {"data": data}
...
class AsyncKeysClient:
    ...
    async def key_import(
        ...
        *,
        ...
        client = AsyncTruvityApi(api_key="YOUR_API_KEY", )
        await client.keys.key_import(data="-----BEGIN PRIVATE KEY-----
        MIG2AgEAMBAGByqGSM49AgEGBSuBBAAiBIGeMIGbAgEBBDANVkwr29lAEVjW91gr
        AQASTxRf07kG+TUYqFS/1p2B7t7JVYEh/x5R0cIWh8eZeaOhZANiAAQiB906hR9Y
        E0OBrYAYRbRJYwyFLUa9xScZF5bCY8ZxhtnB0Wh56KarkIcIw2sIko1Bi8PfW/WW
        FG0PfxczFs7bVjQg7m4ApV0KZ4hzzSUQ0mCEw00n/GKaBxuwmipgSTo=
