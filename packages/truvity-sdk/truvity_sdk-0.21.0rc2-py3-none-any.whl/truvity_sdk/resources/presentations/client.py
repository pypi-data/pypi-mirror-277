...
from ...types.presentation_issue import PresentationIssue
...
class PresentationsClient:
    ...
    def presentation_issue(
        self,
        id: ResourceId,
        *,
        data: PresentationIssue,
        annotations: typing.Optional[Annotations] = OMIT,
        labels: typing.Optional[Labels] = OMIT,
        idempotency_key: typing.Optional[str] = None,
        if_match: str,
        ...
        Parameters:
            ...
            - request_options: typing.Optional[RequestOptions]. Request-specific configuration.
        ---
        from truvity_sdk import CryptoSuite, PresentationIssue
        from truvity_sdk.client import TruvityApi

        client = TruvityApi(
            api_key="YOUR_API_KEY",
        )
        client.presentations.presentation_issue(
            id="id",
            if_match="If-Match",
            data=PresentationIssue(
                key_id="key_id",
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/", f"presentations/{jsonable_encoder(id)}/issue"
            ),
            params=jsonable_encoder(
                request_options.get("additional_query_parameters") if request_options is not None else None
            ),
...
class AsyncPresentationsClient:
    ...
    async def presentation_issue(
        ...
        *,
        ...
        await client.presentations.presentation_issue(
            id="id",
            if_match="If-Match",
            data=PresentationIssue(
                key_id="key_id",
