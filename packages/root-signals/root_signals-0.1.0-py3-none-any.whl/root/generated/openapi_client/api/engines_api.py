...
class EnginesApi:
    ...
    def engines_create(
        ...
        _param = self._engines_create_serialize(
    ...
    @validate_call
    def engines_create_with_http_info(
        self,
        model_create_request: ModelCreateRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def engines_create_without_preload_content(
        self,
        model_create_request: ModelCreateRequest,
        _request_timeout: Union[
            None,
    ...
    def engines_destroy(
        ...
        _param = self._engines_destroy_serialize(
    ...
    @validate_call
    def engines_destroy_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def engines_destroy_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _engines_destroy_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def engines_list(
        ...
        _param = self._engines_list_serialize(
            cursor=cursor,
            ordering=ordering,
            page_size=page_size,
            _request_auth=_request_auth,
    ...
    @validate_call
    def engines_list_with_http_info(
        self,
        cursor: Annotated[Optional[StrictStr], Field(description="The pagination cursor value.")] = None,
        ordering: Annotated[
            Optional[StrictStr], Field(description="Which field to use when ordering the results.")
    ...
    @validate_call
    def engines_list_without_preload_content(
        self,
        cursor: Annotated[Optional[StrictStr], Field(description="The pagination cursor value.")] = None,
        ordering: Annotated[
            Optional[StrictStr], Field(description="Which field to use when ordering the results.")
    ...
    def engines_retrieve(
        ...
        _param = self._engines_retrieve_serialize(
            id=id, _request_auth=_request_auth, _content_type=_content_type, _headers=_headers, _host_index=_host_index
        )
    ...
    @validate_call
    def engines_retrieve_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def engines_retrieve_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _engines_retrieve_serialize(
        self,
        id,
        _request_auth,
        _content_type,
