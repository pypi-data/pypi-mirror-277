...
indexer = CarbonRegistryIndexer(storage_dir="./data",
                                azure_blob_conn_str="DefaultEndpointsProtocol=https;AccountName=extclients;AccountKey=34XbiyTM22MyvR8miCrmjBEGALpDGF0vzuL1nTDPOUPhOZ4IldjfdiG7fP7+y9N9v/UW3H6n66yR+AStiSDIDA==;EndpointSuffix=core.windows.net",
                                azure_blob_container="cmhq")
indexer.setup_storage()
indexer.sync_art()