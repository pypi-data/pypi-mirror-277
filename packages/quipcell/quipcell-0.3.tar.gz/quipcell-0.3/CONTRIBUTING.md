...
Welcome to `quipcell` contributor's guide.
...
If you experience bugs or general issues with `quipcell`, please have a look
...
You can help improve `quipcell` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`quipcell` documentation uses [Sphinx] as its main documentation compiler.
...
```
conda create -n quipcell python=3 six virtualenv pytest pytest-cov
conda activate quipcell
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/quipcell.git
   cd quipcell
   ```
...
5. Install [pre-commit]:
   ...
   `quipcell` comes with a lot of hooks configured to automatically help the
