...
def index_backtest(shCode='', indexNm='', pType='종가', frDt='19960101', toDt='20991231'
    ...
    for idx, xCode in enumerate(shCodeList):
        dfRes, dfReport, dfMerge = _index_backtest(shCode=xCode, indexNm=indexNm, pType=pType, frDt=frDt, toDt=toDt
...
def _index_backtest(shCode='', indexNm='', pType='종가', frDt='19960101', toDt='20991231'
    ...
    dfStock = bs.getValidTradeInfo(shCode, frDt, toDt)
