...
EVENT_COUNTER_OBJECTS = LNPattern("0.b.96.15.(0-99).f")
...
ASSOCIATION_OBJECTS = LNPattern("0.0.0.40.e.255")  # 6_2_33
NON_CURRENT_ASSOCIATION = LNPattern("0.0.0.40.(1-255).255")
LIMITER_OBJECTS = LNPattern("0.b.17.0.e.255")  # 6_2_15
