"""
Test of the NaCl minimization framework, with a simple toy model.

Test of constraints. Constraints written in the old way.
"""
...
if __name__ == '__main__':
    res, s = main_aixbicd(n_realizations=1)
