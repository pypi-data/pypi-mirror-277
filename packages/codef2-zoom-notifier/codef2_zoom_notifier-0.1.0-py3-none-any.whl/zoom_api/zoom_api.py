...
ACCOUNT_ID = ""
TO_CHANNEL = ""
TO_CONTACTS = ['muthasir@aggregateintelligence.in','arunnataraj@aggregateintelligence.in']
...
def format_for_zoom_message(message_body):
    """
    Formats the data into messages suitable for sending to a Zoom group.
    """
...
def get_access_token():
    """
    Obtains an access token from Zoom.
    """
...
def send_message_to_zoom_group(message, msg_category, msg_type):
    """
    Sends the formatted message to multiple Zoom contacts.
    """
    ...
    # Check if message length is less than or equal to 25000 characters
    ...
    # Chunk the message into parts if it exceeds 25000 characters
    chunk_size = 25000
...
def send_zoom_notification(message_body,  message_category='unknown', message_type='failure'):
    ...
    try:
        ...
        final_message = format_for_zoom_message(message_body, message_category)
