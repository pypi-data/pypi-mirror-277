...
# Mesh	
# class MeshEngineWrapper:
# 	@staticmethod
# 	def get_instance() -> MeshEngineWrapper: ...
# 	def set_geometry_engine(self, geom_engine: GEOMImpl_Gen) -> None: ...
# 	def set_mesh_export_path(self, export_path: str) -> None: ...
# 	def get_mesh_export_path(self) -> str: ...
	
class MeshElementType(enum.Enum):
	TRIA: MeshElementType
	QUAD: MeshElementType
	
class MeshElementOrder(enum.Enum):
	FIRST: MeshElementOrder
	SECOND: MeshElementOrder

class MeshAlgorithmChoice(enum.Enum):
	MESH_ADAPT: MeshAlgorithmChoice
	DELAUNAY: MeshAlgorithmChoice
	FRONTAL: MeshAlgorithmChoice
	BAMG: MeshAlgorithmChoice
	DELAUNAY_QUAD: MeshAlgorithmChoice

class MeshSettings:
	def __init__(self, 
			  mesh_size: float, 
			  element_type: MeshElementType,
			  mesh_algo_choice: MeshAlgorithmChoice,
			  element_order: MeshElementOrder): ...
	def set_element_size(self, element_size: float) -> None: ...
	def set_element_type(self, element_type: MeshElementType) -> None: ...
	def set_element_order(self, element_order: MeshElementOrder) -> None: ...
	def get_element_size(self) -> float: ...
	def get_element_type(self) -> MeshElementType: ...
	def get_element_order(self) -> MeshElementOrder: ...
	def get_mesh_algorithm(self) -> MeshAlgorithmChoice: ...
...
class MeshFactory:
	...
	def create_2d_mesh(self, geom_object_face: GEOM_Object, mesh_settings: MeshSettings) -> Mesh: ...
...
class ModelBuilder:
	...
	def save_model_to(self, path: str) -> bool: ...
	def close_model(self) -> bool: ...
	def clear_model(self) -> bool: ...
	def load_model(self, path: str) -> bool: ...
	def set_model_name(self, name: str) -> None: ...
	def get_model_name(self) -> str: ...
	def add_geometry_to_model(self, 
				  geom_object: GEOM_Object, 
				  parent_id: int, 
				  publish_under_name: str, 
				  export_path: str, 
				  add_with_refined_size: bool=True) -> int: ...
	def add_mesh_to_model(self, 
				  mesh: Mesh, 
				  publish_under_name: str, 
				  parent_id: int, 
				  export_path: str) -> int: ...
	def get_geometry_asset_name(self, entity_id: int) -> str: ...
	def set_geometry_asset_name(self, entity_id: int, entity_name: str) -> bool: ...
	def add_container(self, name: str) -> int: ...
	def add_folder(self, name: str, parent_id: int) -> int: ...
	def add_file(self, name: str, parent_id: int) -> int: ...
	def is_item_nested(self, item_id: int) -> bool: ...
	def is_item_container(self, item_id: int) -> bool: ...
	def is_item_file_reference(self, item_id: int) -> bool: ...
	def get_item_nesting_level(self, item_id: int) -> int: ...
	def get_nested_component_ids(self, item_id: int) -> list: ...
	def get_all_nested_component_ids(self, item_id: int) -> list: ...
	def remove_from_model(self, item_id: int) -> bool: ...
	def get_object_name(self, item_id: int) -> str: ...
	def get_geom_entity_by_id(self, item_id: int) -> GEOM_Object: ...
	def get_mesh_entity_by_id(self, item_id: int) -> Mesh: ...
	def open_new_model(self, model_name: str) -> None: ...
	def get_added_component_ids(self) -> list[int]: ...
	def get_container_id_by_name(self, name: str) -> int: ...
	def set_object_color(self, item_id: int, color: Color) -> bool: ...
	def get_object_color(self, item_id: int) -> Color: ...
	def set_object_visibility(self, item_id: int, is_visible: bool) -> bool: ...
	def is_object_visible(self, item_id: int) -> bool: ...
	def get_object_opacity(self, item_id: int) -> float: ...
	def set_object_opacity(self, item_id: int, opacity: float) -> bool: ...
