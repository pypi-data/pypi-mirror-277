...
from pinecone_plugins.knowledge.control.core.client import rest
from pinecone_plugins.knowledge.control.core.client.configuration import Configuration
from pinecone_plugins.knowledge.control.core.client.exceptions import PineconeApiTypeError, PineconeApiValueError, PineconeApiException
from pinecone_plugins.knowledge.control.core.client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_knowledge_model  # this is an instance of the class Endpoint
        api_instance.create_knowledge_model()  # this invokes api_instance.create_knowledge_model.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_knowledge_model.callable or self.callable in this class
