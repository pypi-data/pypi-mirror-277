        ...
        if settings.AXES_ONLY_USER_FAILURES and username is None:
            ...
            try:
                ...
                if created:
                    ...
                    separator = "\n---------\n"
                    attempt.get_data = Concat(F("get_data"), Value(separator + get_data))
                    attempt.post_data = Concat(F("post_data"), Value(separator + post_data))
                ...
                log.error("AXES: Unexpected error: %s", e)
