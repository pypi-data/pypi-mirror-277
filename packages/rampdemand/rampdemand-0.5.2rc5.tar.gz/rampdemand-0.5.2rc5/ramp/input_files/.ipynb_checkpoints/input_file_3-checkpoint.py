...
# need to define number,power,num_windows,func_time,time_fraction_random_variability,func_cycle,
# need to define tstart and tstop for all 3 windows, then r_w
# w1 = np.array([0,0]), w2 = np.array([0,0]),r_w = 0, w3 = np.array([0,0])
# need to define power absorbed during first and second part of duty cycle p_1,  p_2 and the durations t_1, t_2
# need to define r_c (random variability of duty cycle segments duration)
# need to define cw11 = np.array([0,0]), cw12 = np.array([0,0]), cw21 = np.array([0,0]), cw22 = np.array([0,0]), cw31 = np.array([0,0]), cw32 = np.array([0,0]))
