...
class Runs(SyncAPIResource):
        ...
        *,
        ...
        Args:
          ...
          instructions: Overrides the
              [instructions](https://platform.sgllm.com/docs/api-reference/assistants/createAssistant)
          ...
          model: The ID of the [Model](https://platform.sgllm.com/docs/api-reference/models) to
              be used to execute this run. If a value is provided here, it will override the
              model associated with the assistant. If not, the model associated with the
              assistant will be used.

          response_format: Specifies the format that the model must output. Compatible with
              [GPT-4o](https://platform.sgllm.com/docs/models/gpt-4o),
    ...
    def create(
        ...
        *,
        ...
        extra_headers = {"SGLLM-Beta": "assistants=v2", **(extra_headers or {})}
        return self._post(
    ...
    def create_and_poll(
        ...
        *,
        ...
        https://platform.sgllm.com/docs/assistants/how-it-works/runs-and-run-steps
        """
        run = self.create(
            thread_id=thread_id,
            assistant_id=assistant_id,
    ...
    def poll(
        ...
        while True:
            ...
            if not is_given(poll_interval_ms):
                from_header = response.headers.get("sgllm-poll-after-ms")
