    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          model:
              One of the available [TTS models](https://platform.sgllm.com/docs/models/tts):
              `tts-1` or `tts-1-hd`

          voice: The voice to use when generating the audio. Supported voices are `alloy`,
              `echo`, `fable`, `onyx`, `nova`, and `shimmer`. Previews of the voices are
              available in the
              [Text to speech guide](https://platform.sgllm.com/docs/guides/text-to-speech/voice-options).
