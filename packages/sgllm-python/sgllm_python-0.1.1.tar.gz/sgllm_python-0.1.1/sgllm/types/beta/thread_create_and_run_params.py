...
class ThreadCreateAndRunParamsBase(TypedDict, total=False):
    ...
    """
    The ID of the
    [assistant](https://platform.sgllm.com/docs/api-reference/assistants) to use to
    execute this run.
    """
    ...
    """
    The ID of the [Model](https://platform.sgllm.com/docs/api-reference/models) to
    ...
    Compatible with [GPT-4o](https://platform.sgllm.com/docs/models/gpt-4o),
    [GPT-4 Turbo](https://platform.sgllm.com/docs/models/gpt-4-turbo-and-gpt-4),
...
class ThreadToolResourcesCodeInterpreter(TypedDict, total=False):
    file_ids: List[str]
    """
    A list of [file](https://platform.sgllm.com/docs/api-reference/files) IDs made
...
class ThreadToolResourcesFileSearchVectorStore(TypedDict, total=False):
    file_ids: List[str]
    """
    A list of [file](https://platform.sgllm.com/docs/api-reference/files) IDs to
...
class ThreadToolResourcesFileSearch(TypedDict, total=False):
    ...
    """
    The
    [vector store](https://platform.sgllm.com/docs/api-reference/vector-stores/object)
...
class Thread(TypedDict, total=False):
    ...
    """
    A list of [messages](https://platform.sgllm.com/docs/api-reference/messages) to
