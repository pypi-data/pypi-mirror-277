...
class UpdateFile(BaseModel):
    ...
    file_path: str = Field(
        ...,
        description=(
            "The full file path of the file you would like to update"
            " where the path must NOT start with a slash, e.g."
            " `some_dir/my_file.py`. Only input a string,"
            " not the param name."
        ),
    ...
    new_file_content: str = Field(
        ...,
        description="The new content of the file you would like to update.",
    )
...
- The `file_path` must be the full path of the file you would like to update, where the path must NOT start with a slash, e.g. `some_dir/my_file.py`.
- The `new_file_content` must be the new content of the file you would like to update. It must be a string with full content of the file.
"""
...
class AlitaGitHubAPIWrapper(GitHubAPIWrapper):
    ...
    def update_file(self, file_path: str, new_file_content: str) -> str:
        """
        Updates a file with new content.
        Parameters:
            File_content (str): The full content to be written to the file
        Returns:
