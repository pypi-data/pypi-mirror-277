...
from chik.pools.pool_config import PoolWalletConfig, add_auth_key, load_pool_config, update_pool_url
from chik.protocols import farmer_protocol, harvester_protocol
from chik.protocols.pool_protocol import (
...
from chik.util.errors import KeychainProxyConnectionFailure
...
from chik.wallet.puzzles.singleton_top_layer import SINGLETON_MOD
...
class Farmer:
    ...
    async def setup_keys(self) -> bool:
        no_keys_error_str = "No keys exist. Please run 'chik keys generate' or open the UI."
        try:
    ...
    def notify_farmer_reward_taken_by_harvester_as_fee(
        ...
        """
        Apply a fee quality convention (see CHIP-22: https://github.com/Chik-Network/chips/pull/88)
