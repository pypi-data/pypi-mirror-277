...
from chik.rpc.full_node_rpc_api import get_average_block_time, get_nearest_transaction_block
from chik.rpc.full_node_rpc_client import FullNodeRpcClient
from chik.server.outbound_message import NodeType
from chik.simulator.block_tools import get_signage_point
...
async def test_get_network_info(one_wallet_and_one_simulator_services, self_hostname):
    ...
    async with FullNodeRpcClient.create_as_context(
        ...
        assert network_info == {"network_name": "testnet0", "network_prefix": "txck", "success": True}
