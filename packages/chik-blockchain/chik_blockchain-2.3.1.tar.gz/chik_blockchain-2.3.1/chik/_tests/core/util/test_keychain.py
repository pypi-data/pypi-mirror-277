...
class TestKeychain:
    def test_basic_add_delete(self, empty_temp_file_keyring: TempKeyring, seeded_random: random.Random):
        kc: Keychain = Keychain(user="testing-1.8.0", service="chik-testing-1.8.0")
        kc.delete_all_keys()
    ...
    def test_add_private_key_label(self, empty_temp_file_keyring: TempKeyring):
        keychain: Keychain = Keychain(user="testing-1.8.0", service="chik-testing-1.8.0")
    ...
    def test_bip39_test_vectors(self):
        test_vectors_path = pkg_resources.resource_filename(chik._tests.util.__name__, "bip39_test_vectors.json")
