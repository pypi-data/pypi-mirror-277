...
from chik.wallet.puzzles.puzzle_utils import make_create_coin_condition
...
def do_test_spend(
    ...
    coin_db.update_coin_store_for_spend_bundle(spend_bundle, spend_time, MAX_BLOCK_COST_KLVM)
