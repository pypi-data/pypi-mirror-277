...
def measure_runtime(
    ...
    entry_file, entry_line = caller_file_and_line(
        relative_to=(
            pathlib.Path(chik.__file__).parent.parent,
            pathlib.Path(chik._tests.__file__).parent.parent,
        )
    )
...
class _AssertRuntime:
    ...
    Produces output of the following form.
        ...
        /home/altendky/repos/chik-blockchain/tests/core/full_node/test_performance.py:187
