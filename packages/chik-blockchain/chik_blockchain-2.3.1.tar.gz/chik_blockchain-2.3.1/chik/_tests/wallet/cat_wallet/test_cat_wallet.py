...
async def test_cat_spend(wallet_environments: WalletTestFramework) -> None:
    ...
    api_0 = env_1.rpc_api
    api_1 = env_2.rpc_api
    wallet = env_1.xck_wallet
    wallet2 = env_2.xck_wallet
...
async def test_cat_change_detection(
    ...
    addr = encode_puzzle_hash(cat_puzzle.get_tree_hash(), "txck")
...
async def test_cat_melt_balance(wallet_environments: WalletTestFramework) -> None:
    ...
    from chik.simulator.simulator_protocol import GetAllCoinsProtocol
    from chik.wallet.cat_wallet.cat_utils import SpendableCAT, unsigned_spend_bundle_for_spendable_cats
    from chik.wallet.conditions import UnknownCondition
