...
from chik.wallet.dao_wallet.dao_utils import curry_singleton, get_p2_singleton_puzhash, get_treasury_puzzle
from chik.wallet.puzzles.load_klvm import load_klvm
from chik.wallet.singleton import create_singleton_puzzle_hash
...
DAO_UPDATE_MOD: Program = load_klvm("dao_update_proposal.clsp")
...
def test_proposal() -> None:
    ...
    assert "klvm raise" in e_info.value.args[0]
...
def test_spend_p2_singleton() -> None:
    ...
    # Solution Values
    xck_parent_amt_list = [[b"x" * 32, 10], [b"y" * 32, 100]]
    cat_parent_amt_list = [
    ...
    # Solution
    spend_p2_sol = Program.to([xck_parent_amt_list, cat_parent_amt_list, treasury_inner_puzhash])
