...
from chik._tests.blockchain.blockchain_test_utils import (
...
from chik.simulator.block_tools import create_block_tools_async
...
class TestBodyValidation:
    ...
    async def test_cost_exceeds_max(self, empty_blockchain, softfork_height, bt):
        ...
        npc_result = get_name_puzzle_conditions(
            block_generator,
            b.constants.MAX_BLOCK_COST_KLVM * 1000,
            mempool_mode=False,
