...
from chik.farmer.farmer import UPDATE_POOL_FARMER_INFO_INTERVAL, Farmer, increment_pool_stats, strip_old_entries
from chik.pools.pool_config import PoolWalletConfig
from chik.protocols import farmer_protocol, harvester_protocol
from chik.protocols.harvester_protocol import NewProofOfSpace, RespondSignatures
from chik.protocols.pool_protocol import PoolErrorCode
...
async def test_farmer_pool_response(
    ...
    peer = cast(WSChikConnection, DummyHarvesterPeer(False))
    await farmer_api.new_proof_of_space(new_pos, peer)
