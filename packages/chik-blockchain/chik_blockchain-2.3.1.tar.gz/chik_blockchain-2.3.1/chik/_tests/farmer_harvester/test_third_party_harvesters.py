...
from chik.protocols.farmer_protocol import RequestSignedValues
...
from chik.types.aliases import FarmerService, FullNodeService, HarvesterService, SimulatorFullNodeService
...
async def test_harvester_receive_source_signing_data(
    ...
    See: CHIP-22: https://github.com/Chik-Network/chips/pull/88
    """
    (
        farmer_service,
        harvester_service,
    ...
    farmer_reward_address = decode_puzzle_hash("txck1psqeaw0h244v5sy2r4se8pheyl62n8778zl6t5e7dep0xch9xfkqlmn5he")
...
async def test_harvester_fee_convention(
    ...
    """
    Tests fee convention specified in CHIP-22: https://github.com/Chik-Network/chips/pull/88
    """
    (
        farmer_service,
        _,
...
async def test_harvester_fee_invalid_convention(
    ...
    given the fee convention from CHIP-22: https://github.com/Chik-Network/chips/pull/88
    """
    (
        farmer_service,
        _,
...
def prepare_sp_and_pos_for_fee_test(
    ...
    pos = harvester_protocol.NewProofOfSpace(
        ...
        farmer_reward_address_override=decode_puzzle_hash(
            "txck1psqeaw0h244v5sy2r4se8pheyl62n8778zl6t5e7dep0xch9xfkqlmn5he"
        ),
