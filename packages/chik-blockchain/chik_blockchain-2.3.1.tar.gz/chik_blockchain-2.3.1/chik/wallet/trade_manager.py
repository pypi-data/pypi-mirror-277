...
from chik.wallet.conditions import Condition, ConditionValidTimes, parse_conditions_non_consensus, parse_timelock_info
from chik.wallet.db_wallet.db_wallet_puzzles import ACS_MU_PH
...
from chik.wallet.trading.offer import NotarizedPayment, Offer
from chik.wallet.trading.trade_status import TradeStatus
from chik.wallet.trading.trade_store import TradeStore
...
from chik.wallet.vc_wallet.cr_cat_drivers import ProofsChecker, construct_pending_approval_state
...
class TradeManager:
    ...
    Puzzle Drivers:
      - See chik/wallet/outer_puzzles.py for a full description of how to build these
        ...
        try:
            ...
            for id, amount in offer_dict.items():
                ...
                if amount > 0:
                    ...
                    # For the XCK wallet also include the fee amount to the coins we use to pay this offer
            ...
            # with the XCK side of the offer and don't create an extra fee transaction in other wallets.
