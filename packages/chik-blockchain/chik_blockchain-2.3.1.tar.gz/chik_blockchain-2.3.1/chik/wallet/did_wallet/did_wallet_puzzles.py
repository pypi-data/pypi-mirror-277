...
DID_INNERPUZ_MOD = load_klvm_maybe_recompile(
...
INTERMEDIATE_LAUNCHER_MOD = load_klvm_maybe_recompile(
    "nft_intermediate_launcher.clsp", package_or_requirement="chik.wallet.nft_wallet.puzzles"
)
    ...
    try:
        if mod == SINGLETON_TOP_LAYER_MOD:
            ...
            if mod == DID_INNERPUZ_MOD:
                # TODO: Remove cast when we have klvm type hinting for this
