...
from chik.wallet.conditions import AssertCoinAnnouncement, Condition, CreateCoinAnnouncement, parse_timelock_info
...
from chik.wallet.puzzles.puzzle_utils import make_create_coin_condition, make_reserve_fee_condition
...
class Wallet:
    ...
    def max_send_quantity(self) -> int:
        ...
        return int(self.wallet_state_manager.constants.MAX_BLOCK_COST_KLVM / 5 / self.cost_of_single_tx)
