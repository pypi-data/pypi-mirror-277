...
def create_data_store(
    ...
    from chik.cmds.data_funcs import create_data_store_cmd
...
def get_value(
    ...
    from chik.cmds.data_funcs import get_value_cmd
...
def update_data_store(
    ...
    from chik.cmds.data_funcs import update_data_store_cmd
...
def submit_pending_root(
    ...
    from chik.cmds.data_funcs import submit_pending_root_cmd
...
def get_keys(
    ...
    from chik.cmds.data_funcs import get_keys_cmd
...
def get_keys_values(
    ...
    from chik.cmds.data_funcs import get_keys_values_cmd
...
def get_root(
    ...
    from chik.cmds.data_funcs import get_root_cmd
...
def subscribe(
    ...
    from chik.cmds.data_funcs import subscribe_cmd
...
def remove_subscription(
    ...
    from chik.cmds.data_funcs import remove_subscriptions_cmd
...
def unsubscribe(
    ...
    from chik.cmds.data_funcs import unsubscribe_cmd
...
def get_kv_diff(
    ...
    from chik.cmds.data_funcs import get_kv_diff_cmd
...
def get_root_history(
    ...
    from chik.cmds.data_funcs import get_root_history_cmd
...
def add_missing_files(
    ...
    from chik.cmds.data_funcs import add_missing_files_cmd
...
def add_mirror(
    ...
    from chik.cmds.data_funcs import add_mirror_cmd
...
def delete_mirror(
    ...
    from chik.cmds.data_funcs import delete_mirror_cmd
...
def get_mirrors(
    ...
    from chik.cmds.data_funcs import get_mirrors_cmd
...
def get_subscriptions(
    ...
    from chik.cmds.data_funcs import get_subscriptions_cmd
...
def get_owned_stores(
    ...
    from chik.cmds.data_funcs import get_owned_stores_cmd
...
def get_sync_status(
    ...
    from chik.cmds.data_funcs import get_sync_status_cmd
...
def check_plugins(
    ...
    from chik.cmds.data_funcs import check_plugins_cmd
...
def clear_pending_roots(
    ...
    from chik.cmds.data_funcs import clear_pending_roots
...
def wallet_log_in(
    ...
    from chik.cmds.data_funcs import wallet_log_in_cmd
...
def get_proof(
    ...
    from chik.cmds.data_funcs import get_proof_cmd
...
def verify_proof(
    ...
    from chik.cmds.data_funcs import verify_proof_cmd
