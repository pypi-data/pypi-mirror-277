...
ts_docs_dir = os.path.abspath(os.path.dirname(__file__))
...
extensions = ['breathe',
              ...
              'ts_docs.generic_extensions.html_redirects',
              'ts_docs.generic_extensions.toctree_filter',
              'ts_docs.generic_extensions.list_filter',
              'ts_docs.generic_extensions.google_analytics',
              'ts_docs.generic_extensions.add_warnings',

              'ts_docs.ts_extensions.format_ts_target',
              'ts_docs.ts_extensions.include_build_file',
              'ts_docs.ts_extensions.latex_builder',
              'ts_docs.ts_extensions.link_roles',
              'ts_docs.ts_extensions.exclude_docs',
...
latex_template_dir = os.path.join(ts_docs_dir, 'latex_templates')
...
# the title page.
latex_logo = os.path.join(ts_docs_dir, '_static', 'timesintelli.jpg')
...
def setup(app):
    ...
    app.add_config_value('latex_template_dir', os.path.join(ts_docs_dir, 'latex_templates'), 'env')

    app.config.breathe_projects = {'ts-docs': os.path.join(app.config.build_dir, 'xml_in/')}
    app.config.breathe_default_project = 'ts-docs'
...
def setup_html(app, config):
    ...
    ts_docs_static_path = os.path.join(config.config_dir, '_static')
    app.config.html_static_path.append(ts_docs_static_path)

    # The name of an image file (relative to this directory) to place at the top
    # of the sidebar.
    app.config.html_logo = os.path.join(ts_docs_static_path, 'timesintelli-logo.jpg')
