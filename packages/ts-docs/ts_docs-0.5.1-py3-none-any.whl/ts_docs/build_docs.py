...
print("ts_docs_path:--------------",ts_docs_path)
...
def main():
    ...
    for language in languages:
        for builder in builders:
            source_dir = os.path.join(ts_docs_path, "docs", args.source_dir)
            build_dir = os.path.join(ts_docs_path, "docs", args.build_dir, chips, language, builder)
...
def build_docs(parameters):
    ...
    for parameter in parameters:
        clean_cmd = "rm -rf ${TS_DOCS_PATH}/docs/_build/{}/{}".format(parameter[0], parameter[1])
        print("Deleting ${TS_DOCS_PATH}/docs/_build/{}/{}".format(parameter[0], parameter[1]))
        sbp_call(clean_cmd)
