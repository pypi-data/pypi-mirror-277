...
from NEMO.utilities import is_trainer, slugify_underscore
...
staff_member_or_manager_required = permission_decorator(
    lambda u: u.is_active and (u.is_staff or u.is_facility_manager or u.is_superuser)
)
