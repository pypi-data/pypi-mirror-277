...
class CardApiResponseImagesFront(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardApiResponseImagesFront:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardApiResponseImagesFront:
        """Create an instance of CardApiResponseImagesFront from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardApiResponseImagesFront.parse_obj(obj)
