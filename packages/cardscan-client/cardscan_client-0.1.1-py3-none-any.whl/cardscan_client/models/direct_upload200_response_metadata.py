...
class DirectUpload200ResponseMetadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirectUpload200ResponseMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DirectUpload200ResponseMetadata:
        """Create an instance of DirectUpload200ResponseMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectUpload200ResponseMetadata.parse_obj(obj)
