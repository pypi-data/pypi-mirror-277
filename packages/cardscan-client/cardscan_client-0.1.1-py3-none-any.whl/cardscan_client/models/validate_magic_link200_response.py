...
class ValidateMagicLink200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidateMagicLink200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidateMagicLink200Response:
        """Create an instance of ValidateMagicLink200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidateMagicLink200Response.parse_obj(obj)

        _obj = ValidateMagicLink200Response.parse_obj({
            "token": obj.get("Token"),
