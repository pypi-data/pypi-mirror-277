...
Date   : 2024-04-14
Purpose: AI Studio Exported Python Code to HTML
"""
...
from google_ai_studio_utils.utils import (
    ...
    extract_chat_history_from_exported_python_code,
    gist_create,
    gist_url_to_gtm,
)
...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        description="AI Studio Exported Python Code to HTML",
    ...
    parser.add_argument(
        ...
        metavar="path",
        type=Path,
        help="Path to Python code exported from AI Studio",
    )
...
def main():
    ...
    convo = extract_chat_history_from_exported_python_code(python_code)
    kwargs = {}
    if args.title:
