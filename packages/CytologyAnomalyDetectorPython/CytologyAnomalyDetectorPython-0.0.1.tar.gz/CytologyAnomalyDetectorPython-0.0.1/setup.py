...
setup(
    ...
    name='CytologyAnomalyDetectorPython',  # Required
    ...
    description='Deep Learning model for anomaly detection of citology images',  # Required
    ...
    # project.
    author='Jónathan Heras Vicente',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='joheras@gmail.com',  # Optional
