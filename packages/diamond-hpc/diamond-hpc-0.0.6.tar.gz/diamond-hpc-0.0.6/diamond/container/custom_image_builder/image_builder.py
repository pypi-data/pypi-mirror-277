...
from diamond.container.custom_image_builder.exception.ImageBuilderException import ImageBuilderException
from diamond.container.custom_image_builder.exception.RegisterImageException import RegisterImageException
...
%runscript
    ...
    process = subprocess.Popen(
        f"apptainer build --force {images_dir}/{build_image_file_name}.sif {build_image_file_name}.def",
    ...
    return f"Output logs are as follows: \n {str(stderr)}  \n {str(stdout)}", f"{images_dir}/{build_image_file_name}.sif", exit_code
