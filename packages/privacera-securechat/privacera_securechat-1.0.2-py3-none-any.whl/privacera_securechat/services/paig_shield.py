...
class PAIGShield:
    ...
    def setup_shield_client(self):
        if self.DISABLE_PAIG_SHIELD_PLUGIN_FLAG:
            ...
            try:
                privacera_shield.client.setup(frameworks=self.ai_application_conf["shield_frameworks"])
    ...
    def set_paig_config_map(self, ai_application_name, ai_application_config):
        ...
        try:
            ai_app = privacera_shield.client.setup_app(application_config_file=paig_shield_config_file)
