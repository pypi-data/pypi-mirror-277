...
def reentry_straddle(
    ...
    notifier(
        f"{underlying.name} {strategy_tag} starting with straddle {strangle} and prices {strangle.fetch_ltp()}",
        notification_url,
        "INFO",
    )
    ...
    status_dict = {
        strangle.call_option: (True, reentries),
        strangle.put_option: (True, reentries),
    }
