...
class Separator(jneqsim.neqsim.processSimulation.processEquipment.ProcessEquipmentBaseClass, SeparatorInterface):
    ...
    @typing.overload
    def getSeparatorSection(self, string: typing.Union[java.lang.String, str]) -> jneqsim.neqsim.processSimulation.processEquipment.separator.sectionType.SeparatorSection: ...
