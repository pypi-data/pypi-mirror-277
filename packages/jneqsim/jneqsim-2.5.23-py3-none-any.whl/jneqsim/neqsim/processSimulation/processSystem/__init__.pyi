...
class ModuleInterface(jneqsim.neqsim.processSimulation.processEquipment.ProcessEquipmentInterface):
    def addInputStream(self, string: typing.Union[java.lang.String, str], streamInterface: jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface) -> None: ...
    def equals(self, object: typing.Any) -> bool: ...
    def getOperations(self) -> 'ProcessSystem': ...
    def getOutputStream(self, string: typing.Union[java.lang.String, str]) -> jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface: ...
...
class ProcessSystem(jneqsim.neqsim.processSimulation.SimulationBaseClass):
    ...
    def replaceObject(self, string: typing.Union[java.lang.String, str], processEquipmentBaseClass: jneqsim.neqsim.processSimulation.processEquipment.ProcessEquipmentBaseClass) -> None: ...
