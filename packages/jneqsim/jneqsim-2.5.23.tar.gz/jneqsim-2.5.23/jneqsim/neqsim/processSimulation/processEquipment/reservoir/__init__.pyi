...
class SimpleReservoir(jneqsim.neqsim.processSimulation.processEquipment.ProcessEquipmentBaseClass):
    ...
    def addGasInjector(self, string: typing.Union[java.lang.String, str]) -> jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface: ...
    def addGasProducer(self, string: typing.Union[java.lang.String, str]) -> jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface: ...
    def addOilProducer(self, string: typing.Union[java.lang.String, str]) -> jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface: ...
    def addWaterInjector(self, string: typing.Union[java.lang.String, str]) -> jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface: ...
    def addWaterProducer(self, string: typing.Union[java.lang.String, str]) -> jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface: ...
...
class WellFlow(jneqsim.neqsim.processSimulation.processEquipment.TwoPortEquipment):
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
