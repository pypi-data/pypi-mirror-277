...
class CompressorMonitor(MeasurementDeviceBaseClass):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], compressor: jneqsim.neqsim.processSimulation.processEquipment.compressor.Compressor): ...
    @typing.overload
...
class LevelTransmitter(MeasurementDeviceBaseClass):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], separator: jneqsim.neqsim.processSimulation.processEquipment.separator.Separator): ...
    @typing.overload
...
class StreamMeasurementDeviceBaseClass(MeasurementDeviceBaseClass):
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], streamInterface: jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface): ...
