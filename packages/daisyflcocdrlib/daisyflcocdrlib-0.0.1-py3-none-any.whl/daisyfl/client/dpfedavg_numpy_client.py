...
from daisyfl.common.dp import add_gaussian_noise, clip_by_l2
from daisyfl.common.typing import NDArrays, Scalar
...
class DPFedAvgNumPyClient(NumPyClient):
    ...
    def get_properties(self, config: TypedDict) -> Dict[str, Scalar]:
