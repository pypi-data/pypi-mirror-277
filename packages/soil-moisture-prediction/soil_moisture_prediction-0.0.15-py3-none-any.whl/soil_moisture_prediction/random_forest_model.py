        ...
        *,
        ...
        for file_name, predictor_data in input_parameters.predictors.items():
            ...
            if type_name == "rain":
                ...
                if (
                    input_parameters.monte_carlo_predictor
                    and predictor_data.std_deviation
                ):
                    predictors_input[type_name] = (
                        os.path.join(work_dir, file_name),
                        predictor_data.unit,
                        os.path.join(work_dir, predictor_data.std_deviation),
                    )
                else:
                    predictors_input[type_name] = (
                        os.path.join(work_dir, file_name),
        ...
        self.input_data = InputData(
            ...
            self.rect_geom,
            uncertainty_sm=input_parameters.monte_carlo_soil_moisture,
            uncertainty_predictor=input_parameters.monte_carlo_predictor,
        )
