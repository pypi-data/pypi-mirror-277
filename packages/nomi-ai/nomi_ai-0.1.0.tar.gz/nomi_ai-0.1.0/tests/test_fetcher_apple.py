...
from nomi.domain.models.note import NoteContentLine
from nomi.domain.models.style import AttributeText, TextAttribute, ParagraphStyle
import pytest
import unittest

from nomi.infra.helper.apple import build_content_lines, build_paragraph_list
