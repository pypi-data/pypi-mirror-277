...
class App(customtkinter.CTk):
	...
	def refresh_step_view(self, value):
		...
		if mode == "Optimization: MG-PSO":
			...
			self.test_button.configure(fg_color="transparent")
			self.download_button.configure(state="normal")
			self.download_button.configure(fg_color="transparent")
		else:
	...
	def make_request(self):
		...
		try:
			...
			self.after(1000, lambda: self.refresh_button.configure(fg_color=self.default_button_color))
