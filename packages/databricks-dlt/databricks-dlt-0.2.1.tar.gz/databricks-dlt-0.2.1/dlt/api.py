import warnings
from typing import Union, Collection, List, Dict, Optional, Callable, Any
...
def append_flow(name: Optional[str] = None,
                target: Optional[str] = None,
                comment: Optional[str] = None,
                spark_conf: Optional[Dict[str, str]] = None,
                once: bool = False) -> Callable[[Callable[[], DataFrame]], None]:
    """
...
def table(query_function: Optional[Callable[...,DataFrame]] = None,
          ...
          cluster_by: Optional[List[str]] = None) -> Callable[[Callable[[], DataFrame]], Callable[[], DataFrame]]:
    """
...
def view(query_function: Optional[Callable[...,DataFrame]] = None,
         name: Optional[str] = None,
         comment: Optional[str] = None,
         spark_conf: Optional[Dict[str, str]] = None) -> Union[Callable[[Callable[[], DataFrame]], Callable[[], DataFrame]]]:
    """
...
def on_event_hook(user_event_hook_fn: Optional[Callable] = None,
...
def expect_all(expectations: Dict[str, Union[str, Column]]) -> Callable[[Callable[[], DataFrame]], Callable[[], DataFrame]]:
    """
...
def expect_all_or_fail(expectations: Dict[str, Union[str, Column]]) -> Callable[[Callable[[], DataFrame]], Callable[[], DataFrame]]:
    """
...
def expect_all_or_drop(expectations: Dict[str, Union[str, Column]]) -> Callable[[Callable[[], DataFrame]], Callable[[], DataFrame]]:
    """
...
def expect(name: str, inv: Union[str, Column]) -> Callable[[Callable[[], DataFrame]], Callable[[], DataFrame]]:
    """
...
def expect_or_fail(name: str, inv: Union[str, Column]) -> Callable[[Callable[[], DataFrame]], Callable[[], DataFrame]]:
    """
...
def expect_or_drop(name: str, inv: Union[str, Column]) -> Callable[[Callable[[], DataFrame]], Callable[[], DataFrame]]:
    """
...
def create_streaming_table(
        ...
        cluster_by: Optional[List[str]] = None) -> None:
    """
...
def apply_changes_from_snapshot(
        ...
        track_history_column_list: Optional[Union[List[str], List[Column]]] = None,
        track_history_except_column_list: Optional[Union[List[str], List[Column]]] = None) -> None:
    """
