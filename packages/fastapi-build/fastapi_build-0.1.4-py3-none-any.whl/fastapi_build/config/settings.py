...
ASYNC_DATABASE_ENGINE = os.getenv("ASYNC_DATABASE_ENGINE", "mysql+pymysql")
...
ASYNC_DB_URL = f"{DATABASE_ENGINE}://{ASYNC_DATABASE_ENGINE}:{DATABASE_PASSWORD}@{DATABASE_HOST}:{DATABASE_PORT}/{DATABASE_NAME}?charset={DATABASE_CHARSET}",
