...
class ExampleView(BaseView):
    ...
    @api_description(summary='example view', response_model=Res(ExampleResponseModel))
    ...
    def post(self, request: Request, data: ExampleRequestModel) -> Res(ExampleResponseModel):
