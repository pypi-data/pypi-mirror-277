...
def test_prompt_tuning_c(prompt_tuning_step, universal_step, data_storage):
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Tuning")
def test_prompt_tuning_ca(prompt_tuning_step, universal_step):
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Tuning")
def test_prompt_tuning_da(prompt_tuning_step, universal_step, data_storage):
