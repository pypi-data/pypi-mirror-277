...
def test_prompt_template_deployment(universal_step, data_storage, prompt_id):
    meta_props = {
    ...
    print(f'Project ID in test: {data_storage.project_id}')
    print(f'Client  Def Project id in test: {data_storage.api_client.default_project_id}')
    # universal_step.set_project_id(data_storage.project_id)
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template Deployment")
def test_prompt_template_deployment_without_base_model(universal_step, prompt_id, data_storage):
    meta_props = {
        data_storage.api_client.deployments.ConfigurationMetaNames.NAME: "SAMPLE DEPLOYMENT PROMPT TEMPLATE",
        data_storage.api_client.deployments.ConfigurationMetaNames.ONLINE: {}
    }
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template Deployment")
def test_generate_without_prompt_variables(universal_step, prompt_template_step, prompt_id, data_storage):
    meta_props = {
        data_storage.api_client.deployments.ConfigurationMetaNames.NAME: "SAMPLE DEPLOYMENT PROMPT TEMPLATE",
        data_storage.api_client.deployments.ConfigurationMetaNames.ONLINE: {},
        data_storage.api_client.deployments.ConfigurationMetaNames.BASE_MODEL_ID: data_storage.base_model_id
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template Deployment")
def test_generate(universal_step, prompt_template_step, prompt_id, data_storage):
    print(data_storage.api_client.default_space_id)
    print(data_storage.api_client.default_project_id)
    meta_props = {
        data_storage.api_client.deployments.ConfigurationMetaNames.NAME: "SAMPLE DEPLOYMENT PROMPT TEMPLATE",
        data_storage.api_client.deployments.ConfigurationMetaNames.ONLINE: {},
        data_storage.api_client.deployments.ConfigurationMetaNames.BASE_MODEL_ID: data_storage.base_model_id
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template Deployment")
def test_generate_text(universal_step, prompt_template_step, prompt_id, data_storage):
    meta_props = {
        data_storage.api_client.deployments.ConfigurationMetaNames.NAME: "SAMPLE DEPLOYMENT PROMPT TEMPLATE",
        data_storage.api_client.deployments.ConfigurationMetaNames.ONLINE: {},
        data_storage.api_client.deployments.ConfigurationMetaNames.BASE_MODEL_ID: data_storage.base_model_id
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template Deployment")
def test_generate_stream_text(universal_step, prompt_template_step, prompt_id, data_storage):
    meta_props = {
        data_storage.api_client.deployments.ConfigurationMetaNames.NAME: "SAMPLE DEPLOYMENT PROMPT TEMPLATE",
        data_storage.api_client.deployments.ConfigurationMetaNames.ONLINE: {},
        data_storage.api_client.deployments.ConfigurationMetaNames.BASE_MODEL_ID: data_storage.base_model_id
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template Deployment")
def test_model_generate_without_variables(universal_step, prompt_template_step, prompt_id, data_storage):
    meta_props = {
        data_storage.api_client.deployments.ConfigurationMetaNames.NAME: "SAMPLE DEPLOYMENT PROMPT TEMPLATE",
        data_storage.api_client.deployments.ConfigurationMetaNames.ONLINE: {},
        data_storage.api_client.deployments.ConfigurationMetaNames.BASE_MODEL_ID: data_storage.base_model_id
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template Deployment")
def test_model_generate(universal_step, prompt_template_step, prompt_id, data_storage):
    meta_props = {
        data_storage.api_client.deployments.ConfigurationMetaNames.NAME: "SAMPLE DEPLOYMENT PROMPT TEMPLATE",
        data_storage.api_client.deployments.ConfigurationMetaNames.ONLINE: {},
        data_storage.api_client.deployments.ConfigurationMetaNames.BASE_MODEL_ID: data_storage.base_model_id
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template Deployment")
def test_model_generate_text(universal_step, prompt_template_step, prompt_id, data_storage):
    meta_props = {
        data_storage.api_client.deployments.ConfigurationMetaNames.NAME: "SAMPLE DEPLOYMENT PROMPT TEMPLATE",
        data_storage.api_client.deployments.ConfigurationMetaNames.ONLINE: {},
        data_storage.api_client.deployments.ConfigurationMetaNames.BASE_MODEL_ID: data_storage.base_model_id
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template Deployment")
def test_model_credentials_generate(universal_step, prompt_template_step, prompt_id, data_storage):
    meta_props = {
        data_storage.api_client.deployments.ConfigurationMetaNames.NAME: "SAMPLE DEPLOYMENT PROMPT TEMPLATE",
        data_storage.api_client.deployments.ConfigurationMetaNames.ONLINE: {},
        data_storage.api_client.deployments.ConfigurationMetaNames.BASE_MODEL_ID: data_storage.base_model_id
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template Deployment")
def test_update_deployment(universal_step, prompt_template_step, prompt_id, data_storage):
    meta_props = {
        data_storage.api_client.deployments.ConfigurationMetaNames.NAME: "SAMPLE DEPLOYMENT PROMPT TEMPLATE",
        data_storage.api_client.deployments.ConfigurationMetaNames.ONLINE: {},
        data_storage.api_client.deployments.ConfigurationMetaNames.BASE_MODEL_ID: data_storage.base_model_id
