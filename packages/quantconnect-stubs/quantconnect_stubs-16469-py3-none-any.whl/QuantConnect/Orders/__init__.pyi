...
class OrderRequest(System.Object, metaclass=abc.ABCMeta):
    ...
    @property
    @abc.abstractmethod
    def order_request_type(self) -> int:
        """
...
class Order(System.Object, metaclass=abc.ABCMeta):
    ...
    @property
    def price_adjustment_mode(self) -> int:
        """
...
class OrderSizing(System.Object):
    ...
    @staticmethod
    @overload
    def get_unordered_quantity(algorithm: QuantConnect.Interfaces.IAlgorithm, target: QuantConnect.Algorithm.Framework.Portfolio.IPortfolioTarget, security: QuantConnect.Securities.Security) -> float:
        """
        Gets the remaining quantity to be ordered to reach the specified target quantity.
...
class ApiOrderResponse(System.Object):
