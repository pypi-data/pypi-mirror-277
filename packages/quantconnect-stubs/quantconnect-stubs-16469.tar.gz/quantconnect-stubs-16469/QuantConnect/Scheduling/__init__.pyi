...
class DateRules(QuantConnect.Scheduling.BaseScheduleRules):
    ...
    @overload
    def every_day(self, symbol: typing.Union[QuantConnect.Symbol, str]) -> QuantConnect.Scheduling.IDateRule:
        """
    ...
    @overload
    def month_end(self, symbol: typing.Union[QuantConnect.Symbol, str], days_offset: int = 0) -> QuantConnect.Scheduling.IDateRule:
        """
    ...
    @overload
    def month_start(self, symbol: typing.Union[QuantConnect.Symbol, str], days_offset: int = 0) -> QuantConnect.Scheduling.IDateRule:
        """
    ...
    @overload
    def week_end(self, symbol: typing.Union[QuantConnect.Symbol, str], days_offset: int = 0) -> QuantConnect.Scheduling.IDateRule:
        """
    ...
    @overload
    def week_start(self, symbol: typing.Union[QuantConnect.Symbol, str], days_offset: int = 0) -> QuantConnect.Scheduling.IDateRule:
        """
