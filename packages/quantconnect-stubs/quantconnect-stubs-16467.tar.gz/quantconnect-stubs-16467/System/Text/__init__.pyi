...
class Ascii(System.Object):
    ...
    @staticmethod
    def from_utf_16(source: System.ReadOnlySpan[str], destination: System.Span[int], bytes_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
    ...
    @staticmethod
    @overload
    def to_lower(source: System.ReadOnlySpan[int], destination: System.Span[int], bytes_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Copies text from a source buffer to a destination buffer, converting
    ...
    @staticmethod
    @overload
    def to_lower(source: System.ReadOnlySpan[str], destination: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Copies text from a source buffer to a destination buffer, converting
        ASCII letters to lowercase during the copy.
    ...
    @staticmethod
    @overload
    def to_lower(source: System.ReadOnlySpan[int], destination: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Copies text from a source buffer to a destination buffer, converting
        ASCII letters to lowercase during the copy.
    ...
    @staticmethod
    @overload
    def to_lower(source: System.ReadOnlySpan[str], destination: System.Span[int], bytes_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Copies text from a source buffer to a destination buffer, converting
        ASCII letters to lowercase during the copy.
    ...
    @staticmethod
    @overload
    def to_lower_in_place(value: System.Span[int], bytes_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
    ...
    @staticmethod
    @overload
    def to_lower_in_place(value: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Performs in-place uppercase conversion.
    ...
    @staticmethod
    @overload
    def to_upper(source: System.ReadOnlySpan[int], destination: System.Span[int], bytes_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Copies text from a source buffer to a destination buffer, converting
    ...
    @staticmethod
    @overload
    def to_upper(source: System.ReadOnlySpan[str], destination: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Copies text from a source buffer to a destination buffer, converting
        ASCII letters to uppercase during the copy.
    ...
    @staticmethod
    @overload
    def to_upper(source: System.ReadOnlySpan[int], destination: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Copies text from a source buffer to a destination buffer, converting
        ASCII letters to uppercase during the copy.
    ...
    @staticmethod
    @overload
    def to_upper(source: System.ReadOnlySpan[str], destination: System.Span[int], bytes_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Copies text from a source buffer to a destination buffer, converting
        ASCII letters to uppercase during the copy.
    ...
    @staticmethod
    @overload
    def to_upper_in_place(value: System.Span[int], bytes_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
    ...
    @staticmethod
    @overload
    def to_upper_in_place(value: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Performs in-place lowercase conversion.
    ...
    @staticmethod
    def to_utf_16(source: System.ReadOnlySpan[int], destination: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Copies text from a source buffer to a destination buffer, converting
...
class Rune(System.IComparable[System_Text_Rune], System.IEquatable[System_Text_Rune]):
    ...
    @staticmethod
    def decode_from_utf_16(source: System.ReadOnlySpan[str], result: typing.Optional[System.Text.Rune], chars_consumed: typing.Optional[int]) -> typing.Union[int, System.Text.Rune, int]:
        """
    ...
    @staticmethod
    def decode_from_utf_8(source: System.ReadOnlySpan[int], result: typing.Optional[System.Text.Rune], bytes_consumed: typing.Optional[int]) -> typing.Union[int, System.Text.Rune, int]:
        """
    ...
    @staticmethod
    def decode_last_from_utf_16(source: System.ReadOnlySpan[str], result: typing.Optional[System.Text.Rune], chars_consumed: typing.Optional[int]) -> typing.Union[int, System.Text.Rune, int]:
        """
    ...
    @staticmethod
    def decode_last_from_utf_8(source: System.ReadOnlySpan[int], value: typing.Optional[System.Text.Rune], bytes_consumed: typing.Optional[int]) -> typing.Union[int, System.Text.Rune, int]:
        """
    ...
    @staticmethod
    def get_unicode_category(value: System.Text.Rune) -> int:
