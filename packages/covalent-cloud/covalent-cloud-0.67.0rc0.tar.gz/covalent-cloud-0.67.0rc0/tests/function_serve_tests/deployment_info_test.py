...
class TestDeployment(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self) -> None:
        self.normal_route = RouteInfo(
            route="/custom123", method="POST", streaming=False
        )
    ...
    def test_user_endpoint_sync(self):
        ...
        with patch(
            ...
            with patch.object(
                ...
                assert response["request_kwargs"]["url"] == f"{info.address}{self.normal_route.route}"
