...
class ClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getMetrics = channel.unary_unary(
                ...
                _registered_method=True)
        self.loadJsonSchema = channel.unary_unary(
                '/gs.rpc.groot.Client/loadJsonSchema',
                request_serializer=groot_dot_sdk_dot_client__service__pb2.LoadJsonSchemaRequest.SerializeToString,
                response_deserializer=groot_dot_sdk_dot_client__service__pb2.LoadJsonSchemaResponse.FromString,
                _registered_method=True)
...
class ClientServicer(object):
    ...
    def loadJsonSchema(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'loadJsonSchema': grpc.unary_unary_rpc_method_handler(
                    servicer.loadJsonSchema,
                    request_deserializer=groot_dot_sdk_dot_client__service__pb2.LoadJsonSchemaRequest.FromString,
                    response_serializer=groot_dot_sdk_dot_client__service__pb2.LoadJsonSchemaResponse.SerializeToString,
            ),
...
class Client(object):
    ...
    def loadJsonSchema(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gs.rpc.groot.Client/loadJsonSchema',
            groot_dot_sdk_dot_client__service__pb2.LoadJsonSchemaRequest.SerializeToString,
            groot_dot_sdk_dot_client__service__pb2.LoadJsonSchemaResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
