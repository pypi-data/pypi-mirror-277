...
def _update_intelligent_playlist(self, AUTH_TOKEN, URL, ID, COLLECTIONS, END_SEARCH_DATE, 
    ...
    SCHEDULE_INFO = _send_request(self, AUTH_TOKEN, "Update Intelligent Playlist", SCHEDULE_API_URL, "PUT", SCHEDULE_BODY, None, True, DEBUG)
    ...
    return _send_request(self, AUTH_TOKEN, "Update Intelligent Playlist", ITEM_API_URL, "PUT", ITEM_BODY, None, True, DEBUG)