...
function rn(l) {
  ...
  l[0]({}), {
    ...
    m(a, _) {
      zt(a, e, _), s && s.m(e, null), je(e, t), je(e, n), tn(i, n, null), f = !0, o || (r = en(
        e,
        "click",
        /*click_handler*/
        l[14]
...
function tt(l, e = {}) {
  ...
  function y(q, L = {}) {
    _ = q;
    const d = s = {};
    return l == null || L.hard || S.stiffness >= 1 && S.damping >= 1 ? (b = !0, o = $e(), a = q, t.set(l = _), Promise.resolve()) : (L.soft && (w = 1 / ((L.soft === !0 ? 0.5 : +L.soft) * 60), c = 0), r || (o = $e(), b = !1, r = vn((u) => {
      if (b)
        return b = !1, r = null, !1;
      c = Math.min(c + w, 1);
      const m = {
...
function Vn(l) {
  ...
  return {
    ...
    m(b, y) {
      Ln(b, e, y), E(e, t), E(t, n), E(n, i), E(n, f), E(n, o), E(n, r), E(t, s), E(s, a), E(s, _), E(s, c), E(s, w);
    },
    p(b, [y]) {
      y & /*$top*/
...
function In(l, e, t) {
  ...
  var f = this && this.__awaiter || function(b, y, S, q) {
    ...
    return new (S || (S = Promise))(function(d, u) {
      ...
      function g(V) {
        V.done ? d(V.value) : L(V.value).then(m, C);
      }
...
class Nn extends qn {
  constructor(e) {
    super(), Sn(this, e, In, Vn, zn, { margin: 0 });
  }
}
const {
  SvelteComponent: Zn,
...
function Yn(l) {
  ...
  return {
    ...
    p(u, m) {
      ...
      let C = f;
      f = L(u), f === C ? ~f && q[f].p(u, m) : (o && (De(), H(q[C], 1, 1, () => {
        q[C] = null;
...
function ei(l, e, t) {
  ...
  this && this.__awaiter;
  const o = Dn();
  let { i18n: r } = e, { eta: s = null } = e, { queue_position: a } = e, { queue_size: _ } = e, { status: c } = e, { scroll_to_output: w = !1 } = e, { timer: b = !0 } = e, { show_progress: y = "full" } = e, { message: S = null } = e, { progress: q = null } = e, { variant: L = "default" } = e, { loading_text: d = "Loading..." } = e, { absolute: u = !0 } = e, { translucent: m = !1 } = e, { border: C = !1 } = e, { autoscroll: g } = e, V, z = !1, G = 0, J = 0, Q = null, W = null, p = 0, I = null, ee, x = null, Re = !0;
  const Yt = () => {
    t(0, s = t(27, Q = t(19, de = null))), t(25, G = performance.now()), t(26, J = 0), z = !0, Ue();
  };
  function Ue() {
    requestAnimationFrame(() => {
      t(26, J = (performance.now() - G) / 1e3), z && Ue();
    });
  }
  function He() {
    t(26, J = 0), t(0, s = t(27, Q = t(19, de = null))), z && (z = !1);
  }
  An(() => {
    z && He();
  });
  ...
  return {
    c() {
      ...
      a = Ze(), _ = oe("input"), Z(
        ...
        /*id*/
        l[15]
      ), Z(i, "class", "head svelte-46715e"), Z(s, "class", "labels svelte-46715e"), Z(_, "type", "range"), Z(
        _,
        "id",
        /*id*/
        l[15]
      ...
      l[12]}`), Z(_, "class", "slider svelte-46715e"), Z(n, "class", "wrap svelte-46715e");
    },
    m(m, C) {
      Ye(e, m, C), Le(m, t, C), Le(m, n, C), le(n, i), le(i, f), Ye(o, f, null), le(n, r), le(n, s);
    ...
    p(m, C) {
      ...
      2048) {
        ...
        for (z = 0; z < d.length; z += 1) {
          const G = qt(m, d, z);
          u[z] ? u[z].p(G, C) : (u[z] = Ct(G), u[z].c(), u[z].m(s, null));
        }
        for (; z < u.length; z += 1)
          u[z].d(1);
        u.length = d.length;
...
let gi = 0;
function hi(l, e, t) {
  let n, { gradio: i } = e, { elem_id: f = "" } = e, { elem_classes: o = [] } = e, { visible: r = !0 } = e, { value: s = 0 } = e, { label: a = i.i18n("slider.slider") } = e, { info: _ = void 0 } = e, { container: c = !0 } = e, { scale: w = null } = e, { min_width: b = void 0 } = e, { show_label: y } = e, { interactive: S } = e, { loading_status: q } = e, { value_is_output: L = !1 } = e, { categories: d = [] } = e, u;
  const m = `range_id_${gi++}`;
  function C() {
    i.dispatch("change"), L || i.dispatch("input");
  }
  ci(() => {
    t(18, L = !1), V();
  });
  ...
  function V() {
    u && (t(13, u.max = (d.length - 1).toString(), u), G(), u.addEventListener("input", z));
  }
  function z() {
  ...
  return l.$$set = (p) => {
    "gradio" in p && t(1, i = p.gradio), "elem_id" in p && t(2, f = p.elem_id), "elem_classes" in p && t(3, o = p.elem_classes), "visible" in p && t(4, r = p.visible), "value" in p && t(0, s = p.value), "label" in p && t(12, a = p.label), "info" in p && t(5, _ = p.info), "container" in p && t(6, c = p.container), "scale" in p && t(7, w = p.scale), "min_width" in p && t(8, b = p.min_width), "show_label" in p && t(9, y = p.show_label), "interactive" in p && t(19, S = p.interactive), "loading_status" in p && t(10, q = p.loading_status), "value_is_output" in p && t(18, L = p.value_is_output), "categories" in p && t(11, d = p.categories);
  }, l.$$.update = () => {
    l.$$.dirty & /*interactive*/
