...
"""
    ...
    The version of the OpenAPI document: 4.131.0
...
class DatasetSyncUpdateRequest(BaseModel):
    """
    DatasetSyncUpdateRequest
    """ # noqa: E501
    id: StrictStr = Field(description="dataset sync ID")
    dataset_id: StrictStr = Field(description="dataset ID", alias="datasetId")
    status: StrictStr = Field(description="Status of the dataset sync.<br>Pending, active, or canceled.")
    ...
    key: StrictStr = Field(description="Security key used for the dataset sync")
    created_by_user_id: StrictStr = Field(description="ID of User that created the dataset sync", alias="createdByUserId")
    is_origin_workspace: StrictBool = Field(description="Indicates if dataset for sync originates in this workspace", alias="isOriginWorkspace")
    host: StrictStr = Field(description="Our Host name")
    workspace_id: StrictStr = Field(description="Our workspace ID", alias="workspaceId")
    workspace_unique_id: StrictStr = Field(description="Our workspace uniqueId", alias="workspaceUniqueId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatasetSyncUpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatasetSyncUpdateRequest from a dict"""
        if obj is None:
            return None
