...
class ApplicationUpdateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "url", "redirectUrl", "workspaceId", "clientId", "clientSecret", "visible", "description", "type", "allowedUsers", "requiredDatasetAccess", "resetSecret"]
