...
class GroupMembershipUpdateRequest(BaseModel):
    ...
    role: StrictStr
    __properties: ClassVar[List[str]] = ["id", "groupId", "userId", "role"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupMembershipUpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupMembershipUpdateRequest from a dict"""
        if obj is None:
            return None
