...
class TestDatasetSyncUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DatasetSyncUpdateRequest:
        """Test DatasetSyncUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatasetSyncUpdateRequest`
        """
        model = DatasetSyncUpdateRequest()
        if include_optional:
            return DatasetSyncUpdateRequest(
                id = '',
                dataset_id = '',
                status = 'pending',
                type = 'read',
