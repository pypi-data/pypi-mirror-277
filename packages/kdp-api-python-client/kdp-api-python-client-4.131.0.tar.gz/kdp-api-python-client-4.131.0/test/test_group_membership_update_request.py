...
class TestGroupMembershipUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GroupMembershipUpdateRequest:
        """Test GroupMembershipUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupMembershipUpdateRequest`
        """
        model = GroupMembershipUpdateRequest()
        if include_optional:
            return GroupMembershipUpdateRequest(
                id = '',
                group_id = '',
                user_id = '',
                role = 'member'
