...
class TestAttributeAssignmentUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AttributeAssignmentUpdateRequest:
        """Test AttributeAssignmentUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributeAssignmentUpdateRequest`
        """
        model = AttributeAssignmentUpdateRequest()
        if include_optional:
            return AttributeAssignmentUpdateRequest(
                id = '',
                attribute_id = '',
                user_id = ''
            )
