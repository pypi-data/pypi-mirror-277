...
class TestQueryDocumentLuceneResponseRecordsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QueryDocumentLuceneResponseRecordsInner:
        """Test QueryDocumentLuceneResponseRecordsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryDocumentLuceneResponseRecordsInner`
        """
        model = QueryDocumentLuceneResponseRecordsInner()
        if include_optional:
            return QueryDocumentLuceneResponseRecordsInner(
                body = '',
                filename = '',
