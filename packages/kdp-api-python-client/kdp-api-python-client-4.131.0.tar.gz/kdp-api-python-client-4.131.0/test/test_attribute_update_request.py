...
class TestAttributeUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AttributeUpdateRequest:
        """Test AttributeUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributeUpdateRequest`
        """
        model = AttributeUpdateRequest()
        if include_optional:
