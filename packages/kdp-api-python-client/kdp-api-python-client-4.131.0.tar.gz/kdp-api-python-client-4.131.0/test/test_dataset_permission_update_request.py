...
class TestDatasetPermissionUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DatasetPermissionUpdateRequest:
        """Test DatasetPermissionUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatasetPermissionUpdateRequest`
        """
        model = DatasetPermissionUpdateRequest()
        if include_optional:
            return DatasetPermissionUpdateRequest(
                id = '',
                action = 'read',
                dataset_id = '',
                group_id = ''
