...
class Owners():
    ...
    def get_owner_info(self, response):
        ...
        for record in results:
            owner_record = [record["id"],record["createdAt"],record["email"],record["firstName"],record["lastName"],record["userId"],record["userIdIncludingInactive"],record["archived"]]
    ...
    def request_normalize(self, archived:bool) -> list:
        ...
        data = []
        while True:
            rq = self.get_owners_request(after)
    ...
    def get_dataframe(self, archived:bool):
        ...
        columns = ["id_propietario","fecha_creacion","email","nombre","apellido","id_usuario","id_usuario_inactivo","archivado"]
