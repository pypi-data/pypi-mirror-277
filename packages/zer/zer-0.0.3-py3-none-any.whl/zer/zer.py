...
class random:
    def length(quantity):
        ...
        quantity: number of characters in the random number. Maximum value 150 characters.
        '''
        if quantity>150:
            return 'Error: The possible number of generated numbers has been exceeded.'
        import random
        numbers = ''
        coll1 = f'{random.random()}'
        numbers+= coll1[2:12]
        coll2 = f'{random.random()}'
        numbers+= coll2[2:12]
        coll3 = f'{random.random()}'
        numbers+= coll3[2:12]
        if quantity>=31:
            coll4 = f'{random.random()}'
            numbers+= coll4[2:12]
            coll5 = f'{random.random()}'
            numbers+= coll5[2:12]
            coll6 = f'{random.random()}'
            numbers+= coll6[2:12]
        if quantity>=61:
            coll7 = f'{random.random()}'
            numbers+= coll7[2:12]
            coll8 = f'{random.random()}'
            numbers+= coll8[2:12]
            coll9 = f'{random.random()}'
            numbers+= coll9[2:12]
            coll10= f'{random.random()}'
            numbers+= coll10[2:12]
        if quantity>=101:
            coll11 = f'{random.random()}'
            numbers+= coll11[2:12]
            coll12 = f'{random.random()}'
            numbers+= coll12[2:12]
            coll13 = f'{random.random()}'
            numbers+= coll13[2:12]
            coll14= f'{random.random()}'
            numbers+= coll14[2:12]
            coll15 = f'{random.random()}'
            numbers+= coll15[2:12]
