...
class AttributeQuery(Boost.Python.instance):
    ...
    @overload
    def __init__(self, attribute: PrimDefinition.Attribute, resolveTarget: ResolveTarget) -> None: ...
    @overload
    def __init__(self, attribute: PrimDefinition.Attribute) -> None: ...
    @staticmethod
...
class Notice(Boost.Python.instance):
    ...
    class ObjectsChanged(Notice.StageNotice):
        ...
        def GetResolvedAssetPathsResyncedPaths(self) -> Any: ...
...
class Prim(Object):
    ...
    @overload
    def CreateAttribute(self, nameElts: object, typeName: pxr.Sdf.ValueTypeName, custom: bool = ..., variability: object = ...) -> PrimDefinition.Attribute: ...
    @overload
    def CreateAttribute(self, name: object, typeName: pxr.Sdf.ValueTypeName, custom: bool = ..., variability: object = ...) -> PrimDefinition.Attribute: ...
    @overload
...
class SchemaRegistry(Boost.Python.instance):
    ...
    @overload
    @staticmethod
    def FindSchemaInfo(schemaFamily: object, schemaVersion: int) -> SchemaRegistry.SchemaInfo: ...
    @overload
    @staticmethod
    def FindSchemaInfo(schemaType: pxr.Tf.Type) -> SchemaRegistry.SchemaInfo: ...
    @overload
    @staticmethod
    def FindSchemaInfo(schemaIdentifier: object) -> SchemaRegistry.SchemaInfo: ...
    @overload
    @staticmethod
    ...
    @staticmethod
    def GetSchemaTypeName(schemaType: pxr.Tf.Type) -> Any: ...
    @staticmethod
...
class StageCache(Boost.Python.instance):
    class Id(Boost.Python.instance):
        ...
        @staticmethod
        def FromString(s: object) -> StageCache.Id: ...
        def IsValid(self) -> bool: ...
