...
*BookmarksApi* | [**convert_and_drop_bookmarks**](docs/BookmarksApi.md#convert_and_drop_bookmarks) | **POST** /data-layouts/{dataLayoutId}/convert-and-drop | Convert and drop engine bookmarks and vdb groups for the data-layout.
...
*BookmarksApi* | [**import_engine_accounts**](docs/BookmarksApi.md#import_engine_accounts) | **POST** /data-layouts/import-engine-accounts | Import engine (self-service) accounts.
