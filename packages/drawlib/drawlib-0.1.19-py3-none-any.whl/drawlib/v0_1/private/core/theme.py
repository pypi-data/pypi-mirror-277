...
class Theme:
    ...
    * provide theme access methods
    ...
    @error_handler
    def apply_official_theme(self, name: Literal["default", "simple", "rich", "monochrome"]) -> None:
        if name == "default":
            t = theme_officials.get_default()
        elif name == "simple":
            t = theme_officials.get_simple()
        elif name == "rich":
            t = theme_officials.get_rich()
    ...
    @error_handler
    def print_style_table(self, max_columns: int = 10) -> None:
    ...
    def _get_style_table(self, max_columns: int = 10) -> str:
