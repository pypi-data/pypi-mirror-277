...
def plan(
    ...
    if cicd:
        ...
        gh_report.publish_bigconfig_plan(plan=report)
...
def export(
    ...
    if collection_id:
        ...
        metric_ids.extend(collection.metric_ids)
    ...
    if table_id:
        ...
        metric_ids.extend([m.metric_configuration.id for m in metrics_from_table])
    ...
    metrics: MetricInfoList = client.get_metric_info_batch_post(metric_ids=metric_ids)
