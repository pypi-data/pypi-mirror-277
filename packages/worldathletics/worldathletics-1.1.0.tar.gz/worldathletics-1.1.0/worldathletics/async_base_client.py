...
class AsyncBaseClient:
    def __init__(
        self,
        url: str = "https://tol6rynsmvbyvhunna6nzzkkku.appsync-api.eu-west-1.amazonaws.com/graphql",
        headers: Optional[Dict[str, str]] = {"x-api-key": "da2-wajez2un5je6tlbopgncijf6ai", "x-amz-user-agent": "aws-amplify/3.0.2"},
