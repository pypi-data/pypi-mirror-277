...
from typing import Callable, Iterable, Optional, ParamSpec, Tuple, TypeVar
...
def do_list(
    fn: Callable[[T_Inv], core.Res[U_Inv]], lst: list[T_Inv]
) -> core.Res[list[U_Inv]]:
...
def unzip2(
    lst: list[tuple[str, Optional[str]]]
