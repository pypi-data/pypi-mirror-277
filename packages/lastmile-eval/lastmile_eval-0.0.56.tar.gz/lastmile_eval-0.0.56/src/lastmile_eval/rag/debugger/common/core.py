...
DFExampleSet must have:
    ...
    | exampleSetId | exampleId | query | context (?) | fullyResolvedPrompt (?) | output (?)| groundTruth | ragQueryTraceId (?) | traceId (?) |
...
DFMinimalExampleSet must have:
    ...
    | query | context (?) | fullyResolvedPrompt (?) | output (?)| groundTruth | ragQueryTraceId (?) | traceId (?) |
