...
class LastMileTracer(LastMileTracerAPI):
    ...
    def get_last_rag_query_trace_id_written(
        ...
        More specifically, run_query_flow returns a record containing (output, the_written_trace_id).
        The user will call this method to get the ID.
    ...
    def set_project(self) -> None:
        ...
        raise_for_status(
            response,
            f"Error fetching projects with name {self.project_name}",
        )
