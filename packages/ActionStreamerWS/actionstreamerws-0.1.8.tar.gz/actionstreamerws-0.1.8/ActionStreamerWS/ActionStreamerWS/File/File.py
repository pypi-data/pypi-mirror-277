...
from ActionStreamerWS import API
import ActionStreamerWS.API


def create_file(ws_config: ActionStreamerWS.API.WebServiceConfig, device_name: str, filename: str, file_size: int, sha256_hash: str) -> tuple[int, str, str, int]:

    """
    Create a file.
    
    Parameters:
    ws_config (API.WebServiceConfig): The web service configuration.
