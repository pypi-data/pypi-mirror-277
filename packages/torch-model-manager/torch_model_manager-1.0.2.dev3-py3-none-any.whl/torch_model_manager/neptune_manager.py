...
class NeptuneManager:
    ...
    def download_folder_from_neptune(self, namespace, destination):
        ...
        self.download_recursive(NeptuneManager.project, namespace, destination)
    ...
    def download_recursive(self, namespace, destination):
        ...
        items = NeptuneManager.project[namespace].fetch_files_list()
        ...
        for item in items:
            ...
            if item_type == 'file':
                ...
                # Download the file
                NeptuneManager.project[item_path].download(local_path)
                print(f"Downloaded {item_path} to {local_path}")
            elif item_type == 'directory':
                # Recursively download the directory
                self.download_recursive(NeptuneManager.project, item_path, destination)
            else:
