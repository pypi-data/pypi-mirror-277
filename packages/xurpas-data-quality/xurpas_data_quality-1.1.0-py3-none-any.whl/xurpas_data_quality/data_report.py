...
class DataReport:
    def __init__(self, file:str=None, 
        ...
        Args
            ...
            minimal:     Check if you want minimal mode as your data report.
        """
    ...
    def describe_dataframe(self, minimal):
        self.description = describe(df=self.df, minimal=minimal, data_types=self.data_types)

    def get_data_quality_report(self, minimal:bool,report_name=None):
        self.describe_dataframe(minimal=minimal)
