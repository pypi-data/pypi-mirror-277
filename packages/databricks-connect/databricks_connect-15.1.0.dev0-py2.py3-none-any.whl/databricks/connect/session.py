...
class DatabricksSession:
    ...
    class Builder:
        ...
        def getOrCreate(self) -> SparkSession:
            ...
            if self._host is not None or self._token is not None or self._cluster_id is not None:
                ...
                return self._from_sdkconfig(
                    ...
                    self._validate_session_enabled, self._serverless_mode)
            ...
            if self._profile is not None:
                ...
                return self._from_sdkconfig(
                    Config(profile=self._profile), self._gen_user_agent(), self._headers,
                    self._validate_session_enabled, self._serverless_mode)
        ...
        def _cache_from_sdk_config(config: Config, user_agent: str, headers: dict[str, str],
                                   validate_session: Optional[bool], serverless_mode: bool):
            return (HashableDict(config.as_dict()), user_agent,
                    HashableDict(headers), validate_session, serverless_mode)
