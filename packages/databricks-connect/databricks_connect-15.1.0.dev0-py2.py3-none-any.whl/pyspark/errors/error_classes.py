...
ERROR_CLASSES_JSON = '''
{
  ...
  "NOT_SUPPORTED_WITH_SERVERLESS": {
    "message": [
      "`<feature>` is not supported on serverless compute."
    ]
  },
  "NOT_WINDOWSPEC": {
    "message": [
  ...
  "PYTHON_TVF_ARGUMENT_CANNOT_BE_NULL": {
    "message" : [
      "The argument `<arg_name>` of function `<func_name>` cannot be null. Please supply a ",
      "non-NULL value for this argument and then retry the query."
    ]
  },
  "PYTHON_TVF_ARGUMENT_MUST_BE_TABLE_VALUED": {
    "message" : [
      "The argument `<arg_name>` of function `<func_name>` must be table-valued. Please wrap the ",
      "`<arg_name>` expression with the TABLE() identifier and then retry the query."
    ]
  },
  "PYTHON_TVF_ARRAY_CANNOT_BE_EMPTY": {
    "message" : [
      "The argument `<arg_name>` of function `<func_name>` cannot be empty. Please supply a ",
      "non-empty value for this argument and then retry the query."
    ]
  },
  "PYTHON_TVF_CANNOT_APPLY_FREQUENCY_TO_DATES": {
    "message" : [
      "The argument `<date_col_arg_name>` of function `<func_name>` references the column ",
      "'<date_col_name>' which is of type DATE. The argument `<freq_arg_name>` has the value ",
      "'<freq_arg_value>' which cannot be applied to DATE columns. Please specify a date-compatible ",
      "frequency (day, week, month) or cast '<date_col_name>' to a TIMESTAMP and retry the query."
    ]
  },
  "PYTHON_TVF_CANNOT_BIND_FUNCTION_ARGUMENTS": {
    "message" : [
      "Attempting to bind the provided arguments to function `<func_name>` resulted in the ",
      "following error: <message>. Please check the function signature and retry the query."
    ]
  },
  "PYTHON_TVF_COLUMNS_CANNOT_BE_COMPLEX_TYPE": {
    "message" : [
      "The argument `<arg_name>` of function `<func_name>` refers to column '<col_name>' which ",
      "is a complex type (MAP, ARRAY, STRUCT). Complex types are not allowed as inputs to ",
      "this argument. Please remove references to columns with complex type, or cast '<col_name>' ",
      "to a simple type (e.g. STRING) and then retry the query."
    ]
  },
  "PYTHON_TVF_COLUMN_VALUES_MUST_BE_UNIQUE_WITHIN_PARTITION": {
    "message" : [
      "The argument `<arg_name>` of function `<func_name>` refers to the column '<col_name>' ",
      "which contains the value `<duplicate_value>` more than once in a single partition, which ",
      "is not allowed. Please update the input table to remove this duplication or otherwise ",
      "change the function call to refer to a different column name without duplicate values, and ",
      "then retry the query."
    ]
  },
  "PYTHON_TVF_COULD_NOT_INTERPRET_JSON": {
    "message" : [
      "The argument `<arg_name>` of function `<func_name>` did not match the expected JSON format. ",
      "Please make sure the JSON is valid and compatible with the format specified in the ",
      "documentation and then retry the query."
    ]
  },
  "PYTHON_TVF_INCOMPATIBLE_ARGUMENT_TYPE": {
    "message": [
      "The argument `<arg_name>` of function `<func_name>` is not compatible with the expected ",
      "type `<target_type>`. Please provide a <target_type>-castable value for this argument ",
      "and then retry the query."
    ]
  },
  "PYTHON_TVF_INCOMPATIBLE_COLUMN_TYPE": {
    "message": [
      "The argument `<arg_name>` of function `<func_name>` refers to column '<col_name>' which ",
      "is not compatible with the expected column type `<target_type>`. Please cast '<col_name>' ",
      " to a <target_type>-castable type, or specify a different column name and then retry the ",
      "query."
    ]
  },
  "PYTHON_TVF_INVALID_TIME_SERIES_FREQUENCY": {
    "message" : [
      "The argument `<arg_name>` of function `<func_name>` is not a valid time-series frequency. ",
      "Please provide a valid unit (see DATE_TRUNC documentation) or a Pandas offset alias and ",
      "retry the query."
    ]
  },
  "PYTHON_TVF_ITEMS_IN_ARRAY_MUST_BE_UNIQUE": {
    "message" : [
      "The argument `<arg_name>` of function `<func_name>` contains the value `<duplicate_value>` ",
      "more than once, which is not allowed. Please remove all duplicate values and then retry ",
      "the query."
    ]
  },
  "PYTHON_TVF_MISSING_REQUIRED_ARGUMENT": {
    "message" : [
      "The invocation of function `<func_name>` is missing a required argument `<arg_name>`. ",
      "Please provide a value for the required argument and then retry the query."
    ]
  },
  "PYTHON_TVF_PASS_THROUGH_COLUMN_NAME_RESERVED": {
    "message" : [
      "The argument `<arg_name>` of function `<func_name>` contains a pass-through column named ",
      "'<reserved_name>' which is not allowed. Please rename the input column and retry the query."
    ]
  },
  "PYTHON_TVF_REFERENCED_COLUMN_NOT_FOUND": {
    "message": [
      "The argument `<arg_name>` of function `<func_name>` refers to column '<col_name>' which ",
      "was not found in the input table. Please provide the name of a valid column and then ",
      "retry the query."
    ]
  },
  "PYTHON_TVF_UNEXPECTED_ERROR": {
    "message": [
      "An unexpected error was encountered evaluating the Python TVF `<func_name>` method ",
      "`<method_name>`: <message>"
    ]
  },
  "PYTHON_TVF_VALUE_OUT_OF_BOUND": {
    "message" : [
      "The argument `<arg_name>` of function `<func_name>` must be greater than <lower_bound> ",
      "and less than <upper_bound> (got <actual>). Please provide a value within the valid range ",
      "and retry the query."
    ]
  },
