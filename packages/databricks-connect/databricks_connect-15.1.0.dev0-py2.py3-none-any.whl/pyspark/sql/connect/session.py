...
class SparkSession:
    ...
    def __init__(self, connection: Union[str, ChannelBuilder], userId: Optional[str] = None):
        ...
        self._init_session_id = self._init_client._session_id

        # BEGIN-EDGE
        class SessionThreadLocals(threading.local):
            client: SparkConnectClient = self._init_client
            session_id: str = self._init_session_id

        self.thread_local = SessionThreadLocals()

        # WARNING: This is a temporary hack
        # TODO [SC-148434] Remove this.
        self._streaming_start_call_back = None
    ...
    # WARNING: This is a temporary hack
    # TODO [SC-148434] Remove this.
    def _register_streaming_callback(self, start_callback: Callable[["StreamingQuery"], None]):
        self._streaming_start_call_back = start_callback

    @property
    def _client(self) -> SparkConnectClient:
        return self.thread_local.client

    @_client.setter
    def _client(self, new_client: SparkConnectClient) -> None:
        self.thread_local.client = new_client
    ...
    @_session_id.setter
    def _session_id(self, new_session_id: str) -> None:
        self.thread_local.session_id = new_session_id
