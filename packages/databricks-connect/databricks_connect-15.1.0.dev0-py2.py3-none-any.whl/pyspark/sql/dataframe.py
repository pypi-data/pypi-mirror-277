...
class DataFrame(PandasMapOpsMixin, PandasConversionMixin):
    ...
    def hint(
        ...
        >>> df.join(df2.hint("broadcast"), "name").explain()  # doctest: +SKIP
        == Physical Plan ==
        ...
        ... +- BroadcastHashJoin ...
        ...
    ...
    def observe(
        ...
        * It will report the value of the defined aggregate columns as soon as we reach a completion
        ...
        ...        pass
        ...
        >>>  # TODO[SC-162611][Wei] revisit this doc test
        >>>  spark.streams.addListener(MyErrorListener()) # doctest: +SKIP
        >>>  # Observe row count (rc) and error row count (erc) in the streaming Dataset
        ...  observed_ds = df.observe( # doctest: +SKIP
        ...     "my_event", # doctest: +SKIP
        ...     count(lit(1)).alias("rc"), # doctest: +SKIP
