...
from pyspark.databricks.deprecated_func_usage_logger import DeprecatedFuncUsageLogger  # Edge
...
def sumDistinct(col: "ColumnOrName") -> Column:
    ...
    DeprecatedFuncUsageLogger().log_deprecated(
        "def sumDistinct(col)", "python/pyspark/sql/functions.py"
    )
    from pyspark.sql import SparkSession

    spark = SparkSession.getActiveSession()
    if spark is not None and (
        spark.conf.get("spark.databricks.pyspark.blockDeprecatedFeature.enabled", "false").lower()
        == "true"
    ):
        raise PySparkNotImplementedError(
            error_class="DEPRECATED_FEATURE_BLOCKED",
            message_parameters={
                "feature": "sumDistinct",
                "suggestion": "sum_distinct",
            },
        )
    # END-EDGE
...
def bitwiseNOT(col: "ColumnOrName") -> Column:
    ...
    # BEGIN-EDGE
    DeprecatedFuncUsageLogger().log_deprecated(
        "def bitwiseNOT(col)", "python/pyspark/sql/functions.py"
    )
    from pyspark.sql import SparkSession
...
def approxCountDistinct(col: "ColumnOrName", rsd: Optional[float] = None) -> Column:
    ...
    if spark is not None and (
        ...
        raise PySparkNotImplementedError(
            error_class="DEPRECATED_FEATURE_BLOCKED",
            message_parameters={
                "feature": "approxCountDistinct",
                "suggestion": "approx_count_distinct",
            },
        )
    # END-EDGE
...
def rand(seed: Optional[int] = None) -> Column:
    ...
    >>> from pyspark.sql import functions as sf
    >>> spark.range(0, 2, 1, 1).withColumn('rand', sf.rand(seed=42) * 3).show()  # doctest: +SKIP
    +---+------------------+
    | id|              rand|
    +---+------------------+
...
def randn(seed: Optional[int] = None) -> Column:
    ...
    >>> from pyspark.sql import functions as sf
    >>> spark.range(0, 2, 1, 1).withColumn('randn', sf.randn(seed=42)).show()  # doctest: +SKIP
    +---+------------------+
    | id|             randn|
    +---+------------------+
    |  0| 2.384479054241165|
...
def shiftLeft(col: "ColumnOrName", numBits: int) -> Column:
    ...
    # BEGIN-EDGE
    DeprecatedFuncUsageLogger().log_deprecated(
        "def shiftLeft(col)", "python/pyspark/sql/functions.py"
    )
    from pyspark.sql import SparkSession
...
def shiftRight(col: "ColumnOrName", numBits: int) -> Column:
    ...
    # BEGIN-EDGE
    DeprecatedFuncUsageLogger().log_deprecated(
        "def shiftRight(col)", "python/pyspark/sql/functions.py"
    )
    from pyspark.sql import SparkSession
...
def shiftRightUnsigned(col: "ColumnOrName", numBits: int) -> Column:
    ...
    # BEGIN-EDGE
    DeprecatedFuncUsageLogger().log_deprecated(
        "def shiftRightUnsigned(col)", "python/pyspark/sql/functions.py"
    )
    from pyspark.sql import SparkSession
    ...
    if spark is not None and (
        ...
        raise PySparkNotImplementedError(
            error_class="DEPRECATED_FEATURE_BLOCKED",
            message_parameters={
                "feature": "shiftRightUnsigned",
                "suggestion": "shiftrightunsigned",
            },
        )
    # END-EDGE
...
def current_catalog() -> Column:
    ...
    Examples
    --------
    >>> spark.range(1).select(current_catalog()).show() # doctest: +SKIP
    +-----------------+
    |current_catalog()|
    +-----------------+
    |    spark_catalog|
...
def years(col: "ColumnOrName") -> Column:
    ...
    # BEGIN-EDGE
    DeprecatedFuncUsageLogger().log_deprecated("def years(col)", "python/pyspark/sql/functions.py")
    from pyspark.sql import SparkSession
...
def months(col: "ColumnOrName") -> Column:
    ...
    # BEGIN-EDGE
    DeprecatedFuncUsageLogger().log_deprecated("def months(col)", "python/pyspark/sql/functions.py")
    from pyspark.sql import SparkSession
    ...
    if spark is not None and (
        ...
        raise PySparkNotImplementedError(
            ...
            message_parameters={
                "feature": "months",
                "suggestion": "partitioning.months",
            },
        )
    # END-EDGE
...
def days(col: "ColumnOrName") -> Column:
    ...
    # BEGIN-EDGE
    DeprecatedFuncUsageLogger().log_deprecated("def days(col)", "python/pyspark/sql/functions.py")
    from pyspark.sql import SparkSession
...
def hours(col: "ColumnOrName") -> Column:
    ...
    # BEGIN-EDGE
    DeprecatedFuncUsageLogger().log_deprecated("def hours(col)", "python/pyspark/sql/functions.py")
    from pyspark.sql import SparkSession
...
def bucket(numBuckets: Union[Column, int], col: "ColumnOrName") -> Column:
    ...
    # BEGIN-EDGE
    DeprecatedFuncUsageLogger().log_deprecated(
        "def bucket(numBuckets, col)", "python/pyspark/sql/functions.py"
    )
    from pyspark.sql import SparkSession
    ...
    if spark is not None and (
        ...
        raise PySparkNotImplementedError(
            ...
            message_parameters={
                "feature": "bucket",
                "suggestion": "partitioning.bucket",
            },
        )
    # END-EDGE
