            ...
            with self._lock:
                if (
                    ...
                    with SparkContext._lock:
                        ...
                        # BEGIN-EDGE
                        # SC-140177: in DLT, there is a existing Py4J Spark session running
                        # This is a workaround by returning directly the active/default
                        # Spark Connect session.
                        if RemoteSparkSession.getActiveSession() is not None:
                            return RemoteSparkSession.getActiveSession()
                        if RemoteSparkSession._get_default_session() is not None:
                            return RemoteSparkSession._get_default_session()
                        # END-EDGE
