------------
**NEW in version 1.3** (released 2024-06-03):
--------------------------------------------
...
Documentation
-------------
- [`quickstart.ipynb`](https://github.com/kstueb/riversand/blob/main/riversand/example_scripts/quickstart_v1.3.ipynb)
- [`step_by_step.ipynb`](https://github.com/kstueb/riversand/blob/main/riversand/example_scripts/step_by_step_v1.3.ipynb)
