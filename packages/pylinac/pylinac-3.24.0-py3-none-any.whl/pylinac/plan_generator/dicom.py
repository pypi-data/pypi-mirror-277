...
from .mlc import MLCShaper, DualStackMLCShaper, STACK
...
class DualStackPlanGenerator(PlanGenerator):
    ...
    @property
    def leaf_config(self) -> list[float]:
        raise ValueError("Dual Stacks have independent leaf configs. Use `distal_leaf_config` or `proximal_leaf_config`")
