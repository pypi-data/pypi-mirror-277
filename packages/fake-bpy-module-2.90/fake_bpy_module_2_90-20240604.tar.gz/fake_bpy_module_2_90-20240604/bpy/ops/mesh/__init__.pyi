...
def edge_split(
    ...
    *,
    ...
    VERT
    Faces & Edges by Vertices, Split faces & edges connected to selected vertices.
        :type type: str | None
    """
...
def normals_tools(
    ...
    *,
    ...
    COPY
    Copy Normal, Copy normal to buffer.

    PASTE
    Paste Normal, Paste normal from buffer.
...
def sort_elements(
    ...
    *,
    ...
    MATERIAL
    Material, Sort selected elements from smallest to greatest material index (faces only!).

    SELECTED
    Selected, Move all selected elements in first places, preserving their relative order (WARNING: this will affect unselected elements' indices as well!).
