...
class PlaybackManager:
    ...
    @classmethod
    def setVolume(cls, sound: Sound, catKey: int) -> Handle:
...
class Sound:
    ...
    @classmethod
    def envelope(
        cls, attack: float, release: float, threshold: float, arthreshold: float
    ) -> Sound:
        """Delays by playing adding silence in front of the other sound's data.
    ...
    @classmethod
    def filter(cls, b: list[float], a: list[float] = 1) -> Sound:
