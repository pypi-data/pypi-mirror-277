...
from generated.apps.models.v1_get_app_runtime_snapshot_response import V1GetAppRuntimeSnapshotResponse  # noqa: E501

class TestV1GetAppRuntimeSnapshotResponse(unittest.TestCase):
    """V1GetAppRuntimeSnapshotResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GetAppRuntimeSnapshotResponse:
        """Test V1GetAppRuntimeSnapshotResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GetAppRuntimeSnapshotResponse`
        """
        model = V1GetAppRuntimeSnapshotResponse()  # noqa: E501
        if include_optional:
            return V1GetAppRuntimeSnapshotResponse(
                snapshot = generated.apps.models.v1_app_runtime.v1AppRuntime(
    ...
    def testV1GetAppRuntimeSnapshotResponse(self):
        """Test V1GetAppRuntimeSnapshotResponse"""
