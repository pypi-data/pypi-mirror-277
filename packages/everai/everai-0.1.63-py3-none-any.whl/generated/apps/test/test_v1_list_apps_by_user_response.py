...
from generated.apps.models.v1_list_apps_by_user_response import V1ListAppsByUserResponse  # noqa: E501

class TestV1ListAppsByUserResponse(unittest.TestCase):
    """V1ListAppsByUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ListAppsByUserResponse:
        """Test V1ListAppsByUserResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ListAppsByUserResponse`
        """
        model = V1ListAppsByUserResponse()  # noqa: E501
        if include_optional:
            return V1ListAppsByUserResponse(
                apps = [
    ...
    def testV1ListAppsByUserResponse(self):
        """Test V1ListAppsByUserResponse"""
