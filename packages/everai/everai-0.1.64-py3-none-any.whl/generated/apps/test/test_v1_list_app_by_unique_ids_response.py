...
from generated.apps.models.v1_list_app_by_unique_ids_response import V1ListAppByUniqueIDsResponse  # noqa: E501

class TestV1ListAppByUniqueIDsResponse(unittest.TestCase):
    """V1ListAppByUniqueIDsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ListAppByUniqueIDsResponse:
        """Test V1ListAppByUniqueIDsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ListAppByUniqueIDsResponse`
        """
        model = V1ListAppByUniqueIDsResponse()  # noqa: E501
        if include_optional:
            return V1ListAppByUniqueIDsResponse(
                apps = [
    ...
    def testV1ListAppByUniqueIDsResponse(self):
        """Test V1ListAppByUniqueIDsResponse"""
