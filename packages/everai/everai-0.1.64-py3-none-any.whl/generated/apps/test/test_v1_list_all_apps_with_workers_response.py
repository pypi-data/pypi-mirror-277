...
from generated.apps.models.v1_list_all_apps_with_workers_response import V1ListAllAppsWithWorkersResponse  # noqa: E501

class TestV1ListAllAppsWithWorkersResponse(unittest.TestCase):
    """V1ListAllAppsWithWorkersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ListAllAppsWithWorkersResponse:
        """Test V1ListAllAppsWithWorkersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ListAllAppsWithWorkersResponse`
        """
        model = V1ListAllAppsWithWorkersResponse()  # noqa: E501
        if include_optional:
            return V1ListAllAppsWithWorkersResponse(
                apps = [
    ...
    def testV1ListAllAppsWithWorkersResponse(self):
        """Test V1ListAllAppsWithWorkersResponse"""
