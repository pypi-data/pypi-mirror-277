...
from generated.apps.models.v1_app_revision import V1AppRevision  # noqa: E501

class TestV1AppRevision(unittest.TestCase):
    """V1AppRevision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1AppRevision:
        """Test V1AppRevision
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1AppRevision`
        """
        model = V1AppRevision()  # noqa: E501
        if include_optional:
            return V1AppRevision(
                name = '',
                volumes = [
