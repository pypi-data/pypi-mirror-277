...
class TakeoffClient:
    ...
    def embed(self, text: Union[str, List[str]], consumer_group: str = "primary") -> dict:
        ...
        """
        return self._sync_post(self.url + "/embed", json={"text": text, "consumer_group": consumer_group})
    ...
    async def embed_async(self, text: Union[str, List[str]], consumer_group: str = "primary") -> dict:
        ...
        Returns:
            dict: Embedding response.
        """
        return await self._async_post(self.url + "/embed", json={"text": text, "consumer_group": consumer_group})
    ...
    async def tokenize_async(self, text: str, reader_id: str) -> List[str]:
    ...
    async def get_status_async(self) -> Dict[str, Any]:
        ...
        """
        return await self._async_get(self.mgmt_url + f"/status")
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: takeoff server status.
        """
        return self._sync_get(self.mgmt_url + f"/status")
