...
def find_peaks(
    ...
    Find peaks in spectrum (dnpdata object) and returns peak index, chemical shift (ppm), peak height, peak width (Hz) and peak width height. The function uses the SciPy functions "find_peaks" and "peak_widths".
