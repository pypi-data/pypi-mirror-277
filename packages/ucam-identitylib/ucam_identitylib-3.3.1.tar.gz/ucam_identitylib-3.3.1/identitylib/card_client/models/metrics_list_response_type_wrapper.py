...
class MetricsListResponseTypeWrapper(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetricsListResponseTypeWrapper from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetricsListResponseTypeWrapper from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "results": MetricsListResponseType.from_dict(obj["results"]) if obj.get("results") is not None else None
        })
        return _obj
