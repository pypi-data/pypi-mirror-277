...
class DiscontinuedIdentifierCreateRequest(BaseModel):
    """
    DiscontinuedIdentifierCreateRequest
    """ # noqa: E501
    notes: Optional[StrictStr] = Field(default=None, description="Notes about the discontinued identifier")
    permitted_identifier: Optional[StrictStr] = Field(default=None, description="The identifier permitted to use the discontinued identifier in {value}@{scheme} format (if not specified, the discontinued identifier cannot be used by other identifiers)", alias="permittedIdentifier")
    ...
    value: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The discontinued identifier's value")
    __properties: ClassVar[List[str]] = ["notes", "permittedIdentifier", "scheme", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DiscontinuedIdentifierCreateRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if permitted_identifier (nullable) is None
        # and model_fields_set contains the field
        if self.permitted_identifier is None and "permitted_identifier" in self.model_fields_set:
            _dict['permittedIdentifier'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DiscontinuedIdentifierCreateRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "notes": obj.get("notes"),
            "permittedIdentifier": obj.get("permittedIdentifier"),
