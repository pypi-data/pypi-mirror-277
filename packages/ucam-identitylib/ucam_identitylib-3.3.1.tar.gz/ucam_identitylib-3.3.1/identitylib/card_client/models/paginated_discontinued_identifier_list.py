...
class PaginatedDiscontinuedIdentifierList(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaginatedDiscontinuedIdentifierList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaginatedDiscontinuedIdentifierList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [DiscontinuedIdentifier.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
