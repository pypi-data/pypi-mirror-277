...
class RevokedAtNotesType(BaseModel):
    ...
    RevokedAtNotesType
    """ # noqa: E501
    change_of_details: Optional[StrictInt] = Field(default=None, alias="ChangeOfDetails")
    change_of_role: Optional[StrictInt] = Field(default=None, alias="ChangeOfRole")
    expiring: Optional[StrictInt] = Field(default=None, alias="Expiring")
    incorrect_details: Optional[StrictInt] = Field(default=None, alias="IncorrectDetails")
    lost_by_cardholder: Optional[StrictInt] = Field(default=None, alias="LostByCardholder")
    lost_in_transit: Optional[StrictInt] = Field(default=None, alias="LostInTransit")
    no_longer_requiresa_card: Optional[StrictInt] = Field(default=None, alias="NoLongerRequiresaCard")
    not_working_electronic_issue: Optional[StrictInt] = Field(default=None, alias="NotWorkingElectronicIssue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ChangeOfDetails": obj.get("ChangeOfDetails"),
            "ChangeOfRole": obj.get("ChangeOfRole"),
            "Expiring": obj.get("Expiring"),
            "IncorrectDetails": obj.get("IncorrectDetails"),
            "LostByCardholder": obj.get("LostByCardholder"),
            "LostInTransit": obj.get("LostInTransit"),
            "NoLongerRequiresaCard": obj.get("NoLongerRequiresaCard"),
            "NotWorkingElectronicIssue": obj.get("NotWorkingElectronicIssue"),
            "NotWorkingPhysicalDamage": obj.get("NotWorkingPhysicalDamage"),
            "Other": obj.get("Other"),
            "PrintFaded": obj.get("PrintFaded"),
