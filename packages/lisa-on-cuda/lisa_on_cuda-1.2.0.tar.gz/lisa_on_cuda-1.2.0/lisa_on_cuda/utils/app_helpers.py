...
GPU_DURATION_SET_MODEL = int(os.getenv("GPU_DURATION_SET_MODEL", 120))
GPU_DURATION_BASE = int(os.getenv("GPU_DURATION_BASE", 30))
app_logger.info(f"GPU_DURATION_SET_MODEL:{GPU_DURATION_SET_MODEL}. GPU_DURATION_BASE:{GPU_DURATION_BASE}.")
...
@spaces.GPU(duration=GPU_DURATION_SET_MODEL)
@session_logger.set_uuid_logging
...
@spaces.GPU(duration=GPU_DURATION_BASE)
@session_logger.set_uuid_logging
