...
class XpsDocument(aspose.page.Document):
    ...
    def save(self, device: aspose.page.Device, options: aspose.page.SaveOptions) -> None:
        '''Saves the document using the :class:`aspose.page.Device` instance.
        
        :param device: The :class:`aspose.page.Device` instance.
    ...
    @overload
    def merge(self, files_for_merge: list[str], device: aspose.page.Device, options: aspose.page.SaveOptions) -> None:
        '''Merging XPS documents to PDF using the :class:`aspose.page.Device` instance.
    ...
    @overload
    def add_canvas(self, element: aspose.page.xps.xpsmodel.XpsCanvas) -> aspose.page.xps.xpsmodel.XpsCanvas:
        '''Adds a canvas
        
        :param element: The canvas to be added.
    ...
    @overload
    def add_path(self, element: aspose.page.xps.xpsmodel.XpsPath) -> aspose.page.xps.xpsmodel.XpsPath:
        '''Adds a path element
        
        :param element: The path to be added.
        :returns: Added path.'''
        ...
    ...
    @overload
    def add_glyphs(self, element: aspose.page.xps.xpsmodel.XpsGlyphs) -> aspose.page.xps.xpsmodel.XpsGlyphs:
        '''Adds a glyphs element
        
        :param element: The glyphs element to be added.
    ...
    @overload
    def create_path_geometry(self, path_figures: list[aspose.page.xps.xpsmodel.XpsPathFigure]) -> aspose.page.xps.xpsmodel.XpsPathGeometry:
        ...
    ...
    @overload
    def create_path_figure(self, start_point: aspose.pydrawing.PointF, segments: list[aspose.page.xps.xpsmodel.XpsPathSegment], is_closed: bool) -> aspose.page.xps.xpsmodel.XpsPathFigure:
        ...
    ...
    @overload
    def create_linear_gradient_brush(self, gradient_stops: list[aspose.page.xps.xpsmodel.XpsGradientStop], start_point: aspose.pydrawing.PointF, end_point: aspose.pydrawing.PointF) -> aspose.page.xps.xpsmodel.XpsLinearGradientBrush:
        ...
    ...
    @overload
    def create_radial_gradient_brush(self, gradient_stops: list[aspose.page.xps.xpsmodel.XpsGradientStop], center: aspose.pydrawing.PointF, gradient_origin: aspose.pydrawing.PointF, radius_x: float, radius_y: float) -> aspose.page.xps.xpsmodel.XpsRadialGradientBrush:
        ...
