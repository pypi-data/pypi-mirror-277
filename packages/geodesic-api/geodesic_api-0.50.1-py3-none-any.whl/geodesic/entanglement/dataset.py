...
class Dataset(Object):
    ...
    def _repr_mimebundle_(self, **kwargs):
        ...
        return geodesic_widgets.ObjectWidget(datasetList)._repr_mimebundle_(**kwargs)
    ...
    def search(
        ...
        collection = page_through_results(collection, limit=limit)
    ...
    def get_pixels(
        ...
        *,
        ...
        Examples:
            ...
            >>> bands = [AssetBands(asset="B04", bands=[0]), AssetBands(asset="B03", bands=[0]), AssetBands(asset="B02", bands=[0])]
            >>> pixels = ds.get_pixels(bbox=bbox, datetime=range, pixel_size=(1000,1000), bands=bands, output_srs="EPSG:3857", bbox_srs="EPSG:4326")
        """
...
class DatasetList(_APIObject):
    ...
    def _repr_mimebundle_(self, **kwargs):
        return geodesic_widgets.ObjectWidget(self)._repr_mimebundle_(**kwargs)
...
class ItemAssets(dict):
    ...
    def _repr_mimebundle_(self, **kwargs):
        return geodesic_widgets.ItemAssetsWidget(self)._repr_mimebundle_(**kwargs)
