...
"""
    ...
    pip3 cache purge
    pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple Fr1997v011==1.6.6
"""
...
class SpiderJike:
    ...
    def douyin_video_response2(res_data, tp='django_video_info'):
        ...
        tag1, tag2, tag3 = mode_douyin.douyin_tag_info(video_tag)

        video_tag = res_data['video_tag']
...
class ModeFunc:
    ...
    def qianchuan_index_cookie(self):
        ...
        # 缓存到内存
        data_list = cache_get('jike_qianchuan_ad_cookie_v1')
        if not data_list:
            data_list = []
...
# mode_douyin.api_douyin_user('MS4wLjABAAAATjfBnSaWkl6ZJiznrCzkt7-l_7pkD4pLkKyPkLtD2VU')
# print(mode_douyin.api_douyin_video('7377123974318181647'))
