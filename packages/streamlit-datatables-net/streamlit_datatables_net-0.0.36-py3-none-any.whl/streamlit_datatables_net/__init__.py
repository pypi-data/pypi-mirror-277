...
def st_datatable(data: pd.DataFrame | list[dict], column_order: List[str] = None, props: Dict = None, dt_config: str = "default", table_id: str = None, class_name: str = None, js_scripts: List[str] = None, stylesheets: List[str] = None, disabled: bool = False, enable_top_navigation: bool = False, date_format: str = None, export_file_name: str = None, on_click: Optional[Callable] = None, args: Optional[Tuple[Any, ...]] = None,
                ...
                with st.echo():
                    ...
                    with dt_container:
                        dt_response = st_datatable(
                            big_data, column_order=column_order, props=props, table_id="example_1", key="example_1", dt_config="default", date_format="%m/%d/%Y", disabled=False, enable_top_navigation=True, export_file_name="Example 1", on_click=my_on_click_function, args=["example_1"])
                        st.json(dt_response)
        with st.container(border=True):
            ...
            with st.expander("Code"):
                with st.echo():
                    ...
                    with dt_container:
                        dt_response = st_datatable(
                            data, props=props, table_id="example_1", key="example_1b", enable_top_navigation=True, date_format="%b %d %Y")
                        st.json(dt_response)
