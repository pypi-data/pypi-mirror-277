...
def configure(globals_dict, django_settings_module=None):
    ...
    This configure() does *not* call atelier.sphinxconf.configure(). It can be
    used with either atelier.sphinxconf.configure() or
    ...
    if django_settings_module is not None:
        ...
        print("Django started with DJANGO_SETTINGS_MODULE={}.".format(
    ...
    extlinks.update(synodal.SPHINX_EXTLINKS)
