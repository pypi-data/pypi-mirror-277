...
class NotifyingAction(actions.Action):
    ...
    parameters = dict(
        notify_subject=models.CharField(_("Summary"),
                                        blank=True,
                                        max_length=200),
        notify_body=dd.RichTextField(_("Description"), blank=True),
        notify_silent=models.BooleanField(_("Don't notify others"),
                                          default=False),
    )
    ...
    def emit_message(self, ar, obj, **kw):
        ...
        rt.models.notify.Message.emit_notification(ar, owner, mt, msg,
                                                   recipients)
