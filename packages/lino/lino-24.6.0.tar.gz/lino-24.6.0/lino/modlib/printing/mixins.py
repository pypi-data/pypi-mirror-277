...
from .actions import (DirectPrintAction, CachedPrintAction, ClearCacheAction,
                      EditTemplate)
...
class PrintableType(Model):
    ...
    def template_choices(cls, build_method):
        return cls.get_template_choices(build_method,
...
class CachedPrintable(Duplicable, Printable):
    ...
    build_time = models.DateTimeField(_("build time"),
                                      null=True,
                                      editable=False)
