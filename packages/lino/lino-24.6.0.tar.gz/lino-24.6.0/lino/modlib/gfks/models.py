            ...
            if issubclass(cl, dd.Model) and cl is not dd.Model \
               and cl._meta.managed:
                if getattr(cl, '_meta', False) and not cl._meta.abstract:
                    ...
                    chunks.append(ar.obj2html(ct, str(cl._meta.verbose_name)))
...
#     # Deprecated. Nobody every used this feature in reality.
#     class Meta(object):
#         app_label = 'gfks'
...
class BrokenGFKsByModel(BrokenGFKs):
    ...
    def get_pk_field(self):
        return rt.models.system.SiteConfig._meta.get_field('id')
