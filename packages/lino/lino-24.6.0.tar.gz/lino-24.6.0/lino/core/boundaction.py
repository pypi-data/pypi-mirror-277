...
from lino.core.permissions import (make_permission_handler,
...
class BoundAction(object):
    ...
    def __init__(self, actor, action):
        ...
        self.allow_view = curry(
            make_static_permission_handler(self, action.readonly,
    ...
    def __repr__(self):
        return "<%s(%s, %r)>" % (self.__class__.__name__, self.actor,
                                 self.action)
