        ...
        def allow(action, user_type):
            ...
            if True:  # not v:
                logger.info(
                    ...
                    "required(%s), allow(%s)--> %s", action,
                    action.required_roles, user_type, v)
            return v

    return allow


def make_permission_handler_(elem,
                             actor,
                             readonly,
                             debug_permissions,
                             required_roles,
