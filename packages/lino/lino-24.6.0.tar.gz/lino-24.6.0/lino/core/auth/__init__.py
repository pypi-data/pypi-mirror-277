...
These objects are being managed automatically by Lino and basically as
an application developer or system admin you don't need to care about
them.
...
# unmodified copy of django/contrib/auth/__init__.py
