...
class Table(AbstractTable):
    ...
    def get_actor_label(self):
        ...
        if isinstance(self.model, str):
            ...
            raise Exception("20231104 {}.model is {!r}".format(
                self, self.model))
                ...
                try:
                    ...
                    if fk is None:
                        if hasattr(self.model, '_meta'):
                            ...
                            candidates = "N/A"
                        raise Exception(
                            "Invalid master_key '{}' for {} ({} has fields {})"
                            .format(self.master_key, self, self.model,
                                    candidates))
                    if fk.remote_field:
    ...
    def disable_delete(self, obj, ar):
        ...
        if not self.get_row_permission(obj, ar, self.get_row_state(obj),
                                       self.delete_action):
