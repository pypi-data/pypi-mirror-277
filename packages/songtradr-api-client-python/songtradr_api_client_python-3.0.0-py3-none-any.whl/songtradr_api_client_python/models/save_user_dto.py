...
class SaveUserDTO(BaseModel):
    ...
    language: Optional[StrictStr] = Field(default=None, description="Current status of the recording.")
    __properties: ClassVar[List[str]] = ["system", "emailAddress", "password", "fullName", "companyName", "language"]
