...
class FileUploadDTO(BaseModel):
    ...
    """ # noqa: E501
    identifiers: Optional[List[ConfigIdentifierDTO]] = None
    flags: Optional[List[StrictStr]] = None
    access: Optional[List[ConfigAccessDTO]] = None
    __properties: ClassVar[List[str]] = ["identifiers", "flags", "access"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identifiers": [ConfigIdentifierDTO.from_dict(_item) for _item in obj["identifiers"]] if obj.get("identifiers") is not None else None,
            "flags": obj.get("flags"),
            "access": [ConfigAccessDTO.from_dict(_item) for _item in obj["access"]] if obj.get("access") is not None else None
        })
        return _obj
