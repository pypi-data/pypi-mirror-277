...
class TestSearchFilterValuesDTO(unittest.TestCase):
    """SearchFilterValuesDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchFilterValuesDTO:
        """Test SearchFilterValuesDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchFilterValuesDTO`
        """
        model = SearchFilterValuesDTO()
        if include_optional:
            return SearchFilterValuesDTO(
                ...
                secondary_audience_region = [
                    ''
                    ],
                tertiary_audience_region = [
                    ''
                    ],
                origin_decade = [
                    ''
