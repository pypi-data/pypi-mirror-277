...
class TestRecordingGenrePredictionDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecordingGenrePredictionDTO:
        """Test RecordingGenrePredictionDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecordingGenrePredictionDTO`
        """
        model = RecordingGenrePredictionDTO()
        if include_optional:
    ...
    def testRecordingGenrePredictionDTO(self):
        """Test RecordingGenrePredictionDTO"""
