...
class RecordingGenrePredictionDTO(BaseModel):
    """
    AI-predicted Genres for a recording
    """ # noqa: E501
    genre_type: StrictStr = Field(alias="genreType")
    genre: GenreMinimalDTO
    probability: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["genreType", "genre", "probability"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "genreType": obj.get("genreType"),
            "genre": GenreMinimalDTO.from_dict(obj["genre"]) if obj.get("genre") is not None else None,
