...
from ML_management.executor_template.patterns import ArbitraryModelsPattern, OneModelPattern
...
class BaseExecutor(RichPythonModel, ABC):
    ...
    def __init__(
        self, executor_name: str, executor_models_pattern: Union[OneModelPattern, ArbitraryModelsPattern]
    ) -> None:
        """
        Init Executor class.
