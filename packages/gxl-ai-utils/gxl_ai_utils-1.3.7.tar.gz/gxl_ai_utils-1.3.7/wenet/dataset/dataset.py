...
def Dataset(data_type,
    ...
    assert feats_type in ['fbank', 'mfcc', 'log_mel_spectrogram', 'log_mel_spectrogram_and_fbank']
    if feats_type == 'fbank':
    ...
    elif feats_type == 'log_mel_spectrogram_and_fbank':
        log_mel_spectrogram_and_fbank_conf = conf.get('log_mel_spectrogram_and_fbank_conf', {})
        dataset = Processor(dataset, processor.compute_log_mel_spectrogram_and_fbank,
                            **log_mel_spectrogram_and_fbank_conf)
