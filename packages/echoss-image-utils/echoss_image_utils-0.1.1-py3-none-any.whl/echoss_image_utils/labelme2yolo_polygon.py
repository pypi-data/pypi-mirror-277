...
class Labelme2YOLO(object):
    ...
    def __init__(self, json_dir, img_copy):
    ...
    def _get_other_shape_yolo_object(self, shape, img_h, img_w):
        ...
        x_lists, y_lists = __get_object_desc(shape['points'])
    ...
    def _save_yolo_label(self, json_name, label_dir_path, target_dir, yolo_obj_list):
        ...
        with open(txt_path, 'w+') as f:
            for yolo_obj_idx, yolo_obj_lists in enumerate(yolo_obj_list):
                yolo_obj_label_id = yolo_obj_lists[0]
                yolo_x_lists = yolo_obj_lists[1]
                yolo_y_lists = yolo_obj_lists[2]
...
if __name__ == '__main__':
    ...
    convertor = Labelme2YOLO(args.json_dir, args.img_copy)
