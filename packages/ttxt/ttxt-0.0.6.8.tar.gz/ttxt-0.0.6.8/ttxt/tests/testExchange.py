...
def test(exchangeName="", params={}):
    ...
    if "createLimitOrder" in params and params["createLimitOrder"]:
        ...
        try:
            resp = ttxtExchange.create_limit_order(symbol=tickerToTest, amount=10, side="sell", price=1.9999)
    ...
    if "cancelOrder" in params and params["cancelOrder"]:
        ...
        try:
            resp = ttxtExchange.cancel_order(id='OWMNJX-ADDYO-TH3TD5', symbol=tickerToTest)
...
if __name__ == "__main__":
    ...
    testingParams = {"ticker": False, 
                     ...
                     "myTrades": False,
                     "accountInfo": False}
    test(params=testingParams, exchangeName="kraken")
