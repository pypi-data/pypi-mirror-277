...
class ExperimentEvalsDto(BaseModel):
    """
    ExperimentEvalsDto
    """ # noqa: E501
    experiment: ExperimentDto
    charts: List[ExperimentEvalsChartDto]
    __properties: ClassVar[List[str]] = ["experiment", "charts"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "experiment": ExperimentDto.from_dict(obj.get("experiment")) if obj.get("experiment") is not None else None,
            "charts": [ExperimentEvalsChartDto.from_dict(_item) for _item in obj.get("charts")] if obj.get("charts") is not None else None
        })
        return _obj
