...
class PaginatedExperimentsDto(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "experiments": [ExperimentDto.from_dict(_item) for _item in obj.get("experiments")] if obj.get("experiments") is not None else None,
