...
class FineTuneOpenaiInput(BaseModel):
    """
    FineTuneOpenaiInput
    """ # noqa: E501
    model: StrictStr
    ...
    def model_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('gpt-3.5-turbo-0125', 'gpt-3.5-turbo-1106'):
            raise ValueError("must be one of enum values ('gpt-3.5-turbo-0125', 'gpt-3.5-turbo-1106')")
        return value
