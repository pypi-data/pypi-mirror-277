...
class GenerateApi:
    ...
    @validate_call
    def generate_controller_generate(
        self,
        ...
        _param = self._generate_controller_generate_serialize(
    ...
    @validate_call
    def generate_controller_generate_with_http_info(
        self,
        generate_input: GenerateInput,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def generate_controller_generate_without_preload_content(
        self,
        generate_input: GenerateInput,
        _request_timeout: Union[
            None,
    ...
    def _generate_controller_generate_serialize(
        self,
        generate_input,
        _request_auth,
        _content_type,
