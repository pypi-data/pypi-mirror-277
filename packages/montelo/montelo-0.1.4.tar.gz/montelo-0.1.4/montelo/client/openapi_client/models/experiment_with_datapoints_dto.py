...
class ExperimentWithDatapointsDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "datasetId", "name", "description", "createdAt", "dataset"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "dataset": FullDatasetDto.from_dict(obj.get("dataset")) if obj.get("dataset") is not None else None
        })
        return _obj
