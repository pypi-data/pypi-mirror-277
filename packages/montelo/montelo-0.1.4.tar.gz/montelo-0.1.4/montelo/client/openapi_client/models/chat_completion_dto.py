...
class ChatCompletionDto(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "model": obj.get("model"),
            "choices": [ChoiceDto.from_dict(_item) for _item in obj.get("choices")] if obj.get("choices") is not None else None,
            "usage": UsageDataDto.from_dict(obj.get("usage")) if obj.get("usage") is not None else None
        })
        return _obj
