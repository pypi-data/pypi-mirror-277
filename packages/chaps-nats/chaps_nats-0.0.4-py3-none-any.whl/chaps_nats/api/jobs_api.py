...
class JobAPI:
    ...
    def add_routes(self):
        ...
        if _submit_job_fun is not None:
            self.router.post(
                f"{self.api_prefix}/submit_job", tags=__tags, response_model=_JobID
            )(_submit_job_fun)

        # Results
        _results_job_fun = self._job_results_fun()
        if _results_job_fun is not None:
            self.router.get(f"{self.api_prefix}/job_results/{{job_id}}", tags=__tags)(
                _results_job_fun
            )
        ...
        if _jobs_status_fun is not None:
            self.router.get(f"{self.api_prefix}/job_status/{{job_id}}", tags=__tags)(
                _jobs_status_fun
            )
        ...
        if _job_delete_fun is not None:
            self.router.delete(f"{self.api_prefix}/delete_job/{{job_id}}", tags=__tags)(
                _job_delete_fun
            )
        ...
        if _job_lists_fun is not None:
            self.router.get(f"{self.api_prefix}/job_list", tags=__tags)(_job_lists_fun)
