"""
Project generated by builder 0.10.20 protocol 1.0.1
"""
import logging
...
from ctypes import c_int, c_void_p, c_size_t, c_wchar_p, c_char_p
import atexit
try:
...
urpc_builder_version_bugfix = 20
urpc_builder_version_suffix = ""
urpc_builder_version = "0.10.20"
_Ok = 0
_Error = -1
_NotImplemented = -2
_ValueError = -3
...
def _load_lib():
    ...
    if os_kind == "windows":
        ...
        raise RuntimeError("Unexpected OS. Package is not intended for this OS. Build library from source codes. "
                           "If you do not know where to get source code, contact device developer info@physlab.ru")
