.. |Documentation Status| image:: https://readthedocs.org/projects/dgenerate/badge/?version=v3.6.0
   :target: http://dgenerate.readthedocs.io/en/v3.6.0/
...
For library documentation visit `readthedocs <http://dgenerate.readthedocs.io/en/v3.6.0/>`_.
...
.. code-block:: text
    ...
    options:
      ...
      -mc EXPR [EXPR ...], --cache-memory-constraints EXPR [EXPR ...]
                            ...
                            3.6.0/dgenerate_submodules.html#dgenerate.pipelinewrapper.CACHE_MEMORY_CON
                            STRAINTS]
      -pmc EXPR [EXPR ...], --pipeline-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            adthedocs.io/en/v3.6.0/dgenerate_submodules.html#dgenerate.pipelinewrapper
      ...
      -umc EXPR [EXPR ...], --unet-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            Syntax See: [https://dgenerate.readthedocs.io/en/v3.6.0/dgenerate_submodul
      ...
      -cmc EXPR [EXPR ...], --control-net-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            3.6.0/dgenerate_submodules.html#dgenerate.pipelinewrapper.CONTROL_NET_CACH
...
.. code-block:: bash
    ...
    pipx install dgenerate==3.6.0 ^
    --pip-args "--extra-index-url https://download.pytorch.org/whl/cu121/"

    # You can install without pipx into your own environment like so

    pip install dgenerate==3.6.0 --extra-index-url https://download.pytorch.org/whl/cu121/
...
.. code-block:: bash
    ...
    pipx install dgenerate[flax]==3.6.0 \
    --pip-args "--extra-index-url https://download.pytorch.org/whl/cu121/ \
    -f https://storage.googleapis.com/jax-releases/jax_cuda_releases.html"

    # You can install without pipx into your own environment like so

    pip3 install dgenerate==3.6.0 --extra-index-url https://download.pytorch.org/whl/cu121/

    # Or with flax

    pip3 install dgenerate[flax]==3.6.0 --extra-index-url https://download.pytorch.org/whl/cu121/ \
    -f https://storage.googleapis.com/jax-releases/jax_cuda_releases.html
 ...
 * `my-image-seed.png <https://raw.githubusercontent.com/Teriks/dgenerate/v3.6.0/examples/media/dog-on-bench.png>`_
 * `my-mask-image.png <https://raw.githubusercontent.com/Teriks/dgenerate/v3.6.0/examples/media/dog-on-bench-mask.png>`_
...
These examples use: `vermeer_canny_edged.png <https://raw.githubusercontent.com/Teriks/dgenerate/v3.6.0/examples/media/vermeer_canny_edged.png>`_
...
This image of a `horse <https://raw.githubusercontent.com/Teriks/dgenerate/v3.6.0/examples/media/horse2.jpeg>`_
...
The image used in the example below is this `low resolution cat <https://raw.githubusercontent.com/Teriks/dgenerate/v3.6.0/examples/media/low_res_cat.png>`_
...
.. image:: https://raw.githubusercontent.com/Teriks/dgenerate/v3.6.0/examples/media/ui.gif
   :alt: console ui
...
in the `"writing_plugins/image_processor" <https://github.com/Teriks/dgenerate/tree/v3.6.0/examples/writing_plugins/image_processor>`_
folder of the examples folder.

The source code for the built in `canny <https://github.com/Teriks/dgenerate/blob/v3.6.0/dgenerate/imageprocessors/canny.py>`_ processor,
the `openpose <https://github.com/Teriks/dgenerate/blob/v3.6.0/dgenerate/imageprocessors/openpose.py>`_ processor, and the simple
`pillow image operations <https://github.com/Teriks/dgenerate/blob/v3.6.0/dgenerate/imageprocessors/imageops.py>`_ processors can also
...
`"writing_plugins/config_directive" <https://github.com/Teriks/dgenerate/tree/v3.6.0/examples/writing_plugins/config_directive>`_ folder
of the examples folder. Config template functions can also be implemented by plugins,
see: `"writing_plugins/template_function" <https://github.com/Teriks/dgenerate/tree/v3.6.0/examples/writing_plugins/template_function>`_

Currently the only internal directive that is implemented as a plugin is the ``\image_process`` directive,
who's source file `can be located here <https://github.com/Teriks/dgenerate/blob/v3.6.0/dgenerate/batchprocess/image_process_directive.py>`_,
...
`is implemented here <https://github.com/Teriks/dgenerate/blob/v3.6.0/dgenerate/image_process>`_.
