...
class APIContext:
    ...
    def __init__(self, path, adapter=None) -> None:
        ...
        self._dbt_project_metadata: dbtProjectMetadata = dbtProjectMetadata.load_from_project_path("/Users/jdhiman/projects/inmetrics-prototype/in-dbt-examples/in-dbt-examples/src/metrics_example/")
