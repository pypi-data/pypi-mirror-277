...
from metricflow.sql.render.spark import SparkSqlQueryPlanRenderer
...
class SupportedAdapterTypes(enum.Enum):
    ...
    def sql_engine_type(self) -> SqlEngine:
        ...
        elif self is SupportedAdapterTypes.SPARK:
            return SqlEngine.SPARK
        else:
            return SqlEngine.SPARK
    ...
    def sql_query_plan_renderer(self) -> SqlQueryPlanRenderer:
        ...
        if self is SupportedAdapterTypes.BIGQUERY:
            ...
            return SparkSqlQueryPlanRenderer()
        else:
