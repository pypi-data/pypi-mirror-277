...
class VideoOperation(object):
    def __init__(self, ffmpeg_path, ffprobe_path=None, ffplay_path=None):
...
if __name__ == '__main__':
    # ffmpeg_path = r"G:\ContentPro\PythonPro\PiPyPro\static\ffmpeg\bin\ffmpeg.exe"
    # ffprobe_path = r"G:\ContentPro\PythonPro\PiPyPro\static\ffmpeg\bin\ffprobe.exe"
    # ffplay_path = r"G:\ContentPro\PythonPro\PiPyPro\static\ffmpeg\bin\ffplay.exe"
    # video_obj = VideoOperation(ffmpeg_path=ffmpeg_path, ffprobe_path=ffprobe_path, )
