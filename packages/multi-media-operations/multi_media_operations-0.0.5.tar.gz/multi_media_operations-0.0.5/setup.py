...
version = '0.0.5'  # Any format you want
DESCRIPTION = 'Easily cut the basic type by multi_media_operations'
...
setup(
    ...
    url='https://gitee.com/SkyOceanchen/multi_media_operations.git',  # 项目开源地址
