...
from blinker.base import ANY, ANY_ID, make_id
...
def listener(signal_class: Any, sender: Any = ANY, priority: EventPriority | None = None):
    """
...
class Blink:
    ...
    def send(event: Any, sender: Any = None):
        ...
        Args:
            ...
            sender (Any): The sender of the event.
        """
        _listener_registry.send_event(event, sender)
    ...
    async def asend(event: Any, sender: Any = None):
        ...
        Args:
            ...
            sender (Any): The sender of the event.
        """
        await _listener_registry.asend_event(event, sender)
    ...
    def listener(signal_class, sender: Any = ANY, priority: EventPriority | None = None):
        ...
        """
        return listener(signal_class, sender, priority)
    ...
    def alistener(signal_class: Any, sender: Any = ANY, priority: EventPriority | None = None):
        ...
        Returns:
            Callable: The listener function.
        """
        return alistener(signal_class, sender, priority)
