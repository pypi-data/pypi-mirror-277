...
"""
pip install -U kuojingyueyi-api
pip --no-cache-dir install -U kuojingyueyi-api
...
setup(
    ...
    # 官网地址
    url="https://github.com/ldsxp/kuojingyueyi-api",
    # 程序的下载地址
    download_url="https://pypi.org/project/kuojingyueyi-api",
    # 作者
    author="lds",
    # 作者的邮箱地址
