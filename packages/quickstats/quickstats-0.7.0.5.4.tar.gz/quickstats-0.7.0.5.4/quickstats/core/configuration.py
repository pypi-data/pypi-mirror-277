...
class ConfigComponent:
    def __init__(self, dtype: Union[type, str], required: bool = False,
        ...
        Args:
            ...
            default: The default value for the component, if not set to MISSING.
            default_factory: A callable that returns the default value, if not set to MISSING.
    ...
    def get_explain_text(self, indent_level: int = 0, indent_size: int = 4, line_break: int = 100,
        ...
        attributes_text = format_dict_to_string(components, left_margin=left_margin, line_break=line_break)
        # TODO: display level?
        return f"{indent}{name}\n{attributes_text}"

    def explain(self, line_break: int = 100,
                with_default:bool=True,
                with_description:bool=True) -> None:
        print(self.get_explain_text(line_break=line_break,
...
class ConfigScheme(AbstractObject, metaclass=MergeConfigAnnotationsMeta):
    ...
    def get_explain_text(self, components:Optional[List[str]]=None,
                         indent_level: int = 0, indent_size: int = 4, line_break: int = 100,
                         with_default:bool=True, with_description:bool=True) -> str:
    ...
    def validate(self):
        ...
        for name, component in components.items():
            ...
            if (value is MISSING) and (component.required):
