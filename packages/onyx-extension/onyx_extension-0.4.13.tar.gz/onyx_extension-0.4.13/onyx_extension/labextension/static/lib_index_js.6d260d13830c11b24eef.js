...
class ReactAppWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    ...
    render() {
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement((climb_onyx_ui__WEBPACK_IMPORTED_MODULE_2___default()), { domain: this.domain, token: this.token, s3PathHandler: this.s3PathHandler });
    }
}
...
async function requestAPI(endPoint = '', init = {}, param = ['', '']) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_1__.URLExt.join(settings.baseUrl, 'onyx-extension', endPoint);
...
/* harmony import */ var _App__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./App */ "./lib/App.js");
...
class OpenS3FileWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_4__.Widget {
    constructor() {
...
const plugin = {
    ...
    activate: (app, palette, documentManager, launcher, htmlTracker) => {
        ...
        let domain;
        let token;
        const s3_open_function = (s3_link) => {
            (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)('s3', {}, ['s3location', s3_link])
                .then(data => {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)('settings')
            .then(data => {
            domain = data['domain'];
            token = data['token'];
        })
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)('reroute', {}, ['route', 'https://onyx-test.climb.ac.uk/projects/'])
            .then(data => {
            console.log(data);
        })
            .catch(reason => {
            console.error(`The onyx_extension could not redirect.\n${reason}`);
        });
        ...
        app.commands.addCommand(command, {
            label: 'Onyx',
            caption: 'Onyx',
            icon: _icon__WEBPACK_IMPORTED_MODULE_6__.chatIcon,
            execute: () => {
                if (!widget || widget.disposed) {
                    const content = new _App__WEBPACK_IMPORTED_MODULE_7__.ReactAppWidget(domain, token, s3_open_function);
...
//# sourceMappingURL=lib_index_js.6d260d13830c11b24eef.js.map