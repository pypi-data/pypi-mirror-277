...
class S3Bucket(AWSResource[S3BucketOutputs]):
    ...
    bucket = lf.aws.S3Bucket("my-bucket", region="us-west-1")
    ```
    ...
    def inputs(self, environment_type: EnvironmentType) -> S3BucketInputs:
        return S3BucketInputs(region=self.region)
