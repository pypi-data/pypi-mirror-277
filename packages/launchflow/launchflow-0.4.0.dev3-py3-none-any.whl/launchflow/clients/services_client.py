...
class ServicesAsyncClient:
    ...
    async def save(
        ...
        response = await self.http_client.post(
            f"{self.base_url(project_name, environment_name)}/{service_name}?lock_id={lock_id}",
    ...
    async def delete(
        ...
        url = f"{self.base_url(project_name, environment_name)}/{service_name}?lock_id={lock_id}"
