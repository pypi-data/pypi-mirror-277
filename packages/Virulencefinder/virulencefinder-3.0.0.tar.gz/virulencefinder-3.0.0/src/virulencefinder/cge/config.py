...
class Config:
    ...
    def get_abs_path_and_check(path, allow_exit=True):
        ...
        :param: allow_exit: Default True. If set to False virulencefinder will continue to run.
    ...
    def get_prg_path(prg_path):
        ...
        :result: Checks whether prg_path exists and if so, it will test kma by running help. If the programm does not work it will exit the run.
        """
        try:
