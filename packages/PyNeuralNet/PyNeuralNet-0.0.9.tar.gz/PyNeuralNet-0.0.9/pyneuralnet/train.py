...
def train(metadata_file, root_dir):
    ...
    dataset = DatasetLoader(metadata_file=metadata_file, root_dir=root_dir, transform=transform) #SuperResolutionDataset(metadata_file=metadata_file, root_dir=root_dir, transform=transform)
