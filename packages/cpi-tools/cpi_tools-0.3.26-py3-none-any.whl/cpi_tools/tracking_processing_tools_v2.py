...
def extract_reference_sheets():
    ...
    process_reference_data(pd.read_excel(f's3://{S3_STAGE}/{s3_file_path}/{file_name}', sheet_name='institution_list_cpi'),
...
def update_ref_tables():
    ...
    export_dropbox_file_to_s3(reference_metadata_dropbox_path, s3_bucket='cpi-uk-us-datascience-stage',
