...
class SubjectClaims(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["federation", b"federation", "yandex_claims", b"yandex_claims"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["email", b"email", "family_name", b"family_name", "federation", b"federation", "gender", b"gender", "given_name", b"given_name", "groups", b"groups", "locale", b"locale", "name", b"name", "phone_number", b"phone_number", "picture", b"picture", "picture_data", b"picture_data", "preferred_username", b"preferred_username", "service_account_folder_id", b"service_account_folder_id", "sub", b"sub", "sub_type", b"sub_type", "yandex_claims", b"yandex_claims", "zoneinfo", b"zoneinfo"]) -> None: ...
...
class Federation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["id", b"id", "is_global", b"is_global", "name", b"name", "organization", b"organization"]) -> None: ...
