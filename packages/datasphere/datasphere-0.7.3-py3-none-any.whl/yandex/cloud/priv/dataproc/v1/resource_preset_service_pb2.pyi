...
class ListResourcePresetsResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def resource_presets(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.priv.dataproc.v1.resource_preset_pb2.ResourcePreset]:
        """List of ResourcePreset resources."""

    def __init__(
        self,
        *,
        resource_presets: collections.abc.Iterable[yandex.cloud.priv.dataproc.v1.resource_preset_pb2.ResourcePreset] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
