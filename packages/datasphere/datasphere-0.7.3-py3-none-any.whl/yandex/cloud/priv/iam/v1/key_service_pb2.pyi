...
class CreateKeyRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "federated_user_id", b"federated_user_id", "format", b"format", "key_algorithm", b"key_algorithm", "key_id", b"key_id", "public_key", b"public_key", "service_account_id", b"service_account_id", "user_account_id", b"user_account_id"]) -> None: ...
