...
class RefreshToken(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["created_at", b"created_at", "expire_at", b"expire_at", "last_use_at", b"last_use_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["client_id", b"client_id", "client_instance_id", b"client_instance_id", "created_at", b"created_at", "expire_at", b"expire_at", "id", b"id", "last_use_at", b"last_use_at", "protection_level", b"protection_level", "subject_id", b"subject_id"]) -> None: ...
...
class RevokeFilter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["client_id", b"client_id", "client_instance_id", b"client_instance_id", "subject_id", b"subject_id"]) -> None: ...
