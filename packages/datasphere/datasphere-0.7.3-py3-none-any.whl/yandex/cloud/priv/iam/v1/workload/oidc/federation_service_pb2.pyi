...
class CreateFederationRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["audiences", b"audiences", "description", b"description", "disabled", b"disabled", "folder_id", b"folder_id", "id", b"id", "issuer", b"issuer", "jwks_url", b"jwks_url", "labels", b"labels", "name", b"name"]) -> None: ...
