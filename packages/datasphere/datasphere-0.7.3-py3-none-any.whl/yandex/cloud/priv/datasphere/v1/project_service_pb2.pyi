...
class CreateProjectRequest(google.protobuf.message.Message):
    ...
    PARENT_CHECKPOINT_URI_FIELD_NUMBER: builtins.int
    folder_id: builtins.str
    name: builtins.str
    description: builtins.str
    parent_checkpoint_uri: builtins.str
    @property
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "folder_id", b"folder_id", "labels", b"labels", "limits", b"limits", "name", b"name", "parent_checkpoint_uri", b"parent_checkpoint_uri", "settings", b"settings"]) -> None: ...
