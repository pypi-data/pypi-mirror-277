...
class Checkpoint(google.protobuf.message.Message):
    ...
    class CellInfo(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["cell_id", b"cell_id", "cell_version", b"cell_version", "code", b"code", "state_version", b"state_version"]) -> None: ...
    ...
    class NotebookInfo(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["notebook_id", b"notebook_id", "notebook_path", b"notebook_path"]) -> None: ...
    ...
    class NbCheckpoint(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["created_at", b"created_at", "execution_count", b"execution_count", "nb_checkpoint_id", b"nb_checkpoint_id", "notebook_id", b"notebook_id", "notebook_path", b"notebook_path", "project_id", b"project_id", "state_version", b"state_version", "view_version", b"view_version"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["cell_info", b"cell_info", "created_at", b"created_at", "notebook_info", b"notebook_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cell_info", b"cell_info", "created_at", b"created_at", "created_by_id", b"created_by_id", "id", b"id", "labels", b"labels", "name", b"name", "nb_checkpoints", b"nb_checkpoints", "notebook_info", b"notebook_info", "pinned_by_id", b"pinned_by_id", "project_id", b"project_id", "tags", b"tags", "type", b"type"]) -> None: ...
