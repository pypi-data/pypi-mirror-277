...
class ListProjectJobRequest(google.protobuf.message.Message):
    ...
    example:
      * only running jobs == "status IN (EXECUTING, UPLOADING_RESULTS)"
    """
...
class GetProjectJobStorageCostEstimationResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["cost", b"cost", "currency", b"currency", "used_storage_size_gb", b"used_storage_size_gb"]) -> None: ...
...
class StartJobsConfigEncryptionMigrationRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dry_run", b"dry_run"]) -> None: ...
