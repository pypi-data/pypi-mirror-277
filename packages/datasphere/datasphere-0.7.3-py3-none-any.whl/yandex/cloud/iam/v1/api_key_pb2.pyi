...
class ApiKey(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["created_at", b"created_at", "description", b"description", "id", b"id", "last_used_at", b"last_used_at", "service_account_id", b"service_account_id"]) -> None: ...
