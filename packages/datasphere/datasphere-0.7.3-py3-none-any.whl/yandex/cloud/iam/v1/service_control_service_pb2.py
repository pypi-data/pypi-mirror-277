...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_SERVICECONTROLSERVICE'].methods_by_name['Get']._options = None
  ...
  _globals['_SERVICECONTROLSERVICE'].methods_by_name['List']._options = None
