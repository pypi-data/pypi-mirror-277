    ...
    for _, row in input_df.iterrows():
        ...
        if s3_reference_image_path is None:
            ...
            if local_image_path and site_id and food_item:
                ...
                entries.append((site_id, local_image_path, food_item,local_image_folder,image_dict['image'],s3_reference_image_path,s3_reference_weight,rework_g,model_final_name))
    ...
    for index, (site_id, local_image_path, food_item,local_image_folder,image_dict_name,reference_image,reference_image_gt,rework_g,model_final_name) in enumerate(entries):
        try:
            ...
            if food_item in equalizer_items:
                ...
                equalizer = False
            masked_img = get_seg(local_image_path, model, mask_val=mask_val, resize=True, new_bg_removal=new_bg_removal, equalize=equalizer)
            ...
            masked_img_ref = get_seg(reference_image, model, mask_val=mask_val, resize=True, new_bg_removal=new_bg_removal, equalize=equalizer)
