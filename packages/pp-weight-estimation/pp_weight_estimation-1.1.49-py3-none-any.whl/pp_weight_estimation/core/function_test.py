...
def process_pipeline(config_path: str, logger: logging.Logger = None, **kwargs) -> Union[pd.DataFrame, List]:
    ...
    for _, row in input_df.iterrows():
        ...
        if local_image_path and site_id and food_item:
            ...
            entries.append((site_id, local_image_path, food_item,local_image_folder,image_dict['image'],s3_reference_image_path,rework_g,model_version))
    ...
    results = []
    for index, (site_id, local_image_path, food_item,local_image_folder,image_dict_name,reference_image,rework_g,model_version) in enumerate(entries):
        try:
