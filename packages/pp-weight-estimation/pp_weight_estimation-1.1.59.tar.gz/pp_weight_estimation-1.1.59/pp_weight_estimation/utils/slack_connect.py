...
def send_message_to_slack(message,slack_channel='pp_image_weight_estimation',is_df=False,tabulate_type='orgtbl',url=None):
    """
    ...
    try :
        ...
        if is_df:
            ...
            tab = (tabulate.tabulate(message,headers=list(message.columns), tablefmt=tabulate_type))
