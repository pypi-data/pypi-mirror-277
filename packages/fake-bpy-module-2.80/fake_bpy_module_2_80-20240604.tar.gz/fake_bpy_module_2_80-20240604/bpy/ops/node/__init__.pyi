...
def add_and_link_node(
    ...
    *,
    ...
    settings: bpy.types.bpy_prop_collection[bpy.types.NodeSetting] | None = None,
    ...
    :type settings: bpy.types.bpy_prop_collection[bpy.types.NodeSetting] | None
