...
def gltf(
    ...
    undo: bool | None = None,
    *,
    export_format: str | None = "GLB",
    ui_tab: str | None = "GENERAL",
    export_copyright: str | typing.Any = "",
    export_image_format: str | None = "NAME",
    ...
    export_selected: bool | typing.Any | None = False,
    ...
    export_frame_range: bool | typing.Any | None = True,
    export_frame_step: typing.Any | None = 1,
    export_force_sampling: bool | typing.Any | None = False,
    ...
    export_displacement: bool | typing.Any | None = False,
    ...
    ANIMATION Animation, Animation settings.
        ...
        :param export_image_format: Images, Output format for images. PNG is lossless and generally preferred, but JPEG might be preferable for web applications due to the smaller file size

    NAME Automatic, Determine the image format from the blender image name.

    JPEG JPEG Format (.jpg), Encode and save textures as .jpg files. Be aware of a possible loss in quality.

    PNG PNG Format (.png), Encode and save textures as .png files.
        ...
        :type export_selected: bool | typing.Any | None
        ...
        :type export_displacement: bool | typing.Any | None
...
def obj(
    ...
    *,
    ...
    use_selection: bool | typing.Any | None = False,
    use_animation: bool | typing.Any | None = False,
    use_mesh_modifiers: bool | typing.Any | None = True,
    use_edges: bool | typing.Any | None = True,
    use_smooth_groups: bool | typing.Any | None = False,
    use_smooth_groups_bitflags: bool | typing.Any | None = False,
    use_normals: bool | typing.Any | None = True,
    use_uvs: bool | typing.Any | None = True,
    use_materials: bool | typing.Any | None = True,
    use_triangles: bool | typing.Any | None = False,
    use_nurbs: bool | typing.Any | None = False,
    use_vertex_groups: bool | typing.Any | None = False,
    use_blen_objects: bool | typing.Any | None = True,
    group_by_object: bool | typing.Any | None = False,
    group_by_material: bool | typing.Any | None = False,
    keep_vertex_order: bool | typing.Any | None = False,
    global_scale: typing.Any | None = 1.0,
    path_mode: str | None = "AUTO",
    axis_forward: str | None = "-Z",
    axis_up: str | None = "Y",
    ...
    """Save a Wavefront OBJ File
        ...
        :type use_animation: bool | typing.Any | None
        ...
        :type use_smooth_groups_bitflags: bool | typing.Any | None
        ...
        :type use_uvs: bool | typing.Any | None
        :param use_materials: Write Materials, Write out the MTL file
        :type use_materials: bool | typing.Any | None
        ...
        :type use_nurbs: bool | typing.Any | None
        :param use_vertex_groups: Polygroups
        :type use_vertex_groups: bool | typing.Any | None
        :param use_blen_objects: Objects as OBJ Objects
        :type use_blen_objects: bool | typing.Any | None
        :param group_by_object: Objects as OBJ Groups
        :type group_by_object: bool | typing.Any | None
        :param group_by_material: Material Groups
        :type group_by_material: bool | typing.Any | None
        :param keep_vertex_order: Keep Vertex Order
        :type keep_vertex_order: bool | typing.Any | None
