...
class GUI:
    def __init__(self):
        ...
        self.top_portion.grid(row=0, column=0, sticky="nsew")
        ...
        self.app_browse_button = tk.Button(self.app_browse_guide, text="Browse", command=lambda: browse(self.app_input_text))
        ...
        self.java_browse_button = tk.Button(self.java_browse_guide, text="Browse", command=lambda: browse(self.java_input_text))
        ...
        options_list = ("Select an example", "NOTES_SetLeftSwipeToDelete")
        ...
        self.bottom_portion.grid(row=1, column=0, sticky="nsew")
        ...
        self.permission_checkbox = tk.Checkbutton(self.checkbox_input_frame, text="Auto Grant Permissions", anchor="w", variable=self.perm_var)
        self.permission_checkbox.grid(row=0, column=0, sticky="nsew")
        self.permission_checkbox.select()

        self.noreset_var = tk.IntVar()
        self.noreset_checkbox = tk.Checkbutton(self.checkbox_input_frame, text="No Reset", anchor="w", variable=self.noreset_var)
        self.noreset_checkbox.grid(row=1, column=0, sticky="nsew")

        self.fullreset_var = tk.IntVar()
        self.fullreset_checkbox = tk.Checkbutton(self.checkbox_input_frame, text="Full Reset", anchor="w", variable=self.fullreset_var)
        self.fullreset_checkbox.grid(row=2, column=0, sticky="nsew")
        self.fullreset_checkbox.select()

        self.exitafterparse_var = tk.IntVar()
        self.exitafterparse_checkbox = tk.Checkbutton(self.checkbox_input_frame, text="Exit After Parse", anchor="w", variable=self.exitafterparse_var)
        ...
        self.output_text_label = tk.Label(self.bottom_portion, text="Output", anchor="nw", justify="left", bg="white", wraplength=525, width=40)
    ...
    def ddtrace(self, *args):
        map = {
            ...
            "NOTES_SetLeftSwipeToDelete": {
                "app": os.path.join(os.path.dirname(__file__), "examples", "NOTES_SetLeftSwipeToDelete", "another-notes-app.apk"),
                "java": os.path.join(os.path.dirname(__file__), "examples", "NOTES_SetLeftSwipeToDelete", "NOTES_SetLeftSwipeToDelete.java"),
                "activity": "com.maltaisn.notes.ui.main.MainActivity",
            }
        }

        selection = map[self.dropdown_var.get()]
    ...
    def start(self):
        ...
        if not os.path.exists(app_path):
            self.output_text += f"⛔ File: '{app_path}' does not exist\n"

        if not os.path.exists(java_path):
            self.output_text += f"⛔ File: '{java_path}' does not exist\n"
