...
@cli_command(
    ...
    command_examples=[
        ...
        "     {} --literal term",
        "2. read from system environment, filter by regexes (OR):",
        "     {} ^term ssh",
        "3. read from a file, filter by regexes (AND):",
        "     {} -F .env --and ^term ssh",
...
@cli_option(
    ...
    is_flag=True,
    default=False,
    help="Treat specified FILTERs as plain strings [default: as extended regexes].",
)
@cli_option(
    "-a",
    "--and",
