...
@auth_group.command("info", help="Display information about your environment.")
def display_info():
    import pyhectiqlab
    ...
    click.secho("📦 Hectiq Lab", bold=True, fg="green")
    click.secho(f" → Version: {pyhectiqlab.__version__}", fg="bright_blue")
    click.secho(f" → Directory path: {os.path.dirname(pyhectiqlab.__file__)}", fg="bright_blue")
