...
Refer to the Terraform Registry for docs: [`akeyless_role`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role).
'''
import abc
import builtins
import datetime
...
class Role(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role akeyless_role}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role akeyless_role} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Role name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#name Role#name}
        :param analytics_access: Allow this role to view analytics. Currently only 'none', 'own' and 'all' values are supported, allowing associated auth methods to view reports produced by the same auth methods. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#analytics_access Role#analytics_access}
        :param assoc_auth_method: assoc_auth_method block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#assoc_auth_method Role#assoc_auth_method}
        :param audit_access: Allow this role to view audit logs. Currently only 'none', 'own' and 'all' values are supported, allowing associated auth methods to view audit logs produced by the same auth methods. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#audit_access Role#audit_access}
        :param description: Description of the object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#description Role#description}
        :param gw_analytics_access: Allow this role to view gw analytics. Currently only 'none', 'own' and 'all' values are supported, allowing associated auth methods to view reports produced by the same auth methods. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#gw_analytics_access Role#gw_analytics_access}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#id Role#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param rules: rules block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#rules Role#rules}
        :param sra_reports_access: Allow this role to view SRA Clusters. Currently only 'none', 'own' and 'all' values are supported. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#sra_reports_access Role#sra_reports_access}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Role that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#import import section} in the documentation of this resource for the id to use
...
class RoleAssocAuthMethod:
    def __init__(
        ...
        *,
        ...
        '''
        :param am_name: The auth method to associate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#am_name Role#am_name}
        :param case_sensitive: Treat sub claims as case-sensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#case_sensitive Role#case_sensitive}
        :param sub_claims: key/val of sub claims, e.g group=admins,developers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#sub_claims Role#sub_claims}
        '''
        if __debug__:
    ...
    def am_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#am_name Role#am_name}
        '''
    ...
    def case_sensitive(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#case_sensitive Role#case_sensitive}
        '''
    ...
    def sub_claims(self) -> typing.Optional[typing.Mapping[builtins.str, builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#sub_claims Role#sub_claims}
        '''
...
class RoleConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#name Role#name}
        '''
    ...
    def analytics_access(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#analytics_access Role#analytics_access}
        '''
    ...
    def assoc_auth_method(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#assoc_auth_method Role#assoc_auth_method}
        '''
    ...
    def audit_access(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#audit_access Role#audit_access}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#description Role#description}
        '''
    ...
    def gw_analytics_access(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#gw_analytics_access Role#gw_analytics_access}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#id Role#id}.
    ...
    def rules(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#rules Role#rules}
        '''
    ...
    def sra_reports_access(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#sra_reports_access Role#sra_reports_access}
        '''
...
class RoleRules:
    def __init__(
        ...
        *,
        ...
        '''
        :param capability: List of the approved/denied capabilities in the path options: [read, create, update, delete, list, deny]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#capability Role#capability}
        :param path: The path the rule refers to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#path Role#path}
        :param rule_type: item-rule, target-rule, role-rule, auth-method-rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#rule_type Role#rule_type}
        '''
        if __debug__:
    ...
    def capability(self) -> typing.List[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#capability Role#capability}
        '''
    ...
    def path(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#path Role#path}
        '''
    ...
    def rule_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/role#rule_type Role#rule_type}
        '''
