...
Refer to the Terraform Registry for docs: [`akeyless_rotated_secret_mongodb`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb).
'''
import abc
import builtins
import datetime
...
class RotatedSecretMongodb(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb akeyless_rotated_secret_mongodb}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb akeyless_rotated_secret_mongodb} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Secret name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#name RotatedSecretMongodb#name}
        :param rotator_type: The rotator type [target/password]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#rotator_type RotatedSecretMongodb#rotator_type}
        :param target_name: The target name to associate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#target_name RotatedSecretMongodb#target_name}
        :param authentication_credentials: The credentials to connect with [use-self-creds/use-target-creds]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#authentication_credentials RotatedSecretMongodb#authentication_credentials}
        :param auto_rotate: Whether to automatically rotate every --rotation-interval days, or disable existing automatic rotation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#auto_rotate RotatedSecretMongodb#auto_rotate}
        :param description: Description of the object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#description RotatedSecretMongodb#description}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#id RotatedSecretMongodb#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param key: The name of a key that is used to encrypt the secret value (if empty, the account default protectionKey key will be used). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#key RotatedSecretMongodb#key}
        :param password_length: The length of the password to be generated. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#password_length RotatedSecretMongodb#password_length}
        :param rotated_password: rotated-username password (relevant only for rotator-type=password). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#rotated_password RotatedSecretMongodb#rotated_password}
        :param rotated_username: username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it's own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type=password). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#rotated_username RotatedSecretMongodb#rotated_username}
        :param rotation_hour: The Hour of the rotation in UTC. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#rotation_hour RotatedSecretMongodb#rotation_hour}
        :param rotation_interval: The number of days to wait between every automatic rotation (1-365),custom rotator interval will be set in minutes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#rotation_interval RotatedSecretMongodb#rotation_interval}
        :param tags: List of the tags attached to this secret. To specify multiple tags use argument multiple times: -t Tag1 -t Tag2 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#tags RotatedSecretMongodb#tags}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RotatedSecretMongodb that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#import import section} in the documentation of this resource for the id to use
...
class RotatedSecretMongodbConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#name RotatedSecretMongodb#name}
        '''
    ...
    def rotator_type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#rotator_type RotatedSecretMongodb#rotator_type}
        '''
    ...
    def target_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#target_name RotatedSecretMongodb#target_name}
        '''
    ...
    def authentication_credentials(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#authentication_credentials RotatedSecretMongodb#authentication_credentials}
        '''
    ...
    def auto_rotate(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#auto_rotate RotatedSecretMongodb#auto_rotate}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#description RotatedSecretMongodb#description}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#id RotatedSecretMongodb#id}.
    ...
    def key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#key RotatedSecretMongodb#key}
        '''
    ...
    def password_length(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#password_length RotatedSecretMongodb#password_length}
        '''
    ...
    def rotated_password(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#rotated_password RotatedSecretMongodb#rotated_password}
        '''
    ...
    def rotated_username(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#rotated_username RotatedSecretMongodb#rotated_username}
        '''
    ...
    def rotation_hour(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#rotation_hour RotatedSecretMongodb#rotation_hour}
        '''
    ...
    def rotation_interval(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#rotation_interval RotatedSecretMongodb#rotation_interval}
        '''
    ...
    def tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/rotated_secret_mongodb#tags RotatedSecretMongodb#tags}
        '''
