...
Refer to the Terraform Registry for docs: [`akeyless_dynamic_secret_rdp`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp).
'''
import abc
import builtins
import datetime
...
class DynamicSecretRdp(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp akeyless_dynamic_secret_rdp}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp akeyless_dynamic_secret_rdp} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Dynamic secret name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#name DynamicSecretRdp#name}
        :param encryption_key_name: Encrypt dynamic secret details with following key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#encryption_key_name DynamicSecretRdp#encryption_key_name}
        :param fixed_user_only: Enable fixed user only. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#fixed_user_only DynamicSecretRdp#fixed_user_only}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#id DynamicSecretRdp#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param password_length: The length of the password to be generated. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#password_length DynamicSecretRdp#password_length}
        :param rdp_admin_name: RDP Admin name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#rdp_admin_name DynamicSecretRdp#rdp_admin_name}
        :param rdp_admin_pwd: RDP Admin Password. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#rdp_admin_pwd DynamicSecretRdp#rdp_admin_pwd}
        :param rdp_host_name: RDP Host name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#rdp_host_name DynamicSecretRdp#rdp_host_name}
        :param rdp_host_port: RDP Host port. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#rdp_host_port DynamicSecretRdp#rdp_host_port}
        :param rdp_user_groups: RDP UserGroup name(s). Multiple values should be separated by comma. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#rdp_user_groups DynamicSecretRdp#rdp_user_groups}
        :param secure_access_allow_external_user: Allow providing external user for a domain users. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_allow_external_user DynamicSecretRdp#secure_access_allow_external_user}
        :param secure_access_enable: Enable/Disable secure remote access, [true/false]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_enable DynamicSecretRdp#secure_access_enable}
        :param secure_access_host: Target servers for connections., For multiple values repeat this flag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_host DynamicSecretRdp#secure_access_host}
        :param secure_access_rdp_domain: Required when the Dynamic Secret is used for a domain user. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_rdp_domain DynamicSecretRdp#secure_access_rdp_domain}
        :param secure_access_rdp_user: Override the RDP Domain username. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_rdp_user DynamicSecretRdp#secure_access_rdp_user}
        :param secure_access_web: Enable Web Secure Remote Access. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_web DynamicSecretRdp#secure_access_web}
        :param tags: List of the tags attached to this secret. To specify multiple tags use argument multiple times: -t Tag1 -t Tag2 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#tags DynamicSecretRdp#tags}
        :param target_name: Name of existing target to use in dynamic secret creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#target_name DynamicSecretRdp#target_name}
        :param user_ttl: User TTL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#user_ttl DynamicSecretRdp#user_ttl}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DynamicSecretRdp that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#import import section} in the documentation of this resource for the id to use
...
class DynamicSecretRdpConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#name DynamicSecretRdp#name}
        '''
    ...
    def encryption_key_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#encryption_key_name DynamicSecretRdp#encryption_key_name}
        '''
    ...
    def fixed_user_only(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#fixed_user_only DynamicSecretRdp#fixed_user_only}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#id DynamicSecretRdp#id}.
    ...
    def password_length(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#password_length DynamicSecretRdp#password_length}
        '''
    ...
    def rdp_admin_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#rdp_admin_name DynamicSecretRdp#rdp_admin_name}
        '''
    ...
    def rdp_admin_pwd(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#rdp_admin_pwd DynamicSecretRdp#rdp_admin_pwd}
        '''
    ...
    def rdp_host_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#rdp_host_name DynamicSecretRdp#rdp_host_name}
        '''
    ...
    def rdp_host_port(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#rdp_host_port DynamicSecretRdp#rdp_host_port}
        '''
    ...
    def rdp_user_groups(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#rdp_user_groups DynamicSecretRdp#rdp_user_groups}
        '''
    ...
    def secure_access_allow_external_user(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_allow_external_user DynamicSecretRdp#secure_access_allow_external_user}
        '''
    ...
    def secure_access_enable(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_enable DynamicSecretRdp#secure_access_enable}
        '''
    ...
    def secure_access_host(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_host DynamicSecretRdp#secure_access_host}
        '''
    ...
    def secure_access_rdp_domain(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_rdp_domain DynamicSecretRdp#secure_access_rdp_domain}
        '''
    ...
    def secure_access_rdp_user(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_rdp_user DynamicSecretRdp#secure_access_rdp_user}
        '''
    ...
    def secure_access_web(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#secure_access_web DynamicSecretRdp#secure_access_web}
        '''
    ...
    def tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#tags DynamicSecretRdp#tags}
        '''
    ...
    def target_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#target_name DynamicSecretRdp#target_name}
        '''
    ...
    def user_ttl(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/dynamic_secret_rdp#user_ttl DynamicSecretRdp#user_ttl}
        '''
