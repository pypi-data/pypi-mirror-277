...
Refer to the Terraform Registry for docs: [`akeyless_target_k8s`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s).
'''
import abc
import builtins
import datetime
...
class TargetK8S(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s akeyless_target_k8s}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s akeyless_target_k8s} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param k8_s_cluster_ca_cert: K8S Cluster certificate. Base 64 encoded certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#k8s_cluster_ca_cert TargetK8S#k8s_cluster_ca_cert}
        :param k8_s_cluster_endpoint: K8S Cluster endpoint. https:// , <DNS / IP> of the cluster. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#k8s_cluster_endpoint TargetK8S#k8s_cluster_endpoint}
        :param k8_s_cluster_token: K8S Cluster authentication token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#k8s_cluster_token TargetK8S#k8s_cluster_token}
        :param name: Target name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#name TargetK8S#name}
        :param description: Description of the object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#description TargetK8S#description}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#id TargetK8S#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param key: Key name. The key will be used to encrypt the target secret value. If key name is not specified, the account default protection key is used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#key TargetK8S#key}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing TargetK8S that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#import import section} in the documentation of this resource for the id to use
...
class TargetK8SConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def k8_s_cluster_ca_cert(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#k8s_cluster_ca_cert TargetK8S#k8s_cluster_ca_cert}
        '''
    ...
    def k8_s_cluster_endpoint(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#k8s_cluster_endpoint TargetK8S#k8s_cluster_endpoint}
        '''
    ...
    def k8_s_cluster_token(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#k8s_cluster_token TargetK8S#k8s_cluster_token}
        '''
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#name TargetK8S#name}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#description TargetK8S#description}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#id TargetK8S#id}.
    ...
    def key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.5.1/docs/resources/target_k8s#key TargetK8S#key}
        '''
