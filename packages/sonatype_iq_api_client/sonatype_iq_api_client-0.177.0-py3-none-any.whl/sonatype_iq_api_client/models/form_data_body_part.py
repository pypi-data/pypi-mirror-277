...
class FormDataBodyPart(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contentDisposition", "entity", "formDataContentDisposition", "headers", "mediaType", "messageBodyWorkers", "name", "parameterizedHeaders", "parent", "providers", "simple", "value"]
