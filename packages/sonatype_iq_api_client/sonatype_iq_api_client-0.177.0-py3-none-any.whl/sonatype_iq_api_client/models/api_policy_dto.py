...
class ApiPolicyDTO(BaseModel):
    ...
    policy_type: Optional[StrictStr] = Field(default=None, alias="policyType")
    threat_level: Optional[StrictInt] = Field(default=None, alias="threatLevel")
    __properties: ClassVar[List[str]] = ["id", "name", "ownerId", "ownerType", "policyType", "threatLevel"]
    ...
    def owner_type_validate_enum(cls, value):
        ...
        if value not in set(['APPLICATION', 'ORGANIZATION']):
            raise ValueError("must be one of enum values ('APPLICATION', 'ORGANIZATION')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiPolicyDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiPolicyDTO from a dict"""
        if obj is None:
            return None
