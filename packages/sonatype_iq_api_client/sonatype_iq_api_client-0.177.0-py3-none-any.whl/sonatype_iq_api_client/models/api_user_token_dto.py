...
class ApiUserTokenDTO(BaseModel):
    """
    ApiUserTokenDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["passCode", "realm", "userCode", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiUserTokenDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiUserTokenDTO from a dict"""
        if obj is None:
            return None
