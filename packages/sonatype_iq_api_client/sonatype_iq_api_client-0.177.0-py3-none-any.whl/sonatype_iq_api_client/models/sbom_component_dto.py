...
class SbomComponentDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["componentIdentifier", "dependencyType", "displayName", "hash", "licenses", "name", "packageUrl", "percentageAnnotated", "version", "vulnerabilitySeverityCriticalCount", "vulnerabilitySeverityHighCount", "vulnerabilitySeverityLowCount", "vulnerabilitySeverityMediumCount", "vulnerabilitySeverityNoneCount"]
