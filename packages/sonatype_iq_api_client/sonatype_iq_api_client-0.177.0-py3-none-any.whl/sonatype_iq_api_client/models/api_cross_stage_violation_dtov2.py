...
class ApiCrossStageViolationDTOV2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["applicationName", "applicationPublicId", "componentIdentifier", "constraintViolations", "displayName", "filename", "fixTime", "hash", "openTime", "organizationName", "policyId", "policyName", "policyOwner", "policyThreatCategory", "policyViolationId", "stageData", "threatLevel"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.constraint_violations:
            for _item in self.constraint_violations:
                if _item:
        ...
        _field_dict = {}
        if self.stage_data:
            for _key in self.stage_data:
                if self.stage_data[_key]:
                    _field_dict[_key] = self.stage_data[_key].to_dict()
