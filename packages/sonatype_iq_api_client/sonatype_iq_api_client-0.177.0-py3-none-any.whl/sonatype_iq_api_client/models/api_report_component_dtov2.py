...
class ApiReportComponentDTOV2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["componentIdentifier", "cpe", "dependencyData", "displayName", "hash", "identificationSource", "licenseData", "matchState", "packageUrl", "pathnames", "proprietary", "securityData", "sha256", "swid", "thirdParty"]
