...
class ApiApplicationEvaluationResultDTOV2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["embeddableReportHtmlUrl", "reason", "reportDataUrl", "reportHtmlUrl", "reportPdfUrl", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiApplicationEvaluationResultDTOV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiApplicationEvaluationResultDTOV2 from a dict"""
        if obj is None:
            return None
