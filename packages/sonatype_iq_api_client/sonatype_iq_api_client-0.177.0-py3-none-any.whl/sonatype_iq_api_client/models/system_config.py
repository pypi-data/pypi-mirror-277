...
class SystemConfig(BaseModel):
    ...
    force_base_url: Optional[StrictBool] = Field(default=None, alias="forceBaseUrl")
    __properties: ClassVar[List[str]] = ["baseUrl", "forceBaseUrl"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if force_base_url (nullable) is None
        # and model_fields_set contains the field
        if self.force_base_url is None and "force_base_url" in self.model_fields_set:
            _dict['forceBaseUrl'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "forceBaseUrl": obj.get("forceBaseUrl")
        })
        return _obj
