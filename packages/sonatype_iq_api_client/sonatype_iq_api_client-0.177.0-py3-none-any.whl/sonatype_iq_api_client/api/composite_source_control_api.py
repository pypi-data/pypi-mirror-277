...
class CompositeSourceControlApi:
    ...
    def get_composite_source_control_by_owner(
        ...
        _param = self._get_composite_source_control_by_owner_serialize(
    ...
    def get_composite_source_control_by_owner_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiCompositeSourceControlDTO]:
        """get_composite_source_control_by_owner
    ...
    @validate_call
    def get_composite_source_control_by_owner_without_preload_content(
        self,
        owner_type: Annotated[str, Field(strict=True)],
        internal_owner_id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_composite_source_control_by_owner_serialize(
        self,
        owner_type,
        internal_owner_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/compositeSourceControl/{ownerType}/{internalOwnerId}',
