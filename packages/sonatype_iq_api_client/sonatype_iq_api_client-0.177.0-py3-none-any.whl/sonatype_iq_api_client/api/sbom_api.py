...
class SbomApi:
    ...
    def get_sbom_metadata_summary_for_application(
        self,
        application_id: Annotated[StrictStr, Field(description="The internal id of the application")],
        sort_by_date: Annotated[Optional[StrictStr], Field(description="Sort results by import date. Allowed values [asc|desc]. default = asc")] = None,
        ...
        :param application_id: The internal id of the application (required)
        :type application_id: str
        :param sort_by_date: Sort results by import date. Allowed values [asc|desc]. default = asc
    ...
    def get_sbom_version(
        ...
        specification: Annotated[Optional[StrictStr], Field(description="Target specification of the sbom. Allowed values [cyclonedx1.5|spdx2.3]. default = cyclonedx1.5")] = None,
        ...
        :type state: str
        :param specification: Target specification of the sbom. Allowed values [cyclonedx1.5|spdx2.3]. default = cyclonedx1.5
    ...
    def import_sbom(
        self,
        import_sbom_request: Optional[ImportSbomRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param import_sbom_request:
        :type import_sbom_request: ImportSbomRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._import_sbom_serialize(
            import_sbom_request=import_sbom_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _import_sbom_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if import_sbom_request is not None:
            _body_params = import_sbom_request
