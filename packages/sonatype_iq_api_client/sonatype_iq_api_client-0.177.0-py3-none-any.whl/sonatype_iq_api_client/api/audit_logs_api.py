...
class AuditLogsApi:
    ...
    def get_audit_logs(
        self,
        start_utc_date: Optional[StrictStr] = None,
        end_utc_date: Optional[StrictStr] = None,
        ...
        :param start_utc_date:
        :type start_utc_date: str
        :param end_utc_date:
        :type end_utc_date: str
    ...
    def _get_audit_logs_serialize(
        ...
        if start_utc_date is not None:
            ...
            _query_params.append(('startUtcDate', start_utc_date))
            
        if end_utc_date is not None:
            
            _query_params.append(('endUtcDate', end_utc_date))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/auditLogs',
