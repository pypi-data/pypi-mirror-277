...
class AttachmentText(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content", "contentType", "encoding"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttachmentText from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttachmentText from a dict"""
        if obj is None:
            return None
