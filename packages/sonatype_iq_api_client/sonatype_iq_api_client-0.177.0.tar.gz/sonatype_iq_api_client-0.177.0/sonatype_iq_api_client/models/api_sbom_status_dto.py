...
class ApiSbomStatusDTO(BaseModel):
    """
    ApiSbomStatusDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["applicationId", "downloadUrl", "errorMessage", "isError", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiSbomStatusDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiSbomStatusDTO from a dict"""
        if obj is None:
            return None
