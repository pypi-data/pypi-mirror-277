...
class ApiLicenseLegalObligationDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "componentIdentifier", "id", "lastUpdatedAt", "lastUpdatedByUsername", "name", "ownerId", "packageUrl", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['OPEN', 'IGNORED', 'FLAGGED', 'FULFILLED']):
            raise ValueError("must be one of enum values ('OPEN', 'IGNORED', 'FLAGGED', 'FULFILLED')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiLicenseLegalObligationDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiLicenseLegalObligationDTO from a dict"""
        if obj is None:
            return None
