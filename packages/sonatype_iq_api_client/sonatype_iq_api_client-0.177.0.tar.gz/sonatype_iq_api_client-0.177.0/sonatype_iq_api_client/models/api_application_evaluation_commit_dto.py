...
class ApiApplicationEvaluationCommitDTO(BaseModel):
    """
    ...
    scan_time: Optional[datetime] = Field(default=None, alias="scanTime")
    __properties: ClassVar[List[str]] = ["commitHash", "reportUrl", "scanId", "scanTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiApplicationEvaluationCommitDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiApplicationEvaluationCommitDTO from a dict"""
        if obj is None:
            return None
