...
class ApiComponentDTOV2(BaseModel):
    """
    ApiComponentDTOV2
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["componentIdentifier", "displayName", "hash", "packageUrl", "proprietary", "sha256", "thirdParty"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiComponentDTOV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiComponentDTOV2 from a dict"""
        if obj is None:
            return None
