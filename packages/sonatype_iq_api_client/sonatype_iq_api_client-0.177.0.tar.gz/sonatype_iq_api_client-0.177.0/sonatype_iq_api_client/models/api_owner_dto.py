...
class ApiOwnerDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ownerId", "ownerName", "ownerPublicId", "ownerType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiOwnerDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiOwnerDTO from a dict"""
        if obj is None:
            return None
