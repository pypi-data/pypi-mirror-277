...
class ComponentObligationAttributionDTO(BaseModel):
    """
    ...
    obligation_name: Optional[StrictStr] = Field(default=None, alias="obligationName")
    ...
    __properties: ClassVar[List[str]] = ["componentIdentifier", "content", "id", "lastUpdatedAt", "lastUpdatedByUsername", "obligationName", "ownerId", "packageUrl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ComponentObligationAttributionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ComponentObligationAttributionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "obligationName": obj.get("obligationName"),
