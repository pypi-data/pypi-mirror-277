...
class ApiEnhancedPolicyViolationDTOV2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["component", "constraintViolations", "openTime", "policyId", "policyName", "policyViolationId", "reportId", "reportUrl", "stageId", "threatLevel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiEnhancedPolicyViolationDTOV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiEnhancedPolicyViolationDTOV2 from a dict"""
        if obj is None:
            return None
