...
class ApiStaleWaiverDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["comment", "constraintFacts", "createTime", "creatorId", "creatorName", "expiryTime", "policyId", "policyName", "scopeOwnerId", "scopeOwnerName", "scopeOwnerType", "staleEvaluations", "waiverId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.constraint_facts:
            for _item in self.constraint_facts:
                if _item:
