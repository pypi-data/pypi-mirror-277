...
class PolicyWaiverApi:
    ...
    def add_policy_waiver(
        ...
        """ # noqa: E501
        warnings.warn("POST /api/v2/policyWaiver/{policyViolationId}/{ownerType} is deprecated.", DeprecationWarning)

        _param = self._add_policy_waiver_serialize(
    ...
    @validate_call
    def add_policy_waiver_without_preload_content(
        self,
        policy_violation_id: StrictStr,
        owner_type: Annotated[str, Field(strict=True)],
        body: Optional[StrictStr] = None,
    ...
    def _add_policy_waiver_serialize(
        self,
        policy_violation_id,
        owner_type,
        body,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/policyWaiver/{policyViolationId}/{ownerType}',
