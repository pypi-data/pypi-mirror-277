...
class TelemetryApi:
    ...
    def post_external_telemetry(
        ...
        _param = self._post_external_telemetry_serialize(
    ...
    @validate_call
    def post_external_telemetry_with_http_info(
        self,
        user_agent: Optional[StrictStr] = None,
        request_body: Optional[Dict[str, StrictStr]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def post_external_telemetry_without_preload_content(
        self,
        user_agent: Optional[StrictStr] = None,
        request_body: Optional[Dict[str, StrictStr]] = None,
        _request_timeout: Union[
    ...
    def _post_external_telemetry_serialize(
        self,
        user_agent,
        request_body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/telemetry',
