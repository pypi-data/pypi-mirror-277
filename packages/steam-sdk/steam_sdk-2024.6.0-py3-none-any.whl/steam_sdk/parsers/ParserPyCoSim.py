...
class ParserPyCoSim:
    ...
    def translateDataModelCosimToDataPyCoSim(self):
        ...
        # self.pycosim_data.Folders = self.cosim_data.Folders
        self.pycosim_data.Simulations = self.cosim_data.Simulations
        self.pycosim_data.Settings = self.cosim_data.Settings
        self.pycosim_data.Options = self.cosim_data.Options_PyCoSim
