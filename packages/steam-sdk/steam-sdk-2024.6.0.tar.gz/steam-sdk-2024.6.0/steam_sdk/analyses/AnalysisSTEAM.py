    ...
    def step_modify_model(self, step, verbose: bool = None):
        ...
        for v, value in enumerate(step.variable_value):
            ...
            if 'Conductors[' in step.variable_to_change:  # Special case when the variable to change is the Conductors key
                ...
                simulation_set_variable_to_change = step.variable_to_change.split('].')[1]
                old_value = get_attribute_model(case_model, BM, simulation_set_variable_to_change, name_simulation_set=name_simulation_set)
                if verbose:
                ...
                if len_new_model_name > 0:  # Make a new copy of the BuilderModel object, and change it
                    ...
                    rsetattr(BM.cosim_data.Simulations[name_simulation_set], simulation_set_variable_to_change, value)
