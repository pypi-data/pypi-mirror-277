...
class CreditNoteQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> CreditNoteQueryParams:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> CreditNoteQueryParams:
    """Create an instance of CreditNoteQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return CreditNoteQueryParams.parse_obj(obj)

    _obj = CreditNoteQueryParams.parse_obj(
      {
