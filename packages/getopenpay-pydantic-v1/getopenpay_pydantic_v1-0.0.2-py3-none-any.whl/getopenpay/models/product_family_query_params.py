...
class ProductFamilyQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ProductFamilyQueryParams:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ProductFamilyQueryParams:
    """Create an instance of ProductFamilyQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ProductFamilyQueryParams.parse_obj(obj)

    _obj = ProductFamilyQueryParams.parse_obj(
      {
