...
class PaymentLinkQueryParams(BaseModel):
  ...
  __properties = ['page_number', 'page_size', 'sort_key', 'sort_descending', 'created_at', 'expand']
  ...
  @classmethod
  def from_json(cls, json_str: str) -> PaymentLinkQueryParams:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> PaymentLinkQueryParams:
    """Create an instance of PaymentLinkQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return PaymentLinkQueryParams.parse_obj(obj)

    _obj = PaymentLinkQueryParams.parse_obj(
      {
