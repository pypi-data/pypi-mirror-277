...
class PaymentIntentQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> PaymentIntentQueryParams:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> PaymentIntentQueryParams:
    """Create an instance of PaymentIntentQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return PaymentIntentQueryParams.parse_obj(obj)

    _obj = PaymentIntentQueryParams.parse_obj(
      {
