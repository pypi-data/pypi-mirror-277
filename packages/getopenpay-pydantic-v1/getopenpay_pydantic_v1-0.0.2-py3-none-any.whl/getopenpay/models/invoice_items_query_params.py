...
class InvoiceItemsQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> InvoiceItemsQueryParams:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> InvoiceItemsQueryParams:
    """Create an instance of InvoiceItemsQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return InvoiceItemsQueryParams.parse_obj(obj)

    _obj = InvoiceItemsQueryParams.parse_obj(
      {
