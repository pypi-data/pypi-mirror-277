...
class CheckoutSessionExternal(BaseModel):
  ...
  amount_subtotal_atom: StrictInt = Field(
    ..., description='The integer amount representing the subtotal amount for the line items.'
  )
  ...
  line_items: conlist(CheckoutSessionLineItemExternal) = Field(...)
  mode: CheckoutMode = Field(...)
  payment_intent_id: Optional[StrictStr] = Field(...)
  return_url: Optional[StrictStr] = Field(...)
  secure_token: StrictStr = Field(
    ..., description='The random secure token associated with the checkout session.'
  )
  status: CheckoutSessionStatus = Field(...)
  subscription_id: Optional[StrictStr] = Field(...)
  success_url: Optional[StrictStr] = Field(...)
  tax_amount_atom: StrictInt = Field(
    ..., description='The integer amount representing the tax amount for the line items.'
  )
  ...
  __properties = [
    ...
    'amount_subtotal_atom', 'amount_total_atom', 'client_reference_id', 'currency', 'customer_id',
    'customer_email', 'line_items', 'mode', 'payment_intent_id', 'return_url', 'secure_token',
    'status', 'subscription_id', 'success_url', 'tax_amount_atom', 'url'
  ]
    ...
    _obj = CheckoutSessionExternal.parse_obj(
      {
        ...
        'line_items':
          [CheckoutSessionLineItemExternal.from_dict(_item) for _item in obj.get('line_items')]
