...
class CustomerPaymentMethodQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> CustomerPaymentMethodQueryParams:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> CustomerPaymentMethodQueryParams:
    """Create an instance of CustomerPaymentMethodQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return CustomerPaymentMethodQueryParams.parse_obj(obj)

    _obj = CustomerPaymentMethodQueryParams.parse_obj(
      {
