...
class CustomerQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> CustomerQueryParams:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> CustomerQueryParams:
    """Create an instance of CustomerQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return CustomerQueryParams.parse_obj(obj)

    _obj = CustomerQueryParams.parse_obj(
      {
