...
class ProductQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ProductQueryParams:
  ...
  def to_dict(self):
    ...
    # and __fields_set__ contains the field
    if self.name_contains is None and 'name_contains' in self.__fields_set__:
      _dict['name_contains'] = None

    return _dict

  @classmethod
  def from_dict(cls, obj: dict) -> ProductQueryParams:
    """Create an instance of ProductQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ProductQueryParams.parse_obj(obj)

    _obj = ProductQueryParams.parse_obj(
      {
