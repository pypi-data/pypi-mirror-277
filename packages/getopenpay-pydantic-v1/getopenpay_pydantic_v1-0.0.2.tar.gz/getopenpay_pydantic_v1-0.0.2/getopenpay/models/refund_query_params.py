...
class RefundQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> RefundQueryParams:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> RefundQueryParams:
    """Create an instance of RefundQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return RefundQueryParams.parse_obj(obj)

    _obj = RefundQueryParams.parse_obj(
      {
