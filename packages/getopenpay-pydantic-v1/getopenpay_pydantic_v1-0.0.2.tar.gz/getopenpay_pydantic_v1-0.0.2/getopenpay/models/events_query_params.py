...
class EventsQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> EventsQueryParams:
  ...
  def to_dict(self):
    ...
    # and __fields_set__ contains the field
    if self.delivery_success is None and 'delivery_success' in self.__fields_set__:
      _dict['delivery_success'] = None

    return _dict

  @classmethod
  def from_dict(cls, obj: dict) -> EventsQueryParams:
    """Create an instance of EventsQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return EventsQueryParams.parse_obj(obj)

    _obj = EventsQueryParams.parse_obj(
      {
