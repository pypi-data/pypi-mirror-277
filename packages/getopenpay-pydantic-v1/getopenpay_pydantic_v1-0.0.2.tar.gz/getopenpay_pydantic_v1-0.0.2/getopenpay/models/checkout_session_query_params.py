...
class CheckoutSessionQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> CheckoutSessionQueryParams:
  ...
  def to_dict(self):
    ...
    # and __fields_set__ contains the field
    if self.payment_link_id is None and 'payment_link_id' in self.__fields_set__:
      _dict['payment_link_id'] = None

    return _dict

  @classmethod
  def from_dict(cls, obj: dict) -> CheckoutSessionQueryParams:
    """Create an instance of CheckoutSessionQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return CheckoutSessionQueryParams.parse_obj(obj)

    _obj = CheckoutSessionQueryParams.parse_obj(
      {
