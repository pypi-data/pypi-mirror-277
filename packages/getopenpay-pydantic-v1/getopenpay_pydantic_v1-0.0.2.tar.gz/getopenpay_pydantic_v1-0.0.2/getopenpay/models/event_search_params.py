...
class EventSearchParams(BaseModel):
  ...
  types: Optional[conlist(EventType)] = None
  limit: Optional[StrictInt] = Field(50, description='Maximum number of documents to retrieve.')
  __properties = [
  ...
  @classmethod
  def from_json(cls, json_str: str) -> EventSearchParams:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> EventSearchParams:
    """Create an instance of EventSearchParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return EventSearchParams.parse_obj(obj)

    _obj = EventSearchParams.parse_obj(
      {
