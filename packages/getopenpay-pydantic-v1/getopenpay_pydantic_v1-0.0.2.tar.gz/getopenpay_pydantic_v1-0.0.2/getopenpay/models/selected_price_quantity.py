...
class SelectedPriceQuantity(BaseModel):
  ...
  quantity: StrictInt = Field(
    ..., description='Quantity of the product selected for the subscription.'
  )
  ...
  @classmethod
  def from_json(cls, json_str: str) -> SelectedPriceQuantity:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> SelectedPriceQuantity:
    """Create an instance of SelectedPriceQuantity from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return SelectedPriceQuantity.parse_obj(obj)

    _obj = SelectedPriceQuantity.parse_obj(
      {
