...
class InvoiceQueryParams(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> InvoiceQueryParams:
  ...
  def to_dict(self):
    ...
    # and __fields_set__ contains the field
    if self.billing_reason is None and 'billing_reason' in self.__fields_set__:
    ...
    # and __fields_set__ contains the field
    if self.period_start is None and 'period_start' in self.__fields_set__:
      _dict['period_start'] = None

    # set to None if period_end (nullable) is None
    # and __fields_set__ contains the field
    if self.period_end is None and 'period_end' in self.__fields_set__:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> InvoiceQueryParams:
    """Create an instance of InvoiceQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return InvoiceQueryParams.parse_obj(obj)

    _obj = InvoiceQueryParams.parse_obj(
      {
