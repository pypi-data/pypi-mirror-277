...
class InvoicesApi:
  ...
  @validate_arguments
  def create_invoice(
    self, create_invoice_request: CreateInvoiceRequest, **kwargs
  ) -> InvoiceExternal:  # noqa: E501
  ...
  def create_invoice_with_http_info(
    ...
    _all_params = ['create_invoice_request']
    _all_params.extend(
      [
  ...
  def finalize_invoice_with_http_info(
    ...
    **kwargs
    ...
    _all_params = ['invoice_external_id']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
    ...
    return self.api_client.call_api(
      '/invoices/{invoice_external_id}/finalize',
      'POST',
      _path_params,
      _query_params,
      _header_params,
  ...
  def get_invoice(
    ...
    **kwargs
    ...
    """Get Invoice  # noqa: E501
        ...
        >>> thread = api.get_invoice(invoice_external_id, async_req=True)
        >>> result = thread.get()
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.get_invoice_with_http_info(invoice_external_id, **kwargs)  # noqa: E501
  ...
  def get_invoice_with_http_info(
    ...
    **kwargs
    ...
    """Get Invoice  # noqa: E501
        ...
        >>> thread = api.get_invoice_with_http_info(invoice_external_id, async_req=True)
        >>> result = thread.get()
  ...
  def get_invoice_public_with_http_info(
    ...
    **kwargs
    ...
    _all_params = ['public_permanent_token']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
    ...
    return self.api_client.call_api(
      '/invoices/public/{public_permanent_token}',
      'GET',
      _path_params,
      _query_params,
      _header_params,
  ...
  @validate_arguments
  def list_invoices(
    self, invoice_query_params: InvoiceQueryParams, **kwargs
  ) -> ListResponseInvoiceExternal:  # noqa: E501
  ...
  def list_invoices_with_http_info(
    ...
    _all_params = ['invoice_query_params']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def mark_invoice_as_uncollectible(
    ...
    **kwargs
    ...
    """Mark Invoice As Uncollectible  # noqa: E501
        ...
        >>> thread = api.mark_invoice_as_uncollectible(invoice_external_id, async_req=True)
        >>> result = thread.get()
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.mark_invoice_as_uncollectible_with_http_info(
      invoice_external_id, **kwargs
    )  # noqa: E501
  ...
  def mark_invoice_as_uncollectible_with_http_info(
    ...
    **kwargs
    ...
    """Mark Invoice As Uncollectible  # noqa: E501
        ...
        >>> thread = api.mark_invoice_as_uncollectible_with_http_info(invoice_external_id, async_req=True)
        >>> result = thread.get()
    ...
    return self.api_client.call_api(
      '/invoices/{invoice_external_id}/mark_uncollectible',
      'POST',
      _path_params,
      _query_params,
      _header_params,
  ...
  def mark_invoice_as_void(
    ...
    **kwargs
    ...
    """Mark Invoice As Void  # noqa: E501
        ...
        >>> thread = api.mark_invoice_as_void(invoice_external_id, async_req=True)
        >>> result = thread.get()
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.mark_invoice_as_void_with_http_info(invoice_external_id, **kwargs)  # noqa: E501
  ...
  def mark_invoice_as_void_with_http_info(
    ...
    **kwargs
    ...
    """Mark Invoice As Void  # noqa: E501
        ...
        >>> thread = api.mark_invoice_as_void_with_http_info(invoice_external_id, async_req=True)
        >>> result = thread.get()
    ...
    return self.api_client.call_api(
      '/invoices/{invoice_external_id}/void',
      'POST',
      _path_params,
      _query_params,
      _header_params,
  ...
  def pay_invoice(
    ...
    invoice_external_id: Annotated[StrictStr,
                                   Field(..., description='Unique identifier of the invoice.')],
    pay_invoice_request: PayInvoiceRequest, **kwargs
  ) -> InvoiceExternal:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.pay_invoice_with_http_info(
      invoice_external_id, pay_invoice_request, **kwargs
    )  # noqa: E501
  ...
  def pay_invoice_with_http_info(
    ...
    _all_params = ['invoice_external_id', 'pay_invoice_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
    ...
    return self.api_client.call_api(
      '/invoices/{invoice_external_id}/pay',
      'POST',
      _path_params,
      _query_params,
      _header_params,
  ...
  @validate_arguments
  def search_invoices(
    self, search_invoice_request: SearchInvoiceRequest, **kwargs
  ) -> ListResponseInvoiceExternal:  # noqa: E501
    """Search Invoices  # noqa: E501
        ...
        >>> thread = api.search_invoices(search_invoice_request, async_req=True)
        >>> result = thread.get()
    ...
    kwargs['_return_http_data_only'] = True
    if '_preload_content' in kwargs:
      message = 'Error! Please call the search_invoices_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data'  # noqa: E501
      raise ValueError(message)
    return self.search_invoices_with_http_info(search_invoice_request, **kwargs)  # noqa: E501
  ...
  def search_invoices_with_http_info(
    ...
    """Search Invoices  # noqa: E501
        ...
        >>> thread = api.search_invoices_with_http_info(search_invoice_request, async_req=True)
        >>> result = thread.get()
    ...
    _all_params = ['search_invoice_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
    ...
    for _key, _val in _params['kwargs'].items():
      if _key not in _all_params:
        raise ApiTypeError(
          "Got an unexpected keyword argument '%s'"
          ' to method search_invoices' % _key
        )
      _params[_key] = _val
    del _params['kwargs']
    ...
    # process the body parameter
    _body_params = None
    if _params['search_invoice_request'] is not None:
      _body_params = _params['search_invoice_request']
  ...
  @validate_arguments
  def update_invoice(
    self, invoice_id: Annotated[StrictStr,
                                Field(..., description='Unique identifier of the invoice.')],
    update_invoice_request: UpdateInvoiceRequest, **kwargs
  ) -> InvoiceExternal:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.update_invoice_with_http_info(
      invoice_id, update_invoice_request, **kwargs
    )  # noqa: E501
  ...
  def update_invoice_with_http_info(
    ...
    _all_params = ['invoice_id', 'update_invoice_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
