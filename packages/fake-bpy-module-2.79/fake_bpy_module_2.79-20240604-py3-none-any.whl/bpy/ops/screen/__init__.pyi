...
def area_join(
    ...
    undo: bool | None = None,
    *,
    min_x: typing.Any | None = -100,
    min_y: typing.Any | None = -100,
    max_x: typing.Any | None = -100,
    max_y: typing.Any | None = -100,
):
    ...
    :type undo: bool | None
    :param min_x: X 1
    :type min_x: typing.Any | None
    :param min_y: Y 1
    :type min_y: typing.Any | None
    :param max_x: X 2
    :type max_x: typing.Any | None
    :param max_y: Y 2
    :type max_y: typing.Any | None
    """
...
def area_split(
    ...
    *,
    ...
    mouse_x: typing.Any | None = -100,
    mouse_y: typing.Any | None = -100,
):
...
def screencast(
    ...
    *,
    ...
    full: bool | typing.Any | None = True,
):
    ...
    :type full: bool | typing.Any | None
    """
