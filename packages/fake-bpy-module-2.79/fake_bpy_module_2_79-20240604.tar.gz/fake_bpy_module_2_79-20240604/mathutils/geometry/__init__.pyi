...
def barycentric_transform(
    ...
    :param tri_a1: source triangle vertex.target triangle vertex.
    :type tri_a1: collections.abc.Sequence[float] | mathutils.Vector
    :param tri_a2: source triangle vertex.target triangle vertex.
    :type tri_a2: collections.abc.Sequence[float] | mathutils.Vector
    :param tri_a3: source triangle vertex.target triangle vertex.
