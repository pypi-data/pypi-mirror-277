...
class extract_sub_sc(Operator):
    ...
    to the label space in input 1. If pin 1 is not defined, pin 0
    ...
    def _spec():
        description = """Creates a new scopings container with all the scopings corresponding
            to the label space in input 1. If pin 1 is not defined,
            pin 0 input will be copied to the output."""
        spec = Specification(
