...
class ThermalConductivityStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Thermal Conductivity step. It must be
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return thermal_conductivity_step.TkThermalConductivity(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return ThermalConductivityStep.my_description
