...
# -*- coding: utf-8 -*-
#
# thermal_conductivity_step documentation build configuration file,
...
import thermal_conductivity_step  # noqa: E402
...
project = u'SEAMM Thermal Conductivity Plug-in'
...
version = thermal_conductivity_step.__version__
# The full version, including alpha/beta/rc tags.
release = thermal_conductivity_step.__version__
...
htmlhelp_basename = 'thermal_conductivity_stepdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'thermal_conductivity_step.tex',
     u'Thermal Conductivity Step Documentation',
     u'Paul Saxe', 'manual'),
]
...
man_pages = [
    ('index', 'thermal_conductivity_step',
     u'Thermal Conductivity Step Documentation',
     [u'Paul Saxe'], 1)
]
