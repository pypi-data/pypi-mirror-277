...
class UtrBertEncoder(nn.Module):
    def __init__(self, config: UtrBertConfig):
        super().__init__()
        self.config = config
...
class UtrBertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if attention_mask is not None:
            # Apply the attention mask is (precomputed for all layers in UtrBertModel forward() function)
...
class UtrBertSelfOutput(nn.Module):
    def __init__(self, config: UtrBertConfig):
        super().__init__()
...
class UtrBertIntermediate(nn.Module):
    def __init__(self, config: UtrBertConfig):
        super().__init__()
