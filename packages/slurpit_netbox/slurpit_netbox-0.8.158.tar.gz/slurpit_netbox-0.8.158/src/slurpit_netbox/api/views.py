...
from .serializers import SlurpitPlanningSerializer, SlurpitSnapshotSerializer, SlurpitImportedDeviceSerializer, SlurpitInterfaceSerializer, SlurpitInitIPAddressSerializer, SlurpitPrefixSerializer
...
class SlurpitInterfaceView(SlurpitViewSet):
    ...
    serializer_class = SlurpitInterfaceSerializer
...
class SlurpitIPAMView(SlurpitViewSet):
    ...
    serializer_class = SlurpitInitIPAddressSerializer
...
class SlurpitPrefixView(SlurpitViewSet):
    ...
    serializer_class = SlurpitPrefixSerializer
