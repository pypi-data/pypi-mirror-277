...
class PrivateClauseOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, type_, data_sharing_type, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_629')) else
      _ods_ir.AttrBuilder.get('anonymous_629')(type_, context=_ods_context))
...
class WsloopOp(_ods_ir.OpView):
  ...
  def __init__(self, linear_vars, linear_step_vars, reduction_vars, *, reductions=None, schedule_val=None, schedule_chunk_var=None, schedule_modifier=None, simd_modifier=None, nowait=None, byref=None, ordered_val=None, order_val=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def wsloop(linear_vars, linear_step_vars, reduction_vars, *, reductions=None, schedule_val=None, schedule_chunk_var=None, schedule_modifier=None, simd_modifier=None, nowait=None, byref=None, ordered_val=None, order_val=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(WsloopOp(linear_vars=linear_vars, linear_step_vars=linear_step_vars, reduction_vars=reduction_vars, reductions=reductions, schedule_val=schedule_val, schedule_chunk_var=schedule_chunk_var, schedule_modifier=schedule_modifier, simd_modifier=simd_modifier, nowait=nowait, byref=byref, ordered_val=ordered_val, order_val=order_val, loc=loc, ip=ip))
