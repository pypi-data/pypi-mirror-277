...
class HawatApp(flask.Flask):
    ...
    def get_endpoints(self, filter_func=None):
        ...
        return {
            k: v.view_class for k, v in self.view_functions.items() if
            hasattr(v, 'view_class') and filter_func(k, v.view_class)
        }
    ...
    def _setup_app_core(self):
        ...
        def jinja_inject_variables():  # pylint: disable=locally-disabled,unused-variable
            ...
            return {
                ...
                "hawat_chart_dimensions": hawat.chart_const.CHART_CSS_DIMENSIONS,
                "hawat_table_aggregations": hawat.chart_const.TABLE_AGGREGATIONS,
                "hawat_color_list": hawat.chart_const.COLOR_LIST
            }
        ...
        def jinja2_inject_functions():  # pylint: disable=locally-disabled,unused-variable,too-many-locals
            ...
            def get_endpoints_dict():
                ...
                """
                return {k: v.view_class for k, v in flask.current_app.view_functions.items() if
                        hasattr(v, 'view_class')}
        ...
        def to_pretty_json(value):  # pylint: disable=locally-disabled,unused-variable
            return json.dumps(
                ...
                sort_keys=True,
                indent=4,
                cls=HawatJSONEncoder
            )

        class HawatJSONEncoder(flask.json.JSONEncoder):  # pylint: disable=locally-disabled,too-few-public-methods
            """
            Custom JSON encoder for converting anything into JSON strings.
            """

            def default(self, o):  # pylint: disable=locally-disabled,method-hidden,arguments-differ
                try:
