...
class RrdStats:
    ...
    def _json_dump(fname, data):
        ...
        """
        with open(fname, 'w', encoding="utf8") as expf:
    ...
    def prepare_db(self, ds_id, time_start = None):
        ...
        try:
            ...
            raise RrdsCreateException("Unable to create RRD database '{}' in file '{}': {}".format(ds_id, rrddb, str(exc))) from exc
    ...
    def update(self, ds_id, value, tst = None):
        ...
        try:
            ...
            raise RrdsUpdateException("Unable to update RRD database '{}' in file '{}' with value '{}' and timestamp '{}': {}"
                                      .format(ds_id, rrddb, value, str(tst), str(exc))) from exc
    ...
    def export(self, ds_id):
        ...
        try:
            result = rrdtool.xport(
                ...
                'CDEF:{feed_id}_r={feed_id},300,*'.format(feed_id=FEED_ID),
            ...
            raise RrdsExportException("Unable to export RRD database '{}' in file '{}': {}"
                                      .format(ds_id, rrddb, str(exc))) from exc
