...
@dataclass
class Guild:
    _info_data: InitVar[Dict | None] = None
    _member_data: InitVar[Dict | None] = None
    guild_id: int = 0
    name: str = None
    ...
    def __post_init__(self, _info_data: dict, _member_data: dict):
        ...
        self.creation_date = datetime.fromtimestamp(self.creation_date_raw).strftime("%I:%M %p on %B %d, %Y")
