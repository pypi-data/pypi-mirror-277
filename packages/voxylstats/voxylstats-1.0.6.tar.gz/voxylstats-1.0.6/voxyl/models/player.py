...
@dataclass
class VoxylPlayer:
    _gen_data: InitVar[Dict | None] = None
    _over_data: InitVar[Dict | None] = None
    _game_data: InitVar[Dict | None] = None
    _guild_data: InitVar[Dict | None] = None
    _ach_data: InitVar[List | None] = None
    uuid: str = None
    name: str = None
