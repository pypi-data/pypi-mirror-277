...
setup(
    ...
    name='javascript_fixes',  # Required
    ...
    url='https://github.com/omkarcloud/botasaurus',  # Optional
    ...
    # larger catalog.
    keywords='node, javascript, bridge, development',  # Optional
