...
@_convert_sys_argv_
def build(path:str='.', config:str='config.ini', file:str='', query:list=[], preprocess:list=[], postprocess:list=[], delete_all:list=[], separator:str=';',
            ...
            no_duplicates:bool=False, allow_blanks:bool=False, batch:int=0, auth:bool=False, order:str='qnrc', primary_property:str='', required_labels:list=[],
            required_properties:list=[], database:str='0', verify:bool=False, summarise:bool=False, show_queries:bool=False, show_returns:bool=False, 
            write_queries:str='', write_returns:str='', display_rate='auto', create_node_csv_file:bool=False, node_labels:list=[], node_properties:list=[],
    ...
    """The main model builder tools, features a suite of options that allow for importing, exporting, building and updating neo4j data models
        ...
        Args:
            ...
            allow_blanks: Update a property even if it is blank
