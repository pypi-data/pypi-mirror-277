...
class AnneInfo:
    ...
    def getName(self):
        ...
        try:
            if self.country in self.name_list:
                first_names = self.name_list[self.country][0]
                last_names = self.name_list[self.country][1]
    ...
    def getInfo(self,
        ...
        try:
            ...
            # Email
            email = self.getEmail(name_data["first_name"], name_data["last_name"], username_custom, domain)
            data["email"] = email["email"]

            # Password
            password = self.getPassword(password_space, password_custom)
