...
class AnneCaptcha:
    ...
    def rockcaptcha(self, api_key=None, mode='microsoft', proxy=None, timeout=60):
        try:
            ...
            if mode == 'check':
                ...
                params = {'apikey': api_key, 'sitekey': 'B7D8911C-5CC8-A9A3-35B0-554ACEE604DA', 'siteurl': 'https://signup.live.com', 'affiliateid': '37007', 'proxy': proxy}
    ...
    def ezcaptcha(self, api_key=None, mode='microsoft', proxy=None, timeout=60):
        try:
            ...
            if mode == 'check':
                ...
                params = {'clientKey': api_key, 'appId': '40523', 'task': {'websiteURL': 'https://signup.live.com', 'websiteKey': 'B7D8911C-5CC8-A9A3-35B0-554ACEE604DA', 'type': 'FuncaptchaTaskProxyless', 'proxy': proxy}}
