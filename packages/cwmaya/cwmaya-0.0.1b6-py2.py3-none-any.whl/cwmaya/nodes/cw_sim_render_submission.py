...
class cwSimRenderSubmission(cwSubmission):
    ...
    def initialize(cls):
        ...
        cls.aSceneAsset = cls.makeStringAttribute(
            "sceneAsset", "sas", usedAsFilename=True
        )
        om.MPxNode.addAttribute(cls.aSceneAsset)
        om.MPxNode.attributeAffects(cls.aSceneAsset, cls.aOutput)
