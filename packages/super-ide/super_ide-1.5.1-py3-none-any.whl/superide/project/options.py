...
from superide.compat import IS_WINDOWS, hashlib_encode_data
...
def ConfigPlatformioOption(*args, **kwargs):
    return ConfigOption("superide", *args, **kwargs)
...
def get_default_core_dir():
    path = os.path.join(fs.expanduser("~"), ".superide")
    if IS_WINDOWS:
        win_core_dir = os.path.splitdrive(path)[0] + "\\.superide"
    ...
    [
        ...
        for option in [
            ...
            ConfigPlatformioOption(
                ...
                name="default_envs",
                description=(
                    "Configure a list with environments which superide should "
                    "process by default"
                ),
            ...
            ConfigPlatformioOption(
                ...
                name="core_dir",
                description=(
                    "superide Core location where it keeps installed development "
            ...
            ConfigPlatformioOption(
                ...
                name="globallib_dir",
                description=(
                    "A library folder/storage where superide Library Dependency "
                    "Finder (LDF) looks for global libraries"
                ),
                sysenvvar="PLATFORMIO_GLOBALLIB_DIR",
                default=os.path.join("${superide.core_dir}", "lib"),
                validate=validate_dir,
            ),
            ConfigPlatformioOption(
                group="directory",
                name="platforms_dir",
                description=(
                    "A location where superide Core keeps installed development "
                    "platforms"
                ),
                sysenvvar="PLATFORMIO_PLATFORMS_DIR",
                default=os.path.join("${superide.core_dir}", "platforms"),
                validate=validate_dir,
            ),
            ConfigPlatformioOption(
                group="directory",
                name="packages_dir",
                description=(
                    "A location where superide Core keeps installed packages"
                ),
                sysenvvar="PLATFORMIO_PACKAGES_DIR",
                default=os.path.join("${superide.core_dir}", "packages"),
                validate=validate_dir,
            ),
            ConfigPlatformioOption(
                group="directory",
                name="cache_dir",
                description=(
                    "A location where superide Core stores caching information "
                    "(requests to superide Registry, downloaded packages and "
                    "other service information)"
                ),
                sysenvvar="PLATFORMIO_CACHE_DIR",
                default=os.path.join("${superide.core_dir}", ".cache"),
                validate=validate_dir,
            ),
            ConfigPlatformioOption(
                group="directory",
                ...
                description=(
                    "A location where superide Core keeps derived files from a "
            ...
            ConfigPlatformioOption(
                ...
                name="workspace_dir",
                description=(
                    "A path to a project workspace directory where superide keeps "
            ...
            ConfigPlatformioOption(
                ...
                default=os.path.join("${superide.workspace_dir}", "libdeps"),
                validate=validate_dir,
            ),
            ConfigPlatformioOption(
                group="directory",
                name="include_dir",
                description=(
                    "A default location for project header files. superide Build "
            ...
            ConfigPlatformioOption(
                ...
                name="src_dir",
                description=(
                    "A default location where superide Build System looks for the "
            ...
            ConfigPlatformioOption(
                ...
                name="test_dir",
                description=(
                    "A location where superide Unit Testing engine looks for "
                    "test source files"
                ),
            ...
            ConfigPlatformioOption(
                ...
                name="shared_dir",
                description=(
                    "A location which superide Remote Development service uses to "
            ...
            ConfigEnvOption(
                group="build",
                name="targets",
                description="A custom list of targets for superide Build System",
                multiple=True,
            ),
            # Upload
            ConfigEnvOption(
            ...
            ConfigEnvOption(
                ...
                description=(
                    "Allows one to control when superide should load debugging "
