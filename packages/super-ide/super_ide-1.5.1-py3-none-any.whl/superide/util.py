...
from superide import __version__

# pylint: disable=unused-import
# from superide.device.list.util import list_serial_ports as get_serial_ports
from superide.fs import cd, load_json
...
def pioversion_to_intstr():
    """Legacy for  framework-zephyr/scripts/superide/superide-build-pre.py"""
