...
class GPUFrameBuffer:
    ...
    def read_depth(self, x: int, y, xsize, ysize, data: Buffer | None = None) -> Buffer:
    ...
    def viewport_set(self, x: int, y, xsize, ysize):
...
class GPUShaderCreateInfo:
    ...
    def fragment_source(self, source: str):
        """Fragment shader source code written in GLSL.Example:`GLSL Cross Compilation <https://wiki.blender.org/wiki/EEVEE_%26_Viewport/GPU_Module/GLSL_Cross_Compilation>`__
    ...
    def vertex_source(self, source: str):
        """Vertex shader source code written in GLSL.Example:`GLSL Cross Compilation <https://wiki.blender.org/wiki/EEVEE_%26_Viewport/GPU_Module/GLSL_Cross_Compilation>`__
...
class GPUTexture:
    ...
    def clear(self, format="FLOAT", value=(0.0, 0.0, 0.0, 1.0)):
