...
def bend(
    ...
    *,
    ...
    use_snap_selectable_only: bool | typing.Any | None = False,
    use_snap_to_same_target: bool | typing.Any | None = False,
    snap_face_nearest_steps: typing.Any | None = 1,
    ...
    :type use_snap_selectable_only: bool | typing.Any | None
    :param use_snap_to_same_target: Snap to Same Target
    :type use_snap_to_same_target: bool | typing.Any | None
    :param snap_face_nearest_steps: Face Nearest Steps
    :type snap_face_nearest_steps: typing.Any | None
