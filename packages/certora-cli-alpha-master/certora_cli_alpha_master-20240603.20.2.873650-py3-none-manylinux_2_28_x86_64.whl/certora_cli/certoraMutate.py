...
class IncompleteCollectFile(Util.CertoraUserInputError):
    pass
...
def run_mutate_collect(mutate_app: App.MutateApp) -> None:
    ...
    if not ready:
        raise Util.IncompleteCollectFile("The report might broken because some results could not be fetched. "
