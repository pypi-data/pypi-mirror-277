# -*- coding: utf-8 -*-
#
# FRETBursts documentation build configuration file, created by
# sphinx-quickstart on Mon Mar 10 15:05:39 2014.
#
...
project = u'FRETBursts'
import time
copyright = u'2013-{}, The Regents of the University of California, Antonino Ingargiola and contributors.'.format(time.strftime("%Y"))
...
htmlhelp_basename = 'FRETBurstsdoc'
...
latex_documents = [
  ('index', 'FRETBursts.tex', u'FRETBursts Documentation',
   u'Antonino Ingargiola', 'manual'),
]
...
man_pages = [
    ('index', 'fretbursts', u'FRETBursts Documentation',
     [u'Antonino Ingargiola'], 1)
]
...
texinfo_documents = [
  ('index', 'FRETBursts', u'FRETBursts Documentation',
   u'Antonino Ingargiola', 'FRETBursts', 'One line description of project.',
   'Miscellaneous'),
]
