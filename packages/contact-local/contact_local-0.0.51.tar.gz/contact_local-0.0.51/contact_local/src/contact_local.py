    ...
    def __get_data_dict_compare_for_upsert_contact_dict(self, contact_dict: dict) -> MultiDict:
        ...
        if len(data_dict_compare) == 0:
            if contact_dict.get('website1'):
                ...
                data_dict_compare.add('website1', website1)
                data_dict_compare.add('website1', normalized_website1)
            elif contact_dict.get('first_name'):
                data_dict_compare.add('first_name', contact_dict.get('first_name'))
                if contact_dict.get('last_name'):
                    data_dict_compare.add('last_name', contact_dict.get('last_name'))
        ...
        if contact_dict.get("resource_name"):
            ...
            if data_source_type_id == contact_dict.get("data_source_type_id"):
                contact_id = self.select_one_value_by_column_and_value(
                    schema_name="importer", view_table_name="importer_view",
