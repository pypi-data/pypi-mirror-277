...
class OrderFillEventV1(_message.Message):
    __slots__ = ("maker_order", "order", "liquidation_order", "fill_amount", "maker_fee", "taker_fee", "total_filled_maker", "total_filled_taker")
...
class StatefulOrderEventV1(_message.Message):
    __slots__ = ("order_place", "order_removal", "conditional_order_placement", "conditional_order_triggered", "long_term_order_placement", "order_replace")
    ...
    order_replace: StatefulOrderEventV1.LongTermOrderReplacementV1
    def __init__(self, order_place: _Optional[_Union[StatefulOrderEventV1.StatefulOrderPlacementV1, _Mapping]] = ..., order_removal: _Optional[_Union[StatefulOrderEventV1.StatefulOrderRemovalV1, _Mapping]] = ..., conditional_order_placement: _Optional[_Union[StatefulOrderEventV1.ConditionalOrderPlacementV1, _Mapping]] = ..., conditional_order_triggered: _Optional[_Union[StatefulOrderEventV1.ConditionalOrderTriggeredV1, _Mapping]] = ..., long_term_order_placement: _Optional[_Union[StatefulOrderEventV1.LongTermOrderPlacementV1, _Mapping]] = ..., order_replace: _Optional[_Union[StatefulOrderEventV1.LongTermOrderReplacementV1, _Mapping]] = ...) -> None: ...
