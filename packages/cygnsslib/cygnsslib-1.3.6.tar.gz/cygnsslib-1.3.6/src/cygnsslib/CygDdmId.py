...
L1_OCEAN_FOLDER = "v3.1"


def get_sample_id_of_different_cyg_version(in_cygddmid, new_version, original_cyg_ver=None):
    """
    ...
    dis_ver_cygddmid = CygDdmId(cyg_dis_ver_file_name, in_cygddmid.year, in_cygddmid.day, in_cygddmid.sc_num, in_cygddmid.ch_id, dis_ver_sample_id)
...
def find_cygnss_file(data_year, data_day, sc_num, cygnss_l1_path=None, using_cyg_rawif_data=False, rawif_sampling_rate=None):
    """
...
class CygDdmId:
    ...
    def fill_file_name(self, cygnss_l1_path=None, using_cyg_rawif_data=False, rawif_sampling_rate=None):
        ...
        :return:
        """
        self.file_name = find_cygnss_file(self.year, self.day, self.sc_num, cygnss_l1_path, using_cyg_rawif_data, rawif_sampling_rate)
