...
class GenericMLTrainParametersProto(_message.Message):
    __slots__ = ("model_type", "layers", "num_epochs", "batch_size", "learning_rate", "optim", "loss_func", "train_model_info", "data_processing_parameters", "k_fold")
