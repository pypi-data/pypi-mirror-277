...
class UpdateFlcPolicy(object):
    ...
    def __init__(self, display_name=None, file_selection_criteria=None, lc_action=None, enabled=None, dry_run=None, use_recycle_bin=None, whitelist_paths=None, blacklist_paths=None, dest_obs_name=None, _configuration=None):  # noqa: E501
        """UpdateFlcPolicy - a model defined in Swagger"""  # noqa: E501
    ...
    def display_name(self):
        """Gets the display_name of this UpdateFlcPolicy.  # noqa: E501

        Policy name.  # noqa: E501

        :return: The display_name of this UpdateFlcPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this UpdateFlcPolicy.

        Policy name.  # noqa: E501

        :param display_name: The display_name of this UpdateFlcPolicy.  # noqa: E501
        :type: str
        """
    ...
    def file_selection_criteria(self):
        """Gets the file_selection_criteria of this UpdateFlcPolicy.  # noqa: E501

        The criteria by which the policy files will be selected. Should be in a MongoDB $match aggregation format.  # noqa: E501

        :return: The file_selection_criteria of this UpdateFlcPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def file_selection_criteria(self, file_selection_criteria):
        """Sets the file_selection_criteria of this UpdateFlcPolicy.

        The criteria by which the policy files will be selected. Should be in a MongoDB $match aggregation format.  # noqa: E501

        :param file_selection_criteria: The file_selection_criteria of this UpdateFlcPolicy.  # noqa: E501
        :type: str
        """
    ...
    @property
    def lc_action(self):
        """Gets the lc_action of this UpdateFlcPolicy.  # noqa: E501

        The action that the policy performs on the selected files.  # noqa: E501

        :return: The lc_action of this UpdateFlcPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def lc_action(self, lc_action):
        """Sets the lc_action of this UpdateFlcPolicy.

        The action that the policy performs on the selected files.  # noqa: E501

        :param lc_action: The lc_action of this UpdateFlcPolicy.  # noqa: E501
        :type: str
        """
    ...
    @property
    def enabled(self):
        """Gets the enabled of this UpdateFlcPolicy.  # noqa: E501

        Controls enablement of the policy after it is created.  # noqa: E501

        :return: The enabled of this UpdateFlcPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this UpdateFlcPolicy.

        Controls enablement of the policy after it is created.  # noqa: E501

        :param enabled: The enabled of this UpdateFlcPolicy.  # noqa: E501
        :type: str
        """
    ...
    def dry_run(self, dry_run):
        """Sets the dry_run of this UpdateFlcPolicy.

        When the policy is in dry run mode, it'll only print its actions to the log instead of actually performing them.  # noqa: E501

        :param dry_run: The dry_run of this UpdateFlcPolicy.  # noqa: E501
        :type: str
        """
        allowed_values = ["YES", "NO"]  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def use_recycle_bin(self):
        """Gets the use_recycle_bin of this UpdateFlcPolicy.  # noqa: E501

        When using recycle bin, files that are handled by the policy are also copied to the recycle bin.  # noqa: E501

        :return: The use_recycle_bin of this UpdateFlcPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def use_recycle_bin(self, use_recycle_bin):
        """Sets the use_recycle_bin of this UpdateFlcPolicy.

        When using recycle bin, files that are handled by the policy are also copied to the recycle bin.  # noqa: E501

        :param use_recycle_bin: The use_recycle_bin of this UpdateFlcPolicy.  # noqa: E501
        :type: str
        """
        allowed_values = ["YES", "NO"]  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def whitelist_paths(self):
        """Gets the whitelist_paths of this UpdateFlcPolicy.  # noqa: E501

        Comma delimited list of paths that the policy should only run on them.  # noqa: E501

        :return: The whitelist_paths of this UpdateFlcPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def whitelist_paths(self, whitelist_paths):
        """Sets the whitelist_paths of this UpdateFlcPolicy.

        Comma delimited list of paths that the policy should only run on them.  # noqa: E501

        :param whitelist_paths: The whitelist_paths of this UpdateFlcPolicy.  # noqa: E501
        :type: str
        """
    ...
    def blacklist_paths(self):
        """Gets the blacklist_paths of this UpdateFlcPolicy.  # noqa: E501

        Comma delimited list of paths that the policy should not run on.  # noqa: E501

        :return: The blacklist_paths of this UpdateFlcPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def blacklist_paths(self, blacklist_paths):
        """Sets the blacklist_paths of this UpdateFlcPolicy.

        Comma delimited list of paths that the policy should not run on.  # noqa: E501

        :param blacklist_paths: The blacklist_paths of this UpdateFlcPolicy.  # noqa: E501
        :type: str
        """
    ...
    def dest_obs_name(self):
        """Gets the dest_obs_name of this UpdateFlcPolicy.  # noqa: E501

        Destination object storage to archive files to.  # noqa: E501

        :return: The dest_obs_name of this UpdateFlcPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def dest_obs_name(self, dest_obs_name):
        """Sets the dest_obs_name of this UpdateFlcPolicy.

        Destination object storage to archive files to.  # noqa: E501

        :param dest_obs_name: The dest_obs_name of this UpdateFlcPolicy.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateFlcPolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateFlcPolicy):
            return False
