...
class PricesApi(object):
    ...
    def get_prices(self, **kwargs):  # noqa: E501
        """get_prices  # noqa: E501

        Get the list of prices for all providers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_prices(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_prices_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_prices_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_prices_with_http_info(self, **kwargs):  # noqa: E501
        """get_prices  # noqa: E501

        Get the list of prices for all providers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_prices_with_http_info(async_req=True)
        >>> result = thread.get()
