...
class AccessLogsApi(object):
    ...
    def list_logs(self, **kwargs):  # noqa: E501
        ...
        :param int user_id:
        :param str controller: controller that handles the action
        :param str access_type: where the access came from. Can be Web or API
        :param str action: the action executed
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.list_logs_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def list_logs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'per_page', 'user_id', 'controller', 'access_type', 'action']  # noqa: E501
        ...
        if 'controller' in params:
            query_params.append(('controller', params['controller']))  # noqa: E501
