...
class AddNewUser(object):
    ...
    def __init__(self, username=None, email=None, account_id=None, notify_on_events=None, role=None, _configuration=None):  # noqa: E501
        """AddNewUser - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def username(self):
        """Gets the username of this AddNewUser.  # noqa: E501

        The new username  # noqa: E501

        :return: The username of this AddNewUser.  # noqa: E501
        :rtype: str
        """
    ...
    def username(self, username):
        """Sets the username of this AddNewUser.

        The new username  # noqa: E501

        :param username: The username of this AddNewUser.  # noqa: E501
        :type: str
        """
    ...
    @property
    def email(self):
        """Gets the email of this AddNewUser.  # noqa: E501

        The new user email  # noqa: E501

        :return: The email of this AddNewUser.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this AddNewUser.

        The new user email  # noqa: E501

        :param email: The email of this AddNewUser.  # noqa: E501
        :type: str
        """
    ...
    @property
    def account_id(self):
        """Gets the account_id of this AddNewUser.  # noqa: E501

        Account ID  # noqa: E501

        :return: The account_id of this AddNewUser.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this AddNewUser.

        Account ID  # noqa: E501

        :param account_id: The account_id of this AddNewUser.  # noqa: E501
        :type: str
        """
    ...
    def notify_on_events(self):
        """Gets the notify_on_events of this AddNewUser.  # noqa: E501

        Notify the user on system events  # noqa: E501

        :return: The notify_on_events of this AddNewUser.  # noqa: E501
        :rtype: str
        """
    ...
    def notify_on_events(self, notify_on_events):
        """Sets the notify_on_events of this AddNewUser.

        Notify the user on system events  # noqa: E501

        :param notify_on_events: The notify_on_events of this AddNewUser.  # noqa: E501
        :type: str
        """
        allowed_values = ["YES", "NO"]  # noqa: E501
        if (self._configuration.client_side_validation and
                notify_on_events not in allowed_values):
            raise ValueError(
                "Invalid value for `notify_on_events` ({0}), must be one of {1}"  # noqa: E501
                .format(notify_on_events, allowed_values)
            )
    ...
    @property
    def role(self):
        """Gets the role of this AddNewUser.  # noqa: E501

        User role in account  # noqa: E501

        :return: The role of this AddNewUser.  # noqa: E501
        :rtype: str
        """
        return self._role
    ...
    @role.setter
    def role(self, role):
        """Sets the role of this AddNewUser.

        User role in account  # noqa: E501

        :param role: The role of this AddNewUser.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and role is None:
            raise ValueError("Invalid value for `role`, must not be `None`")  # noqa: E501
        allowed_values = ["zios_admin", "account_admin", "member"]  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddNewUser):
            return False
