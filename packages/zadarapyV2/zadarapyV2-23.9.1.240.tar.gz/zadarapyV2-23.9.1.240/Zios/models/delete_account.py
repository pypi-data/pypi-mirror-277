...
class DeleteAccount(object):
    ...
    def __init__(self, force=None, _configuration=None):  # noqa: E501
        """DeleteAccount - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def force(self):
        """Gets the force of this DeleteAccount.  # noqa: E501

        force a deletion  # noqa: E501

        :return: The force of this DeleteAccount.  # noqa: E501
        :rtype: str
        """
        return self._force
    ...
    def force(self, force):
        """Sets the force of this DeleteAccount.

        force a deletion  # noqa: E501

        :param force: The force of this DeleteAccount.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and force is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeleteAccount, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteAccount):
            return False
