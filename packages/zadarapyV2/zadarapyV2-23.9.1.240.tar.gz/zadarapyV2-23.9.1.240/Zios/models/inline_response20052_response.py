...
class InlineResponse20052Response(object):
    ...
    swagger_types = {
        'message': 'str',
        'status': 'int',
        'user': 'InlineResponse20052ResponseUser'
    }
    ...
    @property
    def user(self):
        """Gets the user of this InlineResponse20052Response.  # noqa: E501


        :return: The user of this InlineResponse20052Response.  # noqa: E501
        :rtype: InlineResponse20052ResponseUser
        """
        return self._user

    @user.setter
    def user(self, user):
        """Sets the user of this InlineResponse20052Response.


        :param user: The user of this InlineResponse20052Response.  # noqa: E501
        :type: InlineResponse20052ResponseUser
        """
