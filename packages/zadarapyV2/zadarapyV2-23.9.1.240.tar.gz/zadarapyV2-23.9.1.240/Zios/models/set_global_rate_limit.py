...
class SetGlobalRateLimit(object):
    ...
    def __init__(self, enabled=None, global_rate_limit=None, _configuration=None):  # noqa: E501
        """SetGlobalRateLimit - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def enabled(self):
        """Gets the enabled of this SetGlobalRateLimit.  # noqa: E501


        :return: The enabled of this SetGlobalRateLimit.  # noqa: E501
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this SetGlobalRateLimit.


        :param enabled: The enabled of this SetGlobalRateLimit.  # noqa: E501
        :type: bool
        """
    ...
    def global_rate_limit(self):
        """Gets the global_rate_limit of this SetGlobalRateLimit.  # noqa: E501

        Limit object account operations (PUT/POST/DELETE/COPY) per second, this setting will be applied for all accounts and can be overridden for specific account.  # noqa: E501

        :return: The global_rate_limit of this SetGlobalRateLimit.  # noqa: E501
        :rtype: int
        """
    ...
    def global_rate_limit(self, global_rate_limit):
        """Sets the global_rate_limit of this SetGlobalRateLimit.

        Limit object account operations (PUT/POST/DELETE/COPY) per second, this setting will be applied for all accounts and can be overridden for specific account.  # noqa: E501

        :param global_rate_limit: The global_rate_limit of this SetGlobalRateLimit.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SetGlobalRateLimit, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetGlobalRateLimit):
            return False
