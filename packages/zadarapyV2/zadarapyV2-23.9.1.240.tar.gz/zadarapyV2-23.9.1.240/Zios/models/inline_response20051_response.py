...
class InlineResponse20051Response(object):
    ...
    swagger_types = {
        'message': 'str',
        'user': 'InlineResponse20051ResponseUser',
        'status': 'int'
    }
    ...
    @property
    def user(self):
        """Gets the user of this InlineResponse20051Response.  # noqa: E501


        :return: The user of this InlineResponse20051Response.  # noqa: E501
        :rtype: InlineResponse20051ResponseUser
        """
        return self._user

    @user.setter
    def user(self, user):
        """Sets the user of this InlineResponse20051Response.


        :param user: The user of this InlineResponse20051Response.  # noqa: E501
        :type: InlineResponse20051ResponseUser
        """
