...
class TestObjectStorageDestinationsApi(unittest.TestCase):
    ...
    def test_get_ros_destinations_from_account(self):
        """Test case for get_ros_destinations_from_account

        """
        pass

    def test_update_object_storage_destination(self):
        """Test case for update_object_storage_destination
