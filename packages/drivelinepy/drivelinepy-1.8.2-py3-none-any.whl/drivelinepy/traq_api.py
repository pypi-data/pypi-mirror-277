...
class TRAQAPI(BaseAPIWrapper):
    ...
    def get_users(self, traq_id=None, email=None, status_code=None, substatus_code=None, facility_id=None):
        ...
        if status_code:
            ...
            self.logger.error("Status code filter was not provided")
        
        # Add substatus_code to params if provided -- traq naming convention is a bit wonky her because "status" is actually the substatus_code
        if substatus_code:
            ...
            self.logger.error("Substatus code filter was not provided")

        if not params:
            self.logger.error("No valid filters were provided")
            return None
    ...
    def get_workouts(self, program):
        ...
        """
        self.logger.info("Entering get_workouts()")
        ...
        self.logger.info("Exiting get_workouts()")
        return response.get('data') if response else None
    ...
    def get_athlete_workouts(self, traq_id, start_date, end_date):
        ...
        """
        self.logger.info("Entering get_athlete_workouts()")
