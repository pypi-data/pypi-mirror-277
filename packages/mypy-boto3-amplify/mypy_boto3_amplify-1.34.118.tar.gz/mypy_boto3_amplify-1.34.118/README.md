...
[boto3.Amplify 1.34.118](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/amplify.html#Amplify)
...
def check_value(value: CertificateTypeType) -> bool: ...
```
