...
try:
    from python.vdaq_ana.AliVATAModule import AliVATAModule, ModuleDataIterator
...
class VDaqData(object):
    ...
    def create_iterator_at_time(self, T, mod_ids=None):
        ...
        """
        mod_iter = []
        mids = self.check_module_lists(mod_ids)
