...
def test_create_pedido_centro_de_custo():
    with open("./devdata/json/expected_pedido_servico_centro_de_custo_GHN-1089.json", "r", encoding="utf-8") as nota_pedido_arquivo_json: nota_pedido = json.load(nota_pedido_arquivo_json)
    data = {
