...
class NotaPedidoTransaction:
    ...
    def execute(self, sapGuiLib, nota_pedido):
        ...
        if sbar_extracted_text(MSG_SAP_FORNECEDOR_NAO_CRIADO, msg) != None:
        ...
        for index, sintese_item in enumerate(nota_pedido['sintese_itens']):
            ...
            if item['centro_custo'] is not None:
                ...
                sapGuiLib.session.findById(f"{id_gui_detalhes}/subSUB3:SAPLMEVIEWS:1100/subSUB2:SAPLMEVIEWS:1200/subSUB1:SAPLMEGUI:1301/subSUB2:SAPLMEGUI:1303/tabsITEM_DETAIL/tabpTABIDT1/ssubTABSTRIPCONTROL1SUB:SAPLMEGUI:1328/subSUB0:SAPLMLSP:0400/tblSAPLMLSPTC_VIEW/txtESLL-MENGE[3,{index}]").Text = item['quantidade']  # (Quantidade)
                sapGuiLib.session.findById(f"{id_gui_detalhes}/subSUB3:SAPLMEVIEWS:1100/subSUB2:SAPLMEVIEWS:1200/subSUB1:SAPLMEGUI:1301/subSUB2:SAPLMEGUI:1303/tabsITEM_DETAIL/tabpTABIDT1/ssubTABSTRIPCONTROL1SUB:SAPLMEGUI:1328/subSUB0:SAPLMLSP:0400/tblSAPLMLSPTC_VIEW/txtESLL-TBTWR[4,{index}]").Text = item['valor_bruto'] # (Preço bruto)
            ...
            if sbar_extracted_text(MSG_ORDEM_BLOQUEADA, msg) != None:
                raise HntSapException(msg)
