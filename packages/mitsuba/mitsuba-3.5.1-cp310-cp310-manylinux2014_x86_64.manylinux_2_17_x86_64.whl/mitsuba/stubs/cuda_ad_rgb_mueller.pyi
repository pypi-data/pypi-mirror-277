...
@overload
def absorber(value: mitsuba.Float) -> mitsuba.Matrix4f:
    """
...
@overload
def absorber(value: mitsuba.cuda_ad_rgb.Color3f):
    """
    Constructs the Mueller matrix of an ideal absorber
...
@overload
def depolarizer(value: mitsuba.Float = 1.0) -> mitsuba.Matrix4f:
    """
...
@overload
def depolarizer(value: mitsuba.cuda_ad_rgb.Color3f = 1.0):
    """
    Constructs the Mueller matrix of an ideal depolarizer
...
@overload
def diattenuator(x: mitsuba.Float, y: mitsuba.Float) -> mitsuba.Matrix4f:
    """
...
@overload
def diattenuator(x: mitsuba.cuda_ad_rgb.Color3f, y: mitsuba.cuda_ad_rgb.Color3f):
    """
    Constructs the Mueller matrix of a linear diattenuator, which
    attenuates the electric field components at 0 and 90 degrees by 'x'
    and 'y', * respectively.
...
@overload
def linear_polarizer(value: mitsuba.Float = 1.0) -> mitsuba.Matrix4f:
    """
...
@overload
def linear_polarizer(value: mitsuba.cuda_ad_rgb.Color3f = 1.0):
    """
    Constructs the Mueller matrix of a linear polarizer which transmits
    linear polarization at 0 degrees.
...
@overload
def linear_retarder(phase: mitsuba.Float) -> mitsuba.Matrix4f:
    """
...
@overload
def linear_retarder(phase: mitsuba.cuda_ad_rgb.Color3f):
    """
    Constructs the Mueller matrix of a linear retarder which has its fast
    axis aligned horizontally.
...
@overload
def rotate_mueller_basis(M: mitsuba.Matrix4f, in_forward: mitsuba.cuda_ad_rgb.Vector3f, in_basis_current: mitsuba.cuda_ad_rgb.Vector3f, in_basis_target: mitsuba.cuda_ad_rgb.Vector3f, out_forward: mitsuba.cuda_ad_rgb.Vector3f, out_basis_current: mitsuba.cuda_ad_rgb.Vector3f, out_basis_target: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.Matrix4f:
    """
...
@overload
def rotate_mueller_basis(M, in_forward: mitsuba.cuda_ad_rgb.Vector3f, in_basis_current: mitsuba.cuda_ad_rgb.Vector3f, in_basis_target: mitsuba.cuda_ad_rgb.Vector3f, out_forward: mitsuba.cuda_ad_rgb.Vector3f, out_basis_current: mitsuba.cuda_ad_rgb.Vector3f, out_basis_target: mitsuba.cuda_ad_rgb.Vector3f):
    """
    Return the Mueller matrix for some new reference frames. This version
    rotates the input/output frames independently.
...
@overload
def rotate_mueller_basis_collinear(M: mitsuba.Matrix4f, forward: mitsuba.cuda_ad_rgb.Vector3f, basis_current: mitsuba.cuda_ad_rgb.Vector3f, basis_target: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.Matrix4f:
    """
    Return the Mueller matrix for some new reference frames. This version
...
@overload
def rotate_mueller_basis_collinear(M, forward: mitsuba.cuda_ad_rgb.Vector3f, basis_current: mitsuba.cuda_ad_rgb.Vector3f, basis_target: mitsuba.cuda_ad_rgb.Vector3f):
    """
    Return the Mueller matrix for some new reference frames. This version
    applies the same rotation to the input/output frames.
...
def rotate_stokes_basis(wi: mitsuba.cuda_ad_rgb.Vector3f, basis_current: mitsuba.cuda_ad_rgb.Vector3f, basis_target: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.Matrix4f:
    """
...
def rotate_stokes_basis_m(wi: mitsuba.cuda_ad_rgb.Vector3f, basis_current: mitsuba.cuda_ad_rgb.Vector3f, basis_target: mitsuba.cuda_ad_rgb.Vector3f):
    """
    Gives the Mueller matrix that aligns the reference frames (defined by
    their respective basis vectors) of two collinear stokes vectors.
...
@overload
def rotated_element(theta: mitsuba.Float, M: mitsuba.Matrix4f) -> mitsuba.Matrix4f:
    """
...
@overload
def rotated_element(theta: mitsuba.cuda_ad_rgb.Color3f, M):
    """
    Applies a counter-clockwise rotation to the mueller matrix of a given
    element.
    """
...
@overload
def rotator(theta: mitsuba.Float) -> mitsuba.Matrix4f:
    """
...
@overload
def rotator(theta: mitsuba.cuda_ad_rgb.Color3f):
    """
    Constructs the Mueller matrix of an ideal rotator, which performs a
    counter-clockwise rotation of the electric field by 'theta' radians
    (when facing the light beam from the sensor side).
...
@overload
def specular_reflection(cos_theta_i: mitsuba.Float, eta: mitsuba.Complex2f) -> mitsuba.Matrix4f:
    """
...
@overload
def specular_reflection(cos_theta_i: mitsuba.cuda_ad_rgb.Color3f, eta):
    """
    Calculates the Mueller matrix of a specular reflection at an interface
    between two dielectrics or conductors.
...
@overload
def specular_transmission(cos_theta_i: mitsuba.Float, eta: mitsuba.Float) -> mitsuba.Matrix4f:
    """
...
@overload
def specular_transmission(cos_theta_i: mitsuba.cuda_ad_rgb.Color3f, eta: mitsuba.cuda_ad_rgb.Color3f):
    """
    Calculates the Mueller matrix of a specular transmission at an
    interface between two dielectrics or conductors.
...
def stokes_basis(w: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Vector3f:
    """
...
def unit_angle(a: mitsuba.cuda_ad_rgb.Vector3f, b: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.Float: ...
