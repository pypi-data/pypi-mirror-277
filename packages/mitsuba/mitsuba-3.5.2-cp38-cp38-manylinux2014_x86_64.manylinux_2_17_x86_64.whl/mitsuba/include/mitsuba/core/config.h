...
#define MI_EXTERN_STRUCT(Name)                                                  \
    ...
    MI_EXTERN_LIB template struct Name<dr::DiffArray<dr::CUDAArray<float>>, Color<dr::DiffArray<dr::CUDAArray<float>>, 3>>; \
    MI_EXTERN_LIB template struct Name<dr::DiffArray<dr::LLVMArray<float>>, Color<dr::DiffArray<dr::LLVMArray<float>>, 3>>; \
...
#define MI_EXTERN_CLASS(Name)                                                   \
    ...
    MI_EXTERN_LIB template class Name<dr::DiffArray<dr::CUDAArray<float>>, Color<dr::DiffArray<dr::CUDAArray<float>>, 3>>; \
    MI_EXTERN_LIB template class Name<dr::DiffArray<dr::LLVMArray<float>>, Color<dr::DiffArray<dr::LLVMArray<float>>, 3>>; \
...
#define MI_INSTANTIATE_STRUCT(Name)                                             \
    ...
    template struct Name<dr::DiffArray<dr::CUDAArray<float>>, Color<dr::DiffArray<dr::CUDAArray<float>>, 3>>; \
    template struct Name<dr::DiffArray<dr::LLVMArray<float>>, Color<dr::DiffArray<dr::LLVMArray<float>>, 3>>; \
...
#define MI_INSTANTIATE_CLASS(Name)                                              \
    ...
    template class Name<dr::DiffArray<dr::CUDAArray<float>>, Color<dr::DiffArray<dr::CUDAArray<float>>, 3>>; \
    template class Name<dr::DiffArray<dr::LLVMArray<float>>, Color<dr::DiffArray<dr::LLVMArray<float>>, 3>>; \
