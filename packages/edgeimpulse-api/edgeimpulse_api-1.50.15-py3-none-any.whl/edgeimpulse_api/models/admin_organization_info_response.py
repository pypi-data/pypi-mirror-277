...
class AdminOrganizationInfoResponse(BaseModel):
    ...
    total_compute_time: Optional[float] = Field(None, alias="totalComputeTime", description="Total compute time is the amount of computation time spent in jobs, in minutes used by an organization over the given period, calculated as 1 x CPU + 3 x GPU minutes.")
    ...
    __properties = ["success", "error", "cpuComputeTime", "gpuComputeTime", "totalComputeTime", "billable", "entitlementLimits", "computeTimeCurrentContractSince", "totalStorage"]
