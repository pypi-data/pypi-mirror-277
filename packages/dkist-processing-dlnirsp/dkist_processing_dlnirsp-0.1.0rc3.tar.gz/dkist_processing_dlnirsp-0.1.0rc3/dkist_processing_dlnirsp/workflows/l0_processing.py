...
l0_pipeline.add_node(task=InstrumentPolarizationCalibration, upstreams=GeometricCalibration)
...
# Movie flow
l0_pipeline.add_node(task=MakeDlnirspMovieFrames, upstreams=DlnirspWriteL1Frame)
...
l0_pipeline.add_node(task=DlnirspL1QualityMetrics, upstreams=DlnirspWriteL1Frame)
l0_pipeline.add_node(task=QualityL1Metrics, upstreams=DlnirspWriteL1Frame)
...
l0_pipeline.add_node(
    task=SubmitDatasetMetadata, upstreams=[TransferL1Data, DlnirspAssembleQualityData]
)
l0_pipeline.add_node(task=PublishCatalogAndQualityMessages, upstreams=TransferL1Data)
