...
"""
from shellev.models.around_location_array_data_items import AroundLocationArrayDataItems
...
class AroundLocationArray(object):
    ...
    Attributes:
        data (List[AroundLocationArrayDataItems]): An array of station
            objects
    ...
    def __init__(self,
                 data=None):
        """Constructor for the AroundLocationArray class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [AroundLocationArrayDataItems.from_dictionary(x) for x in dictionary.get('data')]
