...
class ReportTest(ModuleBase, unittest.TestCase):
    def setUp(self):
        ...
        self.report_01 = {
            'name': __unique_name1,
            'file_path': "{}.pdf".format(__unique_name1),
            'flg_available': True,
            'description': 'desc 01'
        }
        ...
        self.report_01_upd = {
            ...
            'file_path': "{}.pdf".format(__unique_name_upd),
            'flg_available': False,
    ...
    def test_create_report(self):
        ...
        try:
            ...
            expect_app_info = {'file_path': ['has already been taken']}
            ...
            result3 = report_01_dup.set()
            self.assert_set_success(MODULE_NAME, result3, self.report_01)
