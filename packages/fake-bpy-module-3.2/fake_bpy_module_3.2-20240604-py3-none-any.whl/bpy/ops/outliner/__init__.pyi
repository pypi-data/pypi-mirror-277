...
def id_operation(
    ...
    *,
    ...
    Make Library Override Single -- Make a single, out-of-hierarchy local override of this linked data-block - only applies to active Outliner item.

    OVERRIDE_LIBRARY_CREATE_HIERARCHY
    Make Library Override Hierarchy -- Make a local override of this linked data-block, and its hierarchy of dependencies - only applies to active Outliner item.

    OVERRIDE_LIBRARY_MAKE_EDITABLE
    Make Library Override Editable -- Make the library override data-block editable.

    OVERRIDE_LIBRARY_RESET
    Reset Library Override Single -- Reset this local override to its linked values.

    OVERRIDE_LIBRARY_RESET_HIERARCHY
    Reset Library Override Hierarchy -- Reset this local override to its linked values, as well as its hierarchy of dependencies.

    OVERRIDE_LIBRARY_RESYNC_HIERARCHY
    Resync Library Override Hierarchy -- Rebuild this local override from its linked reference, as well as its hierarchy of dependencies.

    OVERRIDE_LIBRARY_RESYNC_HIERARCHY_ENFORCE
    Resync Library Override Hierarchy Enforce -- Rebuild this local override from its linked reference, as well as its hierarchy of dependencies, enforcing that hierarchy to match the linked data (i.e. ignoring exiting overrides on data-blocks pointer properties).

    OVERRIDE_LIBRARY_CLEAR_SINGLE
    Clear Library Override Single -- Delete this local override and relink its usages to the linked data-blocks if possible, else reset it and mark it as non editable.

    OVERRIDE_LIBRARY_CLEAR_HIERARCHY
    Clear Library Override Hierarchy -- Delete this local override (including its hierarchy of override dependencies) and relink its usages to the linked data-blocks.
...
def lib_operation(
    ...
    *,
    ...
    DELETE
    Delete -- Delete this library and all its item.
    Warning: No undo.
