...
def add_named(
    ...
    *,
    ...
    name: str | typing.Any = "",
    session_uuid: typing.Any | None = 0,
    ...
    :type session_uuid: typing.Any | None
    :param matrix: Matrix
...
def bake(
    ...
    *,
    ...
    VERTEX_COLORS
    Color Attributes -- Bake to active color attribute layer on meshes.
...
def data_transfer(
    ...
    *,
    ...
    Projected Face Interpolated -- Interpolate all source polygons intersected by the projection of destination one along its own normal.
        ...
        :param use_auto_transform: Auto Transform, Automatically compute transformation to get the best possible match between source and destination meshes.
...
def gpencil_add(
    ...
    *,
    ...
    EMPTY
    Blank -- Create an empty grease pencil object.

    STROKE
    Stroke -- Create a simple stroke with basic colors.

    MONKEY
    Monkey -- Construct a Suzanne grease pencil object.

    LRT_SCENE
    Scene Line Art -- Quickly set up line art for the entire scene.

    LRT_COLLECTION
    Collection Line Art -- Quickly set up line art for the active collection.
...
def lightprobe_add(
    ...
    *,
    ...
    CUBEMAP
    Reflection Cubemap -- Reflection probe with spherical or cubic attenuation.

    PLANAR
    Reflection Plane -- Planar reflection probe.
