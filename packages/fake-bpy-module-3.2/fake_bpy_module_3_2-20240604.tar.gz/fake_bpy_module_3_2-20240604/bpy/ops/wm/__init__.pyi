...
def properties_edit(
    ...
    *,
    ...
    NONE
    Plain Data -- Data values without special behavior.

    COLOR
    Linear Color -- Color in the linear space.

    COLOR_GAMMA
    Gamma-Corrected Color -- Color in the gamma corrected space.

    EULER
    Euler Angles -- Euler rotation angles in radians.

    QUATERNION
    Quaternion Rotation -- Quaternion rotation (affects NLA blending).
