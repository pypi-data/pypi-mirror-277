...
template<size_t D> 
PostprocessingMeshCreator<D> createGridOnCells( const ResolutionDeterminor<D>& resolutionDeterminor,
                                                PostprocessTopologies topologies )
{
...
PostprocessingMeshCreator<D> createGridOnCells( std::array<size_t, D> resolution,
                                                PostprocessTopologies topologies )
{
    return createGridOnCells<D>( uniformResolution<D>( resolution ), topologies );
}
...
#define MLHP_INSTANTIATE_DIM( D )                                                           \
    ...
    PostprocessingMeshCreator<D> createGridOnCells( std::array<size_t, D> resolution,       \
                                                    PostprocessTopologies topologies );     \
                                                                                            \
    template MLHP_EXPORT                                                                    \
    PostprocessingMeshCreator<D> createGridOnCells(                                         \
                                 const ResolutionDeterminor<D>& resolutionDeterminor,       \
                                 PostprocessTopologies topologies );                        \
                                                                                            \
    template MLHP_EXPORT                                                                    \
    ResolutionDeterminor<D> uniformResolution( std::array<size_t, D> resolution );          \
