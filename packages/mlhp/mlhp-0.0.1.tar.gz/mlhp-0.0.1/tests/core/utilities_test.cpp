...
{
    constexpr size_t simdSize = mlhp::simd_alignment / sizeof( double );
...
TEST_CASE( "memoryAlignment" )
{
    ...
    CHECK( detail::is_aligned( v1.data( ), mlhp::simd_alignment ) );
    CHECK( detail::is_aligned( v2.data( ), mlhp::simd_alignment ) );
    CHECK( detail::is_aligned( v3.data( ), mlhp::simd_alignment ) );
}
