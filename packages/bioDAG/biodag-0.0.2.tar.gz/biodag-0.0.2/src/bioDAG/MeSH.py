...
import bioDAG
from bioDAG import DAGTerm, DAG
...
class MeSHDAG(DAG):
    ...
    def returnMeSHDAG(cls, **kwargs):
        MeSHDir = kwargs.get("MeSHDir", False)
        meshDf = kwargs.get("MeSHDf", False)
        if meshDf:
            pass
        elif not meshDf and MeSHDir:
            ...
            raise ValueError("You should pass atl least one of (MeSHDir, meshDf) parameter!")
