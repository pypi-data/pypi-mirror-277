...
class BrFsAlgorithm(IAlgorithm):
    ...
    def __init__(self, arg0: IAAG) -> None:
        ...
    @typing.overload
    def __init__(self, applicable_action_generator: IAAG, successor_state_generator: ISSG, event_handler: IAlgorithmEventHandler = ..., pruning_strategy: IPruningStrategy = ...) -> None:
        ...
...
class IPruningStrategy:
    def test_prune_initial_state(self, arg0: State) -> bool:
        ...
    def test_prune_successor_state(self, arg0: State, arg1: State) -> bool:
        ...
class ISSG:
...
class MultiOperatorEnum:
    ...
    def value(self) -> int:
        ...
class NoPruning(IPruningStrategy):
    pass
class NumericFluent:
    def __str__(self) -> str:
        ...
