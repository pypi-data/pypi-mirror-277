...
import typing
__all__ = ['ACTION_COSTS', 'ADL', 'ASSIGN', 'AStarAlgorithm', 'Action', 'AssignOperatorEnum', 'Axiom', 'BinaryOperatorEnum', 'BlindHeuristic', 'BrFsAlgorithm', 'CLOSED', 'CONDITIONAL_EFFECTS', 'CONSTRAINTS', 'ConditionalEffect', 'DEAD_END', 'DECREASE', 'DERIVED_PREDICATES', 'DISJUNCTIVE_PRECONDITIONS', 'DIV', 'DURATIVE_ACTIONS', 'DebugAlgorithmEventHandler', 'DebugGroundedAAGEventHandler', 'DebugLiftedAAGEventHandler', 'DefaultAlgorithmEventHandler', 'DefaultGroundedAAGEventHandler', 'DefaultLiftedAAGEventHandler', 'DerivedAtom', 'DerivedGroundAtom', 'DerivedGroundLiteral', 'DerivedLiteral', 'DerivedPredicate', 'Domain', 'EQUALITY', 'EXHAUSTED', 'EXISTENTIAL_PRECONDITIONS', 'FAILED', 'FLUENTS', 'FluentAtom', 'FluentGroundAtom', 'FluentGroundLiteral', 'FluentLiteral', 'FluentPredicate', 'Function', 'FunctionExpression', 'FunctionExpressionBinaryOperator', 'FunctionExpressionFunction', 'FunctionExpressionMinus', 'FunctionExpressionMultiOperator', 'FunctionExpressionNumber', 'FunctionSkeleton', 'GroundAction', 'GroundFunction', 'GroundFunctionExpression', 'GroundFunctionExpressionBinaryOperator', 'GroundFunctionExpressionFunction', 'GroundFunctionExpressionMinus', 'GroundFunctionExpressionMultiOperator', 'GroundFunctionExpressionNumber', 'GroundedAAG', 'IAAG', 'IAlgorithm', 'IAlgorithmEventHandler', 'IGroundedAAGEventHandler', 'IHeuristic', 'ILiftedAAGEventHandler', 'INCREASE', 'IN_PROGRESS', 'ISSG', 'LiftedAAG', 'MAXIMIZE', 'MINIMIZE', 'MINUS', 'MUL', 'MultiOperatorEnum', 'NEGATIVE_PRECONDITIONS', 'NEW', 'NUMERIC_FLUENTS', 'NumericFluent', 'OBJECT_FLUENTS', 'OPEN', 'OUT_OF_MEMORY', 'OUT_OF_TIME', 'Object', 'OptimizationMetric', 'OptimizationMetricEnum', 'PDDLFactories', 'PDDLParser', 'PLUS', 'PREFERENCES', 'Problem', 'QUANTIFIED_PRECONDITIONS', 'RequirementEnum', 'Requirements', 'SCALE_DOWN', 'SCALE_UP', 'SOLVED', 'SSG', 'STRIPS', 'SearchNodeStatus', 'SearchStatus', 'SimpleEffect', 'State', 'StateSpace', 'StaticAtom', 'StaticGroundAtom', 'StaticGroundLiteral', 'StaticLiteral', 'StaticPredicate', 'TIMED_INITIAL_LITERALS', 'TYPING', 'Term', 'TermObject', 'TermVariable', 'Transition', 'UNIVERSAL_PRECONDITIONS', 'UniversalEffect', 'Variable']
class AStarAlgorithm(IAlgorithm):
    @typing.overload
    def __init__(self, arg0: IAAG, arg1: IHeuristic) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: IAAG, arg1: ISSG, arg2: IHeuristic, arg3: IAlgorithmEventHandler) -> None:
        ...
class Action:
...
class BrFsAlgorithm(IAlgorithm):
    ...
    def __init__(self, arg0: IAAG) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: IAAG, arg1: ISSG, arg2: IAlgorithmEventHandler) -> None:
        ...
class ConditionalEffect:
    ...
    def get_static_conditions(self) -> list[StaticLiteral]:
        ...
class DebugAlgorithmEventHandler(IAlgorithmEventHandler):
    def __init__(self) -> None:
        ...
...
class DebugLiftedAAGEventHandler(ILiftedAAGEventHandler):
    def __init__(self) -> None:
        ...
class DefaultAlgorithmEventHandler(IAlgorithmEventHandler):
    def __init__(self) -> None:
        ...
...
class State:
    ...
    def __hash__(self) -> int:
        ...
    def get_derived_atoms(self, arg0: Problem) -> list[int]:
        ...
    def get_fluent_atoms(self, arg0: Problem) -> list[int]:
        ...
    def get_id(self) -> int:
        ...
    def get_static_atoms(self, arg0: Problem) -> list[int]:
        ...
    @typing.overload
    def literal_holds(self, arg0: Problem, arg1: StaticGroundLiteral) -> bool:
        ...
    @typing.overload
    def literal_holds(self, arg0: Problem, arg1: FluentGroundLiteral) -> bool:
        ...
    @typing.overload
    def literal_holds(self, arg0: Problem, arg1: DerivedGroundLiteral) -> bool:
        ...
    @typing.overload
    def literals_hold(self, arg0: Problem, arg1: list[StaticGroundLiteral]) -> bool:
        ...
    @typing.overload
    def literals_hold(self, arg0: Problem, arg1: list[FluentGroundLiteral]) -> bool:
        ...
    @typing.overload
    def literals_hold(self, arg0: Problem, arg1: list[DerivedGroundLiteral]) -> bool:
        ...
