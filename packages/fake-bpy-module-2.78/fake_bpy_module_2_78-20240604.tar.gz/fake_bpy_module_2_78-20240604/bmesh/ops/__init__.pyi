...
def bisect_plane(
    ...
    """Bisect Plane.Bisects the mesh by a plane (cut the mesh in half).
        ...
        :return: geom_cut: output new geometry from the cut
...
def extrude_discrete_faces(
    bm: bmesh.types.BMesh, faces: list[bmesh.types.BMFace], use_select_history: bool
) -> dict[str, typing.Any]:
...
def extrude_edge_only(
    bm: bmesh.types.BMesh, edges: list[bmesh.types.BMEdge], use_select_history: bool
) -> dict[str, typing.Any]:
...
def smooth_laplacian_vert(
    ...
    """Vertext Smooth Laplacian.Smooths vertices by using Laplacian smoothing propose by.
