...
def intersect(
    ...
    *,
    ...
    use_separate: bool | typing.Any | None = True,
    ...
    SELECT_UNSELECT Selected/Unselected, Intersect selected with unselected faces.
        ...
        :type use_separate: bool | typing.Any | None
...
def poke(
    ...
    *,
    offset: typing.Any | None = 0.0,
    use_relative_offset: bool | typing.Any | None = False,
    center_mode: str | None = "MEAN_WEIGHTED",
):
...
def primitive_circle_add(
    ...
    *,
    ...
    calc_uvs: bool | typing.Any | None = False,
...
def select_axis(
    ...
    undo: bool | None = None,
    *,
    mode: str | None = "POSITIVE",
    axis: str | None = "X_AXIS",
    threshold: typing.Any | None = 0.0001,
):
...
def subdivide(
    ...
    *,
    number_cuts: typing.Any | None = 1,
    smoothness: typing.Any | None = 0.0,
    quadtri: bool | typing.Any | None = False,
    ...
    :type quadtri: bool | typing.Any | None
...
def vertices_smooth_laplacian(
    ...
    *,
    repeat: typing.Any | None = 1,
    lambda_factor: typing.Any | None = 5e-05,
