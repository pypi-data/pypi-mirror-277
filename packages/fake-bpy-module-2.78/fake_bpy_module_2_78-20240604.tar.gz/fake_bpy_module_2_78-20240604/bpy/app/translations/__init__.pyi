...
If you are a regular addon, you should only bother about contexts member,
...
The Manage UI translations
 ...
 addon has several functions to help you collect strings to translate, and
...
def pgettext(msgid: str | None, msgctxt: str | None):
...
def pgettext_data(msgid: str | None, msgctxt: str | None):
...
def pgettext_iface(msgid: str | None, msgctxt: str | None):
...
def pgettext_tip(msgid: str | None, msgctxt: str | None):
