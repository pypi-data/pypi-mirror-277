...
(when added with an add object actuator), (read-only).
    ...
    def replaceMesh(
        self,
        mesh: str,
        useDisplayMesh: bool | None = True,
        usePhysicsMesh: bool | None = False,
    ):
        ...
        :type useDisplayMesh: bool | None
        :param usePhysicsMesh: when enabled the physics mesh will be replaced (optional argument).
        :type usePhysicsMesh: bool | None
        """
        ...

    def setVisible(self, visible: bool, recursive: bool | None):
    ...
    def setOcclusion(self, occlusion: bool, recursive: bool | None):
    ...
    def setLinearVelocity(
        ...
        """Sets the game object's linear velocity.This method sets game object's velocity through it's centre of mass,
    ...
    def getVelocity(
        self,
        point: collections.abc.Sequence[float] | mathutils.Vector | None = (0, 0, 0),
    ):
    ...
    def setParent(
        self, parent: KX_GameObject, compound: bool = True, ghost: bool = True
    ):
    ...
    def getDistanceTo(self, other: KX_GameObject) -> float:
        """
    ...
    def getVectTo(self, other: KX_GameObject):
    ...
    def rayCastTo(self, other: KX_GameObject, dist: float, prop: str) -> KX_GameObject:
    ...
    def rayCast(
        ...
        if poly is 2, returns a 5-tuple with in addition a 2D vector with the UV mapping of the hit point as 5th element.The face paremeter determines the orientation of the normal.The ray has X-Ray capability if xray parameter is 1, otherwise the first object hit (other than self object) stops the ray.
        ...
        If there is no hit or the hit object is not a static mesh, None is returned as 4th element.The ray ignores collision-free objects and faces that dont have the collision flag enabled, you can however use ghost objects.
                ...
                :type objfrom: KX_GameObject | None
    ...
    def sendMessage(self, subject: str, body: str | None = "", to: str | None = ""):
        """Sends a message.
    ...
    def reinstancePhysicsMesh(
        self, gameObject: KX_GameObject | str | None, meshObject: str | None
    ) -> bool:
        ...
        :type gameObject: KX_GameObject | str | None
...
class BL_ShapeActionActuator(SCA_IActuator):
    ...
    mode: int
    """ The operation mode of the actuator. Can be one of `these constants<shape-action-actuator>`.
...
class KX_Camera(KX_GameObject):
    ...
    def getScreenRay(
        self, x: float, y: float, dist: float = None, property: str = None
    ) -> KX_GameObject:
