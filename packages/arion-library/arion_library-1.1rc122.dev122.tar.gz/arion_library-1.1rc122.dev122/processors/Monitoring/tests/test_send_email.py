...
def test_send_email_with_attachment(monitoring_base, caplog):
    ...
    # Call the method
    monitoring_base.send_email_with_attachment(connection_string, file_bytes, subject, body, recipient, sender, cc , displayName=displayName)
