...
import responses
import logging
from rfe_connector import RFEConnector  # Assurez-vous que le module rfe_connector est dans votre PYTHONPATH
...
def test_upload_blob(connector, tmp_path):
    ...
    assert responses.calls[0].request.body.decode('utf-8') == file_content
