...
def set_ingestion_type(ingestion_type):
    ...
    print(f'Set global value INGESTION_TYPE to {ingestion_type}')
...
ERROR_MESSAGES = {
    ...
    3071: "Jira got status code {} on func {}, retry {} / {}.  Trying again in {}...",
...
def send_to_agent_log_file(
    msg: str, level: Optional[int] = logging.INFO, extra: Optional[dict] = {}
):
    ...
    logger.log(level=level, msg=msg, extra=log_extras)
