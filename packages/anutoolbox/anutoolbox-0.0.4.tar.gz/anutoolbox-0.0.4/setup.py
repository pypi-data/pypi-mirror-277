...
setuptools.setup(
    name='anutoolbox',                           # should match the package folder
    packages=['anutoolbox'],                     # should match the package folder
    ...
    keywords=["pypi", "anutoolbox", "tutorial"], #descriptive meta-data
