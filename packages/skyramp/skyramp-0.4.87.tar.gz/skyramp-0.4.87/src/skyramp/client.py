...
from skyramp.test_status import TestStatusV1, TestStatusV2, TestStatusV3, TestStatus
...
class _ClientBase:
    ...
    def _get_tester_status(
        self, namespace: str, address: str, tester_id: str, is_formatting_enabled: bool
    ) -> TestStatus:
        """
    ...
    def execute_request(
        self, request: _Request, namespace: str, address: str
    ) -> ResponseLog:
        """
