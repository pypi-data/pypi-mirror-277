...
@hookimpl
def instance_model() -> tuple[str, tuple[Any, Any]]:
    return (
        ...
        (
            ...
            # TODO: use Ellipsis (...) from Pydantic 2.7+, see
            # https://github.com/pydantic/pydantic/commit/4541142df5e0b007bdac976aaca7b2f6007d67e0
            PydanticUndefined,
        ),
    )
