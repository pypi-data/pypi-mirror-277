        ...
        settingRegistry.load('@jupyterlab/notebook-extension:tracker').then((nbSettings) => {
            ...
            if (former === 'full') {
                nbSettings.set('windowingMode', 'none'),
                    console.log('jupyterlab-gridwidth: windowing mode TURNED OFF');
            }
            else {
                console.log(`jupyterlab-gridwidth: windowing mode already ${former} - leaving off`);
            }
...
//# sourceMappingURL=lib_index_js.b25ba8390ebef966905f.js.map