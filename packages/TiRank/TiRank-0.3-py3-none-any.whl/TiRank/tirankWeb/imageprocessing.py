...
def plot_patho_class_heatmap(data, save_path):
    ...
    colors = ['red', 'blue', 'green', 'yellow', 'purple', 'orange', 'cyan', 'magenta', 'brown', 'pink', 'lime',
              'violet', 'indigo', 'gold', 'crimson']
...
def get_patho_class_(adata, pretrain_path, n_components=50, n_clusters=6, plot_classes=True, image_save_path=None):
