...
def interactive_add(
    ...
    *,
    ...
    plane_axis: str | None = "Z",
    plane_depth: str | None = "SURFACE",
    plane_origin: str | None = "BASE",
    plane_orientation: str | None = "SURFACE",
    wait_for_input: bool | typing.Any | None = True,
):
    """Interactively add an object
        ...
        :type plane_axis: str | None
        :param plane_depth: Position, The initial depth used when placing the cursor

    SURFACE
    Surface, Start placing on the surface, using the 3D cursor position as a fallback.

    CURSOR_PLANE
    3D Cursor Plane, Start placement using a point projected onto the selected axis at the 3D cursor position.

    CURSOR_VIEW
    3D Cursor View, Start placement using the mouse cursor projected onto the view plane.
        :type plane_depth: str | None
        :param plane_origin: Origin, The initial position for placement

    BASE
    Base, Start placing the corner position.

    CENTER
    Center, Start placing the center position.
        :type plane_origin: str | None
        :param plane_orientation: Orientation, The initial depth used when placing the cursor

    SURFACE
    Surface, Use the surface normal (the transform orientation as a fallback).

    DEFAULT
    Default, Use the current transform orientation.
        :type plane_orientation: str | None
        :param wait_for_input: Wait for Input
        :type wait_for_input: bool | typing.Any | None
    """
...
def select_box(
    ...
    *,
    ...
    XOR
    Difference, Inverts existing selection.
...
def toggle_shading(
    ...
    *,
    ...
    MATERIAL
    LookDev, Toggle lookdev shading.
