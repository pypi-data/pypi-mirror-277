...
class GPUShader:
    ...
    It must contain a vertex and fragment shaders, with an optional geometry shader.The GLSL #version directive is automatically included at the top of shaders,
    ...
    and GL_ARB_shader_draw_parameters.To debug shaders, use the --debug-gpu-shaders command line option
    to see full GLSL shader compilation and linking errors.For drawing user interface elements and gizmos, use
