...
class Config:
    ...
    @typing.no_type_check
    def __init__(self, *, boltz_url: "str", electrum_url: "str", working_dir: "str", network: "Network", payment_timeout_sec: "int"):
    ...
    def __str__(self):
        return "Config(boltz_url={}, electrum_url={}, working_dir={}, network={}, payment_timeout_sec={})".format(self.boltz_url, self.electrum_url, self.working_dir, self.network, self.payment_timeout_sec)
...
class Payment:
    ...
    status: "PaymentState"
    @typing.no_type_check
    def __init__(self, *, tx_id: "str", swap_id: "typing.Optional[str]" = _DEFAULT, timestamp: "int", amount_sat: "int", fees_sat: "typing.Optional[int]" = _DEFAULT, preimage: "typing.Optional[str]" = _DEFAULT, refund_tx_id: "typing.Optional[str]" = _DEFAULT, refund_tx_amount_sat: "typing.Optional[int]" = _DEFAULT, payment_type: "PaymentType", status: "PaymentState"):
        self.tx_id = tx_id
...
class LiquidSdkEvent:
    ...
    class PAYMENT_SUCCEED:
        ...
        def __str__(self):
            return "LiquidSdkEvent.PAYMENT_SUCCEED(details={})".format(self.details)
    ...
    def is_payment_succeed(self) -> bool:
        return isinstance(self, LiquidSdkEvent.PAYMENT_SUCCEED)
...
LiquidSdkEvent.PAYMENT_SUCCEED = type("LiquidSdkEvent.PAYMENT_SUCCEED", (LiquidSdkEvent.PAYMENT_SUCCEED, LiquidSdkEvent,), {})  # type: ignore
...
class _UniffiConverterTypeLiquidSdkEvent(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        ...
        if variant == 5:
            return LiquidSdkEvent.PAYMENT_SUCCEED(
                _UniffiConverterTypePayment.read(buf),
            )
        if variant == 6:
