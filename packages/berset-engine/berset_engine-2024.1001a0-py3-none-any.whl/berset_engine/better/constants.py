...
import os
from berset_engine.better.data import noaa_weather_station_list_file
...
class Constants:
    ...
    days_in_year = 365   # number of day of a normal year could be get using pandas
    rgb_color_strs = [
    ...
    df_noaa_weather_station = pd.read_csv(
        noaa_weather_station_list_file,
        dtype=
        {
            'USAF':str,
            'WBAN':str,
