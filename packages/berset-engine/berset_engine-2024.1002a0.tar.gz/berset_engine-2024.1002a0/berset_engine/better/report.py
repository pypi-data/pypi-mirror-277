...
class Report:
    ...
    def generate_building_report_html_with_jinja(self):
        ...
        FIM_des = {
            "Reduce Equipment Schedules": "Your building equipment load is higher than typical. "
                "Equipment and systems within any building should operate using a schedule. "
                "Check equipment schedule and if equipment is operational during low occupancy times or during reduced building use. "
                "Setup a notification to identify when schedules are overridden and are not returned to normal.",
