...
from worldline.connect.sdk.v1.domain.redirect_payment_product869_specific_input import RedirectPaymentProduct869SpecificInput
from worldline.connect.sdk.v1.domain.redirect_payment_product882_specific_input import RedirectPaymentProduct882SpecificInput
...
class RedirectPaymentMethodSpecificInput(AbstractRedirectPaymentMethodSpecificInput):
    ...
    __payment_product869_specific_input: Optional[RedirectPaymentProduct869SpecificInput] = None
    __payment_product882_specific_input: Optional[RedirectPaymentProduct882SpecificInput] = None
    ...
    def payment_product4101_specific_input(self, value: Optional[RedirectPaymentProduct4101SpecificInput]) -> None:
    ...
    def payment_product861_specific_input(self, value: Optional[RedirectPaymentProduct861SpecificInput]) -> None:
    ...
    def payment_product863_specific_input(self, value: Optional[RedirectPaymentProduct863SpecificInput]) -> None:
    ...
    def payment_product869_specific_input(self, value: Optional[RedirectPaymentProduct869SpecificInput]) -> None:
    ...
    def payment_product882_specific_input(self, value: Optional[RedirectPaymentProduct882SpecificInput]) -> None:
