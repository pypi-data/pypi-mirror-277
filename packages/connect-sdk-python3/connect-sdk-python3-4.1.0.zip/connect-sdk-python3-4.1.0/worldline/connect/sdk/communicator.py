...
from worldline.connect.sdk.communication.connection import Connection, Response
...
from worldline.connect.sdk.json.marshaller import Marshaller, T
...
class Communicator(LoggingCapable, ObfuscationCapable):
    ...
    def __init__(self, api_endpoint: Union[str, ParseResult], connection: Connection, authenticator: Authenticator,
                 metadata_provider: MetadataProvider, marshaller: Marshaller):
