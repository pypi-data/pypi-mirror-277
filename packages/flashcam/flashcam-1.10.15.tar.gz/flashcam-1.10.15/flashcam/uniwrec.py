...
"""
               ...
               # ======================================================== IMSHOW
                ...
                if expande > 0: # TRIK-experimental test
                    cv2.resizeWindow(
                        rpi_name,
                ...
                if (frame is not None) and (rpi_name != "") and (key == ord("x") and not CTRL):
                    print("x PRESSED! - expand 1x 2x")
                    if expande == 2:
                ...
                # switch RES s-x
                if (frame is not None) and (rpi_name != "") and (key == ord("X") and (not CTRL) ):
                    print("X PRESSED! - resolution to MAX ")
                ...
                # switch RES  c-x
                if (frame is not None) and (rpi_name != "") and (key == ord("x") and CTRL):
                    print("Ctrl-X PRESSED! - resolution to 640 ")
                    post_addr = videodev.replace("/video", "/cross")
                ...
                if ( (frame is not None)
                    and (rpi_name != "")
                    and (key == ord("l") and CTRL)
                ):
                    print("ctl-l PRESSED! - Laps Astro  BUTTON ---------------------")
                    post_addr = videodev.replace("/video", "/cross")
                    if timelaps == 0:
                        timelaps = -1
                    elif timelaps == -1:
                        ...
                        timelaps = 0
                    print(f"ctl-l PRESSED! - Laps Astro {timelaps}  ---------------------")
