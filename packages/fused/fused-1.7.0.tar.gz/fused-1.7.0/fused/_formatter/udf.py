...
if TYPE_CHECKING:
    ...
    from fused.models.udf.udf import BaseUdf
...
def summarize_udfs(udfs: Dict[str, BaseUdf]):
    li_items = []
...
def fused_registry_repr(registry: Dict[str, BaseUdf]) -> str:
...
def fused_udf_repr(udf: BaseUdf) -> str:
