...
from fused._formatter.formatter_templates import (
    fused_template_repr,
...
from fused.models.coerce_dataset import (
...
class JobStepConfigTemplate(FusedTemplate):
    ...
    def render(
        ...
        **kwargs,
        ...
        config = JobStepConfig.parse_raw(json, content_type="json")
        return config
...
class JobConfigTemplate(FusedTemplate):
    ...
    def render(
        ...
        **kwargs,
        ...
        json = self.template.render(**resolved_kwargs)
        config = JobConfig.parse_raw(json, content_type="json")
        return config
...
class UdfTemplate(FusedTemplate):
    ...
    def render(self, **kwargs) -> BaseUdf:
        resolved_kwargs = {
            **self.defaults,
            **kwargs,
        }
        json = self.template.render(**resolved_kwargs)
        return BaseUdf.parse_raw(json, content_type="json")

    async def render_async(self, **kwargs) -> BaseUdf:
        resolved_kwargs = {
            **self.defaults,
            **kwargs,
        }
