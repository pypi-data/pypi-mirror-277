...
def _detect_function_name(src: str) -> Optional[str]:
    ...
    if show_warning:
        warnings.warn(
            f"Loading the first UDF ({found_function_name})",
            FusedDefaultWarning,
        )
...
def _load_udfs_from_file(
    ...
    *,
    ...
    load_schema: bool = True,
    header_paths: Optional[Sequence[Header]] = None,
) -> Union[UdfRegistry, GeoPandasUdfV2Callable]:
    """
    ...
    new_udf = GeoPandasUdfV2Callable(
