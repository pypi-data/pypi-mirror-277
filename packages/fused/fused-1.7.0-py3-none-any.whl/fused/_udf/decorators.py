...
from fused._udf.state import decorator_src_override, noop_decorators
from fused.models import Schema
from fused.models.udf import Header
from fused.models.udf._specialized_udfs import GeoPandasUdfV2Callable
from fused.models.udf.udf import GeoPandasUdfV2
from fused.warnings import FusedPythonVersionWarning, FusedTypeWarning, FusedUdfWarning
    ...
    def _internal_decorator_wrapper(func):
        ...
        if table_schema is not None:
            if isinstance(table_schema, str):
                ...
                # run on the backend.
                table_schema = Schema.parse_obj(table_schema)
...
def udf(
    ...
    *,
    ...
    return _udf_internal(
        fn=fn,
        _udf_cls=GeoPandasUdfV2Callable,
