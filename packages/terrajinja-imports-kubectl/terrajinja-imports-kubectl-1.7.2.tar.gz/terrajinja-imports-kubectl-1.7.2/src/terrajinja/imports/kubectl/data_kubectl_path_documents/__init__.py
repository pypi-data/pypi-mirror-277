...
Refer to the Terraform Registry for docs: [`data_kubectl_path_documents`](https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents).
'''
import abc
import builtins
import datetime
...
class DataKubectlPathDocuments(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents kubectl_path_documents}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents kubectl_path_documents} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param pattern: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents#pattern DataKubectlPathDocuments#pattern}.
        :param disable_template: Flag to disable template parsing of the loaded documents. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents#disable_template DataKubectlPathDocuments#disable_template}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents#id DataKubectlPathDocuments#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param vars: variables to substitute. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents#vars DataKubectlPathDocuments#vars}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataKubectlPathDocuments that should be imported. Refer to the {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents#import import section} in the documentation of this resource for the id to use
...
class DataKubectlPathDocumentsConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    @builtins.property
    def pattern(self) -> builtins.str:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents#pattern DataKubectlPathDocuments#pattern}.'''
    ...
    def disable_template(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents#disable_template DataKubectlPathDocuments#disable_template}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents#id DataKubectlPathDocuments#id}.
    ...
    def vars(self) -> typing.Optional[typing.Mapping[builtins.str, builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.7.2/docs/data-sources/path_documents#vars DataKubectlPathDocuments#vars}
        '''
