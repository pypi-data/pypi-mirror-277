...
def add_SRRHISAT_subparser(subparsers):
    parser = subparsers.add_parser(
        ...
        "  $ PEA MAP16S --SRR SRR16092814 --SILVA SILVA_Bacteria --CPU 10\n"
...
def add_SRRHISATLOCAL_subparser(subparsers):
    parser = subparsers.add_parser(
        "SRRHISATLOCAL",
        help="Find plant reads matched bacteria lineages",
        description="Find plant reads matched 16S genes of bacteria lineages from the SILVA database.",
        ...
        "  need: TEST_1.fastq.gz TEST_2.fastq.gz "
        "  $ PEA MAP16S --SRR TEST --SILVA SILVA_Bacteria --CPU 10\n"
...
def add_MAP16S_subparser(subparsers):
    parser = subparsers.add_parser(
        ...
        epilog="Usage examples\n--------------\n"
        "Detecting reads in SRR16092814:\n"
        "  $ PEA MAP16S --SRR SRR16092814 --TaxB tax_slv_ssu_138.bacteria.txt --RefID SILVA_138.1_used_tax_silva.ID_List\n"
