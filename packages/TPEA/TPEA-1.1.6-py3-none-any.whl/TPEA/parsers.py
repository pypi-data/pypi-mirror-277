...
def add_SRRHISAT_subparser(subparsers):
    parser = subparsers.add_parser(
        ...
        "  $ TPEA SRRHISAT --SRR SRR16092814 --SILVA SILVA_Bacteria --CPU 10\n"
...
def add_SRRHISATLOCAL_subparser(subparsers):
    parser = subparsers.add_parser(
        ...
        "  $ TPEA SRRHISATLOCAL --SRR TEST --SILVA SILVA_Bacteria --CPU 10\n"
...
def get_parser():
    ...
    add_SRRHISATLOCAL_subparser(subparsers)
