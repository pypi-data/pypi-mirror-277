...
class Agilent53230a(object):
    """Python class for Agilent 53230a counter, written by Adam McCaughan,
    modified from 5131a for 53230a by Emma Batson
    ...
    def basic_setup(self):
        ...
        self.write("INP:LEV:AUTO OFF")  # Turn off auto trigger level
        self.write("INP:LEV -0.200V")  # Set trigger level
        self.write("INP:SLOP POS")  # Or POS. Trigger on negative slope
        self.write("INP:HYST:REL 0")  # Set hysteresis 0 indicates high sensitivity
