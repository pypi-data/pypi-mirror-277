...
class SummarizationTextRequest(BaseModel):
    ...
    __properties = ["language", "text", "texts", "origin", "summarizationDegree"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SummarizationTextRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SummarizationTextRequest:
        """Create an instance of SummarizationTextRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SummarizationTextRequest.parse_obj(obj)

        _obj = SummarizationTextRequest.parse_obj({
