...
class ParaphraseFileResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParaphraseFileResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParaphraseFileResponse:
        """Create an instance of ParaphraseFileResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParaphraseFileResponse.parse_obj(obj)

        _obj = ParaphraseFileResponse.parse_obj({
