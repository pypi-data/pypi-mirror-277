...
class SimplifyFileResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimplifyFileResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimplifyFileResponse:
        """Create an instance of SimplifyFileResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimplifyFileResponse.parse_obj(obj)

        _obj = SimplifyFileResponse.parse_obj({
