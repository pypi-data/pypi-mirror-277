...
class DetectionTrialFileRequest(BaseModel):
    """
    ...
    min_length: Optional[StrictInt] = Field(None, alias="minLength", description="Minimum length of the source text")
    format: Optional[TrialSupportedFormats] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetectionTrialFileRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetectionTrialFileRequest:
        """Create an instance of DetectionTrialFileRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetectionTrialFileRequest.parse_obj(obj)

        _obj = DetectionTrialFileRequest.parse_obj({
