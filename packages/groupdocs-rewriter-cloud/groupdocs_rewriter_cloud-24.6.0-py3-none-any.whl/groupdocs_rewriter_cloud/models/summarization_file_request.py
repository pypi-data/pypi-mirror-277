...
class SummarizationFileRequest(BaseModel):
    ...
    format: Optional[SummarizationSupportedFormats] = None
    __properties = ["language", "url", "origin", "originalName", "savingMode", "outputFormat", "summarizationDegree", "minLength", "format"]
