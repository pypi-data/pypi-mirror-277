...
def load_claim_auto(directory, skip_rows=13, lhnv = None, return_all_dfs = False):
    ...
    if return_all_dfs:
        ...
        df_clm = pd.concat(all_dataframes.values(), ignore_index=True)
