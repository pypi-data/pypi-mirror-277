...
class EmbeddingParameterModel:
    def __init__(
        self,
        max_no_improvement: Optional[int] | None = None,
        random_seed: Optional[int] | None = None,
        timeout: Optional[int] | None = None,
        max_beta: Optional[float] | None = None,
        tries: Optional[int] | None = None,
        inner_rounds: Optional[int] | None = None,
        chainlength_patience: Optional[int] | None = None,
        max_fill: Optional[int] | None = None,
        threads: Optional[int] | None = None,
        return_overlap: Optional[bool] | None = None,
        skip_initialization: Optional[bool] | None = None,
        verbose: Optional[int] | None = None,
        interactive: Optional[bool] | None = None,
        initial_chains: Optional[dict] | None = None,
        fixed_chains: Optional[dict] | None = None,
        restrict_chains: Optional[dict] | None = None,
        suspend_chains: Optional[dict] | None = None,
    ) -> None:
...
class JijSAParameterModel:
    def __init__(
        ...
        num_search: Optional[int] | None = None,
        ...
        # The number of timeout [sec] for post request. If `None`, 600 will be set. Please note that this argument is for the `jijzept` timeout and not for configuring solver settings, such as solving time.  # noqa
        ...
        self.parameters = {
            "beta_min": beta_min,  # inverse temperature. If `None`, this will be set automatically.  # noqa
            "beta_max": beta_max,  # inverse temperature. If `None`, this will be set automatically.  # noqa
            "num_sweeps": num_sweeps,  #  The number of Monte-Carlo steps. If `None`, 1000 will be set.  # noqa
            "num_reads": num_reads,  #  The number of samples. If `None`, 1 will be set.  # noqa
            "initial_state": initial_state,  # Initial state. If `None`, this will be set automatically.  # noqa
            "updater": updater,  # Updater algorithm. "single spin flip" or "swendsen wang". If `None`, "single spin flip" will be set.  # noqa
            "sparse": sparse,  # If `True`, only non-zero matrix elements are stored, which will save memory. If `None`, `False` will be set.  # noqa
            "reinitialize_state": reinitialize_state,  # If `True`, reinitialize state for each run. If `None`, `True` will be set.  # noqa
            "seed": seed,  # Seed for Monte Carlo algorithm. If `None`, this will be set automatically.  # noqa
            "needs_square_constraints": needs_square_constraints,  # This dictionary object is utilized to determine whether to square the constraint condition while incorporating it into the QUBO/HUBO penalty term. Here, the constraint's name is used as the key. If the value is set to True, the corresponding constraint is squared upon its addition to the QUBO/HUBO penalty term. By default, the value is set to True for linear constraints, and to False for non-linear ones.  # noqa
            "relax_as_penalties": relax_as_penalties,  # This dictionary object is designed to regulate the incorporation of constraint conditions into the QUBO/HUBO penalty term, with the constraint's name functioning as the key. If the key's value is True, the respective constraint is added to the QUBO/HUBO penalty term. If the value is False, the constraint is excluded from the penalty term, though it remains subject to evaluation to verify if it meets the constraint conditions. By default, all constraint conditions have this value set to True.  # noqa
        }
...
class JijSQAParameterModel:
    def __init__(
        ...
        self.parameters = {
            "beta": beta,  # inverse temperature. If `None`, this will be set automatically.  # noqa
            "gamma": gamma,  # Strength of transverse field. this will be set automatically.  # noqa
            "trotter": trotter,  # The number of Trotter. this will be set automatically.  # noqa
            "num_sweeps": num_sweeps,  #  The number of Monte-Carlo steps. If `None`, 1000 will be set.  # noqa
            "num_reads": num_reads,  #  The number of samples. If `None`, 1 will be set.  # noqa
            "sparse": sparse,  # If `True`, only non-zero matrix elements are stored, which will save memory. If `None`, `False` will be set.  # noqa
            "reinitialize_state": reinitialize_state,  # If `True`, reinitialize state for each run. If `None`, `True` will be set.  # noqa
...
class JijLeapHybridCQMParameterModel:
    def __init__(
        ...
        self.parameters["time_limit"] = time_limit
...
class ToshibaParameterModel:
    def __init__(
        ...
        maxwait: Optional[int] | None = None,
        algo: Optional[int] | None = None,
        dt: Optional[float] | None = None,
        C: Optional[float] | None = None,
        blocks: Optional[int] | None = None,
        multishot: Optional[int] | None = None,
        PD3Orate: Optional[int] | None = None,
