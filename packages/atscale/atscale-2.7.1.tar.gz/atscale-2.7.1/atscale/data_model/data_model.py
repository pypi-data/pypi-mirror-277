...
class DataModel:
    ...
    def get_features(
        ...
        if feature_list:
            model_utils._check_features(
                ...
                check_list=ret_dict,
                errmsg=private_enums.CheckFeaturesErrMsg.ALL.get_errmsg(is_published=use_published),
            )
    ...
    def delete_measures(
        ...
        model_utils._check_features(
            ...
            check_list=existing,
            errmsg=private_enums.CheckFeaturesErrMsg.NUMERIC.get_errmsg(is_published=False),
        )
    ...
    def create_rolling_features(
        ...
        model_utils._check_features(
            ...
            errmsg=private_enums.CheckFeaturesErrMsg.ALL.get_errmsg(is_published=False),
        )
    ...
    def create_percentage_features(
        ...
        model_utils._check_features(
            features=[numeric_feature_name],
            check_list=existing_features.keys(),
            errmsg=private_enums.CheckFeaturesErrMsg.ALL.get_errmsg(is_published=True),
        )
        ...
        model_utils._check_features(
            ...
            errmsg=private_enums.CheckFeaturesErrMsg.NUMERIC.get_errmsg(is_published=True),
        )
    ...
    def create_user_defined_aggregate(
        ...
        if categorical_features:
            model_utils._check_features(
                ...
                errmsg=private_enums.CheckFeaturesErrMsg.CATEGORICAL.get_errmsg(is_published=False),
            )
