...
def main():
    if len(sys.argv) < 3:
        print(
            "Usage: manufacture create <filename> | filename add [content] | change <oldname> <newname> [--backup] | permissions <filename> <permissions> | ownership <filename> <owner> <group> | directory <dirname> | info <filename> | compress <directory> --output=<output>")
        sys.exit(1)
