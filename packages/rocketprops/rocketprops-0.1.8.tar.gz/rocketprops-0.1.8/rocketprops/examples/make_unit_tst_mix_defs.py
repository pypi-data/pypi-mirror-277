...
propL = ['M20', 'M90', 'MON5', 'MON20', 'MON27', 'A25', 'A75', 'FLOX70']
...
for fname in propL:
    ...
    if 1:#prop_name not in ['__init__.py', 'M20_scaled', 'A50_scaled']:
