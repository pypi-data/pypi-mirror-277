...
def pull(
    ...
    dt = Dynatrace(dt_url, dt_token, too_many_requests_strategy=TOO_MANY_REQUESTS_WAIT, retries=3, log=logger)
...
def push(
    ...
    dt = Dynatrace(dt_url, dt_token, print_bodies=False, too_many_requests_strategy=TOO_MANY_REQUESTS_WAIT, retries=3, log=logger)
