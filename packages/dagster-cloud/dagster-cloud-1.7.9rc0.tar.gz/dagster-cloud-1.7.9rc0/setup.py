...
setup(
    ...
    extras_require={
        "tests": [
            ...
            "dbt-snowflake",
            "dbt-duckdb",
            "dagster-dbt==0.23.9rc0",
            "dagster_k8s==0.23.9rc0",
        ],
        "insights": ["pyarrow"],
        "docker": ["docker", "dagster_docker==0.23.9rc0"],
        "kubernetes": ["kubernetes", "dagster_k8s==0.23.9rc0"],
        "ecs": ["dagster_aws==0.23.9rc0", "boto3"],
        "sandbox": ["supervisor"],
        "pex": ["boto3"],
        "serverless": ["boto3"],
    },
