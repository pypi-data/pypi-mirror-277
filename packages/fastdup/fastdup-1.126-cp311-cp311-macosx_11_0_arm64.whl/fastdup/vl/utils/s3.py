...
if not Settings.IS_FASTDUP:
    ...
    s3 = boto3.client('s3', aws_access_key_id=Settings.AWS_ACCESS_KEY, aws_secret_access_key=Settings.AWS_SECRET_KEY, region_name='us-east-2')
...
def check_connectivity_to_bucket(bucket_path: str, assume_role: Optional[str]) -> bool:
