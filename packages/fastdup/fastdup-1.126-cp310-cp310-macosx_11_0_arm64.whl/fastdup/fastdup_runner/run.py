...
from fastdup.fastdup_runner.run_checker import check_run_problems
...
from fastdup.vl.utils.polars_utils import contains_columns
...
def check_existing_dataset() -> Optional[uuid.UUID]:
    ...
    with connection_manager.get_session() as session:
        try:
            ...
            logger.error(f"error while checking existing dataset: {e}")
