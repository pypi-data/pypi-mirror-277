...
class Settings(metaclass=MyMeta):
    ...
    FILE_FILTER_TREE_INCLUDE_FILES: ConfigValue = ConfigValue(bool, default=False)
    SEARCH_SIMILAR_CLUSTERS_MAX_PREVIEWS: ConfigValue = ConfigValue(int, default=9)
    SEARCH_SIMILAR_CLUSTERS_USE_VECTOR_DB: ConfigValue = ConfigValue(bool, default=False)
    ...
    UNTRACK_BAD_VIDEOS: ConfigValue = ConfigValue(bool, default=False)
    ...
    OBJECTS_ONLY_SAME_VIDEO: ConfigValue = ConfigValue(bool, True)
