...
INTEGRATION = IntegrationTesting(bases=(COLLECTIVE_DMS_BATCHIMPORT,), name="INTEGRATION")

FUNCTIONAL = FunctionalTesting(bases=(COLLECTIVE_DMS_BATCHIMPORT,), name="FUNCTIONAL")
