...
from simple_media_manager.presentation.apis.v2.image import DeleteImageByIdApi, GetImageByIdApi, SearchImagesApi, UpdateImageApi, \
    UploadImageApi
...
urlpatterns = [
    path('image/', include([
        ...
        path('upload', UploadImageApi.as_view(), name='upload_image_v2'),
