...
struct mj_addBufferVFS {
  ...
  static constexpr char doc[] = "Add file to VFS from buffer, return 0: success, 1: full, 2: repeated name, -1: failed to load.";
...
struct mj_makeEmptyFileVFS {
  ...
  static constexpr char doc[] = "deprecated: use mj_copyBufferVFS.";
