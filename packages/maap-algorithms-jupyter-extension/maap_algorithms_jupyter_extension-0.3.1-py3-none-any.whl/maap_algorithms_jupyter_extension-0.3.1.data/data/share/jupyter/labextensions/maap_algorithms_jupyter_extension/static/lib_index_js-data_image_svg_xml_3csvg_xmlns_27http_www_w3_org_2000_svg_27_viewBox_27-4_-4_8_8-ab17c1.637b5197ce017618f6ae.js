...
/* harmony import */ var _TableFileInputs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./TableFileInputs */ "./lib/components/TableFileInputs.js");
/* harmony import */ var _TablePositionalInputs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./TablePositionalInputs */ "./lib/components/TablePositionalInputs.js");
/* harmony import */ var _utils_algoConfig__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/algoConfig */ "./lib/utils/algoConfig.js");
...
/* harmony import */ var _utils_api__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/api */ "./lib/utils/api.js");
...
const RegistrationForm = ({ data }) => {
    ...
    const { registrationUrl, repoRunCommand, algoResource, algoContainer } = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useSelector)(_redux_slices_algorithmSlice__WEBPACK_IMPORTED_MODULE_4__.selectAlgorithm);
    const { setAlgoDesc, setAlgoDiskSpace, setAlgoName, setAlgoResource, setAlgoContainerURL, setRepoBranch, setRepoRunCommand, setRepoBuildCommand, setRepoUrl } = _redux_slices_algorithmSlice__WEBPACK_IMPORTED_MODULE_4__.algorithmActions;
    const validateRepo = (e) => {
        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_5__.checkUrlExists)(e.target.value) ? setValidRepo(true) : setValidRepo(false);
    ...
    async function submitHandler(e) {
        e.preventDefault();
        // setShowSpinner(true)
        let res = await (0,_utils_algoConfig__WEBPACK_IMPORTED_MODULE_6__.registerAlgorithm)();
        if (res) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        (0,_utils_api__WEBPACK_IMPORTED_MODULE_7__.getWorkspaceContainer)().then((param) => {
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__.Form, { onSubmit: submitHandler },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'section-padding' },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null,
                            ...
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", null,
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__.Form.Group, { className: "mb-3 algorithm-input" },
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_select_async__WEBPACK_IMPORTED_MODULE_3__["default"], { cacheOptions: true, defaultOptions: true, value: algoResource, loadOptions: _utils_api__WEBPACK_IMPORTED_MODULE_7__.getResources, onChange: handleResourceChange, placeholder: "Select resource" })))),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null,
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'section-padding' },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_TableFileInputs__WEBPACK_IMPORTED_MODULE_9__.TableFileInputs, null),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_TablePositionalInputs__WEBPACK_IMPORTED_MODULE_10__.TablePositionalInputs, null)),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__.Modal, { show: show, "aria-labelledby": "contained-modal-title-vcenter", onHide: handleModalClose },
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__.Modal.Body, null,
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { href: registrationUrl }, registrationUrl)),
...
/* harmony import */ var _parsers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parsers */ "./lib/utils/parsers.js");
...
async function describeAlgorithms(algo_id) {
    ...
    await fetch(requestUrl.href, {
        ...
        console.log(data);
        body = (0,_parsers__WEBPACK_IMPORTED_MODULE_1__.parseAlgorithmData)(data["response"]);
        console.log(data);
        return body;
    });
    return body;
...
async function getAlgorithms() {
    ...
    await fetch(requestUrl.href, {
        ...
        _redux_store__WEBPACK_IMPORTED_MODULE_2__.store.dispatch(_redux_slices_registeredAlgorithms__WEBPACK_IMPORTED_MODULE_3__.registeredAlgorithmsActions.setAlgorithmsList(algorithms_list_tmp));
...
async function _describeAllAlgorithms() {
    ...
    for (const algorithm of algorithms) {
        ...
        try {
            ...
            console.log(data);
            algorithmData = (0,_parsers__WEBPACK_IMPORTED_MODULE_1__.parseAlgorithmData)(data["response"]);
...
async function describeAllAlgorithms() {
    try {
        ...
        _redux_store__WEBPACK_IMPORTED_MODULE_2__.store.dispatch(_redux_slices_registeredAlgorithms__WEBPACK_IMPORTED_MODULE_3__.registeredAlgorithmsActions.setAlgorithmsData(allData));
    }
    catch (error) {
        console.error('Error fetching data:', error);
    }
...
//# sourceMappingURL=lib_index_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_viewBox_27-4_-4_8_8-ab17c1.637b5197ce017618f6ae.js.map