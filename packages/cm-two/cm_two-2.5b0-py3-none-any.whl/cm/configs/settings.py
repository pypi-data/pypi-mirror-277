...
class Settings:
    ...
    def __init__(self, root, dirpath, mirrored=False, external_cam_frame=None,
        ...
        self.kpp_abort_photocell_waiting_win_btns = [
            ...
            PhotoImage(
                file=self.imgsysdir + 'kpp_abort_photocell_waiting_confirm_btn.png'), 25,
            25,
            'toolbarBtn.TButton',
            PhotoImage(
            ...
            ('kpp_abort_photocell_continue_btn.png', 957.5, 701,
             ...
             PhotoImage(
                 file=self.imgsysdir + 'kpp_abort_photocell_continue_btn.png'), 25,
             25,
             'toolbarBtn.TButton',
             PhotoImage(
        ...
        self.kpp_lift_down_btn = (
            'kpp_lift_down_btn.png', 1028.5, 1040,
            'self.lift_down(mode="manual")',
            PhotoImage(file=self.imgsysdir + 'kpp_lift_down_btn.png'), 20, 220,
            "onGreyBtn.TButton",
            PhotoImage(file=self.imgsysdir + 'kpp_lift_down_btnZ.png'))
