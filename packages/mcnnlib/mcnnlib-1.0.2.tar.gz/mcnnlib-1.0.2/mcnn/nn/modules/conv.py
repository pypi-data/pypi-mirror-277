...
class _manifold_ConvNd(torch.nn.modules.conv._ConvNd):
    def __init__(self, in_channels, out_channels, kernel_size, stride,
                 padding, dilation, transposed, output_padding,
                 groups, bias, padding_mode, weight_manifold, transpose_flag):
        super(_manifold_ConvNd, self).__init__(in_channels, out_channels, kernel_size, stride,
...
class ManifoldConv1d(_manifold_ConvNd):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
        ...
        super(ManifoldConv1d, self).__init__(
...
class ManifoldConv2d(_manifold_ConvNd):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 padding=0, dilation=1, groups=1,
                 bias=True, padding_mode='zeros', weight_manifold=None, transpose_flag=False):
        ...
        super(ManifoldConv2d, self).__init__(
            in_channels, out_channels, kernel_size, stride, padding, dilation,
...
class ManifoldConv3d(_manifold_ConvNd):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
        ...
        super(ManifoldConv3d, self).__init__(
            in_channels, out_channels, kernel_size, stride, padding, dilation,
