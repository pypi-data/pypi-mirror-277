...
"""
from behatconfigleaks.includes import bot
...
from behatconfigleaks.includes import writefile
        ...
        with requests.Session() as session:
            ...
            for endpoint in payreq.text.splitlines():
                ...
                try:
                    ...
                    if response.status_code == 200 and 'default:' in response.text and 'paths:' in response.text and 'suites:' in response.text:
                        outputprint = (
