...
from facex.dataset import get_dataloaders
import numpy as np
...
from facex.plot_facex import plot
...
def facex(test_loader, model, config, r_target):
    ...
    with CustomGradCAM(
        ...
        for idx, (data, target, atts, pth) in enumerate(tqdm(test_loader)):
