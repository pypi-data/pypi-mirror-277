...
from ..models.user_region import UserRegion
from ..models.user_sms_opt_in_status import UserSmsOptInStatus
from ..models.user_units import UserUnits
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.user_scope import UserScope
    from ..models.user_tags import UserTags
...
class User:
    ...
    Attributes:
        ...
        sms_opt_in_status (Union[Unset, None, UserSmsOptInStatus]):
        region (Union[Unset, UserRegion]):
        ...
        units (Union[Unset, UserUnits]):
        timezone (Union[Unset, str]):
        id (Union[Unset, str]):
        created_at (Union[Unset, datetime.datetime]):
        updated_at (Union[Unset, datetime.datetime]):
        tags (Union[Unset, UserTags]):
    """
    ...
    sms_opt_in_status: Union[Unset, None, UserSmsOptInStatus] = UNSET
    region: Union[Unset, UserRegion] = UNSET
    ...
    units: Union[Unset, UserUnits] = UNSET
    timezone: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    created_at: Union[Unset, datetime.datetime] = UNSET
    updated_at: Union[Unset, datetime.datetime] = UNSET
    tags: Union[Unset, "UserTags"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _sms_opt_in_status is None:
            ...
            sms_opt_in_status = UserSmsOptInStatus(_sms_opt_in_status)
