...
class BigdataConnection:
    ...
    # SHARE FILE WITH COMPANY
    # def share_file_with_company(self, file_id: str) -> FileShareResponse:
    #     json_response = self.http.put(f"user-data/files/{file_id}/share", json={})
    #     return FileShareResponse(**json_response)
    #
    # def unshare_file_with_company(self, file_id: str) -> FileShareResponse:
    #     json_response = self.http.put(f"user-data/files/{file_id}/unshare", json={})
    #     return FileShareResponse(**json_response)
