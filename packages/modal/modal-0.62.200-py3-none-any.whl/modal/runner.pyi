...
async def _init_local_app_new(
    client: modal.client._Client, description: str, app_state: int, environment_name: str = "", interactive=False
) -> modal.running_app.RunningApp: ...
async def _init_local_app_from_name(
    client: modal.client._Client, name: str, namespace, environment_name: str = ""
) -> modal.running_app.RunningApp: ...
...
async def _disconnect(
    client: modal.client._Client,
    app_id: str,
    reason: typing.Union[int, None] = None,
    exc_str: typing.Union[str, None] = None,
): ...
def _run_app(
    app: _App,
...
async def _interactive_shell(_app: _App, cmds: typing.List[str], environment_name: str = "", **kwargs): ...
def _run_stub(
    app: _App,
    client: typing.Union[modal.client._Client, None] = None,
    stdout=None,
...
class __interactive_shell_spec(typing_extensions.Protocol):
    def __call__(self, _app: _App, cmds: typing.List[str], environment_name: str = "", **kwargs): ...
    async def aio(self, *args, **kwargs): ...

interactive_shell: __interactive_shell_spec

def run_stub(*args, **kwargs): ...
def deploy_stub(*args, **kwargs): ...
