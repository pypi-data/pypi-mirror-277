...
def main():
    ...
    re_bin_parser = subparsers.add_parser("iter-clean", help="The iterative purify mode. Binning the contigs and cleaning the MAGs with applying the re-binning strategy." +
