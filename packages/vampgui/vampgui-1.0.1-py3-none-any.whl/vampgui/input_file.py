...
# the changement of the order of keyword will change the order of the subtab 
        self.tabkeywords = ["create","material", "dimensions", "sim", "montecarlo",  "exchange", "anisotropy" ,"dipole","hamr","output", "config" ,"screen","cells"]
        self.headerkeywrds =["Creation/material attributes" ,"Creation/material attributes" , "Dimensions System" , 
                           "Simulation","Montecarlo", "Exchange cal.", "Anisotropy cal.", "Dipole field cal.", "HAMR cal.","Output" , "Conf. output", "Screen" ,"cells"]
...
# Buttons   
        tk.Button(button_frame, bg='bisque', text="Load from input", command=self.load_file).grid(row=0, column=1, padx=5, pady=5, sticky="ew")
...
#==========================================            
    def add_create_command(self, tab, keyword):
        ...
        bools = ["voronoi-rounded-grains", "voronoi-row-offset", "crystal-sublattice-materials"]
        ...
        prgsim= [ "benchmark",  "time-series",   "hysteresis-loop", "static-hysteresis-loop", "laser-pulse", "curie-temperature",  "field-cool",  "temperature-pulse",  "electrical-pulse",  "cmc-anisotropy",  "hamr-simulation"] 
...
#===================================================================================================================================           
    ...
    def SubKyewords_list(self,tab,):
        self.create_default_values = {
                    ...
                    "single-spin ": "none",
                    "select-material-by-height ": "none",
                    "select-material-by-geometry ": "none",
                    "fill-core-shell-particles ": "none",
                    "interfacial-roughness ": "none",
                    "material-interfacial-roughness ": "none",
                    "interfacial-roughness-random-seed ": "none",
                    "interfacial-roughness-number-of-seed-points ": "none",
                    "interfacial-roughness-type ": "none",
                    "interfacial-roughness-seed-radius ": "none",
                    "interfacial-roughness-seed-radius-variance ": "none",
                    "interfacial-roughness-mean-height ": "none",
                    "interfacial-roughness-maximum-height ": "none",
                    "interfacial-roughness-height-field-resolution ": "none",
                    "voronoi-size-variance=": "0.01",
                    "voronoi-row-offset=": "false",
                    "voronoi-random-seed=": "10",
                    "voronoi-rounded-grains=": "false",
        ...
        self.dimensions_default_values = {
                    ...
                    "particle-array-offset-x=": "100", 
                    "particle-array-offset-y=": " ",
                    "macro-cell-size=": " "
                    }
        ...
        self.sim_default_values = {
                    ...
                    "second-laser-pulse-maximum-temperature=": " ",
                    ...
                    "constraint-rotation-update ": "none",
        ...
        self.exchange_default_values = {
                    ...
                    "function " : "none" ,
                    "decay-multiplier " : "none",
                    "decay-length " : "none",
                    "decay-shift " : "none",
                    "ucc-exchange-parameters[i][j] " : "none",
                    "dmi-cutoff-range " : "none",
                    "ab-initio " : "none",
        ...
        self.anisotropy_default_values = {
                    ...
                    "surface-anisotropy-nearest-neighbour-range=" : " ",
