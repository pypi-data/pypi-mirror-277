...
# ---------Create help keyword-----------------------------------------Add help content for each keyword
    ...
    elif keyword == "voronoi-row-offset=flag":
    ...
    elif keyword == "voronoi-random-seed = integer":
        help_content += "Sets a different integer random seed for the voronoi seed point generation, and thus produces a different random grain structure."
    elif keyword == "voronoi-rounded-grains=flag":
    ...
    elif keyword == "grain-random-seed integer":
...
# -------------------simulation ---------------
    ...
    elif keyword == "dipole-field-update-rate":
