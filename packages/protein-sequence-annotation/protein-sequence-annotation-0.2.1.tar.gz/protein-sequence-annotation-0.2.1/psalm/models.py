...
class psalm_fam(nn.Module, PyTorchModelHubMixin):
    ...
    def from_pretrained(cls, model_name):
        ...
        model_file = hf_hub_download(f"https://huggingface.co/{model_name}/resolve/main/model.safetensors")
        ...
        config_file = hf_hub_download(f"https://huggingface.co/{model_name}/resolve/main/config.json")
        with open(config_file, 'r') as f:
            config = json.load(f)

        # Download the maps dictionary
        maps_file = hf_hub_download(f"https://huggingface.co/{model_name}/resolve/main/maps.pkl")
