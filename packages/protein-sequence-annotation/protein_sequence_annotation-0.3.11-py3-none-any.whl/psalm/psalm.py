...
class psalm:
    ...
    def annotate(self, seq_list, save_pth=None):
        """
        ...
        - save_pth (str, optional): The path to save the visualization plots. Default is None.
        ...
        for i, seq_tup in enumerate(seq_list):
            ...
            plot_predictions(fam_preds, clan_preds, self.fam_maps, self.threshold, seq_name, save_pth=save_pth)