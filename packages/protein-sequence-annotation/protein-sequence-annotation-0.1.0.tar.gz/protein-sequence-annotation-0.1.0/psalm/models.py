from huggingface_hub import PyTorchModelHubMixin, cached_download
import safetensors
...
class psalm_fam(nn.Module, PyTorchModelHubMixin):
    ...
    def forward(self, x, x_clan, clan_family_matrix):
        """
    ...
    def from_pretrained(cls, model_name):
        ...
        model_file = cached_download(f"https://huggingface.co/{model_name}/resolve/main/model.safetensors")
        ...
        config_file = cached_download(f"https://huggingface.co/{model_name}/resolve/main/config.json")
        with open(config_file, 'r') as f:
            config = json.load(f)

        # Download the maps dictionary
        maps_file = cached_download(f"https://huggingface.co/{model_name}/resolve/main/maps.pkl")
