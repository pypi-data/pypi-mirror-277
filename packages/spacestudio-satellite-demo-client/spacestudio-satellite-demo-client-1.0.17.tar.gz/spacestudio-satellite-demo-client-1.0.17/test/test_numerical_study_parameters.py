    ...
    def make_instance(self, include_optional) -> NumericalStudyParameters:
        ...
        if include_optional:
            return NumericalStudyParameters(
                numerical_outputs_configuration = spacestudio_satellite_demo_client.models.numerical_outputs_configuration.NumericalOutputsConfiguration(
                ...
                maneuvering_strategy = spacestudio_satellite_demo_client.models.maneuvering_strategy.ManeuveringStrategy(
                ...
                simulation_configuration = spacestudio_satellite_demo_client.models.simulation_configuration.SimulationConfiguration(
