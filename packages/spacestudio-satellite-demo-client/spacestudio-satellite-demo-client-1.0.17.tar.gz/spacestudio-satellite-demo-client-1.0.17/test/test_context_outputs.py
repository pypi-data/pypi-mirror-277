...
class TestContextOutputs(unittest.TestCase):
    """ContextOutputs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContextOutputs:
        """Test ContextOutputs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContextOutputs`
        """
        model = ContextOutputs()
        if include_optional:
