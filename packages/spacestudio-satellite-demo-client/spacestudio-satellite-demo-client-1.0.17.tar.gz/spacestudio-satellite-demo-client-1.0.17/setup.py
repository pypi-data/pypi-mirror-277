...
NAME = "spacestudio-satellite-demo-client"
VERSION = "1.0.17"
PYTHON_REQUIRES = ">=3.7"
REQUIRES = [
...
setup(
    name=NAME,
    version=VERSION,
    description="spacestudio satellite demo API documentation",
    author="OpenAPI Generator community",
    author_email="team@openapitools.org",
    url="",
    keywords=["OpenAPI", "OpenAPI-Generator", "spacestudio satellite demo API documentation"],
    ...
    This API is a demo version of the SpaceStudio Satellite API. It is a simplified version of the SpaceStudio Satellite API, with a limited set of functionalities and a reduced set of endpoints. It is intended to be used for demonstration purposes only.
    """,  # noqa: E501
    package_data={"spacestudio_satellite_demo_client": ["py.typed"]},
)
