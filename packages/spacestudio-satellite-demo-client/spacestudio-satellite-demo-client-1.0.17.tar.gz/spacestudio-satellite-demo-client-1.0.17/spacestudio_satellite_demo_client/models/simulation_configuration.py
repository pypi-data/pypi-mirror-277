...
class SimulationConfiguration(BaseModel):
    ...
    """ # noqa: E501
    propagation_type: Optional[StrictStr] = Field(default=None, description="The propagation type", alias="propagationType")
    maximum_simulation_duration: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The maximum simulation duration", alias="maximumSimulationDuration")
    __properties: ClassVar[List[str]] = ["propagationType", "maximumSimulationDuration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maximumSimulationDuration": obj.get("maximumSimulationDuration")
        })
        return _obj
