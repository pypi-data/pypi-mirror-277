...
class NumericalEphemeris(BaseModel):
    """
    TODO
    """ # noqa: E501
    ephemerides: Optional[List[List[Union[StrictFloat, StrictInt]]]] = Field(default=None, description="TODO")
    field_indexes: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, alias="fieldIndexes")
    __properties: ClassVar[List[str]] = ["ephemerides", "fieldIndexes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NumericalEphemeris from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NumericalEphemeris from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fieldIndexes": obj.get("fieldIndexes")
        })
        return _obj
