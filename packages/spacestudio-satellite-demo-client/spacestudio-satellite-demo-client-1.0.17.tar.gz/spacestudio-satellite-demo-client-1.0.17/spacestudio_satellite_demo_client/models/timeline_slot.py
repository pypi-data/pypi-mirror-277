...
class TimelineSlot(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ManeuverTimelineSlot, OrbitTimelineSlot]]:
        ...
        if object_type ==  'ManeuverTimelineSlot':
            return import_module("spacestudio_satellite_demo_client.models.maneuver_timeline_slot").ManeuverTimelineSlot.from_dict(obj)
        if object_type ==  'OrbitTimelineSlot':
            return import_module("spacestudio_satellite_demo_client.models.orbit_timeline_slot").OrbitTimelineSlot.from_dict(obj)
