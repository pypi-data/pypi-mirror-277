...
function GetOciSubcommands_monitoring() {
    $ociSubcommands = @{
        ...
        'monitoring alarm-suppression' = 'create create-alarm-suppression-alarm-suppression-alarm-target delete get summarize-alarm-suppression-history'
...
function GetOciCommandsToLongParams_monitoring() {
    $ociCommandsToLongParams = @{
        ...
        'monitoring alarm create' = 'body compartment-id defined-tags destinations display-name freeform-tags from-json help is-enabled is-notifications-per-metric-dimension-enabled max-wait-seconds message-format metric-compartment-id metric-compartment-id-in-subtree namespace notification-version overrides pending-duration query-text repeat-notification-duration resolution resource-group rule-name severity suppression wait-for-state wait-interval-seconds'
        ...
        'monitoring alarm-suppression create' = 'alarm-suppression-target defined-tags description dimensions display-name freeform-tags from-json help max-wait-seconds time-suppress-from time-suppress-until wait-for-state wait-interval-seconds'
        'monitoring alarm-suppression create-alarm-suppression-alarm-suppression-alarm-target' = 'alarm-suppression-target-alarm-id defined-tags description dimensions display-name freeform-tags from-json help max-wait-seconds time-suppress-from time-suppress-until wait-for-state wait-interval-seconds'
        ...
        'monitoring alarm-suppression-collection list-alarm-suppressions' = 'alarm-id all display-name from-json help lifecycle-state limit page page-size sort-by sort-order'
...
function GetOciCommandsToShortParams_monitoring() {
    $ociCommandsToShortParams = @{
        ...
        'monitoring alarm-suppression create-alarm-suppression-alarm-suppression-alarm-target' = '? h'
        ...
        'monitoring alarm-suppression-collection list-alarm-suppressions' = '? h'
