...
setup(
    ...
    install_requires=['### package_auto_assembler.py', 'requests', 'stdlib-list', 'attrs>=22.2.0', 'nbconvert', 'pip_audit==2.7.3', 'pyyaml', 'pandas', 'nbformat'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A tool to automate package creation within ci based on just .py and optionally .ipynb file.", keywords="['python', 'packaging']", version="0.1.7"
)
