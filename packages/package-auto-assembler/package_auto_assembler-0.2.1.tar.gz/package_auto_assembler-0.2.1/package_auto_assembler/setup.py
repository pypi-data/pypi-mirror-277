...
setup(
    ...
    install_requires=['### package_auto_assembler.py', 'stdlib-list', 'attrs>=22.2.0', 'nbconvert', 'pyyaml', 'requests', 'nbformat', 'pandas', 'pip_audit==2.7.3', 'click'],
    ...
    entry_points = {'console_scripts': ['package_auto_assembler = package_auto_assembler.cli:cli']},

    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A tool to automate package creation within ci based on just .py and optionally .ipynb file.", keywords="['python', 'packaging']", version="0.2.1"
)
