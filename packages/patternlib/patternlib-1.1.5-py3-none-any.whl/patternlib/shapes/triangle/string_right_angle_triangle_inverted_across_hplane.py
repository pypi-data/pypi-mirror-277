...
def string_right_angle_triangle_inverted_across_hplane(string=STD_STRING1):
    '''
     P Y T H O N
     P Y T H O
     P Y T H
    ...
    To view pattern run: 'print(string_right_angle_triangle_inverted_across_hplane.__doc__)'
    '''
