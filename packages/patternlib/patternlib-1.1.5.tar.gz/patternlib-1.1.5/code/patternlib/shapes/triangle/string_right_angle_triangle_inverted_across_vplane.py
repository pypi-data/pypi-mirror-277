...
def string_right_angle_triangle_inverted_across_vplane(string=STD_STRING1):
    '''
               P
             P Y
           P Y T
    ...
    To view pattern run: 'print(string_right_angle_triangle_inverted_across_vplane.__doc__)'
    '''
