...
class TestScenarioWithStudies(unittest.TestCase):
    """ScenarioWithStudies unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScenarioWithStudies:
        """Test ScenarioWithStudies
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScenarioWithStudies`
        """
        model = ScenarioWithStudies()
        if include_optional:
            return ScenarioWithStudies(
                scenario = spacestudio_satellite_client.models.scenario.scenario(
                    id = '', 
                    name = '', 
                    description = '', 
                ...
                studies = [
                    spacestudio_satellite_client.models.study.study(
                        id = '', 
                        name = '', 
                        description = '', 
                        scenario_id = '', 
    ...
    def testScenarioWithStudies(self):
        """Test ScenarioWithStudies"""
