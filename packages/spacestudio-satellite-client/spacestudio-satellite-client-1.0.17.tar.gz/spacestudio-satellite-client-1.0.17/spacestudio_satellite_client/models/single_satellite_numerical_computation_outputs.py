...
class SingleSatelliteNumericalComputationOutputs(ComputationOutputs):
    ...
    __properties: ClassVar[List[str]] = ["type", "ephemeridesFrame", "maneuverModel", "numberOfBurns", "thrustDuration", "usedPropellant", "deltaV", "thrusterMeanDutyCycle", "totalWarmupDutyCycle", "meanBurnDurationEstimation", "missionDuration", "numberOfPeriod", "totalImpulse", "finalDutyCycle", "ephemeris"]
