...
class StudyParameters(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AnalyticalStudyParameters, NumericalStudyParameters]]:
        ...
        if object_type ==  'AnalyticalStudyParameters':
            return import_module("spacestudio_satellite_client.models.analytical_study_parameters").AnalyticalStudyParameters.from_dict(obj)
        if object_type ==  'NumericalStudyParameters':
            return import_module("spacestudio_satellite_client.models.numerical_study_parameters").NumericalStudyParameters.from_dict(obj)
