...
class Tab(BaseModel):
    ...
    computation_index: Optional[StrictInt] = Field(default=None, alias="computationIndex")
    plots: Optional[List[Plot]] = None
    __properties: ClassVar[List[str]] = ["name", "computationIndex", "plots"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "computationIndex": obj.get("computationIndex"),
