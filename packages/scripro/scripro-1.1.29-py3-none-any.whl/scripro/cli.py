...
def add_scrip_parser(subparsers):
    """添加SCRIP命令的参数解析器"""
    parser = subparsers.add_parser("atac", help="invoke SCRIP")
    parser.add_argument('scrip_args', nargs=argparse.REMAINDER, help="Additional arguments passed to the SCRIP command")
