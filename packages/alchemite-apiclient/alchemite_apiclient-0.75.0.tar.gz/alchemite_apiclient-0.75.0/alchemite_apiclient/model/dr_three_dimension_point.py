...
class DRThreeDimensionPoint(ModelNormal):
    ...
    def openapi_types():  # noqa
        ...
        return {
            ...
            'y': ([float],),  # noqa: E501
            'z': ([float],),  # noqa: E501
            'cluster': ([int, none_type],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, x, y, z, cluster, *args, **kwargs):  # noqa: E501
        """DRThreeDimensionPoint - a model defined in OpenAPI
        ...
        Keyword Args:
            dimensions (int): The number of dimensions in the reduced dataset.. defaults to 3, must be one of [3, ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, x, y, z, cluster, *args, **kwargs):  # noqa: E501
        """DRThreeDimensionPoint - a model defined in OpenAPI
