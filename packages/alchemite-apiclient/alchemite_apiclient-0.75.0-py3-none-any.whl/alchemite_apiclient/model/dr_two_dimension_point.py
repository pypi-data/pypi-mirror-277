...
class DRTwoDimensionPoint(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, x, y, cluster, *args, **kwargs):  # noqa: E501
        """DRTwoDimensionPoint - a model defined in OpenAPI
        ...
        Keyword Args:
            dimensions (int): The number of dimensions in the reduced dataset.. defaults to 2, must be one of [2, ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, x, y, cluster, *args, **kwargs):  # noqa: E501
        """DRTwoDimensionPoint - a model defined in OpenAPI
