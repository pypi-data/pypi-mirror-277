...
class DROneDimensionPoint(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, x, cluster, *args, **kwargs):  # noqa: E501
        """DROneDimensionPoint - a model defined in OpenAPI
        ...
        Keyword Args:
            dimensions (int): The number of dimensions in the reduced dataset.. defaults to 1, must be one of [1, ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, x, cluster, *args, **kwargs):  # noqa: E501
        """DROneDimensionPoint - a model defined in OpenAPI
