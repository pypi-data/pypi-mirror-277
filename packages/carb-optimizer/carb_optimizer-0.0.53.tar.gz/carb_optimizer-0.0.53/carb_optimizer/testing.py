...
class TestingTimer():
    ...
    def timer2(cls, func, arg1, arg2, N=None):
        ...
        end_time = time.time()
        return (end_time - start_time)/N*1_000_000*1000
timer = TestingTimer.timer
timer1 = TestingTimer.timer1
timer2 = TestingTimer.timer2
...
print("imported m, np, pd, plt, os, sys, decimal; defined T, iseq, raises, require, Timer")
