...
from rockai_cli_app.server.types import File as RockFile, Path as RockPath, Input, URLPath
import types
from typing_extensions import Annotated

ALLOWED_INPUT_TYPES: List[Type[Any]] = [str, int, float, bool, RockFile, RockPath]
