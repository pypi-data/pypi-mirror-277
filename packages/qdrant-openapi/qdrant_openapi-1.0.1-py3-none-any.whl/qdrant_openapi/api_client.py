...
from qdrant_openapi.exceptions import ApiTypeError, ApiValueError, ApiException
from qdrant_openapi.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.cluster_status  # this is an instance of the class Endpoint
        api_instance.cluster_status()  # this invokes api_instance.cluster_status.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cluster_status.callable or self.callable in this class
