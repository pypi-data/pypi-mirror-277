...
class RaftInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'leader': (int, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, term, commit, pending_operations, is_voter, *args, **kwargs):  # noqa: E501
        """RaftInfo - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            leader (int, none_type): Leader of the current term. [optional]  # noqa: E501
            role (bool, date, datetime, dict, float, int, list, str, none_type): Role of this peer in the current term. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, term, commit, pending_operations, is_voter, *args, **kwargs):  # noqa: E501
        """RaftInfo - a model defined in OpenAPI
