...
class TestPointsApi(unittest.TestCase):
    ...
    def test_discover_batch_points(self):
    ...
    def test_recommend_batch_points(self):
    ...
    def test_recommend_point_groups(self):
    ...
    def test_recommend_points(self):
    ...
    def test_search_batch_points(self):
    ...
    def test_search_point_groups(self):
