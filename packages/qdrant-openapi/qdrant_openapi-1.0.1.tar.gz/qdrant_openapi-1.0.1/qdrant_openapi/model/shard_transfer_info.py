...
class ShardTransferInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, shard_id, _from, to, sync, *args, **kwargs):  # noqa: E501
        """ShardTransferInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, shard_id, _from, to, sync, *args, **kwargs):  # noqa: E501
        """ShardTransferInfo - a model defined in OpenAPI
