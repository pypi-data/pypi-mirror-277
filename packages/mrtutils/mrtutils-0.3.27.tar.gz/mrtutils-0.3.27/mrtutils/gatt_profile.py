...
class GattCharacteristic(object):
    ...
    def loadUri(self,uri):
        ...
        #
        #   Bluetoot SIG stopped publishing XML files, this is a temporary workaround:
        #
        self.url = "https://gitlab.com/uprev/public/mrt/gatt-xml/-/raw/master/" + uri + ".xml"
    ...
    def loadServiceUri(self, uri):
        ...
        #   Bluetoot SIG stopped publishing XML files, this is a temporary workaround:
        #
        url = "https://gitlab.com/uprev/public/mrt/gatt-xml/-/raw/master/" + uri + ".xml"
