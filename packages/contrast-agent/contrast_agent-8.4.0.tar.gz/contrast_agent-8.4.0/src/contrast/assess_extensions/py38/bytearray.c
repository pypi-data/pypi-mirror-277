...
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_split, 43)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_rsplit, 41)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_join, 27)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_capitalize, 5)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_title, 48)
...
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_rjust, 39)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_rstrip, 42)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_rpartition, 40)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_splitlines, 44)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_strip, 46)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_swapcase, 47)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_translate, 49)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_upper, 50)
CREATE_HOOK_METHOD(PyByteArray_Type, bytearray_zfill, 51)
