...
CREATE_HOOK_METHOD(PyBytes_Type, bytes_split, 32)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_rsplit, 30)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_join, 19)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_capitalize, 1)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_title, 37)
...
CREATE_HOOK_METHOD(PyBytes_Type, bytes_rjust, 28)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_rstrip, 31)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_rpartition, 29)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_splitlines, 33)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_strip, 35)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_swapcase, 36)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_translate, 38)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_upper, 39)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_zfill, 40)
