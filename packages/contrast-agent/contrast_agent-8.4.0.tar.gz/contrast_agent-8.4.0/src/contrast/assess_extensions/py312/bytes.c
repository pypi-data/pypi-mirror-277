...
#define BYTES_DECODE_OFFSET 5
#define BYTES_REPLACE_OFFSET 26
#define BYTES_SPLIT_OFFSET 35
#define BYTES_RSPLIT_OFFSET 33
#define BYTES_JOIN_OFFSET 20
#define BYTES_CAPITALIZE_OFFSET 2
#define BYTES_TITLE_OFFSET 40
#define BYTES_CENTER_OFFSET 3
#define BYTES_EXPANDTABS_OFFSET 7
#define BYTES_PARTITION_OFFSET 25
#define BYTES_LJUST_OFFSET 21
#define BYTES_LOWER_OFFSET 22
#define BYTES_LSTRIP_OFFSET 23
#define BYTES_RJUST_OFFSET 31
#define BYTES_RSTRIP_OFFSET 34
#define BYTES_RPARTITION_OFFSET 32
#define BYTES_SPLITLINES_OFFSET 36
#define BYTES_STRIP_OFFSET 38
#define BYTES_SWAPCASE_OFFSET 39
#define BYTES_TRANSLATE_OFFSET 41
#define BYTES_UPPER_OFFSET 42
#define BYTES_ZFILL_OFFSET 43
#define BYTES_REMOVEPREFIX_OFFSET 27
#define BYTES_REMOVESUFFIX_OFFSET 28
...
CREATE_HOOK_METHOD(PyBytes_Type, bytes_decode, 5)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_replace, 26)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_split, 35)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_rsplit, 33)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_join, 20)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_capitalize, 2)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_title, 40)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_center, 3)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_expandtabs, 7)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_partition, 25)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_ljust, 21)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_lower, 22)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_lstrip, 23)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_rjust, 31)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_rstrip, 34)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_rpartition, 32)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_splitlines, 36)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_strip, 38)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_swapcase, 39)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_translate, 41)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_upper, 42)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_zfill, 43)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_removeprefix, 27)
CREATE_HOOK_METHOD(PyBytes_Type, bytes_removesuffix, 28)
