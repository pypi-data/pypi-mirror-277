...
from contrast.utils.library_reader.utils import get_installed_dist_top_level_imports
...
class DistributionContext(Singleton):
    ...
    def init(self):
        ...
        if self.installed_dists is not None:
            for dist, top_level_imports in self.installed_dists.items():
                self._build_tld_entries_from_dist(dist, top_level_imports)
    ...
    def _get_dist_ctx_from_file_path(self, file_path):
        ...
        @param file_path: Path to the file (e.g /Users/nliccione/lib/python3.8/site-packages/django/https.py)
        ...
        # Using this as an example: /Users/nliccione/lib/python3.8/site-packages/django/https.py
        ...
        if top_level_name:
            ...
            if len(nodes) == 1:
                ...
                # tests/samples/sample_packages/sample_namespace_pkg1 and sample_namespace_pkg2
    ...
    def _build_tld_entries_from_dist(self, dist: str, top_level_imports: set):
        """
        ...
        For example, if /Users/nliccione/lib/python3.8/site-packages/django/https.py is the file that is imported, an entry in self.top_level_dir_map
