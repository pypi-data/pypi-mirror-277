...
from contrast.utils.loggers.logger import SecureSysLogHandler
    ...
    def __init__(self):
        ...
        self.default_options = [
            ...
            ConfigOption(
                ...
                default_value=SecureSysLogHandler.protocol("UDP"),
                type_cast=SecureSysLogHandler.protocol,
            ),
            ConfigOption(
            ...
            ConfigOption(
                ...
                default_value=SecureSysLogHandler.severity("ALERT"),
                type_cast=SecureSysLogHandler.severity,
            ),
            ConfigOption(
                canonical_name="agent.security_logger.syslog.severity_blocked",
                default_value=SecureSysLogHandler.severity("NOTICE"),
                type_cast=SecureSysLogHandler.severity,
            ),
            ConfigOption(
            ...
            ConfigOption(
                ...
                default_value=SecureSysLogHandler.severity("WARNING"),
                type_cast=SecureSysLogHandler.severity,
            ),
            ConfigOption(
