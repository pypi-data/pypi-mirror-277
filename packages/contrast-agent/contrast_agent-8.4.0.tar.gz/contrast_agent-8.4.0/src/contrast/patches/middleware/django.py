...
def initialize_django():
    ...
    signals.request_started.connect(django_every_request)
    ...
    signals.request_finished.connect(django_first_request)
...
def register_patches():
    ...
    register_post_import_hook(patch_django_asgi, DJANGO_ASGI_NAME)
