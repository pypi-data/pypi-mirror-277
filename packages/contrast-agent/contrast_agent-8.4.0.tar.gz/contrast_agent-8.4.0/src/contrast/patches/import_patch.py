...
def post__import__analysis(
    ...
    if len(loaded_files_dict) > 0:
        if req_context.observed_library_usage is None:
            ...
            req_context.observed_library_usage = teamserver_messages.LibraryUsage()

        msg = req_context.observed_library_usage
