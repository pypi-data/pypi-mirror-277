...
class HandlerGroup(BaseHandler[UpdateT]):
    """Group of handlers."""
    ...
    def __init__(  # yapf: disable
        ...
        *,
        ...
        handlers: Sequence[BaseHandler[UpdateT]] | None = None,
        ...
        self._handlers: list[BaseHandler[UpdateT]] = []
    ...
    def add_filter(self, filter: BaseFilter[UpdateT], /) -> None:
    ...
    def add_middleware(  # yapf: disable
        ...
        Usage::
            ...
            def middleware(
                handler: HandlerCallableType[UpdateT]
            ) -> HandlerCallableType[UpdateT]:
    ...
    @overload
    def add_handler(self, handler: BaseHandler[UpdateT], /) -> None:
        ...
    ...
    def add_handler(  # yapf: disable
        self,
        handler: HandlerCallable[UpdateT] | BaseHandler[UpdateT],
        *,
        filters: Sequence[BaseFilter[UpdateT]] | None = None,
        middleware: Sequence[HandlerMiddleware[UpdateT]] | None = None,
        guards: Sequence[HandlerGuard[UpdateT]] | None = None,
        ...
        handler = cast("BaseHandler[UpdateT]", handler)
    ...
    def _validate_handler(self, handler: BaseHandler[UpdateT]) -> None:
        if handler is self:
            raise ValueError(
