...
class BaseHandler(AbstractHandler[UpdateT]):
    ...
    ) -> Iterable[HandlerGuard[UpdateT]]:   # yapf: disable
        return self._guards

    def _get_middleware(
        self, exclude_locals: bool  # noqa: U100
    ) -> Iterable[HandlerMiddleware[UpdateT]]:  # yapf: disable
...
class Handler(BaseHandler[UpdateT]):
    ...
    def __init__(
        ...
        *,
        fn: HandlerCallable[UpdateT] | None = None,
        filters: Sequence[BaseFilter[UpdateT]] | None = None,
        guards: Sequence[HandlerGuard[UpdateT]] | None = None,
        middleware: Sequence[HandlerMiddleware[UpdateT]] | None = None,
        dependencies: dict[str, Provide] | None = None,
    ...
    def __call__(self, fn: HandlerCallable[UpdateT]) -> Self:
        self._fn = fn
        self._kwargs = self._get_fn_kwargs(fn)
        return self

    @staticmethod
    def _get_fn_kwargs(fn: HandlerCallable[UpdateT]) -> set[str]:
    ...
    async def _exec(self, update: UpdateT, /) -> None:
