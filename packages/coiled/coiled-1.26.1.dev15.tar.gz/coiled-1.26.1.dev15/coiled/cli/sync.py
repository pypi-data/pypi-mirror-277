...
from coiled.cli.cluster.ssh import add_key_to_agent, get_ssh_add_path, get_ssh_path
...
def connect_mutagen_sync(
    cloud, cluster_id, console, include_vcs: bool = False, debug=False, ignores: Optional[List[str]] = None
) -> Tuple[bool, str]:
    ignores = ignores or []
