...
try:
    from pydantic import v1 as pydantic_v1  # noqa: TID251
except ImportError:
    import pydantic as pydantic_v1  # noqa: TID251
...
def _field_has_model_type(field: pydantic_v1.fields.ModelField) -> bool:
