...
def _get_secret_resolver(materialization_task_params: MaterializationTaskParams) -> Optional[SecretResolver]:
...
def main():
    ...
    elif "MATERIALIZATION_TASK_PARAMS_S3_URL" in os.environ:
        import boto3
