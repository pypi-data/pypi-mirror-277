...
class UploadApi(object):
    ...
    def upload_by_label_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['preserve_metadata','ticket','level','id','job','files','metadata','content_type',]  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def upload_by_reaper_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['preserve_metadata','ticket','uid_placement','level','id','job','files','metadata','content_type',]  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
