...
HTTP_DELETE_TIMEOUT: Final[int] = env_get_int(key=f"{APP_PREFIX}_HTTP_DELETE_TIMEOUT",
                                              def_value=300)
HTTP_GET_TIMEOUT: Final[int] = env_get_int(key=f"{APP_PREFIX}_HTTP_GET_TIMEOUT",
                                           def_value=300)
HTTP_HEAD_TIMEOUT: Final[int] = env_get_int(key=f"{APP_PREFIX}_HTTP_HEAD_TIMEOUT",
                                            def_value=300)
HTTP_PATCH_TIMEOUT: Final[int] = env_get_int(key=f"{APP_PREFIX}_HTTP_POST_TIMEOUT",
                                             def_value=300)
HTTP_POST_TIMEOUT: Final[int] = env_get_int(key=f"{APP_PREFIX}_HTTP_POST_TIMEOUT",
                                            def_value=300)
HTTP_PUT_TIMEOUT: Final[int] = env_get_int(key=f"{APP_PREFIX}_HTTP_PUT_TIMEOUT",
                                           def_value=300)
...
def http_head(errors: list[str] | None,
    ...
    :param logger: optional logger
    :return: the response to the HEAD operation
    """
    return http_rest(errors=errors,
                     method="HEAD",
                     url=url,
