...
class Texture1f:
    @overload
    def __init__(self: drjit.scalar.Texture1f, shape: Annotated[List[int], FixedSize(1)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    ...
    def eval_fetch(self: drjit.scalar.Texture1f, pos: drjit.scalar.Array1f, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
    def eval_fetch_cuda(self: drjit.scalar.Texture1f, pos: drjit.scalar.Array1f, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
    def eval_fetch_drjit(self: drjit.scalar.Texture1f, pos: drjit.scalar.Array1f, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
...
class Texture1f64:
    @overload
    def __init__(self: drjit.scalar.Texture1f64, shape: Annotated[List[int], FixedSize(1)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    ...
    def eval_fetch(self: drjit.scalar.Texture1f64, pos: drjit.scalar.Array1f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
    def eval_fetch_cuda(self: drjit.scalar.Texture1f64, pos: drjit.scalar.Array1f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
    def eval_fetch_drjit(self: drjit.scalar.Texture1f64, pos: drjit.scalar.Array1f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(2)]: ...
...
class Texture2f:
    @overload
    def __init__(self: drjit.scalar.Texture2f, shape: Annotated[List[int], FixedSize(2)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    ...
    def eval_fetch(self: drjit.scalar.Texture2f, pos: drjit.scalar.Array2f, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
    def eval_fetch_cuda(self: drjit.scalar.Texture2f, pos: drjit.scalar.Array2f, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
    def eval_fetch_drjit(self: drjit.scalar.Texture2f, pos: drjit.scalar.Array2f, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
...
class Texture2f64:
    @overload
    def __init__(self: drjit.scalar.Texture2f64, shape: Annotated[List[int], FixedSize(2)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    ...
    def eval_fetch(self: drjit.scalar.Texture2f64, pos: drjit.scalar.Array2f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
    def eval_fetch_cuda(self: drjit.scalar.Texture2f64, pos: drjit.scalar.Array2f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
    def eval_fetch_drjit(self: drjit.scalar.Texture2f64, pos: drjit.scalar.Array2f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(4)]: ...
...
class Texture3f:
    @overload
    def __init__(self: drjit.scalar.Texture3f, shape: Annotated[List[int], FixedSize(3)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    ...
    def eval_fetch(self: drjit.scalar.Texture3f, pos: drjit.scalar.Array3f, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
    def eval_fetch_cuda(self: drjit.scalar.Texture3f, pos: drjit.scalar.Array3f, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
    def eval_fetch_drjit(self: drjit.scalar.Texture3f, pos: drjit.scalar.Array3f, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
...
class Texture3f64:
    @overload
    def __init__(self: drjit.scalar.Texture3f64, shape: Annotated[List[int], FixedSize(3)], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = FilterMode.Linear, wrap_mode: drjit.WrapMode = WrapMode.Clamp) -> None: ...
    @overload
    ...
    def eval_fetch(self: drjit.scalar.Texture3f64, pos: drjit.scalar.Array3f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
    def eval_fetch_cuda(self: drjit.scalar.Texture3f64, pos: drjit.scalar.Array3f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
    def eval_fetch_drjit(self: drjit.scalar.Texture3f64, pos: drjit.scalar.Array3f64, active: bool = True) -> Annotated[List[List[float]], FixedSize(8)]: ...
