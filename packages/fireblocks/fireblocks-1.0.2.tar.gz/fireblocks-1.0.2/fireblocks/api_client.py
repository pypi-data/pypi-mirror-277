...
from fireblocks.unknown_model import create_unknown_model
from fireblocks.api_response import ApiResponse, T as ApiResponseT
import fireblocks.models
from fireblocks import rest
...
class ApiClient:
    ...
    def call_api(
        ...
        response_data.read()
        return self.response_deserialize(
    ...
    def response_deserialize(
        ...
        response_type = response_types_map.get(
            str(response_data.status), response_types_map.get("default", None)
        )
        if (
            not response_type
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(fireblocks.models, klass)
