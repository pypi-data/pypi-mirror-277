...
def request(api_object: dict, options: dict = {}):
    ...
    Args:
        api_object (dict): Your SkyCiv API Object as a Python dictionary - see docs below for more information.
        options (dict): An optional dictionary with the following parameters
