...
class Sections(ModelCollectionComponent):
    ...
    def add_custom_section(self, name: str, material_id: int, s3d_name: str = None) -> int:
        ...
        Args:
            ...
            material_id (int): The ID of the material that is assigned to the section.
            s3d_name (str): The name to use for this section in the S3D model.
        ...
        next_index = next_object_key(self)
        new_section = Section()
        new_section.load_custom_from_library(name, material_id, s3d_name)
        setattr(self, str(next_index), new_section)
        return next_index
