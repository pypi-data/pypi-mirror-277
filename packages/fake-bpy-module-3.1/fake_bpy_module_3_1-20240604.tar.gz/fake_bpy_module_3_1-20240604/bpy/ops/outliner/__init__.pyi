...
def id_operation(
    ...
    *,
    ...
    Delete Library Override Hierarchy -- Delete this local override (including its hierarchy of override dependencies) and relink its usages to the linked data-blocks.
