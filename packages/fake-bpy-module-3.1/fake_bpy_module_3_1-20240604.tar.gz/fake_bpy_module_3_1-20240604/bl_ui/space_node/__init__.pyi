...
class NodeTreeInterfacePanel:
    def draw_socket_list(
        self, context, in_out, sockets_propname, active_socket_propname
    ):
        """

        :param context:
        :param in_out:
        :param sockets_propname:
        :param active_socket_propname:
        """
        ...
...
class NODE_PT_node_tree_interface_inputs(
    bpy_types.Panel, NodeTreeInterfacePanel, bpy_types._GenericUI
):
    bl_category: typing.Any
    bl_label: typing.Any
    bl_region_type: typing.Any
