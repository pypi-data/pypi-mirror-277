...
def Investigation_decoderCompressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcInvestigation]:
    def _arrow1874(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcInvestigation:
        ...
        return ArcInvestigation(_arrow1861(), _arrow1862(), _arrow1863(), _arrow1864(), _arrow1865(), _arrow1866(), _arrow1867(), _arrow1868(), _arrow1869(), _arrow1870(), _arrow1871(), _arrow1873())

    return object(_arrow1874)
...
def Investigation_ROCrate_encoder(oa: ArcInvestigation) -> Json:
    ...
    def _arrow1877(value_5: str, oa: Any=oa) -> Json:
        return Json(0, value_5)

    def _arrow1878(value_7: str, oa: Any=oa) -> Json:
        return Json(0, value_7)

    def _arrow1879(value_9: str, oa: Any=oa) -> Json:
        return Json(0, value_9)

    def _arrow1880(value_11: str, oa: Any=oa) -> Json:
        return Json(0, value_11)

    def _arrow1883(osr: OntologySourceReference, oa: Any=oa) -> Json:
        return OntologySourceReference_ROCrate_encoder(osr)

    def _arrow1884(oa_1: Publication, oa: Any=oa) -> Json:
        return Publication_ROCrate_encoder(oa_1)

    def _arrow1885(oa_2: Person, oa: Any=oa) -> Json:
        return Person_ROCrate_encoder(oa_2)

    def _arrow1886(s: ArcStudy, oa: Any=oa) -> Json:
        return Study_ROCrate_encoder(None, s)

    def _arrow1887(comment: Comment, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoder(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Investigation_ROCrate_genID(oa))), ("@type", Json(0, "Investigation")), ("additionalType", Json(0, "Investigation")), ("identifier", Json(0, oa.Identifier)), ("filename", Json(0, ArcInvestigation.FileName())), try_include("title", _arrow1877, oa.Title), try_include("description", _arrow1878, oa.Description), try_include("submissionDate", _arrow1879, oa.SubmissionDate), try_include("publicReleaseDate", _arrow1880, oa.PublicReleaseDate), try_include_seq("ontologySourceReferences", _arrow1883, oa.OntologySourceReferences), try_include_seq("publications", _arrow1884, oa.Publications), try_include_seq("people", _arrow1885, oa.Contacts), try_include_seq("studies", _arrow1886, oa.Studies), try_include_seq("comments", _arrow1887, oa.Comments), ("@context", context_jsonvalue)])))


def _arrow1899(get: IGetters) -> ArcInvestigation:
    identifier: str
    ...
    def _arrow1888(__unit: None=None) -> FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]] | None:
    ...
    pattern_input: tuple[FSharpList[ArcStudy], FSharpList[FSharpList[ArcAssay]]] = unzip(default_arg(_arrow1888(), empty()))
    studies_raw: FSharpList[ArcStudy] = pattern_input[0]
    def projection(a: ArcAssay) -> str:
        return a.Identifier

    class ObjectExpr1890:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1889(x: str, y: str) -> bool:
                return x == y
    ...
    assays: Array[ArcAssay] = list(distinct_by(projection, concat(pattern_input[1]), ObjectExpr1890()))
    ...
    def _arrow1895(__unit: None=None) -> Array[OntologySourceReference] | None:
    ...
    def _arrow1896(__unit: None=None) -> Array[Publication] | None:
    ...
    def _arrow1897(__unit: None=None) -> Array[Person] | None:
        arg_17: Decoder_1[Array[Person]] = Decode_resizeArray(Person_ROCrate_decoder)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_17)

    def _arrow1898(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_ROCrate_decoder)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return ArcInvestigation(identifier, _arrow1891(), _arrow1892(), _arrow1893(), _arrow1894(), _arrow1895(), _arrow1896(), _arrow1897(), assays, studies, study_identifiers, _arrow1898())


Investigation_ROCrate_decoder: Decoder_1[ArcInvestigation] = object(_arrow1899)
...
def Investigation_ROCrate_encodeRoCrate(oa: ArcInvestigation) -> Json:
    ...
    def _arrow1901(value: str, oa: Any=oa) -> Json:
        return Json(0, value)

    def _arrow1902(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1903(oa_1: ArcInvestigation, oa: Any=oa) -> Json:
        return Investigation_ROCrate_encoder(oa_1)

    return Json(5, choose(chooser, of_array([try_include("@type", _arrow1901, "CreativeWork"), try_include("@id", _arrow1902, "ro-crate-metadata.json"), try_include("about", _arrow1903, oa), ("conformsTo", conforms_to_jsonvalue), ("@context", context_jsonvalue_1)])))
...
def Investigation_ISAJson_encoder(inv: ArcInvestigation) -> Json:
    ...
    def _arrow1904(value_2: str, inv: Any=inv) -> Json:
        return Json(0, value_2)

    def _arrow1905(value_4: str, inv: Any=inv) -> Json:
        return Json(0, value_4)

    def _arrow1906(value_6: str, inv: Any=inv) -> Json:
        return Json(0, value_6)

    def _arrow1907(value_8: str, inv: Any=inv) -> Json:
        return Json(0, value_8)

    def _arrow1908(oa: Publication, inv: Any=inv) -> Json:
        return Publication_ISAJson_encoder(oa)

    def _arrow1909(person: Person, inv: Any=inv) -> Json:
        return Person_ISAJson_encoder(person)

    def _arrow1910(s: ArcStudy, inv: Any=inv) -> Json:
        return Study_ISAJson_encoder(None, s)

    return Json(5, choose(chooser, of_array([("filename", Json(0, ArcInvestigation.FileName())), ("identifier", Json(0, inv.Identifier)), try_include("title", _arrow1904, inv.Title), try_include("description", _arrow1905, inv.Description), try_include("submissionDate", _arrow1906, inv.SubmissionDate), try_include("publicReleaseDate", _arrow1907, inv.PublicReleaseDate), try_include_seq("ontologySourceReferences", OntologySourceReference_ISAJson_encoder, inv.OntologySourceReferences), try_include_seq("publications", _arrow1908, inv.Publications), try_include_seq("people", _arrow1909, inv.Contacts), try_include_seq("studies", _arrow1910, inv.Studies), try_include_seq("comments", Comment_ISAJson_encoder, inv.Comments)])))


def _arrow1923(get: IGetters) -> ArcInvestigation:
    identifer: str
    match_value: str | None
    object_arg: IOptionalGetter = get.Optional
    match_value = object_arg.Field("identifier", string)
    identifer = create_missing_identifier() if (match_value is None) else match_value
    def _arrow1911(__unit: None=None) -> FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]] | None:
        arg_3: Decoder_1[FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]]] = list_1_1(Study_ISAJson_decoder)
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("studies", arg_3)

    pattern_input: tuple[FSharpList[ArcStudy], FSharpList[FSharpList[ArcAssay]]] = unzip(default_arg(_arrow1911(), empty()))
    studies_raw: FSharpList[ArcStudy] = pattern_input[0]
    def projection(a: ArcAssay) -> str:
        return a.Identifier

    class ObjectExpr1913:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1912(x: str, y: str) -> bool:
                return x == y
    ...
    assays: Array[ArcAssay] = list(distinct_by(projection, concat(pattern_input[1]), ObjectExpr1913()))
    studies: Array[ArcStudy] = list(studies_raw)
    def mapping(a_1: ArcStudy) -> str:
        return a_1.Identifier

    study_identifiers: Array[str] = list(map(mapping, studies_raw))
    def _arrow1915(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("title", string)

    def _arrow1916(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("description", string)

    def _arrow1917(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("submissionDate", string)

    def _arrow1918(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("publicReleaseDate", string)

    def _arrow1919(__unit: None=None) -> Array[OntologySourceReference] | None:
        arg_13: Decoder_1[Array[OntologySourceReference]] = Decode_resizeArray(OntologySourceReference_ISAJson_decoder)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("ontologySourceReferences", arg_13)

    def _arrow1920(__unit: None=None) -> Array[Publication] | None:
        arg_15: Decoder_1[Array[Publication]] = Decode_resizeArray(Publication_ISAJson_decoder)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("publications", arg_15)

    def _arrow1921(__unit: None=None) -> Array[Person] | None:
        arg_17: Decoder_1[Array[Person]] = Decode_resizeArray(Person_ISAJson_decoder)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_17)

    def _arrow1922(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_ISAJson_decoder)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return ArcInvestigation(identifer, _arrow1915(), _arrow1916(), _arrow1917(), _arrow1918(), _arrow1919(), _arrow1920(), _arrow1921(), assays, studies, study_identifiers, _arrow1922())


Investigation_ISAJson_decoder: Decoder_1[ArcInvestigation] = Decode_objectNoAdditionalProperties(Investigation_ISAJson_allowedFields, _arrow1923)
...
def ARCtrl_ArcInvestigation__ArcInvestigation_toJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ArcInvestigation], str]:
    def _arrow1924(obj: ArcInvestigation, spaces: Any=spaces) -> str:
...
def ARCtrl_ArcInvestigation__ArcInvestigation_toCompressedJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ArcInvestigation], str]:
    def _arrow1925(obj: ArcInvestigation, spaces: Any=spaces) -> str:
...
def ARCtrl_ArcInvestigation__ArcInvestigation_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ArcInvestigation], str]:
    def _arrow1926(obj: ArcInvestigation, spaces: Any=spaces) -> str:
...
def ARCtrl_ArcInvestigation__ArcInvestigation_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ArcInvestigation], str]:
    def _arrow1929(obj: ArcInvestigation, spaces: Any=spaces) -> str:
