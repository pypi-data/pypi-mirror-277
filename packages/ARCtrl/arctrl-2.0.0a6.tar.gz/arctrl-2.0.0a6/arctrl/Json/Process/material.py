...
def Material_ROCrate_encoder(oa: Material) -> Json:
    ...
    def _arrow1352(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1353(value_4: MaterialType, oa: Any=oa) -> Json:
        return MaterialType_ROCrate_encoder(value_4)

    def _arrow1354(oa_1: Material, oa: Any=oa) -> Json:
        return Material_ROCrate_encoder(oa_1)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Material_ROCrate_genID(oa))), ("@type", list_1_1(singleton(Json(0, "Material")))), try_include("name", _arrow1352, oa.Name), try_include("type", _arrow1353, oa.MaterialType), try_include_list_opt("characteristics", MaterialAttributeValue_ROCrate_encoder, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow1354, oa.DerivesFrom), ("@context", context_jsonvalue)])))


def _arrow1361(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow1360(get: IGetters) -> Material:
            def _arrow1355(__unit: None=None) -> str | None:
            ...
            def _arrow1357(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", MaterialType_ROCrate_decoder)

            def _arrow1358(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow1359(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow1355(), _arrow1356(), _arrow1357(), _arrow1358(), _arrow1359())

        return object(_arrow1360)

    return decode(None)


Material_ROCrate_decoder: Decoder_1[Material] = _arrow1361()
...
def Material_ISAJson_encoder(oa: Material) -> Json:
    ...
    def _arrow1363(value: str, oa: Any=oa) -> Json:
        return Json(0, value)

    def _arrow1364(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1365(oa_1: MaterialAttributeValue, oa: Any=oa) -> Json:
        return MaterialAttributeValue_ISAJson_encoder(oa_1)

    def _arrow1366(oa_2: Material, oa: Any=oa) -> Json:
        return Material_ISAJson_encoder(oa_2)

    return Json(5, choose(chooser, of_array([try_include("@id", _arrow1363, oa.ID), try_include("name", _arrow1364, oa.Name), try_include("type", MaterialType_ISAJson_encoder, oa.MaterialType), try_include_list_opt("characteristics", _arrow1365, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow1366, oa.DerivesFrom)])))


Material_ISAJson_allowedFields: FSharpList[str] = of_array(["@id", "@type", "name", "type", "characteristics", "derivesFrom", "@context"])

def _arrow1373(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow1372(get: IGetters) -> Material:
            def _arrow1367(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)

            def _arrow1368(__unit: None=None) -> str | None:
                object_arg_1: IOptionalGetter = get.Optional
                return object_arg_1.Field("name", string)

            def _arrow1369(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", MaterialType_ISAJson_decoder)

            def _arrow1370(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
                arg_7: Decoder_1[FSharpList[MaterialAttributeValue]] = list_1_2(MaterialAttributeValue_ISAJson_decoder)
                object_arg_3: IOptionalGetter = get.Optional
                return object_arg_3.Field("characteristics", arg_7)

            def _arrow1371(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow1367(), _arrow1368(), _arrow1369(), _arrow1370(), _arrow1371())

        return Decode_objectNoAdditionalProperties(Material_ISAJson_allowedFields, _arrow1372)

    return decode(None)


Material_ISAJson_decoder: Decoder_1[Material] = _arrow1373()
