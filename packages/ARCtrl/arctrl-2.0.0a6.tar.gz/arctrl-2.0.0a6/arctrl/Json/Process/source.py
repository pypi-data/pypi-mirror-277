...
def Source_ROCrate_encoder(oa: Source) -> Json:
    ...
    def _arrow1395(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Source_ROCrate_genID(oa))), ("@type", list_1_1(singleton(Json(0, "Source")))), try_include("name", _arrow1395, oa.Name), try_include_list_opt("characteristics", MaterialAttributeValue_ROCrate_encoder, oa.Characteristics), ("@context", context_jsonvalue)])))


def _arrow1402(get: IGetters) -> Source:
    ...
    def _arrow1401(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow1397(), _arrow1398(), _arrow1401())


Source_ROCrate_decoder: Decoder_1[Source] = object(_arrow1402)
...
def Source_ISAJson_encoder(oa: Source) -> Json:
    ...
    def _arrow1408(value: str, oa: Any=oa) -> Json:
        return Json(0, value)

    def _arrow1409(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1410(oa_1: MaterialAttributeValue, oa: Any=oa) -> Json:
        return MaterialAttributeValue_ISAJson_encoder(oa_1)

    return Json(5, choose(chooser, of_array([try_include("@id", _arrow1408, oa.ID), try_include("name", _arrow1409, oa.Name), try_include_list_opt("characteristics", _arrow1410, oa.Characteristics)])))


Source_ISAJson_allowedFields: FSharpList[str] = of_array(["@id", "name", "characteristics", "@type", "@context"])

def _arrow1416(get: IGetters) -> Source:
    ...
    return Source(_arrow1411(), _arrow1412(), _arrow1414())


Source_ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(Source_ISAJson_allowedFields, _arrow1416)
...
def ARCtrl_Process_Source__Source_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Source], str]:
    def _arrow1420(f: Source, spaces: Any=spaces) -> str:
...
def ARCtrl_Process_Source__Source_toROCrateString_Static_71136F3F(spaces: int | None=None) -> Callable[[Source], str]:
    def _arrow1422(f: Source, spaces: Any=spaces) -> str:
