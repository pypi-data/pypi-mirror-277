...
def Sample_ROCrate_encoder(oa: Sample) -> Json:
    ...
    def _arrow1460(value_4: str, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1461(x: Json, oa: Any=oa) -> Json:
        return x

    return Json(5, choose(chooser, of_array([("@id", Json(0, Sample_ROCrate_genID(oa))), ("@type", list_1_2(singleton(Json(0, "Sample")))), try_include("name", _arrow1460, oa.Name), try_include_list("additionalProperties", _arrow1461, additional_properties), ("@context", context_jsonvalue)])))


class ObjectExpr1463(Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]]):
    def Decode(self, s: IDecoderHelpers_1[__A_], json: __A_) -> FSharpResult_2[tuple[MaterialAttributeValue | None, FactorValue | None], tuple[str, ErrorReason_1[__A_]]]:
        def _arrow1462(__unit: None=None) -> str:
        ...
        if (_arrow1462() if s.has_property("additionalType", json) else "") == "FactorValue":
...
Sample_ROCrate_additionalPropertyDecoder: Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]] = ObjectExpr1463()

def _arrow1467(get: IGetters) -> Sample:
    ...
    def _arrow1464(__unit: None=None) -> str | None:
    ...
    def _arrow1466(__unit: None=None) -> FSharpList[Source] | None:
        arg_7: Decoder_1[FSharpList[Source]] = list_1_3(Source_ROCrate_decoder)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("derivesFrom", arg_7)

    return Sample(_arrow1464(), _arrow1465(), pattern_input[0], pattern_input[1], _arrow1466())


Sample_ROCrate_decoder: Decoder_1[Sample] = object(_arrow1467)
...
def Sample_ISAJson_encoder(oa: Sample) -> Json:
    ...
    def _arrow1476(fv: FactorValue, oa: Any=oa) -> Json:
        return FactorValue_ISAJson_encoder(fv)

    def _arrow1477(oa_2: Source, oa: Any=oa) -> Json:
        return Source_ISAJson_encoder(oa_2)

    return Json(5, choose(chooser, of_array([try_include("@id", _arrow1473, oa.ID), try_include("name", _arrow1474, oa.Name), try_include_list_opt("characteristics", _arrow1475, oa.Characteristics), try_include_list_opt("factorValues", _arrow1476, oa.FactorValues), try_include_list_opt("derivesFrom", _arrow1477, oa.DerivesFrom)])))


Sample_ISAJson_allowedFields: FSharpList[str] = of_array(["@id", "name", "characteristics", "factorValues", "derivesFrom", "@type", "@context"])

def _arrow1487(get: IGetters) -> Sample:
    ...
    def _arrow1480(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    def _arrow1481(__unit: None=None) -> FSharpList[FactorValue] | None:
        arg_7: Decoder_1[FSharpList[FactorValue]] = list_1_3(FactorValue_ISAJson_decoder)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("factorValues", arg_7)

    def _arrow1484(__unit: None=None) -> FSharpList[Source] | None:
        arg_9: Decoder_1[FSharpList[Source]] = list_1_3(Source_ISAJson_decoder)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("derivesFrom", arg_9)

    return Sample(_arrow1478(), _arrow1479(), _arrow1480(), _arrow1481(), _arrow1484())


Sample_ISAJson_decoder: Decoder_1[Sample] = Decode_objectNoAdditionalProperties(Sample_ISAJson_allowedFields, _arrow1487)
...
def ARCtrl_Process_Sample__Sample_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Sample], str]:
    def _arrow1490(f: Sample, spaces: Any=spaces) -> str:
...
def ARCtrl_Process_Sample__Sample_toROCrateString_Static_71136F3F(spaces: int | None=None) -> Callable[[Sample], str]:
    def _arrow1491(f: Sample, spaces: Any=spaces) -> str:
