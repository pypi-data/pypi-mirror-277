...
def get_protocol_names(process_sequence: FSharpList[Process]) -> FSharpList[str]:
    ...
    class ObjectExpr356:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow355(x: str, y: str) -> bool:
                return x == y
    ...
    return List_distinct(choose(chooser, process_sequence), ObjectExpr356())
...
def get_protocols(process_sequence: FSharpList[Process]) -> FSharpList[Protocol]:
    ...
    return List_distinct(choose(chooser, process_sequence), ObjectExpr357())
...
def filter_by_protocol_name(protocol_name: str, process_sequence: FSharpList[Process]) -> FSharpList[Process]:
    def _arrow358(p: Protocol, protocol_name: Any=protocol_name, process_sequence: Any=process_sequence) -> bool:
        return equals(p.Name, protocol_name)

    return filter_by_protocol_by(_arrow358, process_sequence)
...
def get_parameters(process_sequence: FSharpList[Process]) -> FSharpList[ProtocolParameter]:
    ...
    return List_distinct(collect(mapping, process_sequence), ObjectExpr359())
...
def get_characteristics(process_sequence: FSharpList[Process]) -> FSharpList[MaterialAttribute]:
    ...
    return List_distinct(collect(mapping, process_sequence), ObjectExpr360())
...
def get_factors(process_sequence: FSharpList[Process]) -> FSharpList[Factor]:
    ...
    return List_distinct(collect(mapping, process_sequence), ObjectExpr363())
...
def get_root_inputs(process_sequence: FSharpList[Process]) -> FSharpList[ProcessInput]:
    ...
    outputs: Any = of_list(collect(mapping_2, process_sequence), ObjectExpr365())
...
def get_final_outputs(process_sequence: FSharpList[Process]) -> FSharpList[ProcessOutput]:
    ...
    inputs: Any = of_list(collect(mapping_1, process_sequence), ObjectExpr367())
...
def get_root_input_of(process_sequence: FSharpList[Process], sample: str) -> FSharpList[str]:
    ...
    def mapping_2(p: Process, process_sequence: Any=process_sequence, sample: Any=sample) -> FSharpList[tuple[str, str]]:
        ...
        return List_distinct(zip(map(mapping, value_4(p.Outputs)), map(mapping_1, value_4(p.Inputs))), ObjectExpr370())

    class ObjectExpr372:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow371(x_1: str, y_1: str) -> bool:
                return x_1 == y_1
    ...
    mappings: Any = of_list_1(map(mapping_4, List_groupBy(projection, collect(mapping_2, process_sequence), ObjectExpr372())), ObjectExpr373())
...
def get_final_outputs_of(process_sequence: FSharpList[Process], sample: str) -> FSharpList[str]:
    ...
    def mapping_2(p: Process, process_sequence: Any=process_sequence, sample: Any=sample) -> FSharpList[tuple[str, str]]:
        ...
        return List_distinct(zip(map(mapping, value_4(p.Inputs)), map(mapping_1, value_4(p.Outputs))), ObjectExpr374())
...
def get_units(process_sequence: FSharpList[Process]) -> FSharpList[OntologyAnnotation]:
    def _arrow378(p: Process, process_sequence: Any=process_sequence) -> FSharpList[OntologyAnnotation]:
    ...
    return List_distinct(collect(_arrow378, process_sequence), ObjectExpr379())
...
def get_data(process_sequence: FSharpList[Process]) -> FSharpList[Data]:
    ...
    return List_distinct(collect(mapping, process_sequence), ObjectExpr380())
...
def get_sources(process_sequence: FSharpList[Process]) -> FSharpList[Source]:
    ...
    return List_distinct(collect(mapping, process_sequence), ObjectExpr381())
...
def get_samples(process_sequence: FSharpList[Process]) -> FSharpList[Sample]:
    ...
    return List_distinct(collect(mapping, process_sequence), ObjectExpr382())
...
def get_materials(process_sequence: FSharpList[Process]) -> FSharpList[Material]:
    ...
    return List_distinct(collect(mapping, process_sequence), ObjectExpr383())
