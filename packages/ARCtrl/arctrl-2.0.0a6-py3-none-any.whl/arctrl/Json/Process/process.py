...
def Process_ROCrate_encoder(study_name: str | None, assay_name: str | None, oa: Process) -> Json:
    ...
    def _arrow1495(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1496(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Protocol_ROCrate_encoder(study_name, assay_name, oa.Name, oa_1)

    def _arrow1497(author_list: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Person_ROCrate_encodeAuthorListString(author_list)

    def _arrow1498(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1499(value_6: ProcessInput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return ProcessInput_ROCrate_encoder(value_6)

    def _arrow1500(value_7: ProcessOutput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return ProcessOutput_ROCrate_encoder(value_7)

    def _arrow1501(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoder(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Process_ROCrate_genID(oa))), ("@type", list_1_1(singleton(Json(0, "Process")))), try_include("name", _arrow1495, oa.Name), try_include("executesProtocol", _arrow1496, oa.ExecutesProtocol), try_include_list_opt("parameterValues", ProcessParameterValue_ROCrate_encoder, oa.ParameterValues), try_include("performer", _arrow1497, oa.Performer), try_include("date", _arrow1498, oa.Date), try_include_list_opt("inputs", _arrow1499, oa.Inputs), try_include_list_opt("outputs", _arrow1500, oa.Outputs), try_include_list_opt("comments", _arrow1501, oa.Comments), ("@context", context_jsonvalue)])))


def _arrow1511(get: IGetters) -> Process:
    ...
    def _arrow1504(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", Protocol_ROCrate_decoder)

    def _arrow1505(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
    ...
    def _arrow1508(__unit: None=None) -> FSharpList[ProcessInput] | None:
    ...
    def _arrow1509(__unit: None=None) -> FSharpList[ProcessOutput] | None:
    ...
    def _arrow1510(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(Comment_ROCrate_decoder)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Process(_arrow1502(), _arrow1503(), _arrow1504(), _arrow1505(), _arrow1506(), _arrow1507(), None, None, _arrow1508(), _arrow1509(), _arrow1510())


Process_ROCrate_decoder: Decoder_1[Process] = object(_arrow1511)
...
def Process_ISAJson_encoder(oa: Process) -> Json:
    ...
    def _arrow1513(value: str, oa: Any=oa) -> Json:
        return Json(0, value)

    def _arrow1514(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1515(oa_1: Protocol, oa: Any=oa) -> Json:
        return Protocol_ISAJson_encoder(oa_1)

    def _arrow1516(oa_2: ProcessParameterValue, oa: Any=oa) -> Json:
        return ProcessParameterValue_ISAJson_encoder(oa_2)

    def _arrow1517(value_4: str, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1518(value_6: str, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1519(oa_3: Process, oa: Any=oa) -> Json:
        return Process_ISAJson_encoder(oa_3)

    def _arrow1520(oa_4: Process, oa: Any=oa) -> Json:
        return Process_ISAJson_encoder(oa_4)

    def _arrow1521(value_8: ProcessInput, oa: Any=oa) -> Json:
        return ProcessInput_ISAJson_encoder(value_8)

    def _arrow1522(value_9: ProcessOutput, oa: Any=oa) -> Json:
        return ProcessOutput_ISAJson_encoder(value_9)

    return Json(5, choose(chooser, of_array([try_include("@id", _arrow1513, oa.ID), try_include("name", _arrow1514, oa.Name), try_include("executesProtocol", _arrow1515, oa.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow1516, oa.ParameterValues), try_include("performer", _arrow1517, oa.Performer), try_include("date", _arrow1518, oa.Date), try_include("previousProcess", _arrow1519, oa.PreviousProcess), try_include("nextProcess", _arrow1520, oa.NextProcess), try_include_list_opt("inputs", _arrow1521, oa.Inputs), try_include_list_opt("outputs", _arrow1522, oa.Outputs), try_include_list_opt("comments", Comment_ISAJson_encoder, oa.Comments)])))


def _arrow1535(__unit: None=None) -> Decoder_1[Process]:
    def decode(__unit: None=None) -> Decoder_1[Process]:
        def _arrow1534(get: IGetters) -> Process:
            def _arrow1523(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)
            ...
            def _arrow1525(__unit: None=None) -> Protocol | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("executesProtocol", Protocol_ISAJson_decoder)

            def _arrow1526(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
            ...
            def _arrow1533(__unit: None=None) -> FSharpList[Comment] | None:
                arg_21: Decoder_1[FSharpList[Comment]] = list_1_2(Comment_ISAJson_decoder)
                object_arg_10: IOptionalGetter = get.Optional
                return object_arg_10.Field("comments", arg_21)

            return Process(_arrow1523(), _arrow1524(), _arrow1525(), _arrow1526(), _arrow1527(), _arrow1528(), _arrow1529(), _arrow1530(), _arrow1531(), _arrow1532(), _arrow1533())

        return object(_arrow1534)

    return decode(None)


Process_ISAJson_decoder: Decoder_1[Process] = _arrow1535()
...
def ARCtrl_Process_Process__Process_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Process], str]:
    def _arrow1536(f: Process, spaces: Any=spaces) -> str:
...
def ARCtrl_Process_Process__Process_toROCrateString_Static_39E0BC3F(study_name: str | None=None, assay_name: str | None=None, spaces: int | None=None) -> Callable[[Process], str]:
    def _arrow1537(f: Process, study_name: Any=study_name, assay_name: Any=assay_name, spaces: Any=spaces) -> str:
