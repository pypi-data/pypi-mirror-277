...
def Study_encoder(study: ArcStudy) -> Json:
    ...
    def _arrow1710(value_1: str, study: Any=study) -> Json:
        return Json(0, value_1)

    def _arrow1711(value_3: str, study: Any=study) -> Json:
        return Json(0, value_3)

    def _arrow1712(value_5: str, study: Any=study) -> Json:
        return Json(0, value_5)

    def _arrow1713(value_7: str, study: Any=study) -> Json:
        return Json(0, value_7)

    def _arrow1714(oa: Publication, study: Any=study) -> Json:
        return Publication_encoder(oa)

    def _arrow1715(person: Person, study: Any=study) -> Json:
        return Person_encoder(person)

    def _arrow1716(oa_1: OntologyAnnotation, study: Any=study) -> Json:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow1717(table: ArcTable, study: Any=study) -> Json:
        return ArcTable_encoder(table)

    def _arrow1718(value_9: str, study: Any=study) -> Json:
        return Json(0, value_9)

    def _arrow1719(comment: Comment, study: Any=study) -> Json:
        return Comment_encoder(comment)

    return Json(5, choose(chooser, of_array([("Identifier", Json(0, study.Identifier)), try_include("Title", _arrow1710, study.Title), try_include("Description", _arrow1711, study.Description), try_include("SubmissionDate", _arrow1712, study.SubmissionDate), try_include("PublicReleaseDate", _arrow1713, study.PublicReleaseDate), try_include_seq("Publications", _arrow1714, study.Publications), try_include_seq("Contacts", _arrow1715, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow1716, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow1717, study.Tables), try_include_seq("RegisteredAssayIdentifiers", _arrow1718, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow1719, study.Comments)])))


def _arrow1731(get: IGetters) -> ArcStudy:
    ...
    def _arrow1727(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow1728(__unit: None=None) -> Array[ArcTable] | None:
    ...
    return ArcStudy(_arrow1720(), _arrow1721(), _arrow1722(), _arrow1723(), _arrow1724(), _arrow1725(), _arrow1726(), _arrow1727(), _arrow1728(), None, _arrow1729(), _arrow1730())


Study_decoder: Decoder_1[ArcStudy] = object(_arrow1731)
...
def Study_encoderCompressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> Json:
    ...
    def _arrow1732(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Json(0, value_1)

    def _arrow1733(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Json(0, value_3)

    def _arrow1734(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Json(0, value_5)

    def _arrow1735(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Json(0, value_7)

    def _arrow1736(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Publication_encoder(oa)

    def _arrow1737(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Person_encoder(person)

    def _arrow1738(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow1739(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return ArcTable_encoderCompressed(string_table, oa_table, cell_table, table)

    def _arrow1740(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Json(0, value_9)

    def _arrow1741(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> Json:
        return Comment_encoder(comment)

    return Json(5, choose(chooser, of_array([("Identifier", Json(0, study.Identifier)), try_include("Title", _arrow1732, study.Title), try_include("Description", _arrow1733, study.Description), try_include("SubmissionDate", _arrow1734, study.SubmissionDate), try_include("PublicReleaseDate", _arrow1735, study.PublicReleaseDate), try_include_seq("Publications", _arrow1736, study.Publications), try_include_seq("Contacts", _arrow1737, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow1738, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow1739, study.Tables), try_include_seq("RegisteredAssayIdentifiers", _arrow1740, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow1741, study.Comments)])))
...
def Study_decoderCompressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow1753(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        def _arrow1742(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)

        def _arrow1743(__unit: None=None) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("Title", string)
        ...
        def _arrow1747(__unit: None=None) -> Array[Publication] | None:
            arg_11: Decoder_1[Array[Publication]] = Decode_resizeArray(Publication_decoder)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("Publications", arg_11)

        def _arrow1748(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = Decode_resizeArray(Person_decoder)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Contacts", arg_13)

        def _arrow1749(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = Decode_resizeArray(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("StudyDesignDescriptors", arg_15)

        def _arrow1750(__unit: None=None) -> Array[ArcTable] | None:
            arg_17: Decoder_1[Array[ArcTable]] = Decode_resizeArray(ArcTable_decoderCompressed(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Tables", arg_17)

        def _arrow1751(__unit: None=None) -> Array[str] | None:
            arg_19: Decoder_1[Array[str]] = Decode_resizeArray(string)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("RegisteredAssayIdentifiers", arg_19)

        def _arrow1752(__unit: None=None) -> Array[Comment] | None:
            arg_21: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_decoder)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("Comments", arg_21)

        return ArcStudy(_arrow1742(), _arrow1743(), _arrow1744(), _arrow1745(), _arrow1746(), _arrow1747(), _arrow1748(), _arrow1749(), _arrow1750(), None, _arrow1751(), _arrow1752())

    return object(_arrow1753)
...
def Study_ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> Json:
    ...
    def _arrow1754(value_4: str, assays: Any=assays, s: Any=s) -> Json:
        return Json(0, value_4)

    def _arrow1755(value_6: str, assays: Any=assays, s: Any=s) -> Json:
        return Json(0, value_6)

    def _arrow1756(value_8: str, assays: Any=assays, s: Any=s) -> Json:
        return Json(0, value_8)

    def _arrow1757(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> Json:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow1758(value_10: str, assays: Any=assays, s: Any=s) -> Json:
        return Json(0, value_10)

    def _arrow1759(value_12: str, assays: Any=assays, s: Any=s) -> Json:
        return Json(0, value_12)

    def _arrow1760(oa_1: Publication, assays: Any=assays, s: Any=s) -> Json:
        return Publication_ROCrate_encoder(oa_1)

    def _arrow1761(oa_2: Person, assays: Any=assays, s: Any=s) -> Json:
        return Person_ROCrate_encoder(oa_2)

    def _arrow1763(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], Json]:
        study_name: str | None = s.Identifier
        def _arrow1762(oa_3: Process) -> Json:
            return Process_ROCrate_encoder(study_name, None, oa_3)

        return _arrow1762

    def _arrow1765(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], Json]:
        study_name_1: str | None = s.Identifier
        def _arrow1764(a_1: ArcAssay) -> Json:
            return Assay_ROCrate_encoder(study_name_1, a_1)

        return _arrow1764

    def _arrow1766(comment: Comment, assays: Any=assays, s: Any=s) -> Json:
        return Comment_ROCrate_encoder(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Study_ROCrate_genID(s))), ("@type", list_1_1(singleton(Json(0, "Study")))), ("additionalType", Json(0, "Study")), ("identifier", Json(0, s.Identifier)), try_include("filename", _arrow1754, file_name), try_include("title", _arrow1755, s.Title), try_include("description", _arrow1756, s.Description), try_include_seq("studyDesignDescriptors", _arrow1757, s.StudyDesignDescriptors), try_include("submissionDate", _arrow1758, s.SubmissionDate), try_include("publicReleaseDate", _arrow1759, s.PublicReleaseDate), try_include_seq("publications", _arrow1760, s.Publications), try_include_seq("people", _arrow1761, s.Contacts), try_include_list("processSequence", _arrow1763(), processes), try_include_seq("assays", _arrow1765(), assays_1), try_include_seq("comments", _arrow1766, s.Comments), ("@context", context_jsonvalue)])))
...
def _arrow1782(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    ...
    identifier: str = default_arg(bind(Study_tryIdentifierFromFileName, _arrow1767()), create_missing_identifier())
    ...
    return (ArcStudy(identifier, _arrow1771(), _arrow1773(), _arrow1775(), _arrow1776(), _arrow1778(), _arrow1779(), _arrow1780(), tables, None, assay_identifiers, _arrow1781()), default_arg(assays, empty()))
...
def ARCtrl_ArcStudy__ArcStudy_toJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ArcStudy], str]:
    def _arrow1806(obj: ArcStudy, spaces: Any=spaces) -> str:
...
def ARCtrl_ArcStudy__ArcStudy_toROCrateJsonString_Static_3BA23086(assays: FSharpList[ArcAssay] | None=None, spaces: int | None=None) -> Callable[[ArcStudy], str]:
    def _arrow1808(obj: ArcStudy, assays: Any=assays, spaces: Any=spaces) -> str:
...
def ARCtrl_ArcStudy__ArcStudy_toISAJsonString_Static_3BA23086(assays: FSharpList[ArcAssay] | None=None, spaces: int | None=None) -> Callable[[ArcStudy], str]:
    def _arrow1809(obj: ArcStudy, assays: Any=assays, spaces: Any=spaces) -> str:
