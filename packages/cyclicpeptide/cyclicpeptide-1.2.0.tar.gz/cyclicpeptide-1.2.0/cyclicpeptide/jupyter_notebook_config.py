...
#  Default: ''
c.ServerApp.notebook_dir = '/Users/willow/willow_jupyter'
...
#  Default: ''
c.ServerApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$v2dHNmFBGLk0Xd+AFAoH0A$STgWt5erjGYisQecyzDYLu98sGkL0loEtJBMbTY2bzE'
