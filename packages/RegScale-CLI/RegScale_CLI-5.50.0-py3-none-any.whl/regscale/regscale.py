...
Application = import_command_with_timing("regscale.core.app.application", "Application")
actions = import_command_with_timing("regscale.core.app.internal.admin_actions", "actions")
assessments = import_command_with_timing("regscale.core.app.internal.assessments_editor", "assessments")
catalog = import_command_with_timing("regscale.core.app.internal.catalog", "catalog")
compare = import_command_with_timing("regscale.core.app.internal.comparison", "compare")
control_editor = import_command_with_timing("regscale.core.app.internal.control_editor", "control_editor")
...
evidence = import_command_with_timing("regscale.core.app.internal.evidence", "evidence")
file_upload = import_command_with_timing("regscale.core.app.internal.file_uploads", "file_upload")
migrations = import_command_with_timing("regscale.core.app.internal.migrations", "migrations")
issues = import_command_with_timing("regscale.core.app.internal.poam_editor", "issues")

############################################################
# Public Integrations
############################################################
alienvault = import_command_with_timing("regscale.core.app.public.otx", "alienvault")
cisa = import_command_with_timing("regscale.integrations.public.cisa", "cisa")
emass = import_command_with_timing("regscale.core.app.public.emass", "emass")
fedramp = import_command_with_timing("regscale.core.app.public.fedramp.fedramp", "fedramp")
nist = import_command_with_timing("regscale.core.app.public.nist_catalog", "nist")
oscal = import_command_with_timing("regscale.core.app.public.oscal", "oscal")

############################################################
# Commercial Integrations
############################################################
ad = import_command_with_timing("regscale.integrations.commercial.ad", "ad")
aqua = import_command_with_timing("regscale.integrations.commercial.aqua", "aqua")
aws = import_command_with_timing("regscale.integrations.commercial.aws", "aws")
azure = import_command_with_timing("regscale.integrations.commercial.azure", "azure")
burp = import_command_with_timing("regscale.integrations.commercial.burp", "burp")
crowdstrike = import_command_with_timing("regscale.integrations.commercial.crowdstrike", "crowdstrike")
defender = import_command_with_timing("regscale.integrations.commercial.defender", "defender")
dependabot = import_command_with_timing("regscale.integrations.commercial.dependabot", "dependabot")
ecr = import_command_with_timing("regscale.integrations.commercial.ecr", "ecr")
gcp = import_command_with_timing("regscale.integrations.commercial.gcp", "gcp")
gitlab = import_command_with_timing("regscale.integrations.commercial.gitlab", "gitlab")
jira = import_command_with_timing("regscale.integrations.commercial.jira", "jira")
nexpose = import_command_with_timing("regscale.integrations.commercial.nexpose", "nexpose")
okta = import_command_with_timing("regscale.integrations.commercial.okta", "okta")
prisma = import_command_with_timing("regscale.integrations.commercial.prisma", "prisma")
qualys = import_command_with_timing("regscale.integrations.commercial.qualys", "qualys")
salesforce = import_command_with_timing("regscale.integrations.commercial.salesforce", "salesforce")
servicenow = import_command_with_timing("regscale.integrations.commercial.servicenow", "servicenow")
sicura = import_command_with_timing("regscale.integrations.commercial.sicura", "sicura")
stigv2 = import_command_with_timing("regscale.integrations.commercial.stigv2", "stigv2")
snyk = import_command_with_timing("regscale.integrations.commercial.snyk", "snyk")
sonarcloud = import_command_with_timing("regscale.integrations.commercial.sonarcloud", "sonarcloud")
tenable = import_command_with_timing("regscale.integrations.commercial.tenable", "tenable")
wiz = import_command_with_timing("regscale.integrations.commercial.wiz", "wiz")
xray = import_command_with_timing("regscale.integrations.commercial.xray", "xray")
