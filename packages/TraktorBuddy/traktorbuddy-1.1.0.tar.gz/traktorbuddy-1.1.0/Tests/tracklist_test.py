...
def testTrackListTrackWithPlaylistKey(test_tracklist):
    track: Track = test_tracklist.trackWithPlaylistKey('Macintosh HD/:Users/:didier/:Music/:Gigs/:Sunrise (Original Mix).mp3')
    assert track is not None
    assert track.title() == 'Sunrise (Original Mix)'


def testTrackListUnknownTrackWithPlaylistKey(test_tracklist):
    assert test_tracklist.trackWithPlaylistKey('Macintosh HD/:Users/:didier/:Music/:Gigs/:Does Not Exist.mp3') is None


def testTrackListNoElement():
    tracklist: TrackList = TrackList(None)
    assert tracklist.tracks() == []
    assert tracklist.trackWithPlaylistKey('Macintosh HD/:Users/:didier/:Music/:Gigs/:Does Not Exist.mp3') is None
