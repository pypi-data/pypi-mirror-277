...
missing_classes_that_are_not_in_scripting_reference = ["IntFolder", "ElmSite", "ComVstab", "ComQvcurves", "ComMod", "ElmSecctrl", "ElmLod", "ElmIac", "ElmLodlv", "ElmLodmv", "ElmSind", "ElmVsc", "ElmVscmono", "ElmZpu"]
