...
class GetEdgeType(BaseModel):
    ...
    vertex_type_pair_relations: Optional[List[BaseEdgeTypeVertexTypePairRelationsInner]] = None
    type_id: Optional[StrictInt] = None
    description: Optional[StrictStr] = None
    properties: Optional[List[GetPropertyMeta]] = None
    __properties: ClassVar[List[str]] = ["type_name", "vertex_type_pair_relations", "type_id", "description", "properties"]
