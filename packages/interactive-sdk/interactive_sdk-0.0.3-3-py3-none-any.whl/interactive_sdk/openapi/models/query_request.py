...
class QueryRequest(BaseModel):
    ...
    arguments: Optional[List[TypedValue]] = None
    __properties: ClassVar[List[str]] = ["query_name", "arguments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "arguments": [TypedValue.from_dict(_item) for _item in obj["arguments"]] if obj.get("arguments") is not None else None
        })
        return _obj
