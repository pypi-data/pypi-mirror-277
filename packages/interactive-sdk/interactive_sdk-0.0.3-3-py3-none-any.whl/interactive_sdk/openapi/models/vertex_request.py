...
class VertexRequest(BaseModel):
    ...
    """ # noqa: E501
    label: StrictStr
    primary_key_value: Optional[Any]
    properties: Optional[PropertyArray] = None
    __properties: ClassVar[List[str]] = ["label", "primary_key_value", "properties"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if primary_key_value (nullable) is None
        # and model_fields_set contains the field
        if self.primary_key_value is None and "primary_key_value" in self.model_fields_set:
            _dict['primary_key_value'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": PropertyArray.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
