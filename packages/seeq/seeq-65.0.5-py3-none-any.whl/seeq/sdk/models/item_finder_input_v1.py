...
class ItemFinderInputV1(object):
    ...
    def __init__(self, cron_schedule=None, description=None, enabled=True, fixed_list_searches=None, name=None, property_searches=None, scoped_to=None, searches=None, timezone=None):
        """
