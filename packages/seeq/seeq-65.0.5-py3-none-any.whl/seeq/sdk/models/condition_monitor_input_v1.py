...
class ConditionMonitorInputV1(object):
    ...
    def __init__(self, condition_ids=None, cron_schedule=None, description=None, enabled=True, first_run_look_back=None, item_finder_id=None, name=None, query_range_look_ahead=None, timezone=None, webhook_url=None):
        """
