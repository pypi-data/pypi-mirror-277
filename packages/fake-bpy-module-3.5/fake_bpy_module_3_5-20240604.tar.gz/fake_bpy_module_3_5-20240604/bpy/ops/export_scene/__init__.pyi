...
def gltf(
    ...
    *,
    filepath: str | typing.Any = "",
    check_existing: bool | typing.Any | None = True,
    convert_lighting_mode: str | None = "SPEC",
    ...
    export_optimize_animation_size: bool | typing.Any | None = False,
    ...
    """Export scene as glTF 2.0 file
        ...
        :param check_existing: Check Existing, Check and warn on overwriting existing files
        :type check_existing: bool | typing.Any | None
        :param convert_lighting_mode: Lighting Mode, Optional backwards compatibility for non-standard render engines. Applies to lights
    ...
    Raw (Deprecated) -- Blender lighting strengths with no conversion.
        :type convert_lighting_mode: str | None
