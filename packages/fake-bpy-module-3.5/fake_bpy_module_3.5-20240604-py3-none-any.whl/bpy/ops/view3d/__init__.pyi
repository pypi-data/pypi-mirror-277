...
def interactive_add(
    ...
    *,
    ...
    plane_axis_auto: bool | typing.Any | None = False,
    plane_depth: str | None = "SURFACE",
    plane_orientation: str | None = "SURFACE",
    snap_target: str | None = "GEOMETRY",
    ...
    """Interactively add an object
        ...
        :type plane_axis_auto: bool | typing.Any | None
    ...
    Default -- Use the current transform orientation.
        ...
        :param snap_target: Snap to, The target to use while snapping
...
def select(
    ...
    *,
    ...
    vert_without_handles: bool | typing.Any | None = False,
    ...
    :type vert_without_handles: bool | typing.Any | None
