...
class CondaEnvironment(PythonEnvironment):
    ...
    def __init__(self, project: Project) -> None:
        ...
        self._env_candidates: dict[str, CondaCandidate] | None = None
    ...
    @property
    def env_candidates(self) -> dict[str, CondaCandidate]:
        if self._env_candidates is None:
            self._env_candidates = {}
        ...
        return self._env_candidates  # type: ignore
