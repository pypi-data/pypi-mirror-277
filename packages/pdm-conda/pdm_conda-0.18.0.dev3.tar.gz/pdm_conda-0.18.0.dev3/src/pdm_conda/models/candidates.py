...
class CondaCandidate(Candidate):
    ...
    @staticmethod
    def from_setup_distribution(dist: CondaSetupDistribution) -> CondaCandidate:
        """Create conda candidate from conda setup distribution.

        :param dist: conda setup distribution
        :return: conda candidate
        """
        return CondaCandidate.from_lock_package(dist.package)
