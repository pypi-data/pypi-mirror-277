...
class ContactLocationLocal(GenericMapping):
    ...
    def get_or_create_group_id(self, *, group_name: str, profile_id: int, group_category_id: int = None,
        ...
        group_id = self.groups_local.select_one_value_by_column_and_value(
        ...
        if not group_id:
            ...
            if group_lang_code != LangCode.HEBREW:  # TODO: why?
                group_lang_code = LangCode.ENGLISH

            upsert_group_result = self.groups_local.upsert(
