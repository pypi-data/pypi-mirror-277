...
class Base:
    ...
    init_defaults: typing.Dict[str, typing.Any] = {}
    ...
    def schema(self):
        ...
        return self.schema_cls().model_validate(self)
...
class Task(IngestRefMixin, StatusMixin, Base):
    ...
    __table_args__ = (sqla.Index("ix_proc_stats", "ingest_id", "status"),sqla.Index('idx_task_pending_type', "type", postgresql_where="status" == 'pending'))
