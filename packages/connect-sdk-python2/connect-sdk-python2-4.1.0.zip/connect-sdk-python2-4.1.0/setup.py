...
def test_collector():
    """Function to collect tests cases to run for the 'pip connect-sdk-python2 tests' command"""
...
setup(
    ...
    url="https://github.com/Worldline-Global-Collect/connect-sdk-python2",
    ...
    # test_suite="tests/run_unit_tests"   # enables command 'pip connect-sdk-python2 test', which runs unit tests)
