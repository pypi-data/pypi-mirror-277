...
def main():
  ...
  from images_dataset.meta import Meta
  ...
  archive = Meta.Archive(archive=args.archive, format=format, num_images=args.num_files)
  meta = Meta(images_dataset={ name: archive })
