...
class AutoSwaps:
    ...
    :example:
    >>> apollopayment_api.auto_swaps.create_swap(
    ...
    :example:
    >>> apollopayment_api.auto_swaps.get_swap_by_id("18f36b77-bb02-4517-a548-d3989917e784")
    """
    ...
    def __repr__(self):
        return "<apollopayment_api.AutoSwaps>"
