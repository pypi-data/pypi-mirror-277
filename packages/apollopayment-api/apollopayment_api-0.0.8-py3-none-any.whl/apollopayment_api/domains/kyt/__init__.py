...
class KYT:
    ...
    :example:
    >>> apollopayment_api.kyt.check_transaction_risk(
            "0x00E2453...",
            "USDT",
            "ethereum",
            "0x023434a...",
    ...
    :example:
    >>> apollopayment_api.kyt.check_withdrawal_risk(
            "0x023434a...",
            "USDT",
            "ethereum",
            "0.1"
    ...
    :example:
    >>> apollopayment_api.kyt.check_withdrawal_address(
