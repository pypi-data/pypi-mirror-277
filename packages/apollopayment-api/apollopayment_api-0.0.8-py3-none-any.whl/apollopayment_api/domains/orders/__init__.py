...
class Orders:
    ...
    :example:
    >>> apollopayment_api.orders.create_order(
            "USDT",
            "ethereum",
            "0.0001",
            "order-1234",
    ...
    :example:
    >>> apollopayment_api.orders.get_order_by_id("8e2d5033-139f-46d4-b769-4a2d2cee37c4")
    """
    ...
    :example:
    >>> apollopayment_api.orders.get_orders()
    """
    ...
    def __repr__(self):
        return "<apollopayment_api.Orders>"
