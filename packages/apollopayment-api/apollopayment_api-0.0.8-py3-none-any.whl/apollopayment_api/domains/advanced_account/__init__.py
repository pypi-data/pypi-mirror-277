...
class AdvancedAccount:
    ...
    :example:
    >>> apollopayment_api.advanced_account.get_all_advanced_balances()
    """
    ...
    :example:
    >>> apollopayment_api.advanced_account.get_advanced_balance()
    """
    ...
    :example:
    >>> apollopayment_api.advanced_account.get_payment_address(
            "ethereum", 
            "USDT"
        )
    """
    ...
    def __repr__(self):
        return "<apollopayment_api.AdvancedBalance>"
