...
class AddressBook:
    ...
    :example:
    >>> apollopayment_api.address_book.add_address(
    ...
    :example:
    >>> apollopayment_api.address_book.delete_address("cd3867c2-2d55-4bfa-be7e-b2964ccedcc4")
    """
    ...
    :example:
    >>> apollopayment_api.address_book.update_address(
    ...
    :example:
    >>> apollopayment_api.address_book.get_addresses()
    """
    ...
    def __repr__(self):
        return "<apollopayment_api.AddressBook>"
