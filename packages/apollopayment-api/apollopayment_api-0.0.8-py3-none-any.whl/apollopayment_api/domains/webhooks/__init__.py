...
class Webhooks:
    ...
    :example:
    >>> apollopayment_api.webhooks.get_webhook_by_id("8d7db145-80cc-4c43-9cfb-9cde10f8ef40")
    """
    ...
    :example:
    >>> apollopayment_api.webhooks.get_webhook_by_id_extended(
    ...
    def __repr__(self):
        return "<apollopayment_api.Webhooks>"
