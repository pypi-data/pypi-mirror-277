...
class CrosschainSwaps:
    ...
    :example:
    >>> apollopayment_api.crosschain_swaps.get_commission_token(
            "USDT",
            "USDT",
            "ethereum",
            "tron",
    ...
    :example:
    >>> apollopayment_api.crosschain_swaps.get_limits()
    """
    ...
    :example:
    >>> apollopayment_api.crosschain_swaps.get_transfer_by_id("de2b4697-c758-4759-aa87-218a486589c7")
    """
    ...
    :example:
    >>> apollopayment_api.crosschain_swaps.create_transfer(
    ...
    def __repr__(self):
        return "<apollopayment_api.CrosschainSwaps>"
