...
class PersonalAddresses:
    ...
    :example:
    >>> apollopayment_api.personal_addresses.create_or_update_user(
            "id123",
            "user@mail.com",
            "User Name",
        )
    ...
    :example:
    >>> apollopayment_api.personal_addresses.get_user_address(
    ...
    :example:
    >>> apollopayment_api.personal_addresses.get_addresses(limit=10, offset=0)
    """
    ...
    :example:
    >>> apollopayment_api.personal_addresses.get_user("463fa3c3-bc26-451a-9eb9-5cb0d7d7c5aa")
    """
    ...
    def __repr__(self):
        return "<apollopayment_api.PersonalAddresses>"
