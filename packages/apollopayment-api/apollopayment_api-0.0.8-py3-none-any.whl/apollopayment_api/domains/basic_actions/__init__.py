...
class BasicActions:
    ...
    :example:
    >>> apollopayment_api.basic_actions.check_x_api_signature()
    """
    ...
    :example:
    >>> apollopayment_api.basic_actions.get_currencies()
    """
    ...
    :example:
    >>> apollopayment_api.basic_actions.get_current_price("BTC", "USDT")
    """
    ...
    :example:
    >>> apollopayment_api.basic_actions.get_operation_by_tx_hash("0x788529118F2A28C60b9de2Ba0353f5EE4293e044")
    """
    ...
    :example:
    >>> apollopayment_api.basic_actions.check_address_format("0x788529118F2A28C60b9a0353f5EE4293e044", "ethereum")
    """
    ...
    def __repr__(self):
        return "<apollopayment_api.BasicActions>"
