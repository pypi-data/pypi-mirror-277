...
def updateBin(rootDir):
    ...
    asset_url, asset_md5, version, headers = getTpSdkConfig()
    if version:
        getOssResource(rootDir, asset_url, asset_md5, "skymedia.zip.py", headers)
    ...
    if extra_skymedia:
        ...
        effects = os.path.join(rootDir, "skymedia","effects")
