...
class BaseFrameCountDataGatherer(DataGatherer):
    ...
    def __init__(
        ...
        self._trigger: Union[TriggerBasic, TriggerBasicMobile]  # typedef only
        self._filter_content = Union[PortFilterContent,
                                     EndpointFilterContent]  # typedef only

        self._rx_vlan_header_size: int = 0
        self._rx_result: TriggerBasicResultHistory  # typedef only
...
class BaseLatencyFrameCountDataGatherer(DataGatherer):
    ...
    def __init__(
        ...
        self._trigger: Union[LatencyBasic, LatencyBasicMobile]  # typedef only
        self._filter_content = Union[PortFilterContent,
                                     EndpointFilterContent]  # typedef only

        self._rx_vlan_header_size: int = 0
        self._rx_result: LatencyBasicResultHistory  # typedef only
...
class BaseLatencyCDFFrameCountDataGatherer(DataGatherer):
    ...
    def __init__(
        ...
        self._trigger: Union[LatencyDistribution,
                             LatencyDistributionMobile]  # typedef only
        self._filter_content = Union[PortFilterContent,
                                     EndpointFilterContent]  # typedef only
