...
class ChatCompletionParams(betterproto.Message):
    ...
    logit_bias: Dict[int, float] = betterproto.map_field(
        14, betterproto.TYPE_INT64, betterproto.TYPE_DOUBLE
    )
...
class ChatCompletionResponse(betterproto.Message):
    ...
    original_choices: List["ChatCompletionChoice"] = betterproto.message_field(10)
