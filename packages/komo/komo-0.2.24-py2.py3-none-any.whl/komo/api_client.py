...
def _make_request_and_raise_for_status(method, url, headers, files, data):
    try:
        ...
        # TODO: create client/server exception types, and raise them here accordingly
        raise e
...
class APIClient:
    ...
    def launch_job(
        ...
        payload = {
            ...
            "envs": job_config.envs,
            "file_mounts": job_config.file_mounts,
            "setup": job_config.setup,
            "run": job_config.run,
        }
        if job_config.name:
            payload["name"] = job_config.name
    ...
    def launch_machine(
        ...
        payload = {
            ...
            "envs": machine_config.envs,
            "file_mounts": machine_config.file_mounts,
            "setup": machine_config.setup,
            "notebook": machine_config.notebook,
        }
    ...
    def launch_service(
        ...
        payload = {
            ...
            "envs": service_config.envs,
            "file_mounts": service_config.file_mounts,
            "setup": service_config.setup,
            "run": service_config.run,
            "service": {
                "replica_policy": {
                    "min_replicas": service_config.service.replica_policy.min_replicas,
                    "max_replicas": service_config.service.replica_policy.max_replicas,
                    "target_qps_per_replica": service_config.service.replica_policy.target_qps_per_replica,
                    "upscale_delay_seconds": service_config.service.replica_policy.upscale_delay_seconds,
                    "downscale_delay_seconds": service_config.service.replica_policy.downscale_delay_seconds,
                },
                "readiness_probe": {
                    "path": service_config.service.readiness_probe.path,
                    "post_data": service_config.service.readiness_probe.post_data,
                    "initial_delay_seconds": service_config.service.readiness_probe.initial_delay_seconds,
                },
            },
        }
