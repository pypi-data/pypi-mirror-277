...
class GuiandoHelper(BaseHelper):
    ...
    def _get_transition_type(self, complement_form):
        ...
        if "transacao" in complement_form:
            ...
            raise Exception(f"Nenhum tipo de processo encontrado, Ex: Consumo, Serviço.")

        return transition_type
    
    def prepare_attachment(self, attachment, complement_form, request_type):
