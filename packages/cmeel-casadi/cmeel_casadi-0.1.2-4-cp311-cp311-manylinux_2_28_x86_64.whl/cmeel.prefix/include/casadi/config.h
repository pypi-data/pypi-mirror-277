...
#define CASADI_GIT_REVISION "df6f3fe61ed2ddacdc58e191fc9759fed1084ea6"  // NOLINT(whitespace/line_length)
...
#define CASADI_COMPILER "/opt/rh/gcc-toolset-12/root/bin/g++"  // NOLINT(whitespace/line_length)
