...
set_target_properties(SIREN PROPERTIES
  IMPORTED_LOCATION_RELEASE "/tmp/downloads/local/lib/libSIREN.so"
  IMPORTED_SONAME_RELEASE "libSIREN.so"
  )

list(APPEND _cmake_import_check_targets SIREN )
list(APPEND _cmake_import_check_files_for_SIREN "/tmp/downloads/local/lib/libSIREN.so" )
...
set_target_properties(delabella PROPERTIES
  IMPORTED_LOCATION_RELEASE "/tmp/downloads/local/lib/libdelabella.so"
  IMPORTED_SONAME_RELEASE "libdelabella.so"
  )

list(APPEND _cmake_import_check_targets delabella )
list(APPEND _cmake_import_check_files_for_delabella "/tmp/downloads/local/lib/libdelabella.so" )
