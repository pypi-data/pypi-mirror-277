...
class OrbitPropagationResultFieldIndexesInner(BaseModel):
    """
    OrbitPropagationResultFieldIndexesInner
    """ # noqa: E501
    key: Optional[StrictStr] = None
    index: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["key", "index"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrbitPropagationResultFieldIndexesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrbitPropagationResultFieldIndexesInner from a dict"""
        if obj is None:
            return None
