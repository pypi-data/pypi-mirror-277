...
class SphericalSpacecraftGeometry(SpacecraftGeometry):
    """
    SphericalSpacecraftGeometry
    """ # noqa: E501
    spherical_cross_section: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Represents an average cross section of the spacecraft, regardless of its orientation.", alias="sphericalCrossSection")
    __properties: ClassVar[List[str]] = ["type", "sphericalCrossSection"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SphericalSpacecraftGeometry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SphericalSpacecraftGeometry from a dict"""
        if obj is None:
            return None
