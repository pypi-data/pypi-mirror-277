...
class OrbitParameters(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CircularAltitudeOrbitParameters, CircularGroundTrackRepeatedOrbitParameters, EllipticalGroundTrackRepeatedEccentricityOrbitParameters, EllipticalPerigeeAltApogeeAltOrbitParameters, EllipticalPerigeeAltEccentricityOrbitParameters, EllipticalSmaEccentricityOrbitParameters]]:
        ...
        if object_type ==  'CircularAltitudeOrbitParameters':
            return import_module("spacestudio_orbit_propagation.models.circular_altitude_orbit_parameters").CircularAltitudeOrbitParameters.from_dict(obj)
        if object_type ==  'CircularGroundTrackRepeatedOrbitParameters':
            return import_module("spacestudio_orbit_propagation.models.circular_ground_track_repeated_orbit_parameters").CircularGroundTrackRepeatedOrbitParameters.from_dict(obj)
        if object_type ==  'EllipticalGroundTrackRepeatedEccentricityOrbitParameters':
            return import_module("spacestudio_orbit_propagation.models.elliptical_ground_track_repeated_eccentricity_orbit_parameters").EllipticalGroundTrackRepeatedEccentricityOrbitParameters.from_dict(obj)
        if object_type ==  'EllipticalPerigeeAltApogeeAltOrbitParameters':
            return import_module("spacestudio_orbit_propagation.models.elliptical_perigee_alt_apogee_alt_orbit_parameters").EllipticalPerigeeAltApogeeAltOrbitParameters.from_dict(obj)
        if object_type ==  'EllipticalPerigeeAltEccentricityOrbitParameters':
            return import_module("spacestudio_orbit_propagation.models.elliptical_perigee_alt_eccentricity_orbit_parameters").EllipticalPerigeeAltEccentricityOrbitParameters.from_dict(obj)
        if object_type ==  'EllipticalSmaEccentricityOrbitParameters':
            return import_module("spacestudio_orbit_propagation.models.elliptical_sma_eccentricity_orbit_parameters").EllipticalSmaEccentricityOrbitParameters.from_dict(obj)
