...
class SrpPerturbation(Perturbation):
    """
    SrpPerturbation
    """ # noqa: E501
    absorption_coefficient: Union[StrictFloat, StrictInt] = Field(description="The absorption coefficient.", alias="absorptionCoefficient")
    reflection_coefficient: Union[StrictFloat, StrictInt] = Field(description="The reflection coefficient.", alias="reflectionCoefficient")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SrpPerturbation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SrpPerturbation from a dict"""
        if obj is None:
            return None
