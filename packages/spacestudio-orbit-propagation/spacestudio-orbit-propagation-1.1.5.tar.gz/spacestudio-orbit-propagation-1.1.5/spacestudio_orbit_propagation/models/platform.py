...
class Platform(BaseModel):
    ...
    Platform
    """ # noqa: E501
    mass: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The platform mass (in kilograms).  The thruster mass as well as its propellant mass is not counted in this platform mass. ")
    __properties: ClassVar[List[str]] = ["mass"]
