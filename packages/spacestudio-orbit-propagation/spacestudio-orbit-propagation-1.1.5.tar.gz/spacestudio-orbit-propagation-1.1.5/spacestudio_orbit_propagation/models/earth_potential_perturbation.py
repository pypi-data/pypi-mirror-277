...
class EarthPotentialPerturbation(Perturbation):
    ...
    """ # noqa: E501
    custom_maximum_degree: Optional[StrictInt] = Field(default=None, alias="customMaximumDegree")
    custom_maximum_order: Optional[StrictInt] = Field(default=None, alias="customMaximumOrder")
    __properties: ClassVar[List[str]] = ["type", "customMaximumDegree", "customMaximumOrder"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "customMaximumDegree": obj.get("customMaximumDegree"),
            "customMaximumOrder": obj.get("customMaximumOrder")
        })
        return _obj
