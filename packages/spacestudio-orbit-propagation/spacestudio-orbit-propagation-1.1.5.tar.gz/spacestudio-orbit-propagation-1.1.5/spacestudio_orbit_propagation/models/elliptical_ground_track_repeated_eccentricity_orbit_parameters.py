...
class EllipticalGroundTrackRepeatedEccentricityOrbitParameters(OrbitParameters):
    ...
    """ # noqa: E501
    n: Optional[StrictInt] = Field(default=None, description="//TODO")
    p: Optional[StrictInt] = Field(default=None, description="//TODO")
    q: Optional[StrictInt] = Field(default=None, description="//TODO")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EllipticalGroundTrackRepeatedEccentricityOrbitParameters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EllipticalGroundTrackRepeatedEccentricityOrbitParameters from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "parametersType": obj.get("parametersType"),
            "n": obj.get("n"),
            "p": obj.get("p"),
            "q": obj.get("q")
        })
