...
class Axis(BaseModel):
    ...
    Axis
    """ # noqa: E501
    x: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The axis in the X direction")
    y: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The axis in the Y direction")
    z: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The axis in the Z direction")
