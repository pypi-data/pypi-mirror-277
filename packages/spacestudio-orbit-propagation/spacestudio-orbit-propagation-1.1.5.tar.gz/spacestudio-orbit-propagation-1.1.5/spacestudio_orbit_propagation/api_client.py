...
from spacestudio_orbit_propagation.api_response import ApiResponse, T as ApiResponseT
import spacestudio_orbit_propagation.models
from spacestudio_orbit_propagation import rest
from spacestudio_orbit_propagation.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(spacestudio_orbit_propagation.models, klass)
