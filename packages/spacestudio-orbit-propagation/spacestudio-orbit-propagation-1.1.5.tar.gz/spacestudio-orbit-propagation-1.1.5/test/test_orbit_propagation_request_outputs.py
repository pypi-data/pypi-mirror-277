...
class TestOrbitPropagationRequestOutputs(unittest.TestCase):
    """OrbitPropagationRequestOutputs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitPropagationRequestOutputs:
        """Test OrbitPropagationRequestOutputs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitPropagationRequestOutputs`
        """
        model = OrbitPropagationRequestOutputs()
        if include_optional:
            return OrbitPropagationRequestOutputs(
                ephemerides = [
                    'CARTESIAN'
                    ],
                ephemerides_step = 56,
    ...
    def testOrbitPropagationRequestOutputs(self):
        """Test OrbitPropagationRequestOutputs"""
