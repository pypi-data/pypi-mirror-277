...
class TestSphericalSpacecraftGeometry(unittest.TestCase):
    """SphericalSpacecraftGeometry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SphericalSpacecraftGeometry:
        """Test SphericalSpacecraftGeometry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SphericalSpacecraftGeometry`
        """
        model = SphericalSpacecraftGeometry()
        if include_optional:
            return SphericalSpacecraftGeometry(
    ...
    def testSphericalSpacecraftGeometry(self):
        """Test SphericalSpacecraftGeometry"""
