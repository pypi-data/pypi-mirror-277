...
class TestOrbitParameters(unittest.TestCase):
    """OrbitParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitParameters:
        """Test OrbitParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitParameters`
        """
        model = OrbitParameters()
        if include_optional:
