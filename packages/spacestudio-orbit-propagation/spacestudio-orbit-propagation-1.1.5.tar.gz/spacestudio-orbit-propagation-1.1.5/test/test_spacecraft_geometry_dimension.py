...
class TestSpacecraftGeometryDimension(unittest.TestCase):
    """SpacecraftGeometryDimension unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpacecraftGeometryDimension:
        """Test SpacecraftGeometryDimension
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpacecraftGeometryDimension`
        """
        model = SpacecraftGeometryDimension()
        if include_optional:
            return SpacecraftGeometryDimension(
                x = 1.337,
                y = 1.337,
                z = 1.337
            )
    ...
    def testSpacecraftGeometryDimension(self):
        """Test SpacecraftGeometryDimension"""
