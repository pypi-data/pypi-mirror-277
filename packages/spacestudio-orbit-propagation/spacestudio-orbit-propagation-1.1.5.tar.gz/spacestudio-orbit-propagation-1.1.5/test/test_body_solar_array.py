...
class TestBodySolarArray(unittest.TestCase):
    """BodySolarArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BodySolarArray:
        """Test BodySolarArray
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BodySolarArray`
        """
        model = BodySolarArray()
        if include_optional:
            return BodySolarArray(
                faces = [
                    'PLUS_X'
                    ]
            )
