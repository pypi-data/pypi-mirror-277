...
class TestDeployableRotatingSolarArray(unittest.TestCase):
    """DeployableRotatingSolarArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeployableRotatingSolarArray:
        """Test DeployableRotatingSolarArray
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeployableRotatingSolarArray`
        """
        model = DeployableRotatingSolarArray()
        if include_optional:
            return DeployableRotatingSolarArray(
                rotation_axis = spacestudio_orbit_propagation.models.axis.Axis(
                    x = 1.337, 
                    y = 1.337, 
                    z = 1.337, ),
                surface = 1.337
    ...
    def testDeployableRotatingSolarArray(self):
        """Test DeployableRotatingSolarArray"""
