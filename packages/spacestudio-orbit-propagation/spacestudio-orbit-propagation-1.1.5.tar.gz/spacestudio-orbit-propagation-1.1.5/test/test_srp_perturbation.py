...
class TestSrpPerturbation(unittest.TestCase):
    """SrpPerturbation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SrpPerturbation:
        """Test SrpPerturbation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SrpPerturbation`
        """
        model = SrpPerturbation()
        if include_optional:
            return SrpPerturbation(
