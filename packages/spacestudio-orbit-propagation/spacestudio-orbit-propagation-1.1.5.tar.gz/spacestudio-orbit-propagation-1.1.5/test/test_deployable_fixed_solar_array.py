...
class TestDeployableFixedSolarArray(unittest.TestCase):
    """DeployableFixedSolarArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeployableFixedSolarArray:
        """Test DeployableFixedSolarArray
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeployableFixedSolarArray`
        """
        model = DeployableFixedSolarArray()
        if include_optional:
            return DeployableFixedSolarArray(
                normal_direction = spacestudio_orbit_propagation.models.axis.Axis(
                    x = 1.337, 
                    y = 1.337, 
                    z = 1.337, ),
                surface = 1.337
    ...
    def testDeployableFixedSolarArray(self):
        """Test DeployableFixedSolarArray"""
