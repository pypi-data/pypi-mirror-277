...
class TestOrbitPropagationRequestInputs(unittest.TestCase):
    """OrbitPropagationRequestInputs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitPropagationRequestInputs:
        """Test OrbitPropagationRequestInputs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitPropagationRequestInputs`
        """
        model = OrbitPropagationRequestInputs()
        if include_optional:
            return OrbitPropagationRequestInputs(
    ...
    def testOrbitPropagationRequestInputs(self):
        """Test OrbitPropagationRequestInputs"""
