...
"""Complete wrapper for pdftk.
     ** To Merge Pdf : pdftk().merge( input_files=['file1.pdf','file1.pdf'],output='/your path/your pdf.pdf',user_pw='PrinceIsGod',owner_pw='HeIsTheOnlyOwnerOfWorld' )
     -----------------------------------------------------------------------------------------------------------------------------------------------------------------
     ** To Burst Pdf i.e., Make pdf of each page of pdf : pdftk().burst_pdf('file1.pdf',output_folder='pk',input_pw='passwordofyourpdf')
     -----------------------------------------------------------------------------------------------------------------------------------
