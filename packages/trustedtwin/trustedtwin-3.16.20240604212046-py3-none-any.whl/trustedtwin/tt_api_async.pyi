...
Generated for TT API specification version 3.16.00
"""
...
class TTAsyncRESTService:
    ...
    async def update_notifications_account_access(
        self,
        *args,
        body: Optional[Dict] = None,
        dictionary: Optional[Dict] = None,
        **kwargs
        ...
        Example::
            ...
            >>> tt_client = TTAsyncRESTService(tt_auth="TT_SECRET")
            >>> async def loop():
            >>>   status, text = await tt_client.update_notifications_account_access('a6dc7ec3-0bff-4bb8-aadd-d4e6773cc860')
            >>> asyncio.run(loop())
            >>> status
            200 (int)
            >>> text
    ...
    async def get_notifications_access(
        self, dictionary: Optional[Dict] = None, **kwargs
    ) -> Coroutine[int, str]:
        ...
        Example::
            ...
            >>> tt_client = TTAsyncRESTService(tt_auth="TT_SECRET")
            >>> async def loop():
            >>>   status, text = await tt_client.get_notifications_access()
            >>> asyncio.run(loop())
            >>> status
            200 (int)
            >>> text
    ...
    async def get_sticker(
        ...
        Example::
            ...
            >>> tt_client = TTAsyncRESTService(tt_auth="TT_SECRET")
            >>> async def loop():
            >>>   status, text = await tt_client.get_sticker('085c0f9f-427e-4e23-9a60-bacf6585a862', 'dark-grey')
            >>> asyncio.run(loop())
            >>> status
            200 (int)
            >>> text
    ...
    async def remove_sticker(
        ...
        **kwargs
        ...
        Example::
            ...
            >>> tt_client = TTAsyncRESTService(tt_auth="TT_SECRET")
            >>> async def loop():
            >>>   status, text = await tt_client.remove_sticker('085c0f9f-427e-4e23-9a60-bacf6585a862', 'dark-grey')
            >>> asyncio.run(loop())
            >>> status
            200 (int)
            >>> text
