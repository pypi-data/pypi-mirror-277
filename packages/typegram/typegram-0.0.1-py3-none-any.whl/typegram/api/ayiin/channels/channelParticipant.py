...
ChannelParticipant = Union[api.types.channels.ChannelParticipants, api.types.channels.ChannelParticipant, api.types.channels.AdminLogResults, api.types.channels.SendAsPeers, api.types.channels.SponsoredMessageReportResult]
