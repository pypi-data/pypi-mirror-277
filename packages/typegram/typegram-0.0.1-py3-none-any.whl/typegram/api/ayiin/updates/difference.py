...
Difference = Union[api.types.updates.State, api.types.updates.Difference, api.types.updates.ChannelDifference]
...
class Difference(Object):
    ...
    QUALNAME = "typegram.api.ayiin.difference.Difference"
