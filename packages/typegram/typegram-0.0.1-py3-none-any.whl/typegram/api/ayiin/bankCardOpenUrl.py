...
class BankCardOpenUrl(Object):
    ...
    QUALNAME = "typegram.api.ayiin.bankCardOpenUrl.BankCardOpenUrl"

    def __init__(self):
        raise TypeError("Base ayiin can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrogram.org/telegram/base/bankCardOpenUrl")