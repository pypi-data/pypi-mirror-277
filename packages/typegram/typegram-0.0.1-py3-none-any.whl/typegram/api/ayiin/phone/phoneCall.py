...
PhoneCall = Union[api.types.phone.PhoneCall, api.types.phone.GroupCall, api.types.phone.GroupParticipants, api.types.phone.JoinAsPeers, api.types.phone.ExportedGroupCallInvite, api.types.phone.GroupCallStreamChannels, api.types.phone.GroupCallStreamRtmpUrl]
