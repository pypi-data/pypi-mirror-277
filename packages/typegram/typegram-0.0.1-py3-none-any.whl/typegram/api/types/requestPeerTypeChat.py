...
creator (``bool``, *optional*):
    ...
    def __init__(self, *, creator: Optional[bool] = None, bot_participant: Optional[bool] = None, has_username: Optional[bool] = None, forum: Optional[bool] = None, user_admin_rights: "ayiin.ChatAdminRights" = None, bot_admin_rights: "ayiin.ChatAdminRights" = None) -> None:
