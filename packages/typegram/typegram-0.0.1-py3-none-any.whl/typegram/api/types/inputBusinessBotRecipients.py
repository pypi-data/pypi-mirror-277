...
existing_chats (``bool``, *optional*):
    ...
    ID = 0xc4e5921e
    QUALNAME = "functions.types.InputBusinessBotRecipients"

    def __init__(self, *, existing_chats: Optional[bool] = None, new_chats: Optional[bool] = None, contacts: Optional[bool] = None, non_contacts: Optional[bool] = None, exclude_selected: Optional[bool] = None, users: Optional[List["ayiin.InputUser"]] = None, exclude_users: Optional[List["ayiin.InputUser"]] = None) -> None:
