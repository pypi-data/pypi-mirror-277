...
class JsonArray(Object):  # type: ignore
    """Telegram API type.
...
value (List of :obj:`JSONValue<typegram.api.ayiin.JSONValue>`):
                    N/A
    ...
    ID = 0xf7444763
    QUALNAME = "functions.types.JSONValue"

    def __init__(self, *, value: List["ayiin.JSONValue"]) -> None:
