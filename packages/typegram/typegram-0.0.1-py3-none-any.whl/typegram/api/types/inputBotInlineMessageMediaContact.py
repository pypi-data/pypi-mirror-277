...
class InputBotInlineMessageMediaContact(Object):  # type: ignore
    """Telegram API type.
...
phone_number (``str``):
    ...
    def __init__(self, *, phone_number: str, first_name: str, last_name: str, vcard: str, reply_markup: "ayiin.ReplyMarkup" = None) -> None:
