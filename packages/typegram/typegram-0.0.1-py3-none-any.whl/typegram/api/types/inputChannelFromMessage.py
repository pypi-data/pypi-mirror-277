...
class InputChannelFromMessage(Object):  # type: ignore
    """Telegram API type.

    Constructor of :obj:`~typegram.api.ayiin.InputChannel`.
...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    ID = 0x5b934f9d
    QUALNAME = "functions.types.InputChannel"

    def __init__(self, *, peer: "ayiin.InputPeer", msg_id: int, channel_id: int) -> None:
