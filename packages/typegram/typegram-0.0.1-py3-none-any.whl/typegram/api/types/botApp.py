...
class BotApp(Object):  # type: ignore
    ...
    Constructor of :obj:`~typegram.api.ayiin.BotApp`.
...
id (``int`` ``64-bit``):
    ...
    ID = 0x95fcd1d6
    QUALNAME = "functions.types.BotApp"

    def __init__(self, *, id: int, access_hash: int, short_name: str, title: str, description: str, photo: "ayiin.Photo", hash: int, document: "ayiin.Document" = None) -> None:
