...
class SecureValueErrorTranslationFiles(Object):  # type: ignore
    """Telegram API type.
...
type (:obj:`SecureValueType<typegram.api.ayiin.SecureValueType>`):
    ...
    ID = 0x34636dd8
    QUALNAME = "functions.types.SecureValueError"

    def __init__(self, *, type: "ayiin.SecureValueType", file_hash: List[bytes], text: str) -> None:
