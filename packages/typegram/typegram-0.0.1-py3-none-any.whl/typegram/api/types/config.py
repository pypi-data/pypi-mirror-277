...
class Config(Object):  # type: ignore
    """Telegram API type.

    Constructor of :obj:`~typegram.api.ayiin.Config`.
...
date (``int`` ``32-bit``):
        ...
        reactions_default (:obj:`Reaction<typegram.api.ayiin.Reaction>`, *optional*):
                    N/A
    ...
    def __init__(self, *, date: int, expires: int, test_mode: bool, this_dc: int, dc_options: List["ayiin.DcOption"], dc_txt_domain_name: str, chat_size_max: int, megagroup_size_max: int, forwarded_count_max: int, online_update_period_ms: int, offline_blur_timeout_ms: int, offline_idle_timeout_ms: int, online_cloud_timeout_ms: int, notify_cloud_delay_ms: int, notify_default_delay_ms: int, push_chat_period_ms: int, push_chat_limit: int, edit_time_limit: int, revoke_time_limit: int, revoke_pm_time_limit: int, rating_e_decay: int, stickers_recent_limit: int, channels_read_media_period: int, call_receive_timeout_ms: int, call_ring_timeout_ms: int, call_connect_timeout_ms: int, call_packet_timeout_ms: int, me_url_prefix: str, caption_length_max: int, message_length_max: int, webfile_dc_id: int, default_p2p_contacts: Optional[bool] = None, preload_featured_stickers: Optional[bool] = None, revoke_pm_inbox: Optional[bool] = None, blocked_mode: Optional[bool] = None, force_try_ipv6: Optional[bool] = None, tmp_sessions: Optional[int] = None, autoupdate_url_prefix: Optional[str] = None, gif_search_username: Optional[str] = None, venue_search_username: Optional[str] = None, img_search_username: Optional[str] = None, static_maps_provider: Optional[str] = None, suggested_lang_code: Optional[str] = None, lang_pack_version: Optional[int] = None, base_lang_pack_version: Optional[int] = None, reactions_default: "ayiin.Reaction" = None, autologin_token: Optional[str] = None) -> None:
                ...
                self.default_p2p_contacts = default_p2p_contacts  # true
        
                self.preload_featured_stickers = preload_featured_stickers  # true
        
                self.revoke_pm_inbox = revoke_pm_inbox  # true
        
                self.blocked_mode = blocked_mode  # true
        
                self.force_try_ipv6 = force_try_ipv6  # true
        
                self.tmp_sessions = tmp_sessions  # int
        
                self.autoupdate_url_prefix = autoupdate_url_prefix  # string
        
                self.gif_search_username = gif_search_username  # string
        
                self.venue_search_username = venue_search_username  # string
        
                self.img_search_username = img_search_username  # string
        
                self.static_maps_provider = static_maps_provider  # string
        
                self.suggested_lang_code = suggested_lang_code  # string
        
                self.lang_pack_version = lang_pack_version  # int
        
                self.base_lang_pack_version = base_lang_pack_version  # int
        
                self.reactions_default = reactions_default  # Reaction
        
                self.autologin_token = autologin_token  # string
    ...
    def read(b: BytesIO, *args: Any) -> "Config":
        ...
        reactions_default = Object.read(b) if flags & (1 << 15) else None
