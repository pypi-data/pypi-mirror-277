...
shortcut_id (``int`` ``32-bit``):
    ...
    ID = 0x832175e0
    QUALNAME = "functions.types.InputBusinessAwayMessage"

    def __init__(self, *, shortcut_id: int, schedule: "ayiin.BusinessAwayMessageSchedule", recipients: "ayiin.InputBusinessRecipients", offline_only: Optional[bool] = None) -> None:
