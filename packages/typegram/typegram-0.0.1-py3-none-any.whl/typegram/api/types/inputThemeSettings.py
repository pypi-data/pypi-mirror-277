...
base_theme (:obj:`BaseTheme<typegram.api.ayiin.BaseTheme>`):
    ...
    ID = 0x8fde504f
    QUALNAME = "functions.types.InputThemeSettings"

    def __init__(self, *, base_theme: "ayiin.BaseTheme", accent_color: int, message_colors_animated: Optional[bool] = None, outbox_accent_color: Optional[int] = None, message_colors: Optional[List[int]] = None, wallpaper: "ayiin.InputWallPaper" = None, wallpaper_settings: "ayiin.WallPaperSettings" = None) -> None:
