...
geo_point (:obj:`InputGeoPoint<typegram.api.ayiin.InputGeoPoint>`):
    ...
    def __init__(self, *, geo_point: "ayiin.InputGeoPoint", title: str, address: str, provider: str, venue_id: str, venue_type: str, reply_markup: "ayiin.ReplyMarkup" = None) -> None:
