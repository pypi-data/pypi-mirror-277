...
peer_id (:obj:`Peer<typegram.api.ayiin.Peer>`):
    ...
    ID = 0x8c79b63c
    QUALNAME = "functions.types.MessagePeerReaction"

    def __init__(self, *, peer_id: "ayiin.Peer", date: int, reaction: "ayiin.Reaction", big: Optional[bool] = None, unread: Optional[bool] = None, my: Optional[bool] = None) -> None:
