...
count (``int`` ``32-bit``):
    ...
    ID = 0x71e094f3
    QUALNAME = "functions.typesmessages.Dialogs"

    def __init__(self, *, count: int, dialogs: List["ayiin.Dialog"], messages: List["ayiin.Message"], chats: List["ayiin.Chat"], users: List["ayiin.User"]) -> None:
