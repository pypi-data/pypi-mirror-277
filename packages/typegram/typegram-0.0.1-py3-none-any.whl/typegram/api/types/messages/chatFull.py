...
class ChatFull(Object):  # type: ignore
    ...
    Constructor of :obj:`~typegram.api.ayiin.messages.ChatFull`.

    Details:
        - Layer: ``181``
        - ID: ``E5D7D19C``

full_chat (:obj:`ChatFull<typegram.api.ayiin.ChatFull>`):
                    N/A
    ...
    ID = 0xe5d7d19c
    QUALNAME = "functions.typesmessages.ChatFull"

    def __init__(self, *, full_chat: "ayiin.ChatFull", chats: List["ayiin.Chat"], users: List["ayiin.User"]) -> None:
