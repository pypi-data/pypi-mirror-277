...
class PeerDialogs(Object):  # type: ignore
    """Telegram API type.

    Constructor of :obj:`~typegram.api.ayiin.messages.PeerDialogs`.
...
dialogs (List of :obj:`Dialog<typegram.api.ayiin.Dialog>`):
    ...
    ID = 0x3371c354
    QUALNAME = "functions.typesmessages.PeerDialogs"

    def __init__(self, *, dialogs: List["ayiin.Dialog"], messages: List["ayiin.Message"], chats: List["ayiin.Chat"], users: List["ayiin.User"], state: "ayiinupdates.State") -> None:
