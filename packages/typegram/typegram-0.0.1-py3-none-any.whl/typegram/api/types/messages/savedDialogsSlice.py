...
count (``int`` ``32-bit``):
    ...
    ID = 0x44ba9dd9
    QUALNAME = "functions.typesmessages.SavedDialogs"

    def __init__(self, *, count: int, dialogs: List["ayiin.SavedDialog"], messages: List["ayiin.Message"], chats: List["ayiin.Chat"], users: List["ayiin.User"]) -> None:
