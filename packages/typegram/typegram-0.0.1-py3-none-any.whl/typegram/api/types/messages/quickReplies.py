...
quick_replies (List of :obj:`QuickReply<typegram.api.ayiin.QuickReply>`):
    ...
    ID = 0xc68d6695
    QUALNAME = "functions.typesmessages.QuickReplies"

    def __init__(self, *, quick_replies: List["ayiin.QuickReply"], messages: List["ayiin.Message"], chats: List["ayiin.Chat"], users: List["ayiin.User"]) -> None:
