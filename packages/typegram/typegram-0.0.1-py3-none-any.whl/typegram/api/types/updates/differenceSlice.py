...
new_messages (List of :obj:`Message<typegram.api.ayiin.Message>`):
    ...
    def __init__(self, *, new_messages: List["ayiin.Message"], new_encrypted_messages: List["ayiin.EncryptedMessage"], other_updates: List["ayiin.Update"], chats: List["ayiin.Chat"], users: List["ayiin.User"], intermediate_state: "ayiinupdates.State") -> None:
