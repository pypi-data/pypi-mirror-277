...
class InputBusinessGreetingMessage(Object):  # type: ignore
    """Telegram API type.

    Constructor of :obj:`~typegram.api.ayiin.InputBusinessGreetingMessage`.
...
shortcut_id (``int`` ``32-bit``):
    ...
    ID = 0x194cb3b
    QUALNAME = "functions.types.InputBusinessGreetingMessage"

    def __init__(self, *, shortcut_id: int, recipients: "ayiin.InputBusinessRecipients", no_activity_days: int) -> None:
