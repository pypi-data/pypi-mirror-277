...
class CollectibleInfo(Object):  # type: ignore
    """Telegram API type.

    Constructor of :obj:`~typegram.api.ayiin.fragment.CollectibleInfo`.
...
purchase_date (``int`` ``32-bit``):
    ...
    ID = 0x6ebdff91
    QUALNAME = "functions.typesfragment.CollectibleInfo"
