...
class BusinessAwayMessage(Object):  # type: ignore
    """Telegram API type.

    Constructor of :obj:`~typegram.api.ayiin.BusinessAwayMessage`.
...
shortcut_id (``int`` ``32-bit``):
    ...
    ID = 0xef156a5c
    QUALNAME = "functions.types.BusinessAwayMessage"

    def __init__(self, *, shortcut_id: int, schedule: "ayiin.BusinessAwayMessageSchedule", recipients: "ayiin.BusinessRecipients", offline_only: Optional[bool] = None) -> None:
