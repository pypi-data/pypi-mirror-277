...
show_previews (``bool``, *optional*):
    ...
    ID = 0x99622c0c
    QUALNAME = "functions.types.PeerNotifySettings"

    def __init__(self, *, show_previews: Optional[bool] = None, silent: Optional[bool] = None, mute_until: Optional[int] = None, ios_sound: "ayiin.NotificationSound" = None, android_sound: "ayiin.NotificationSound" = None, other_sound: "ayiin.NotificationSound" = None, stories_muted: Optional[bool] = None, stories_hide_sender: Optional[bool] = None, stories_ios_sound: "ayiin.NotificationSound" = None, stories_android_sound: "ayiin.NotificationSound" = None, stories_other_sound: "ayiin.NotificationSound" = None) -> None:
