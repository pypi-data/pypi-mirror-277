...
link (``str``):
    ...
    ID = 0xb4ae666f
    QUALNAME = "functions.types.BusinessChatLink"

    def __init__(self, *, link: str, message: str, views: int, entities: Optional[List["ayiin.MessageEntity"]] = None, title: Optional[str] = None) -> None:
