...
file (:obj:`InputFile<typegram.api.ayiin.InputFile>`):
    ...
    def __init__(self, *, file: "ayiin.InputFile", mime_type: str, attributes: List["ayiin.DocumentAttribute"], nosound_video: Optional[bool] = None, force_file: Optional[bool] = None, spoiler: Optional[bool] = None, thumb: "ayiin.InputFile" = None, stickers: Optional[List["ayiin.InputDocument"]] = None, ttl_seconds: Optional[int] = None) -> None:
