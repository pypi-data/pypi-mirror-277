...
query_id (``int`` ``64-bit``):
    ...
    def __init__(self, *, query_id: int, user_id: int, peer: "ayiin.Peer", msg_id: int, chat_instance: int, data: Optional[bytes] = None, game_short_name: Optional[str] = None) -> None:
