...
class AutoSaveException(Object):  # type: ignore
    """Telegram API type.

    Constructor of :obj:`~typegram.api.ayiin.AutoSaveException`.
...
peer (:obj:`Peer<typegram.api.ayiin.Peer>`):
    ...
    ID = 0x81602d47
    QUALNAME = "functions.types.AutoSaveException"

    def __init__(self, *, peer: "ayiin.Peer", settings: "ayiin.AutoSaveSettings") -> None:
