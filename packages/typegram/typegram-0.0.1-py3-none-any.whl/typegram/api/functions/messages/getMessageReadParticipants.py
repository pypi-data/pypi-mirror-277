...
class GetMessageReadParticipants(Object):  # type: ignore
...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    Returns:
        List of :obj:`ReadParticipantDate<typegram.api.ayiin.ReadParticipantDate>`
    """

    __slots__: List[str] = ["peer", "msg_id"]

    ID = 0x31c1c44f
    QUALNAME = "functions.functions.Vector<ReadParticipantDate>"
