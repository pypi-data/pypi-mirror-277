...
class P_q_inner_data_dc(Object):  # type: ignore
...
pq (``str``):
    ...
    def __init__(self, *, pq: str, p: str, q: str, nonce: "ayiin.int128", server_nonce: "ayiin.int128", new_nonce: "ayiin.int256", dc: int) -> None:
    ...
    @staticmethod
    def read(b: BytesIO, *args: Any) -> "P_q_inner_data_dc":
        # No flags
        ...
        return P_q_inner_data_dc(pq=pq, p=p, q=q, nonce=nonce, server_nonce=server_nonce, new_nonce=new_nonce, dc=dc)
