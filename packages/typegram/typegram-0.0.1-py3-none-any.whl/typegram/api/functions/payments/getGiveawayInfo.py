...
class GetGiveawayInfo(Object):  # type: ignore
...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    Returns:
        :obj:`payments.GiveawayInfo<typegram.api.ayiin.payments.GiveawayInfo>`
    """

    __slots__: List[str] = ["peer", "msg_id"]

    ID = 0xf4239425
    QUALNAME = "functions.functionspayments.GiveawayInfo"
