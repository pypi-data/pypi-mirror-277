...
class EmailUnconfirmedX(BadRequest):
...
class FilePartXMissing(BadRequest):
...
class SessionTooFreshX(BadRequest):
...
class VideoContentTypeInvalid(BadRequest):
    """The video content type is invalid (ie: not streamable)"""
