...
class PhoneCallAccepted(Object):  # type: ignore
    """Telegram API type.
...
id (``int`` ``64-bit``):
    ...
    def __init__(self, *, id: int, access_hash: int, date: int, admin_id: int, participant_id: int, g_b: bytes, protocol: "api.ayiin.PhoneCallProtocol", video: Optional[bool] = None) -> None:
