...
pts (``int`` ``32-bit``):
    ...
    def __init__(self, *, pts: int, new_messages: List["api.ayiin.Message"], other_updates: List["api.ayiin.Update"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], final: Optional[bool] = None, timeout: Optional[int] = None) -> None:
