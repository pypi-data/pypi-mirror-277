...
new_messages (List of :obj:`Message<typegram.api.ayiin.Message>`):
    ...
    def __init__(self, *, new_messages: List["api.ayiin.Message"], new_encrypted_messages: List["api.ayiin.EncryptedMessage"], other_updates: List["api.ayiin.Update"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], state: "api.ayiinupdates.State") -> None:
