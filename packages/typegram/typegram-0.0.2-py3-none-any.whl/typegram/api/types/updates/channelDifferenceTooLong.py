...
dialog (:obj:`Dialog<typegram.api.ayiin.Dialog>`):
    ...
    def __init__(self, *, dialog: "api.ayiin.Dialog", messages: List["api.ayiin.Message"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], final: Optional[bool] = None, timeout: Optional[int] = None) -> None:
