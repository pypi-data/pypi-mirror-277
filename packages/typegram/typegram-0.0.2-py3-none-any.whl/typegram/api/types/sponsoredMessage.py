...
random_id (``bytes``):
    ...
    def __init__(self, *, random_id: bytes, url: str, title: str, message: str, button_text: str, recommended: Optional[bool] = None, can_report: Optional[bool] = None, entities: Optional[List["api.ayiin.MessageEntity"]] = None, photo: "api.ayiin.Photo" = None, color: "api.ayiin.PeerColor" = None, sponsor_info: Optional[str] = None, additional_info: Optional[str] = None) -> None:
