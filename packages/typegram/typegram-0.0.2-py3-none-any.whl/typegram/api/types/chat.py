...
id (``int`` ``64-bit``):
    ...
    def __init__(self, *, id: int, title: str, photo: "api.ayiin.ChatPhoto", participants_count: int, date: int, version: int, creator: Optional[bool] = None, left: Optional[bool] = None, deactivated: Optional[bool] = None, call_active: Optional[bool] = None, call_not_empty: Optional[bool] = None, noforwards: Optional[bool] = None, migrated_to: "api.ayiin.InputChannel" = None, admin_rights: "api.ayiin.ChatAdminRights" = None, default_banned_rights: "api.ayiin.ChatBannedRights" = None) -> None:
