...
class InputMediaVenue(Object):  # type: ignore
    """Telegram API type.
...
geo_point (:obj:`InputGeoPoint<typegram.api.ayiin.InputGeoPoint>`):
    ...
    def __init__(self, *, geo_point: "api.ayiin.InputGeoPoint", title: str, address: str, provider: str, venue_id: str, venue_type: str) -> None:
