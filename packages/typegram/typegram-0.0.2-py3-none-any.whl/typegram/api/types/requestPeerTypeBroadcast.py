...
creator (``bool``, *optional*):
    ...
    def __init__(self, *, creator: Optional[bool] = None, has_username: Optional[bool] = None, user_admin_rights: "api.ayiin.ChatAdminRights" = None, bot_admin_rights: "api.ayiin.ChatAdminRights" = None) -> None:
