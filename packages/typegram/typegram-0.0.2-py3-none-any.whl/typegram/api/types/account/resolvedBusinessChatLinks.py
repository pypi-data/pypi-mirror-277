...
peer (:obj:`Peer<typegram.api.ayiin.Peer>`):
    ...
    def __init__(self, *, peer: "api.ayiin.Peer", message: str, chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], entities: Optional[List["api.ayiin.MessageEntity"]] = None) -> None:
