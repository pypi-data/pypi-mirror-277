...
required_types (List of :obj:`SecureRequiredType<typegram.api.ayiin.SecureRequiredType>`):
    ...
    def __init__(self, *, required_types: List["api.ayiin.SecureRequiredType"], values: List["api.ayiin.SecureValue"], errors: List["api.ayiin.SecureValueError"], users: List["api.ayiin.User"], privacy_policy_url: Optional[str] = None) -> None:
