...
new_algo (:obj:`PasswordKdfAlgo<typegram.api.ayiin.PasswordKdfAlgo>`, *optional*):
    ...
    def __init__(self, *, new_algo: "api.ayiin.PasswordKdfAlgo" = None, new_password_hash: Optional[bytes] = None, hint: Optional[str] = None, email: Optional[str] = None, new_secure_settings: "api.ayiin.SecureSecretSettings" = None) -> None:
