...
period (:obj:`StatsDateRangeDays<typegram.api.ayiin.StatsDateRangeDays>`):
    ...
    def __init__(self, *, period: "api.ayiin.StatsDateRangeDays", followers: "api.ayiin.StatsAbsValueAndPrev", views_per_post: "api.ayiin.StatsAbsValueAndPrev", shares_per_post: "api.ayiin.StatsAbsValueAndPrev", reactions_per_post: "api.ayiin.StatsAbsValueAndPrev", views_per_story: "api.ayiin.StatsAbsValueAndPrev", shares_per_story: "api.ayiin.StatsAbsValueAndPrev", reactions_per_story: "api.ayiin.StatsAbsValueAndPrev", enabled_notifications: "api.ayiin.StatsPercentValue", growth_graph: "api.ayiin.StatsGraph", followers_graph: "api.ayiin.StatsGraph", mute_graph: "api.ayiin.StatsGraph", top_hours_graph: "api.ayiin.StatsGraph", interactions_graph: "api.ayiin.StatsGraph", iv_interactions_graph: "api.ayiin.StatsGraph", views_by_source_graph: "api.ayiin.StatsGraph", new_followers_by_source_graph: "api.ayiin.StatsGraph", languages_graph: "api.ayiin.StatsGraph", reactions_by_emotion_graph: "api.ayiin.StatsGraph", story_interactions_graph: "api.ayiin.StatsGraph", story_reactions_by_emotion_graph: "api.ayiin.StatsGraph", recent_posts_interactions: List["api.ayiin.PostInteractionCounters"]) -> None:
