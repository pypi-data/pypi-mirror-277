...
count (``int`` ``32-bit``):
    ...
    def __init__(self, *, count: int, forwards: List["api.ayiin.PublicForward"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], next_offset: Optional[str] = None) -> None:
