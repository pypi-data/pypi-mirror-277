...
period (:obj:`StatsDateRangeDays<typegram.api.ayiin.StatsDateRangeDays>`):
    ...
    def __init__(self, *, period: "api.ayiin.StatsDateRangeDays", members: "api.ayiin.StatsAbsValueAndPrev", messages: "api.ayiin.StatsAbsValueAndPrev", viewers: "api.ayiin.StatsAbsValueAndPrev", posters: "api.ayiin.StatsAbsValueAndPrev", growth_graph: "api.ayiin.StatsGraph", members_graph: "api.ayiin.StatsGraph", new_members_by_source_graph: "api.ayiin.StatsGraph", languages_graph: "api.ayiin.StatsGraph", messages_graph: "api.ayiin.StatsGraph", actions_graph: "api.ayiin.StatsGraph", top_hours_graph: "api.ayiin.StatsGraph", weekdays_graph: "api.ayiin.StatsGraph", top_posters: List["api.ayiin.StatsGroupTopPoster"], top_admins: List["api.ayiin.StatsGroupTopAdmin"], top_inviters: List["api.ayiin.StatsGroupTopInviter"], users: List["api.ayiin.User"]) -> None:
