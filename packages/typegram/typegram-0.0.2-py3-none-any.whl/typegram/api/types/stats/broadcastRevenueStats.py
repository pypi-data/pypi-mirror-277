...
top_hours_graph (:obj:`StatsGraph<typegram.api.ayiin.StatsGraph>`):
    ...
    def __init__(self, *, top_hours_graph: "api.ayiin.StatsGraph", revenue_graph: "api.ayiin.StatsGraph", balances: "api.ayiin.BroadcastRevenueBalances", usd_rate: float) -> None:
