...
chat_id (``int`` ``64-bit``):
    ...
    def __init__(self, *, chat_id: int, date: int, actor_id: int, user_id: int, qts: int, prev_participant: "api.ayiin.ChatParticipant" = None, new_participant: "api.ayiin.ChatParticipant" = None, invite: "api.ayiin.ExportedChatInvite" = None) -> None:
