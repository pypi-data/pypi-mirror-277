...
header (``bool``, *optional*):
    ...
    def __init__(self, *, header: Optional[bool] = None, align_center: Optional[bool] = None, align_right: Optional[bool] = None, valign_middle: Optional[bool] = None, valign_bottom: Optional[bool] = None, text: "api.ayiin.RichText" = None, colspan: Optional[int] = None, rowspan: Optional[int] = None) -> None:
