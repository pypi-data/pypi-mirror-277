...
id (``int`` ``64-bit``):
    ...
    def __init__(self, *, id: int, url: str, display_url: str, hash: int, has_large_media: Optional[bool] = None, type: Optional[str] = None, site_name: Optional[str] = None, title: Optional[str] = None, description: Optional[str] = None, photo: "api.ayiin.Photo" = None, embed_url: Optional[str] = None, embed_type: Optional[str] = None, embed_width: Optional[int] = None, embed_height: Optional[int] = None, duration: Optional[int] = None, author: Optional[str] = None, document: "api.ayiin.Document" = None, cached_page: "api.ayiin.Page" = None, attributes: Optional[List["api.ayiin.WebPageAttribute"]] = None) -> None:
