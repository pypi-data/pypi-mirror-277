...
id (``int`` ``64-bit``):
    ...
    def __init__(self, *, id: int, question: "api.ayiin.TextWithEntities", answers: List["api.ayiin.PollAnswer"], closed: Optional[bool] = None, public_voters: Optional[bool] = None, multiple_choice: Optional[bool] = None, quiz: Optional[bool] = None, close_period: Optional[int] = None, close_date: Optional[int] = None) -> None:
