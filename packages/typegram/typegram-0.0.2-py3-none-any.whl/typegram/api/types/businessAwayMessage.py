...
shortcut_id (``int`` ``32-bit``):
    ...
    def __init__(self, *, shortcut_id: int, schedule: "api.ayiin.BusinessAwayMessageSchedule", recipients: "api.ayiin.BusinessRecipients", offline_only: Optional[bool] = None) -> None:
