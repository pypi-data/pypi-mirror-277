...
count (``int`` ``32-bit``):
    ...
    def __init__(self, *, count: int, reactions: List["api.ayiin.MessagePeerReaction"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], next_offset: Optional[str] = None) -> None:
