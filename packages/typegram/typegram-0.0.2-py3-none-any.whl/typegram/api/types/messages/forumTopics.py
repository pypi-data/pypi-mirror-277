...
count (``int`` ``32-bit``):
    ...
    def __init__(self, *, count: int, topics: List["api.ayiin.ForumTopic"], messages: List["api.ayiin.Message"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], pts: int, order_by_create_date: Optional[bool] = None) -> None:
