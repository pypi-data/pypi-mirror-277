...
count (``int`` ``32-bit``):
    ...
    def __init__(self, *, count: int, min_date: int, min_msg_id: int, periods: List["api.ayiin.SearchResultsCalendarPeriod"], messages: List["api.ayiin.Message"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], inexact: Optional[bool] = None, offset_id_offset: Optional[int] = None) -> None:
