...
dialogs (List of :obj:`Dialog<typegram.api.ayiin.Dialog>`):
    ...
    def __init__(self, *, dialogs: List["api.ayiin.Dialog"], messages: List["api.ayiin.Message"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], state: "api.ayiinupdates.State") -> None:
