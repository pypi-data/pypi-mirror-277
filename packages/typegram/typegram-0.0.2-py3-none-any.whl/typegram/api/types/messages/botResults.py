...
query_id (``int`` ``64-bit``):
    ...
    def __init__(self, *, query_id: int, results: List["api.ayiin.BotInlineResult"], cache_time: int, users: List["api.ayiin.User"], gallery: Optional[bool] = None, next_offset: Optional[str] = None, switch_pm: "api.ayiin.InlineBotSwitchPM" = None, switch_webview: "api.ayiin.InlineBotWebView" = None) -> None:
