...
class Reactions(Object):  # type: ignore
    """Telegram API type.

    Constructor of :obj:`~typegram.api.ayiin.messages.Reactions`.
...
hash (``int`` ``64-bit``):
    ...
    def __init__(self, *, hash: int, reactions: List["api.ayiin.Reaction"]) -> None:
