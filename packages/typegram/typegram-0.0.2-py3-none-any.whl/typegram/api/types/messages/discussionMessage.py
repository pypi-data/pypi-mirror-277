...
messages (List of :obj:`Message<typegram.api.ayiin.Message>`):
    ...
    def __init__(self, *, messages: List["api.ayiin.Message"], unread_count: int, chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], max_id: Optional[int] = None, read_inbox_max_id: Optional[int] = None, read_outbox_max_id: Optional[int] = None) -> None:
