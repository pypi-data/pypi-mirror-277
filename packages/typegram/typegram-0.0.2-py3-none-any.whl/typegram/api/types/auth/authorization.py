...
user (:obj:`User<typegram.api.ayiin.User>`):
    ...
    def __init__(self, *, user: "api.ayiin.User", setup_password_required: Optional[bool] = None, otherwise_relogin_days: Optional[int] = None, tmp_sessions: Optional[int] = None, future_auth_token: Optional[bytes] = None) -> None:
