...
caption (:obj:`PageCaption<typegram.api.ayiin.PageCaption>`):
    ...
    def __init__(self, *, caption: "api.ayiin.PageCaption", full_width: Optional[bool] = None, allow_scrolling: Optional[bool] = None, url: Optional[str] = None, html: Optional[str] = None, poster_photo_id: Optional[int] = None, w: Optional[int] = None, h: Optional[int] = None) -> None:
