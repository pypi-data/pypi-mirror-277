...
channel_id (``int`` ``64-bit``):
    ...
    def __init__(self, *, channel_id: int, date: int, actor_id: int, user_id: int, qts: int, via_chatlist: Optional[bool] = None, prev_participant: "api.ayiin.ChannelParticipant" = None, new_participant: "api.ayiin.ChannelParticipant" = None, invite: "api.ayiin.ExportedChatInvite" = None) -> None:
