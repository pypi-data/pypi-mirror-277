...
id (``int`` ``32-bit``):
    ...
    def __init__(self, *, id: int, peer_id: "api.ayiin.Peer", date: int, action: "api.ayiin.MessageAction", out: Optional[bool] = None, mentioned: Optional[bool] = None, media_unread: Optional[bool] = None, silent: Optional[bool] = None, post: Optional[bool] = None, legacy: Optional[bool] = None, from_id: "api.ayiin.Peer" = None, reply_to: "api.ayiin.MessageReplyHeader" = None, ttl_period: Optional[int] = None) -> None:
