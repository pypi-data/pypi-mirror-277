...
class ChannelAdminLogEventActionPinTopic(Object):  # type: ignore
    """Telegram API type.
...
prev_topic (:obj:`ForumTopic<typegram.api.ayiin.ForumTopic>`, *optional*):
                    N/A
                
        new_topic (:obj:`ForumTopic<typegram.api.ayiin.ForumTopic>`, *optional*):
                    N/A
    ...
    def __init__(self, *, prev_topic: "api.ayiin.ForumTopic" = None, new_topic: "api.ayiin.ForumTopic" = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "ChannelAdminLogEventActionPinTopic":
        ...
        prev_topic = Object.read(b) if flags & (1 << 0) else None
        
        new_topic = Object.read(b) if flags & (1 << 1) else None
