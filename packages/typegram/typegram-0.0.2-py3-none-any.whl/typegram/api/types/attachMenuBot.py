...
bot_id (``int`` ``64-bit``):
    ...
    def __init__(self, *, bot_id: int, short_name: str, icons: List["api.ayiin.AttachMenuBotIcon"], inactive: Optional[bool] = None, has_settings: Optional[bool] = None, request_write_access: Optional[bool] = None, show_in_attach_menu: Optional[bool] = None, show_in_side_menu: Optional[bool] = None, side_menu_disclaimer_needed: Optional[bool] = None, peer_types: Optional[List["api.ayiin.AttachMenuPeerType"]] = None) -> None:
