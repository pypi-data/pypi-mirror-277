...
class UpdateShortMessage(Object):  # type: ignore
    """Telegram API type.
...
id (``int`` ``32-bit``):
    ...
    def __init__(self, *, id: int, user_id: int, message: str, pts: int, pts_count: int, date: int, out: Optional[bool] = None, mentioned: Optional[bool] = None, media_unread: Optional[bool] = None, silent: Optional[bool] = None, fwd_from: "api.ayiin.MessageFwdHeader" = None, via_bot_id: Optional[int] = None, reply_to: "api.ayiin.MessageReplyHeader" = None, entities: Optional[List["api.ayiin.MessageEntity"]] = None, ttl_period: Optional[int] = None) -> None:
