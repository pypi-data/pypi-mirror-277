...
count (``int`` ``32-bit``):
    ...
    def __init__(self, *, count: int, participants: List["api.ayiin.GroupCallParticipant"], next_offset: str, chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], version: int) -> None:
