...
call (:obj:`GroupCall<typegram.api.ayiin.GroupCall>`):
    ...
    def __init__(self, *, call: "api.ayiin.GroupCall", participants: List["api.ayiin.GroupCallParticipant"], participants_next_offset: str, chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"]) -> None:
