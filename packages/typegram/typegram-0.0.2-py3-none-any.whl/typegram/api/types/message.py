...
id (``int`` ``32-bit``):
    ...
    def __init__(self, *, id: int, peer_id: "api.ayiin.Peer", date: int, message: str, out: Optional[bool] = None, mentioned: Optional[bool] = None, media_unread: Optional[bool] = None, silent: Optional[bool] = None, post: Optional[bool] = None, from_scheduled: Optional[bool] = None, legacy: Optional[bool] = None, edit_hide: Optional[bool] = None, pinned: Optional[bool] = None, noforwards: Optional[bool] = None, invert_media: Optional[bool] = None, offline: Optional[bool] = None, from_id: "api.ayiin.Peer" = None, from_boosts_applied: Optional[int] = None, saved_peer_id: "api.ayiin.Peer" = None, fwd_from: "api.ayiin.MessageFwdHeader" = None, via_bot_id: Optional[int] = None, via_business_bot_id: Optional[int] = None, reply_to: "api.ayiin.MessageReplyHeader" = None, media: "api.ayiin.MessageMedia" = None, reply_markup: "api.ayiin.ReplyMarkup" = None, entities: Optional[List["api.ayiin.MessageEntity"]] = None, views: Optional[int] = None, forwards: Optional[int] = None, replies: "api.ayiin.MessageReplies" = None, edit_date: Optional[int] = None, post_author: Optional[str] = None, grouped_id: Optional[int] = None, reactions: "api.ayiin.MessageReactions" = None, restriction_reason: Optional[List["api.ayiin.RestrictionReason"]] = None, ttl_period: Optional[int] = None, quick_reply_shortcut_id: Optional[int] = None, effect: Optional[int] = None, factcheck: "api.ayiin.FactCheck" = None) -> None:
