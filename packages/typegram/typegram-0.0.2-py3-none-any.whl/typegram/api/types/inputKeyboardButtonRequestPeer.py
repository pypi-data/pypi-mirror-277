...
text (``str``):
    ...
    def __init__(self, *, text: str, button_id: int, peer_type: "api.ayiin.RequestPeerType", max_quantity: int, name_requested: Optional[bool] = None, username_requested: Optional[bool] = None, photo_requested: Optional[bool] = None) -> None:
