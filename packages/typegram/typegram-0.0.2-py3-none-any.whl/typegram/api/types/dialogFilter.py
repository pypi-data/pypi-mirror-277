...
id (``int`` ``32-bit``):
    ...
    def __init__(self, *, id: int, title: str, pinned_peers: List["api.ayiin.InputPeer"], include_peers: List["api.ayiin.InputPeer"], exclude_peers: List["api.ayiin.InputPeer"], contacts: Optional[bool] = None, non_contacts: Optional[bool] = None, groups: Optional[bool] = None, broadcasts: Optional[bool] = None, bots: Optional[bool] = None, exclude_muted: Optional[bool] = None, exclude_read: Optional[bool] = None, exclude_archived: Optional[bool] = None, emoticon: Optional[str] = None, color: Optional[int] = None) -> None:
