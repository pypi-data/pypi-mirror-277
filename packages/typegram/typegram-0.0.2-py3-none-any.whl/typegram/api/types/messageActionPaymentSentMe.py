...
class MessageActionPaymentSentMe(Object):  # type: ignore
    """Telegram API type.
...
currency (``str``):
        ...
        charge (:obj:`PaymentCharge<typegram.api.ayiin.PaymentCharge>`):
                    N/A
    ...
    def __init__(self, *, currency: str, total_amount: int, payload: bytes, charge: "api.ayiin.PaymentCharge", recurring_init: Optional[bool] = None, recurring_used: Optional[bool] = None, info: "api.ayiin.PaymentRequestedInfo" = None, shipping_option_id: Optional[str] = None) -> None:
