...
show_previews (``bool``, *optional*):
    ...
    def __init__(self, *, show_previews: Optional[bool] = None, silent: Optional[bool] = None, mute_until: Optional[int] = None, sound: "api.ayiin.NotificationSound" = None, stories_muted: Optional[bool] = None, stories_hide_sender: Optional[bool] = None, stories_sound: "api.ayiin.NotificationSound" = None) -> None:
