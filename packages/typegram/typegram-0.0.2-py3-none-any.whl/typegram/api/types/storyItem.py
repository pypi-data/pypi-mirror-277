...
id (``int`` ``32-bit``):
    ...
    def __init__(self, *, id: int, date: int, expire_date: int, media: "api.ayiin.MessageMedia", pinned: Optional[bool] = None, public: Optional[bool] = None, close_friends: Optional[bool] = None, min: Optional[bool] = None, noforwards: Optional[bool] = None, edited: Optional[bool] = None, contacts: Optional[bool] = None, selected_contacts: Optional[bool] = None, out: Optional[bool] = None, from_id: "api.ayiin.Peer" = None, fwd_from: "api.ayiin.StoryFwdHeader" = None, caption: Optional[str] = None, entities: Optional[List["api.ayiin.MessageEntity"]] = None, media_areas: Optional[List["api.ayiin.MediaArea"]] = None, privacy: Optional[List["api.ayiin.PrivacyRule"]] = None, views: "api.ayiin.StoryViews" = None, sent_reaction: "api.ayiin.Reaction" = None) -> None:
