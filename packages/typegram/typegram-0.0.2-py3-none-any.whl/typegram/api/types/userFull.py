...
id (``int`` ``64-bit``):
    ...
    def __init__(self, *, id: int, settings: "api.ayiin.PeerSettings", notify_settings: "api.ayiin.PeerNotifySettings", common_chats_count: int, blocked: Optional[bool] = None, phone_calls_available: Optional[bool] = None, phone_calls_private: Optional[bool] = None, can_pin_message: Optional[bool] = None, has_scheduled: Optional[bool] = None, video_calls_available: Optional[bool] = None, voice_messages_forbidden: Optional[bool] = None, translations_disabled: Optional[bool] = None, stories_pinned_available: Optional[bool] = None, blocked_my_stories_from: Optional[bool] = None, wallpaper_overridden: Optional[bool] = None, contact_require_premium: Optional[bool] = None, read_dates_private: Optional[bool] = None, sponsored_enabled: Optional[bool] = None, about: Optional[str] = None, personal_photo: "api.ayiin.Photo" = None, profile_photo: "api.ayiin.Photo" = None, fallback_photo: "api.ayiin.Photo" = None, bot_info: "api.ayiin.BotInfo" = None, pinned_msg_id: Optional[int] = None, folder_id: Optional[int] = None, ttl_period: Optional[int] = None, theme_emoticon: Optional[str] = None, private_forward_name: Optional[str] = None, bot_group_admin_rights: "api.ayiin.ChatAdminRights" = None, bot_broadcast_admin_rights: "api.ayiin.ChatAdminRights" = None, premium_gifts: Optional[List["api.ayiin.PremiumGiftOption"]] = None, wallpaper: "api.ayiin.WallPaper" = None, stories: "api.ayiin.PeerStories" = None, business_work_hours: "api.ayiin.BusinessWorkHours" = None, business_location: "api.ayiin.BusinessLocation" = None, business_greeting_message: "api.ayiin.BusinessGreetingMessage" = None, business_away_message: "api.ayiin.BusinessAwayMessage" = None, business_intro: "api.ayiin.BusinessIntro" = None, birthday: "api.ayiin.Birthday" = None, personal_channel_id: Optional[int] = None, personal_channel_message: Optional[int] = None) -> None:
