...
expires (``int`` ``32-bit``):
    ...
    def __init__(self, *, expires: int, peer: "api.ayiin.Peer", chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], proxy: Optional[bool] = None, psa_type: Optional[str] = None, psa_message: Optional[str] = None) -> None:
