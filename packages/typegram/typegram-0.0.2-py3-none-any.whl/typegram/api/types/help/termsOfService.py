...
id (:obj:`DataJSON<typegram.api.ayiin.DataJSON>`):
    ...
    def __init__(self, *, id: "api.ayiin.DataJSON", text: str, entities: List["api.ayiin.MessageEntity"], popup: Optional[bool] = None, min_age_confirm: Optional[int] = None) -> None:
