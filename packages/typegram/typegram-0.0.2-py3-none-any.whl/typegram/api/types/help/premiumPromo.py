...
status_text (``str``):
    ...
    def __init__(self, *, status_text: str, status_entities: List["api.ayiin.MessageEntity"], video_sections: List[str], videos: List["api.ayiin.Document"], period_options: List["api.ayiin.PremiumSubscriptionOption"], users: List["api.ayiin.User"]) -> None:
