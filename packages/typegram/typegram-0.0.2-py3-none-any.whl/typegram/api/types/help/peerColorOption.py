...
color_id (``int`` ``32-bit``):
    ...
    def __init__(self, *, color_id: int, hidden: Optional[bool] = None, colors: "api.ayiinhelp.PeerColorSet" = None, dark_colors: "api.ayiinhelp.PeerColorSet" = None, channel_min_level: Optional[int] = None, group_min_level: Optional[int] = None) -> None:
