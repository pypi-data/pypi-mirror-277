...
id (``int`` ``32-bit``):
    ...
    def __init__(self, *, id: int, version: str, text: str, entities: List["api.ayiin.MessageEntity"], can_not_skip: Optional[bool] = None, document: "api.ayiin.Document" = None, url: Optional[str] = None, sticker: "api.ayiin.Document" = None) -> None:
