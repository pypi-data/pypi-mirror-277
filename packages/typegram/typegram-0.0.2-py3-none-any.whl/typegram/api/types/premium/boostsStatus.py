...
level (``int`` ``32-bit``):
    ...
    def __init__(self, *, level: int, current_level_boosts: int, boosts: int, boost_url: str, my_boost: Optional[bool] = None, gift_boosts: Optional[int] = None, next_level_boosts: Optional[int] = None, premium_audience: "api.ayiin.StatsPercentValue" = None, prepaid_giveaways: Optional[List["api.ayiin.PrepaidGiveaway"]] = None, my_boost_slots: Optional[List[int]] = None) -> None:
