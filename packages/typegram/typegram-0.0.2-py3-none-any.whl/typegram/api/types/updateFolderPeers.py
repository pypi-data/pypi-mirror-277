...
class UpdateFolderPeers(Object):  # type: ignore
    """Telegram API type.
...
folder_peers (List of :obj:`FolderPeer<typegram.api.ayiin.FolderPeer>`):
                    N/A
    ...
    def __init__(self, *, folder_peers: List["api.ayiin.FolderPeer"], pts: int, pts_count: int) -> None:
        
                self.folder_peers = folder_peers  # FolderPeer
