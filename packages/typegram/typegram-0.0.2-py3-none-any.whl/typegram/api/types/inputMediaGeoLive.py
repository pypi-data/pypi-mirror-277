...
geo_point (:obj:`InputGeoPoint<typegram.api.ayiin.InputGeoPoint>`):
    ...
    def __init__(self, *, geo_point: "api.ayiin.InputGeoPoint", stopped: Optional[bool] = None, heading: Optional[int] = None, period: Optional[int] = None, proximity_notification_radius: Optional[int] = None) -> None:
