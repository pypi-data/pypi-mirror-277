...
class BusinessIntro(Object):  # type: ignore
    """Telegram API type.

    Constructor of :obj:`~typegram.api.ayiin.BusinessIntro`.
...
title (``str``):
    ...
    def __init__(self, *, title: str, description: str, sticker: "api.ayiin.Document" = None) -> None:
