...
date (``int`` ``32-bit``):
    ...
    def __init__(self, *, date: int, months: int, chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], via_giveaway: Optional[bool] = None, from_id: "api.ayiin.Peer" = None, giveaway_msg_id: Optional[int] = None, to_id: Optional[int] = None, used_date: Optional[int] = None) -> None:
