...
date (``int`` ``32-bit``):
    ...
    def __init__(self, *, date: int, bot_id: int, provider_id: int, title: str, description: str, invoice: "api.ayiin.Invoice", currency: str, total_amount: int, credentials_title: str, users: List["api.ayiin.User"], photo: "api.ayiin.WebDocument" = None, info: "api.ayiin.PaymentRequestedInfo" = None, shipping: "api.ayiin.ShippingOption" = None, tip_amount: Optional[int] = None) -> None:
