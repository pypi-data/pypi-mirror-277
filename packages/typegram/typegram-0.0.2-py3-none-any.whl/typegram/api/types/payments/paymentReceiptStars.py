...
date (``int`` ``32-bit``):
    ...
    def __init__(self, *, date: int, bot_id: int, title: str, description: str, invoice: "api.ayiin.Invoice", currency: str, total_amount: int, transaction_id: str, users: List["api.ayiin.User"], photo: "api.ayiin.WebDocument" = None) -> None:
