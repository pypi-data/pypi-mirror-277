...
balance (``int`` ``64-bit``):
    ...
    def __init__(self, *, balance: int, history: List["api.ayiin.StarsTransaction"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], next_offset: Optional[str] = None) -> None:
