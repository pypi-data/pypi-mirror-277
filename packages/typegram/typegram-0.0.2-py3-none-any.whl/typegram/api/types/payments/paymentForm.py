...
form_id (``int`` ``64-bit``):
    ...
    def __init__(self, *, form_id: int, bot_id: int, title: str, description: str, invoice: "api.ayiin.Invoice", provider_id: int, url: str, users: List["api.ayiin.User"], can_save_credentials: Optional[bool] = None, password_missing: Optional[bool] = None, photo: "api.ayiin.WebDocument" = None, native_provider: Optional[str] = None, native_params: "api.ayiin.DataJSON" = None, additional_methods: Optional[List["api.ayiin.PaymentFormMethod"]] = None, saved_info: "api.ayiin.PaymentRequestedInfo" = None, saved_credentials: Optional[List["api.ayiin.PaymentSavedCredentials"]] = None) -> None:
