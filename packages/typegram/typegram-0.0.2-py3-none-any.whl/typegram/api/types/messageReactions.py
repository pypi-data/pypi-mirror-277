...
results (List of :obj:`ReactionCount<typegram.api.ayiin.ReactionCount>`):
    ...
    def __init__(self, *, results: List["api.ayiin.ReactionCount"], min: Optional[bool] = None, can_see_list: Optional[bool] = None, reactions_as_tags: Optional[bool] = None, recent_reactions: Optional[List["api.ayiin.MessagePeerReaction"]] = None) -> None:
