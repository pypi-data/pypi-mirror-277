...
class UpdateDraftMessage(Object):  # type: ignore
    """Telegram API type.
...
peer (:obj:`Peer<typegram.api.ayiin.Peer>`):
        ...
        draft (:obj:`DraftMessage<typegram.api.ayiin.DraftMessage>`):
                    N/A
    ...
    def __init__(self, *, peer: "api.ayiin.Peer", draft: "api.ayiin.DraftMessage", top_msg_id: Optional[int] = None) -> None:
