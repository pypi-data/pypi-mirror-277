...
date (``int`` ``32-bit``):
    ...
    def __init__(self, *, date: int, imported: Optional[bool] = None, saved_out: Optional[bool] = None, from_id: "api.ayiin.Peer" = None, from_name: Optional[str] = None, channel_post: Optional[int] = None, post_author: Optional[str] = None, saved_from_peer: "api.ayiin.Peer" = None, saved_from_msg_id: Optional[int] = None, saved_from_id: "api.ayiin.Peer" = None, saved_from_name: Optional[str] = None, saved_date: Optional[int] = None, psa_type: Optional[str] = None) -> None:
