...
id (``int`` ``64-bit``):
    ...
    def __init__(self, *, id: int, access_hash: int, file_reference: bytes, date: int, sizes: List["api.ayiin.PhotoSize"], dc_id: int, has_stickers: Optional[bool] = None, video_sizes: Optional[List["api.ayiin.VideoSize"]] = None) -> None:
