...
filter_id (``int`` ``32-bit``):
    ...
    def __init__(self, *, filter_id: int, missing_peers: List["api.ayiin.Peer"], already_peers: List["api.ayiin.Peer"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"]) -> None:
