...
id (``int`` ``64-bit``):
    ...
    def __init__(self, *, id: int, access_hash: int, short_name: str, title: str, description: str, photo: "api.ayiin.Photo", hash: int, document: "api.ayiin.Document" = None) -> None:
