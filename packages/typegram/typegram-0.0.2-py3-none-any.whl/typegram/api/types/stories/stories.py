...
count (``int`` ``32-bit``):
    ...
    def __init__(self, *, count: int, stories: List["api.ayiin.StoryItem"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], pinned_to_top: Optional[List[int]] = None) -> None:
