...
count (``int`` ``32-bit``):
    ...
    def __init__(self, *, count: int, state: str, peer_stories: List["api.ayiin.PeerStories"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], stealth_mode: "api.ayiin.StoriesStealthMode", has_more: Optional[bool] = None) -> None:
