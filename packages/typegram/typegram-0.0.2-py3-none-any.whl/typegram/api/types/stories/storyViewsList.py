...
count (``int`` ``32-bit``):
    ...
    def __init__(self, *, count: int, views_count: int, forwards_count: int, reactions_count: int, views: List["api.ayiin.StoryView"], chats: List["api.ayiin.Chat"], users: List["api.ayiin.User"], next_offset: Optional[str] = None) -> None:
