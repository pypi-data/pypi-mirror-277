...
class ChannelAdminLogEventActionChangeLocation(Object):  # type: ignore
    """Telegram API type.
...
prev_value (:obj:`ChannelLocation<typegram.api.ayiin.ChannelLocation>`):
                    N/A
                
        new_value (:obj:`ChannelLocation<typegram.api.ayiin.ChannelLocation>`):
                    N/A
    ...
    def __init__(self, *, prev_value: "api.ayiin.ChannelLocation", new_value: "api.ayiin.ChannelLocation") -> None:
