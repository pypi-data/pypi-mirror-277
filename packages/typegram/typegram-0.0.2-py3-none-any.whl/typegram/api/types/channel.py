...
id (``int`` ``64-bit``):
    ...
    def __init__(self, *, id: int, title: str, photo: "api.ayiin.ChatPhoto", date: int, creator: Optional[bool] = None, left: Optional[bool] = None, broadcast: Optional[bool] = None, verified: Optional[bool] = None, megagroup: Optional[bool] = None, restricted: Optional[bool] = None, signatures: Optional[bool] = None, min: Optional[bool] = None, scam: Optional[bool] = None, has_link: Optional[bool] = None, has_geo: Optional[bool] = None, slowmode_enabled: Optional[bool] = None, call_active: Optional[bool] = None, call_not_empty: Optional[bool] = None, fake: Optional[bool] = None, gigagroup: Optional[bool] = None, noforwards: Optional[bool] = None, join_to_send: Optional[bool] = None, join_request: Optional[bool] = None, forum: Optional[bool] = None, stories_hidden: Optional[bool] = None, stories_hidden_min: Optional[bool] = None, stories_unavailable: Optional[bool] = None, access_hash: Optional[int] = None, username: Optional[str] = None, restriction_reason: Optional[List["api.ayiin.RestrictionReason"]] = None, admin_rights: "api.ayiin.ChatAdminRights" = None, banned_rights: "api.ayiin.ChatBannedRights" = None, default_banned_rights: "api.ayiin.ChatBannedRights" = None, participants_count: Optional[int] = None, usernames: Optional[List["api.ayiin.Username"]] = None, stories_max_id: Optional[int] = None, color: "api.ayiin.PeerColor" = None, profile_color: "api.ayiin.PeerColor" = None, emoji_status: "api.ayiin.EmojiStatus" = None, level: Optional[int] = None) -> None:
