...
title (``str``):
    ...
    def __init__(self, *, title: str, description: str, invoice: "api.ayiin.Invoice", payload: bytes, provider_data: "api.ayiin.DataJSON", photo: "api.ayiin.InputWebDocument" = None, provider: Optional[str] = None, start_param: Optional[str] = None, extended_media: "api.ayiin.InputMedia" = None) -> None:
