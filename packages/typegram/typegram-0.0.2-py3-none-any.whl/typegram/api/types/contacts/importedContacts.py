...
imported (List of :obj:`ImportedContact<typegram.api.ayiin.ImportedContact>`):
    ...
    def __init__(self, *, imported: List["api.ayiin.ImportedContact"], popular_invites: List["api.ayiin.PopularContact"], retry_contacts: List[int], users: List["api.ayiin.User"]) -> None:
