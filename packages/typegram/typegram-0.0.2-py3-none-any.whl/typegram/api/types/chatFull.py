...
id (``int`` ``64-bit``):
    ...
    def __init__(self, *, id: int, about: str, participants: "api.ayiin.ChatParticipants", notify_settings: "api.ayiin.PeerNotifySettings", can_set_username: Optional[bool] = None, has_scheduled: Optional[bool] = None, translations_disabled: Optional[bool] = None, chat_photo: "api.ayiin.Photo" = None, exported_invite: "api.ayiin.ExportedChatInvite" = None, bot_info: Optional[List["api.ayiin.BotInfo"]] = None, pinned_msg_id: Optional[int] = None, folder_id: Optional[int] = None, call: "api.ayiin.InputGroupCall" = None, ttl_period: Optional[int] = None, groupcall_default_join_as: "api.ayiin.Peer" = None, theme_emoticon: Optional[str] = None, requests_pending: Optional[int] = None, recent_requesters: Optional[List[int]] = None, available_reactions: "api.ayiin.ChatReactions" = None, reactions_limit: Optional[int] = None) -> None:
