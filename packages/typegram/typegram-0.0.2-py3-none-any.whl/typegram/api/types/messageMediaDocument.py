...
nopremium (``bool``, *optional*):
    ...
    def __init__(self, *, nopremium: Optional[bool] = None, spoiler: Optional[bool] = None, video: Optional[bool] = None, round: Optional[bool] = None, voice: Optional[bool] = None, document: "api.ayiin.Document" = None, alt_document: "api.ayiin.Document" = None, ttl_seconds: Optional[int] = None) -> None:
