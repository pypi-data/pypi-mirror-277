...
class UpdateBusinessWorkHours(Object):  # type: ignore
...
business_work_hours (:obj:`BusinessWorkHours<typegram.api.ayiin.BusinessWorkHours>`, *optional*):
    ...
    def __init__(self, *, business_work_hours: "api.ayiin.BusinessWorkHours" = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "UpdateBusinessWorkHours":
        ...
        business_work_hours = Object.read(b) if flags & (1 << 0) else None
