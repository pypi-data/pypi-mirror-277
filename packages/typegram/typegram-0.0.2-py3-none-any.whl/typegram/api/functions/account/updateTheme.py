...
format (``str``):
    ...
    def __init__(self, *, format: str, theme: "api.ayiin.InputTheme", slug: Optional[str] = None, title: Optional[str] = None, document: "api.ayiin.InputDocument" = None, settings: Optional[List["api.ayiin.InputThemeSettings"]] = None) -> None:
