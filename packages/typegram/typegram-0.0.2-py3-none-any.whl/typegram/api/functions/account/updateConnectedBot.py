...
bot (:obj:`InputUser<typegram.api.ayiin.InputUser>`):
    ...
    def __init__(self, *, bot: "api.ayiin.InputUser", recipients: "api.ayiin.InputBusinessBotRecipients", can_reply: Optional[bool] = None, deleted: Optional[bool] = None) -> None:
