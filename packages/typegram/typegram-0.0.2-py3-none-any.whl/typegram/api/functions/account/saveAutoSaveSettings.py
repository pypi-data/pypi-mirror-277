...
settings (:obj:`AutoSaveSettings<typegram.api.ayiin.AutoSaveSettings>`):
    ...
    def __init__(self, *, settings: "api.ayiin.AutoSaveSettings", users: Optional[bool] = None, chats: Optional[bool] = None, broadcasts: Optional[bool] = None, peer: "api.ayiin.InputPeer" = None) -> None:
