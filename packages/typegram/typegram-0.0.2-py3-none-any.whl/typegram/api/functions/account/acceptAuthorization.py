...
bot_id (``int`` ``64-bit``):
    ...
    def __init__(self, *, bot_id: int, scope: str, public_key: str, value_hashes: List["api.ayiin.SecureValueHash"], credentials: "api.ayiin.SecureCredentialsEncrypted") -> None:
