...
user_id (:obj:`InputUser<typegram.api.ayiin.InputUser>`):
    ...
    def __init__(self, *, user_id: "api.ayiin.InputUser", title: str, short_name: str, stickers: List["api.ayiin.InputStickerSetItem"], masks: Optional[bool] = None, emojis: Optional[bool] = None, text_color: Optional[bool] = None, thumb: "api.ayiin.InputDocument" = None, software: Optional[str] = None) -> None:
