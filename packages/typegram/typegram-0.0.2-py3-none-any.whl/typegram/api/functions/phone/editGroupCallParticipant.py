...
call (:obj:`InputGroupCall<typegram.api.ayiin.InputGroupCall>`):
    ...
    def __init__(self, *, call: "api.ayiin.InputGroupCall", participant: "api.ayiin.InputPeer", muted: Optional[bool] = None, volume: Optional[int] = None, raise_hand: Optional[bool] = None, video_stopped: Optional[bool] = None, video_paused: Optional[bool] = None, presentation_paused: Optional[bool] = None) -> None:
