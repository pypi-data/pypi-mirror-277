...
call (:obj:`InputGroupCall<typegram.api.ayiin.InputGroupCall>`):
    ...
    def __init__(self, *, call: "api.ayiin.InputGroupCall", start: Optional[bool] = None, video: Optional[bool] = None, title: Optional[str] = None, video_portrait: Optional[bool] = None) -> None:
