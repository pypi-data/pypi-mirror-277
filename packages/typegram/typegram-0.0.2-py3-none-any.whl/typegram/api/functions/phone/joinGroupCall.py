...
call (:obj:`InputGroupCall<typegram.api.ayiin.InputGroupCall>`):
    ...
    def __init__(self, *, call: "api.ayiin.InputGroupCall", join_as: "api.ayiin.InputPeer", params: "api.ayiin.DataJSON", muted: Optional[bool] = None, video_stopped: Optional[bool] = None, invite_hash: Optional[str] = None) -> None:
