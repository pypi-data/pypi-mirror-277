...
channel (:obj:`InputChannel<typegram.api.ayiin.InputChannel>`):
    ...
    def __init__(self, *, channel: "api.ayiin.InputChannel", topic_id: int, title: Optional[str] = None, icon_emoji_id: Optional[int] = None, closed: Optional[bool] = None, hidden: Optional[bool] = None) -> None:
