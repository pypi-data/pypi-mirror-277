...
channel (:obj:`InputChannel<typegram.api.ayiin.InputChannel>`):
    ...
    def __init__(self, *, channel: "api.ayiin.InputChannel", q: str, max_id: int, min_id: int, limit: int, events_filter: "api.ayiin.ChannelAdminLogEventsFilter" = None, admins: Optional[List["api.ayiin.InputUser"]] = None) -> None:
