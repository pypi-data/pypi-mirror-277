...
channel (:obj:`InputChannel<typegram.api.ayiin.InputChannel>`):
    ...
    def __init__(self, *, channel: "api.ayiin.InputChannel", title: str, random_id: int, icon_color: Optional[int] = None, icon_emoji_id: Optional[int] = None, send_as: "api.ayiin.InputPeer" = None) -> None:
