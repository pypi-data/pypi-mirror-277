...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    def __init__(self, *, peer: "api.ayiin.InputPeer", media: "api.ayiin.InputMedia", privacy_rules: List["api.ayiin.InputPrivacyRule"], random_id: int, pinned: Optional[bool] = None, noforwards: Optional[bool] = None, fwd_modified: Optional[bool] = None, media_areas: Optional[List["api.ayiin.MediaArea"]] = None, caption: Optional[str] = None, entities: Optional[List["api.ayiin.MessageEntity"]] = None, period: Optional[int] = None, fwd_from_id: "api.ayiin.InputPeer" = None, fwd_from_story: Optional[int] = None) -> None:
