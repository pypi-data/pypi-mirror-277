...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    def __init__(self, *, peer: "api.ayiin.InputPeer", id: int, media: "api.ayiin.InputMedia" = None, media_areas: Optional[List["api.ayiin.MediaArea"]] = None, caption: Optional[str] = None, entities: Optional[List["api.ayiin.MessageEntity"]] = None, privacy_rules: Optional[List["api.ayiin.InputPrivacyRule"]] = None) -> None:
