...
form_id (``int`` ``64-bit``):
    ...
    def __init__(self, *, form_id: int, invoice: "api.ayiin.InputInvoice", credentials: "api.ayiin.InputPaymentCredentials", requested_info_id: Optional[str] = None, shipping_option_id: Optional[str] = None, tip_amount: Optional[int] = None) -> None:
