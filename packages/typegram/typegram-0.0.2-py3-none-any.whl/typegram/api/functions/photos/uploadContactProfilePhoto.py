...
user_id (:obj:`InputUser<typegram.api.ayiin.InputUser>`):
    ...
    def __init__(self, *, user_id: "api.ayiin.InputUser", suggest: Optional[bool] = None, save: Optional[bool] = None, file: "api.ayiin.InputFile" = None, video: "api.ayiin.InputFile" = None, video_start_ts: Optional[float] = None, video_emoji_markup: "api.ayiin.VideoSize" = None) -> None:
