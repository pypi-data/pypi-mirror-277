...
fallback (``bool``, *optional*):
    ...
    def __init__(self, *, fallback: Optional[bool] = None, bot: "api.ayiin.InputUser" = None, file: "api.ayiin.InputFile" = None, video: "api.ayiin.InputFile" = None, video_start_ts: Optional[float] = None, video_emoji_markup: "api.ayiin.VideoSize" = None) -> None:
