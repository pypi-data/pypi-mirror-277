...
api_id (``int`` ``32-bit``):
    ...
    def __init__(self, *, api_id: int, device_model: str, system_version: str, app_version: str, system_lang_code: str, lang_pack: str, lang_code: str, query: Object, proxy: "api.ayiin.InputClientProxy" = None, params: "api.ayiin.JSONValue" = None) -> None:
