...
id (:obj:`InputBotInlineMessageID<typegram.api.ayiin.InputBotInlineMessageID>`):
    ...
    def __init__(self, *, id: "api.ayiin.InputBotInlineMessageID", user_id: "api.ayiin.InputUser", score: int, edit_message: Optional[bool] = None, force: Optional[bool] = None) -> None:
