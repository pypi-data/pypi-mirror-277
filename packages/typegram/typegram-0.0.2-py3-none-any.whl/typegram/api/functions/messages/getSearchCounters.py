...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    def __init__(self, *, peer: "api.ayiin.InputPeer", filters: List["api.ayiin.MessagesFilter"], saved_peer_id: "api.ayiin.InputPeer" = None, top_msg_id: Optional[int] = None) -> None:
