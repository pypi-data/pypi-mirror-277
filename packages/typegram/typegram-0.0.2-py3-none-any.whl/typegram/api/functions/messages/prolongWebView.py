...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    def __init__(self, *, peer: "api.ayiin.InputPeer", bot: "api.ayiin.InputUser", query_id: int, silent: Optional[bool] = None, reply_to: "api.ayiin.InputReplyTo" = None, send_as: "api.ayiin.InputPeer" = None) -> None:
