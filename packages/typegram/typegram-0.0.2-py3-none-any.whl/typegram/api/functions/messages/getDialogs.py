...
offset_date (``int`` ``32-bit``):
    ...
    def __init__(self, *, offset_date: int, offset_id: int, offset_peer: "api.ayiin.InputPeer", limit: int, hash: int, exclude_pinned: Optional[bool] = None, folder_id: Optional[int] = None) -> None:
