...
class SendMultiMedia(Object):  # type: ignore
...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
        ...
        multi_media (List of :obj:`InputSingleMedia<typegram.api.ayiin.InputSingleMedia>`):
                    N/A
    ...
    def __init__(self, *, peer: "api.ayiin.InputPeer", multi_media: List["api.ayiin.InputSingleMedia"], silent: Optional[bool] = None, background: Optional[bool] = None, clear_draft: Optional[bool] = None, noforwards: Optional[bool] = None, update_stickersets_order: Optional[bool] = None, invert_media: Optional[bool] = None, reply_to: "api.ayiin.InputReplyTo" = None, schedule_date: Optional[int] = None, send_as: "api.ayiin.InputPeer" = None, quick_reply_shortcut: "api.ayiin.InputQuickReplyShortcut" = None, effect: Optional[int] = None) -> None:
        
                self.peer = peer  # InputPeer
        
                self.multi_media = multi_media  # InputSingleMedia
