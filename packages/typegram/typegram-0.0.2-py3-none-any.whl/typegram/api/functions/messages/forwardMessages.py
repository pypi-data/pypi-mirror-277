...
from_peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    def __init__(self, *, from_peer: "api.ayiin.InputPeer", id: List[int], random_id: List[int], to_peer: "api.ayiin.InputPeer", silent: Optional[bool] = None, background: Optional[bool] = None, with_my_score: Optional[bool] = None, drop_author: Optional[bool] = None, drop_media_captions: Optional[bool] = None, noforwards: Optional[bool] = None, top_msg_id: Optional[int] = None, schedule_date: Optional[int] = None, send_as: "api.ayiin.InputPeer" = None, quick_reply_shortcut: "api.ayiin.InputQuickReplyShortcut" = None) -> None:
