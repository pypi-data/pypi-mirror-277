...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    def __init__(self, *, peer: "api.ayiin.InputPeer", message: str, no_webpage: Optional[bool] = None, invert_media: Optional[bool] = None, reply_to: "api.ayiin.InputReplyTo" = None, entities: Optional[List["api.ayiin.MessageEntity"]] = None, media: "api.ayiin.InputMedia" = None) -> None:
