...
write_allowed (``bool``, *optional*):
    ...
    def __init__(self, *, write_allowed: Optional[bool] = None, peer: "api.ayiin.InputPeer" = None, msg_id: Optional[int] = None, button_id: Optional[int] = None, url: Optional[str] = None) -> None:
