...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    def __init__(self, *, peer: "api.ayiin.InputPeer", for_both: Optional[bool] = None, revert: Optional[bool] = None, wallpaper: "api.ayiin.InputWallPaper" = None, settings: "api.ayiin.WallPaperSettings" = None, id: Optional[int] = None) -> None:
