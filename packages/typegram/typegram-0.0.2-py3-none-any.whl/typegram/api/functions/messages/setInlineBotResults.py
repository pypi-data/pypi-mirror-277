...
query_id (``int`` ``64-bit``):
    ...
    def __init__(self, *, query_id: int, results: List["api.ayiin.InputBotInlineResult"], cache_time: int, gallery: Optional[bool] = None, private: Optional[bool] = None, next_offset: Optional[str] = None, switch_pm: "api.ayiin.InlineBotSwitchPM" = None, switch_webview: "api.ayiin.InlineBotWebView" = None) -> None:
