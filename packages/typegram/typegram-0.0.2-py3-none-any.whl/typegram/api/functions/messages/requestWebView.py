...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    def __init__(self, *, peer: "api.ayiin.InputPeer", bot: "api.ayiin.InputUser", platform: str, from_bot_menu: Optional[bool] = None, silent: Optional[bool] = None, url: Optional[str] = None, start_param: Optional[str] = None, theme_params: "api.ayiin.DataJSON" = None, reply_to: "api.ayiin.InputReplyTo" = None, send_as: "api.ayiin.InputPeer" = None) -> None:
