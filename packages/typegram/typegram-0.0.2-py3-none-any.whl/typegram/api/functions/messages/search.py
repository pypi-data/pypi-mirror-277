...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    def __init__(self, *, peer: "api.ayiin.InputPeer", q: str, filter: "api.ayiin.MessagesFilter", min_date: int, max_date: int, offset_id: int, add_offset: int, limit: int, max_id: int, min_id: int, hash: int, from_id: "api.ayiin.InputPeer" = None, saved_peer_id: "api.ayiin.InputPeer" = None, saved_reaction: Optional[List["api.ayiin.Reaction"]] = None, top_msg_id: Optional[int] = None) -> None:
