...
class DeleteSavedHistory(Object):  # type: ignore
...
peer (:obj:`InputPeer<typegram.api.ayiin.InputPeer>`):
    ...
    def __init__(self, *, peer: "api.ayiin.InputPeer", max_id: int, min_date: Optional[int] = None, max_date: Optional[int] = None) -> None:
