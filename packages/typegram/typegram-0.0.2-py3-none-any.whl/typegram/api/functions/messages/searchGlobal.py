...
q (``str``):
    ...
    def __init__(self, *, q: str, filter: "api.ayiin.MessagesFilter", min_date: int, max_date: int, offset_rate: int, offset_peer: "api.ayiin.InputPeer", offset_id: int, limit: int, broadcasts_only: Optional[bool] = None, folder_id: Optional[int] = None) -> None:
