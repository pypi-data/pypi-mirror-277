...
stickersets (List of :obj:`InputStickerSet<typegram.api.ayiin.InputStickerSet>`):
    ...
    def __init__(self, *, stickersets: List["api.ayiin.InputStickerSet"], uninstall: Optional[bool] = None, archive: Optional[bool] = None, unarchive: Optional[bool] = None) -> None:
