...
bot (:obj:`InputUser<typegram.api.ayiin.InputUser>`):
    ...
    def __init__(self, *, bot: "api.ayiin.InputUser", platform: str, from_switch_webview: Optional[bool] = None, from_side_menu: Optional[bool] = None, url: Optional[str] = None, start_param: Optional[str] = None, theme_params: "api.ayiin.DataJSON" = None) -> None:
