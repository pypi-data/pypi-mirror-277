...
TEST_CASE("Fused negative multiplication and addition - mipp::reg", "[mipp::fnmadd]")
{
	...
	SECTION("datatype = double") { test_reg_fnmadd<double>(); }
#endif
...
void test_reg_maskz_fnmadd()
{
	...
	mipp::reg r4 = mipp::maskz<T,mipp::fnmadd<T>>(m, r1, r2, r3);
...
{
#if defined(MIPP_64BIT)
	SECTION("datatype = double") { test_reg_maskz_fnmadd<double>(); }
#endif
...
void test_Reg_maskz_fnmadd()
{
	...
	mipp::Reg<T> r4 = mipp::maskz<T,mipp::fnmadd>(m, r1, r2, r3);
...
void test_reg_mask_fnmadd()
{
	...
	mipp::reg r5 = mipp::mask<T,mipp::fnmadd<T>>(m, r4, r1, r2, r3);
...
{
#if defined(MIPP_64BIT)
	SECTION("datatype = double") { test_reg_mask_fnmadd<double>(); }
#endif
...
void test_Reg_mask_fnmadd()
{
	...
	mipp::Reg<T> r5 = mipp::mask<T,mipp::fnmadd>(m, r4, r1, r2, r3);
