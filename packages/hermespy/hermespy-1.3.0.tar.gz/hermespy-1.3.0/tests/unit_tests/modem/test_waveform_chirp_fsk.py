...
class TestChirpFSKWaveform(unittest.TestCase):
    ...
    def test_init(self) -> None:
        ...
        self.assertIs(self.modem, self.generator.modem, "Modem init produced unexpected result")
        self.assertEqual(self.generator.oversampling_factor, self.parameters["oversampling_factor"], "Oversampling factor init produced unexpected result")
        self.assertEqual(self.generator.modulation_order, self.parameters["modulation_order"], "Modulation order init produced unexpected result")
        self.assertEqual(self.generator.chirp_duration, self.parameters["chirp_duration"], "Chirp duration init produced unexpected result")
        self.assertEqual(self.generator.chirp_bandwidth, self.parameters["chirp_bandwidth"], "Chirp bandwidth init produced unexpected result")
        self.assertEqual(self.generator.freq_difference, self.parameters["freq_difference"], "Frequency difference init produced unexpected result")
        self.assertEqual(self.generator.num_pilot_chirps, self.parameters["num_pilot_chirps"], "Number of pilot chirps init produced unexpected result")
        self.assertEqual(self.generator.num_data_chirps, self.parameters["num_data_chirps"], "Number of data chirps init produced unexpected result")
        self.assertEqual(self.generator.guard_interval, self.parameters["guard_interval"], "Guard interval init produced unexpected result")
    ...
    def test_frame_duration(self) -> None:
        ...
        self.assertEqual(self.generator.frame_duration, expected_duration, "Frame duration computation produced unexpected result")

    def test_duration(self) -> None:
        """Test the valid calculation of chirp durations"""

        expected_duration = self.parameters["chirp_duration"]
        self.assertEqual(expected_duration, self.generator.chirp_duration, "Chirp duration get produced unexpected result")
        self.assertEqual(expected_duration, self.generator.symbol_duration)
    ...
    def test_chirp_duration_get_set(self) -> None:
        ...
        self.assertEqual(chirp_duration, self.generator.chirp_duration, "Chirp duration set/get returned unexpected result")
    ...
    def test_chirp_bandwidth_get_set(self) -> None:
        ...
        self.assertEqual(bandwidth, self.generator.chirp_bandwidth, "Chirp bandwidth set/get returned unexpected result")
    ...
    def test_freq_difference_get_set(self) -> None:
        ...
        self.assertEqual(freq_difference, self.generator.freq_difference, "Frequency difference set/get returned unexpected result")
    ...
    def test_num_pilot_chirps_get_set(self) -> None:
        ...
        self.assertEqual(num_pilot_chirps, self.generator.num_pilot_chirps, "Number of pilot chirps set/get returned unexpected result")
    ...
    def test_num_data_chirps_get_set(self) -> None:
        ...
        self.assertEqual(num_data_chirps, self.generator.num_data_chirps, "Number of data chirps set/get returned unexpected result")
    ...
    def test_guard_interval_get_set(self) -> None:
        ...
        self.assertEqual(guard_interval, self.generator.guard_interval, "Guard interval set/get returned unexpected result")
    ...
    def test_bits_per_symbol_calculation(self) -> None:
        ...
        self.assertEqual(expected_bits_per_symbol, self.generator.bits_per_symbol, "Bits per symbol calculation produced unexpected result")

    def test_bits_per_frame_calculation(self) -> None:
        """Test the calculation of number of bits contained within a single frame"""

        self.assertEqual(self.data_bits_in_frame, self.generator.bits_per_frame(self.generator.num_data_symbols), "Bits per frame calculation produced unexpected result")
    ...
    def test_samples_in_chirp_calculation(self) -> None:
        ...
        self.assertEqual(expected_samples_in_chirp, self.generator.samples_in_chirp, "Samples in chirp calculation produced unexpected result")
    ...
    def test_chirps_in_frame_calculation(self) -> None:
        ...
        self.assertEqual(chirps_in_frame_expected, self.generator.chirps_in_frame, "Calculation of number of chirps in frame produced unexpected result")
    ...
    def test_pick(self) -> None:
        ...
        symbols = Mock()
        picked_symbols = self.generator.pick(symbols)
    ...
    def test_proper_bit_energy_calculation(self) -> None:
        ...
        symbol_energy = np.sum(abs(transmitted_signal.flatten()) ** 2) / (self.generator.num_pilot_chirps + self.generator.num_data_chirps)
        bit_energy = symbol_energy / self.generator.bits_per_symbol

        # compare the measured energy with the expected values
        self.assertAlmostEqual(bit_energy, self.generator.bit_energy, msg="Unexpected bit energy transmitted")
    ...
    def test_proper_symbol_energy_calculation(self) -> None:
        ...
        # compare the measured energy with the expected values
        self.assertAlmostEqual(symbol_energy, self.generator.symbol_energy, msg="Unexpected symbol energy transmitted")
    ...
    def test_proper_power_calculation(self) -> None:
        ...
        self.assertAlmostEqual(power, self.generator.power, places=1, msg="Unexpected baseband signal energy transmitted")
