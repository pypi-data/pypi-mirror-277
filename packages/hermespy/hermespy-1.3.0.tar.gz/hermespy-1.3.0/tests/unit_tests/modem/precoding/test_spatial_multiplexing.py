...
class TestSpatialMultiplexing(unittest.TestCase):
    ...
    def test_serialization(self) -> None:
        ...
        with patch("hermespy.modem.precoding.spatial_multiplexing.SpatialMultiplexing.precoding", new_callable=PropertyMock) as precoding, patch("hermespy.modem.precoding.spatial_multiplexing.SpatialMultiplexing.property_blacklist", new_callable=PropertyMock) as blacklist:
