...
class TestFilteredSingleCarrierWaveform(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.waveform = MockSingleCarrierWaveform(modem=self.modem, symbol_rate=self.symbol_rate, pilot_rate=self.pilot_rate, oversampling_factor=self.oversampling_factor, modulation_order=self.modulation_order, guard_interval=self.guard_interval, num_preamble_symbols=1, num_data_symbols=self.num_data_symbols)
...
class TestLeastSquaresChannelEstimation(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.waveform = MockSingleCarrierWaveform(symbol_rate=1e6, num_preamble_symbols=3, num_postamble_symbols=3, num_data_symbols=100, pilot_rate=10)
...
class TestRolledOfFilteredSingleCarrierWaveform(TestCase):
    ...
    def test_bandwdith(self) -> None:
        ...
        self.waveform.relative_bandwidth = 1.0
...
class TestRootRaisedCosineWaveform(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.waveform = RootRaisedCosineWaveform(oversampling_factor=self.oversampling_factor, relative_bandwidth=self.relative_bandwidth, roll_off=self.roll_off, num_preamble_symbols=self.num_preamble_symbols, num_data_symbols=self.num_data_symbols, symbol_rate=self.symbol_rate)
...
class TestRaisedCosineWaveform(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.waveform = RaisedCosineWaveform(oversampling_factor=self.oversampling_factor, relative_bandwidth=self.relative_bandwidth, roll_off=self.roll_off, num_preamble_symbols=self.num_preamble_symbols, num_data_symbols=self.num_data_symbols, symbol_rate=self.symbol_rate)
...
class TestRectangularWaveform(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.waveform = RectangularWaveform(oversampling_factor=self.oversampling_factor, relative_bandwidth=self.relative_bandwidth, num_preamble_symbols=self.num_preamble_symbols, num_data_symbols=self.num_data_symbols, symbol_rate=self.symbol_rate)
...
class TestFMCWWaveform(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.waveform = FMCWWaveform(oversampling_factor=self.oversampling_factor, bandwidth=self.bandwidth, num_preamble_symbols=self.num_preamble_symbols, num_data_symbols=self.num_data_symbols, symbol_rate=self.symbol_rate)
    ...
    def test_chirp_duration_setget(self) -> None:
        ...
        chirp_duration = 0.5 * self.symbol_rate
    ...
    def test_modulate_demodulate(self) -> None:
        ...
        self.waveform.chirp_duration = 0.5 / self.symbol_rate
