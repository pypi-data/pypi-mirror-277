...
class TestChannelStateInformation(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.state = exp(2j * self.generator.uniform(0, pi, (self.num_rx_streams, self.num_tx_streams, self.num_samples, self.num_information)))
    ...
    def test_state_setget(self) -> None:
        ...
        state = exp(2j * self.generator.uniform(0, pi, (self.num_rx_streams, self.num_tx_streams, self.num_samples, self.num_information)))
    ...
    def test_num_receive_streams(self) -> None:
        ...
        num_rx_streams = 20
        state = exp(2j * self.generator.uniform(0, pi, (num_rx_streams, self.num_tx_streams, self.num_samples, self.num_information)))
    ...
    def test_num_transmit_streams(self) -> None:
        ...
        num_tx_streams = 20
        state = exp(2j * self.generator.uniform(0, pi, (self.num_rx_streams, num_tx_streams, self.num_samples, self.num_information)))
    ...
    def test_num_samples(self) -> None:
        ...
        num_samples = 20
        state = exp(2j * self.generator.uniform(0, pi, (self.num_rx_streams, self.num_tx_streams, num_samples, self.num_information)))
    ...
    def test_num_symbols(self) -> None:
        ...
        num_symbols = 20
        state = exp(2j * self.generator.uniform(0, pi, (self.num_rx_streams, self.num_tx_streams, num_symbols, 1)))
