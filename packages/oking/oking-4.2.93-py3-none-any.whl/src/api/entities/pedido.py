...
class Order:
    def __init__(self, capa: dict, item: dict, entrega: dict, usuario: dict, adiconal: dict, pagamento: dict,
                 ...
                 protocolo: str, data_integracao_externa: str):
...
class OrderCapa:
    def __init__(self, pedido_oking_id: str, pedido_venda_id: str, numero_pedido_externo: str,
                 ...
                 valor_total_sem_desconto: float = 0.0, valor_adicional_forma_pagamento: float = 0.0):
        self.pedido_oking_id = pedido_oking_id
        self.pedido_venda_id = pedido_venda_id
        self.numero_pedido_externo = numero_pedido_externo
        self.valor = valor
...
class OrderEntrega:
    def __init__(self, modo_envio: str, transportadora: str, codigo_rastreio: str, data_previsao_entrega: str):
...
class OrderStatus:
    def __init__(self, comprado_em: str, aprovado_em: str, enviado_em: str, entregue_em: str, faturado_em: str
                 , separado_em: str, cancelado_em: str, separacao_em: str):
...
class Payment:
    def __init__(self, opcao_pagamento: str, parcelas: int, bandeira: str, condicao_pagamento_erp: str,
                 ...
                 codigo_compra: str,
                 codigo_pedido_canal: str, data_movimento: str, codigo_mercado: str, titulos, opcao_pagamento_erp: str):
...
class OrderUsuario:
    def __init__(self, nome: str, usuario_id: str, cpf_cnpj: str, tipo_pessoa: str, razao_social: str, email: str,
                 ...
                 telefone_residencial: str, telefone_celular: str = ''):
        self.nome = nome
...
class OrderEndereco:
    def __init__(self, cep: str, pais: str, bairro: str, cidade: str, estado: str, numero: str, endereco: str,
                 ...
                 descricao_endereco: str, referencia_entrega: str):
        self.cep = cep
        self.pais = pais
        self.bairro = bairro
        self.cidade = cidade
...
class OrderItem:
    def __init__(self, codigo_sku: str, codigo_erp: str, quantidade: int,
                 ...
                 ean: str, valor: int, valor_sem_desconto: float, valor_frete: float = 0.0, desconto: float = 0.0):
...
class OrderOkvendas:
    def __init__(self, id, pedido_venda_id, data_pedido, data_geracao, codigo_referencia, valor_total,
                 ...
                 transacao, usuario, pagamento, itens: list,
                 itens_brinde: list, itens_personalizados, forma_pagamento_parceiro, forma_envio_parceiro,
                 pedido_nota_fiscal, cnpj_intermediador, cnpj_instituicao_pagamento, protocolo, status_observation=None,
                 tipo_frete=None, representante=None, data_status=None, codigo_carga=None, canal_site=None,
...
class Itens:
    def __init__(self, sku_principal, sku_variacao, sku_reference, hierarquia_variacao, is_restock,
                 ...
                 percentual_comissao=None, valor_comissao=None, valor_comissao_frete=None, tipo_anuncio=None):
...
class Itens_brinde:
    def __init__(self, preco_atual, quantidade, desconto, produto_id, codigo_externo, identificador_produto,
                 ...
                 identificador_opcao_atributo, filial_expedicao, filial_faturamento):
...
class Forma_pagamento_parceiro:
    def __init__(self, tipo_pagamento, bandeira, codigo_autorizacao, codigo_status, codigo_transacao, data_criacao,
                 ...
                 parcelas, descricao_condicao_pagamento_lojista=None, codigo_externo_condicao_pagamento_lojista=None):
