...
def get_orc_df(
    ...
    filesystem = pyarrow.fs.S3FileSystem(endpoint_override=endpoint_override)
...
def get_merged_def_from_s3_files(
    ...
    Args:
        ...
        row_sample_count (int): Number of rows to sample per S3 file.
    Returns:
        tuple[dict, Optional[DataAssetFieldsToProfilesMapping]]: Merged definition and data profile if able to be computed.
    """
