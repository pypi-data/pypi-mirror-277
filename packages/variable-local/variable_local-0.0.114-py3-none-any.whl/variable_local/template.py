...
class ReplaceFieldsWithValues(metaclass=MetaLogger, object=variable_local_logger_init_object):
    def __init__(self, message: str, lang_code: LangCode, variables: VariablesLocal):
        # TODO: we don't need those in the constructor (breaking change)
        #  -> def __init__(self): self.variables = VariablesLocal()
